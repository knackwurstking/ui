...
`;var k,p,C,ie;let Re=(ie=class{constructor(t,e){n(this,k,void 0);n(this,p,void 0);n(this,C,void 0);c(this,k,t),c(this,p,e),this.events=new H,c(this,C,document.createElement("h4")),i(this,C).slot="title",i(this,k).appendChild(i(this,C))}get dialog(){return i(this,p)}get fullscreen(){return i(this,k).hasAttribute("fullscreen")}set fullscreen(t){t?i(this,k).setAttribute("fullscreen",""):i(this,k).removeAttribute("fullscreen")}get title(){return i(this,C).innerText}set title(t){i(this,C).innerText=t}open(t=!1,e=!0){const s=i(this,p).inert;i(this,p).inert=e,t?i(this,p).showModal():i(this,p).show(),this.events.dispatch("open",null),i(this,p).inert=s}close(){i(this,p).close(),this.events.dispatch("close",null)}},k=new WeakMap,p=new WeakMap,C=new WeakMap,ie);var J,Y;const wt=class wt extends HTMLElement{constructor(){super();n(this,J,()=>this.ui.close());n(this,Y,()=>this.ui.close());this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ae,this.ui=new Re(this,this.shadowRoot.querySelector("dialog"))}connectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.addEventListener("click",i(this,Y)),e.addEventListener("click",i(this,J))}disconnectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.removeEventListener("click",i(this,Y)),e.removeEventListener("click",i(this,J))}};J=new WeakMap,Y=new WeakMap,o(wt,"register",()=>customElements.define("ui-dialog",wt));let it=wt;const Qt="1",$e=a`
<style></style>
<slot></slot>
...
`;var A,ne;let Be=(ne=class{constructor(t){n(this,A,void 0);c(this,A,t)}get name(){return i(this,A).getAttribute("name")}set name(t){i(this,A).setAttribute("name",t)}},A=new WeakMap,ne);const Ct=class Ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ze,this.ui=new Be(this)}};o(Ct,"register",()=>customElements.define("ui-stack-layout-page",Ct));let dt=Ct;const Je=a`
    ...
    <slot></slot>
`;var T,E,R,ae;let Ye=(ae=class{constructor(t){n(this,T,void 0);n(this,E,!1);n(this,R,{});c(this,T,t),this.events=new H,this.stack=[]}registerPage(t,e){i(this,R)[t]=e}unregisterPage(t){delete i(this,R)[t]}lock(){c(this,E,!0)}unlock(){c(this,E,!1)}goBack(){if(!this.stack.length||i(this,E))return;const t=this.stack.pop();i(this,T).removeChild(t),this.stack.length&&i(this,T).appendChild(this.stack[this.stack.length-1]),this.dispatchChangeEvent()}setPage(t){if(!i(this,E)){if(this.stack.push(i(this,T).appendChild(i(this,R)[t]().children[0])),this.stack.length>1){const e=this.stack[this.stack.length-2];e.parentElement.removeChild(e)}this.dispatchChangeEvent()}}async dispatchChangeEvent(){this.events.dispatch("change",{newPage:this.stack[this.stack.length-1]||null,oldPage:this.stack[this.stack.length-2]||null})}},T=new WeakMap,E=new WeakMap,R=new WeakMap,ae);const Mt=class Mt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Je,this.ui=new Ye(this)}};o(Mt,"register",()=>customElements.define("ui-stack-layout",Mt));let ut=Mt;var x,L,le;let Xe=(le=class{constructor(t){n(this,x,void 0);n(this,L,{});c(this,x,t),this.events=new H}get localStoragePrefix(){return i(this,x).getAttribute("local-storage-prefix")}set localStoragePrefix(t){i(this,x).setAttribute("local-storage-prefix",t)}get enableLocalStorage(){return i(this,x).hasAttribute("enable-local-storage")}set enableLocalStorage(t){t?i(this,x).setAttribute("enable-local-storage",""):i(this,x).removeAttribute("enable-local-storage")}get(t){return i(this,L)[t]}set(t,e,s=!1){if(s&&this.enableLocalStorage){const l=JSON.parse(localStorage.getItem(this.localStoragePrefix+t.toString())||"null");i(this,L)[t]=l??e}else i(this,L)[t]=e;this.enableLocalStorage&&localStorage.setItem(this.localStoragePrefix+t.toString(),JSON.stringify(i(this,L)[t])),this.events.dispatch(t,i(this,L)[t])}update(t,e){if(typeof e!="function")throw"callback is not a function";this.set(t,e(i(this,L)[t]))}on(t,e,s=!1){if(typeof e!="function")throw"callback is not a function";return s&&e(this.get(t)),this.events.on(t,e)}},x=new WeakMap,L=new WeakMap,le);const Tt=class Tt extends HTMLElement{constructor(){super(),this.ui=new Xe(this)}};o(Tt,"register",()=>customElements.define("ui-store",Tt));let pt=Tt;const Fe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,jt=class jt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ti}};o(jt,"register",()=>customElements.define("ui-svg-settings",jt));let Yt=jt;const ei=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,It=class It extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ei}};o(It,"register",()=>customElements.define("ui-svg-today-outline",It));let Xt=It;const v={BackArrowNavigation:Dt,ChevronDown:Nt,Close:Vt,DeleteRecycleBin:Zt,Edit2:Bt,PDFDocument:Jt,Settings:Yt,TodayOutline:Xt},ii=a`
<style>
    :host {
        position: relative !important;
        display: flex !important;
