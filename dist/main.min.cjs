...
`;var M,_t;let Ce=(_t=class{constructor(t){n(this,M,void 0);c(this,M,t)}getLeftSlot(){return[...i(this,M).querySelectorAll('[slot="left"]')]}getCenterSlot(){return[...i(this,M).querySelectorAll('[slot="center"]')]}getRightSlot(){return[...i(this,M).querySelectorAll('[slot="right"]')]}},M=new WeakMap,_t);const vt=class vt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ke,this.ui=new Ce(this)}};o(vt,"register",()=>customElements.define("ui-app-bar",vt));let G=vt;const Me=a`
<style>
    :host {
        display: flex !important;
        align-items: center;
...
<slot></slot>
`,bt=class bt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Se}};o(bt,"register",()=>customElements.define("ui-container",bt));let et=bt;const Ae=a`
<style>
    :host dialog * {
...
`;var k,p,C,ie;let Re=(ie=class{constructor(t,e){n(this,k,void 0);n(this,p,void 0);n(this,C,void 0);c(this,k,t),c(this,p,e),this.events=new H,c(this,C,document.createElement("h4")),i(this,C).slot="title",i(this,k).appendChild(i(this,C))}get dialog(){return i(this,p)}get fullscreen(){return i(this,k).hasAttribute("fullscreen")}set fullscreen(t){t?i(this,k).setAttribute("fullscreen",""):i(this,k).removeAttribute("fullscreen")}get title(){return i(this,C).innerText}set title(t){i(this,C).innerText=t}open(t=!1,e=!0){const s=i(this,p).inert;i(this,p).inert=e,t?i(this,p).showModal():i(this,p).show(),this.events.dispatch("open",null),i(this,p).inert=s}close(){i(this,p).close(),this.events.dispatch("close",null)}},k=new WeakMap,p=new WeakMap,C=new WeakMap,ie);var J,X;const wt=class wt extends HTMLElement{constructor(){super();n(this,J,()=>this.ui.close());n(this,X,()=>this.ui.close());this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ae,this.ui=new Re(this,this.shadowRoot.querySelector("dialog"))}connectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.addEventListener("click",i(this,X)),e.addEventListener("click",i(this,J))}disconnectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.removeEventListener("click",i(this,X)),e.removeEventListener("click",i(this,J))}};J=new WeakMap,X=new WeakMap,o(wt,"register",()=>customElements.define("ui-dialog",wt));let it=wt;const Qt="1",$e=a`
<style></style>
<slot></slot>
`,U=class U extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=$e,this._updateStyle()}attributeChangedCallback(t,e,s){switch(t){case"flex":this._updateStyle({flex:s||Qt});break}}_updateStyle({flex:t=Qt}={}){this.shadowRoot.querySelector("style").textContent=`
        ...
        `}};o(U,"register",()=>customElements.define("ui-flex-grid-item",U)),o(U,"observedAttributes",["flex"]);let st=U;const Wt="0",je=a`
<style></style>
<slot></slot>
`,q=class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=je,this._updateStyle()}attributeChangedCallback(t,e,s){switch(t){case"gap":this._updateStyle({gap:s||Wt});break}}_updateStyle({gap:t=Wt}={}){this.shadowRoot.querySelector("style").textContent=`
        ...
        `}};o(q,"register",()=>customElements.define("ui-flex-grid-row",q)),o(q,"observedAttributes",["gap"]);let rt=q;const Gt="0",Ie=a`
<style></style>
<slot></slot>
`,O=class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ie,this._updateStyle()}attributeChangedCallback(t,e,s){switch(t){case"gap":this._updateStyle({gap:s||Gt});break}}_updateStyle({gap:t=Gt}={}){this.shadowRoot.querySelector("style").textContent=`
        ...
        `}};o(O,"register",()=>customElements.define("ui-flex-grid",O)),o(O,"observedAttributes",["gap"]);let ot=O;const de=document.createElement("template");de.innerHTML=`
    <style>
        :host {
            display: block;
            position: relative;
...
`;let ze=class{constructor(t){this.root=t,this.events=new H,this.input=this.root.shadowRoot.querySelector("input"),this.input.type=this.root.getAttribute("type")||"text",this.input.oninput=()=>this.events.dispatch("input",this.value),this.input.onchange=()=>this.events.dispatch("change",this.value)}set title(t){let e=this.root.shadowRoot.querySelector('[slot="title"]');t===null&&e&&this.root.removeChild(e),e||(e=new B,e.slot="title",this.root.appendChild(e)),e.innerHTML=t||""}get title(){var t;return((t=this.root.querySelector('[slot="title"]'))==null?void 0:t.innerHTML)||null}set type(t){this.input.type=t}get type(){return this.input.type||"text"}set value(t){this.input.value=t}get value(){switch(this.input.type){case"number":return new Number(this.input.value);default:return this.input.value}}set placeholder(t){this.input.placeholder=t}get placeholder(){return this.input.placeholder}set invalid(t){this.input.ariaInvalid=t?"":null}get invalid(){return this.input.ariaInvalid!==null}set min(t){this.input.min=t}get min(){switch(this.input.type){case"number":return new Number(this.input.min);default:return this.input.min}}set max(t){this.input.max=t}get max(){switch(this.input.type){case"number":return new Number(this.input.max);default:return this.input.max}}};const P=class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(de.content.cloneNode(!0)),this.ui=new ze(this)}attributeChangedCallback(t,e,s){switch(t){case"title":this.ui.title=s;break;case"type":s===null?this.ui.type="text":this.ui.type=s;break;case"value":this.ui.value=this.parseNewValue(s);break;case"placeholder":s===null?this.ui.placeholder="":this.ui.placeholder=s;break;case"invalid":this.ui.invalid=s!==null;break;case"min":this.ui.min=this.parseNewValue(s);break;case"max":this.ui.max=this.parseNewValue(s);break}}parseNewValue(t){switch(this.ui.type){case"number":return new Number(t);default:return t||""}}};o(P,"register",()=>customElements.define("ui-input",P)),o(P,"observedAttributes",["title","type","value","placeholder","invalid","min","max"]);let nt=P;const Ue=a`
<style>
    :host {
        display: none;
        align-items: center;
...
`;let Pe=class{constructor(){this.events=new H}};var Y;const xt=class xt extends HTMLElement{constructor(){super();n(this,Y,async e=>{(e.composedPath()||[]).forEach(s=>{s instanceof Z&&([...this.querySelectorAll("ui-select-option")].forEach(l=>l.removeAttribute("selected")),s.setAttribute("selected",""),this.ui.events.dispatch("change",s))})});this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Oe,this.cleanup=[],this.ui=new Pe}connectedCallback(){const e=this.shadowRoot.querySelector(".options"),s=this.onClickOptions.bind(this);e.addEventListener("click",s),this.cleanup.push(()=>{this.removeEventListener("click",s),e.removeEventListener("click",this.onClickOptions)}),this.style.setProperty("--items-length",this.querySelectorAll("ui-select-option").length.toString())}disconnectedCallback(){this.cleanup.forEach(e=>e()),this.cleanup=[]}async onClickOptions(e){this.classList.toggle("open")?(e.stopPropagation(),this.addEventListener("click",i(this,Y))):setTimeout(()=>this.removeEventListener("click",i(this,Y)))}};Y=new WeakMap,o(xt,"register",()=>customElements.define("ui-select",xt));let at=xt;var F,S,K,re;let De=(re=class{constructor(t){n(this,F,void 0);n(this,S,void 0);n(this,K,void 0);c(this,F,t),c(this,S,new H),this.langType=null}getFallbackElement(){return i(this,F).querySelector("ui-lang-type[fallback]")}new(t,e){this.langType=t,c(this,K,e),i(this,S).dispatch("change",this.langType)}get(t,e){var s,l;return((l=(s=i(this,K))==null?void 0:s[t])==null?void 0:l[e])||null}on(t,e,s=!1){if(typeof e!="function")throw"callback is not a function";return s&&e(this.langType),i(this,S).on(t,e)}},F=new WeakMap,S=new WeakMap,K=new WeakMap,re);const D=class D extends HTMLElement{constructor(){super(),this.ui=new De(this)}attributeChangedCallback(t,e,s){switch(t){case"current":s!==null&&this._loadLanguage(s);break}}async _loadLanguage(t){const e=this.querySelector(`ui-lang-type[name="${t}"]`)||this.ui.getFallbackElement();if(!e)return;if(!e.ui.href)throw"Missing href attribute!";const s=await fetch(e.ui.href);this.ui.new(e,await s.json())}};o(D,"register",()=>customElements.define("ui-lang",D)),o(D,"observedAttributes",["current"]);let lt=D;var g,oe;let Ne=(oe=class{constructor(t){n(this,g,void 0);c(this,g,t)}get name(){return i(this,g).getAttribute("name")}set name(t){i(this,g).setAttribute("name",t)}get href(){return i(this,g).getAttribute("href")}set href(t){i(this,g).setAttribute("href",t)}get fallback(){return i(this,g).hasAttribute("fallback")}set fallback(t){t?i(this,g).setAttribute("fallback",""):i(this,g).removeAttribute("fallback")}},g=new WeakMap,oe);const Lt=class Lt extends HTMLElement{constructor(){super(),this.ui=new Ne(this)}};o(Lt,"register",()=>customElements.define("ui-lang-type",Lt));let ct=Lt;const Ve=a`
<style>
    .background {
        z-index: 999;
        position: absolute;
...
`,kt=class kt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ve}};o(kt,"register",()=>customElements.define("ui-spinner",kt));let ht=kt;const Ze=a`
    <style>
        :host {
            display: block !important;
            position: absolute !important;
    ...
    <slot></slot>
`;var A,ne;let Be=(ne=class{constructor(t){n(this,A,void 0);c(this,A,t)}get name(){return i(this,A).getAttribute("name")}set name(t){i(this,A).setAttribute("name",t)}},A=new WeakMap,ne);const Ct=class Ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ze,this.ui=new Be(this)}};o(Ct,"register",()=>customElements.define("ui-stack-layout-page",Ct));let dt=Ct;const Je=a`
    <style>
        :host {
            display: block !important;
            position: relative !important;
    ...
    <slot></slot>
`;var T,E,R,ae;let Xe=(ae=class{constructor(t){n(this,T,void 0);n(this,E,!1);n(this,R,{});c(this,T,t),this.events=new H,this.stack=[]}registerPage(t,e){i(this,R)[t]=e}unregisterPage(t){delete i(this,R)[t]}lock(){c(this,E,!0)}unlock(){c(this,E,!1)}goBack(){if(!this.stack.length||i(this,E))return;const t=this.stack.pop();i(this,T).removeChild(t),this.stack.length&&i(this,T).appendChild(this.stack[this.stack.length-1]),this.dispatchChangeEvent()}setPage(t){if(!i(this,E)){if(this.stack.push(i(this,T).appendChild(i(this,R)[t]().children[0])),this.stack.length>1){const e=this.stack[this.stack.length-2];e.parentElement.removeChild(e)}this.dispatchChangeEvent()}}async dispatchChangeEvent(){this.events.dispatch("change",{newPage:this.stack[this.stack.length-1]||null,oldPage:this.stack[this.stack.length-2]||null})}},T=new WeakMap,E=new WeakMap,R=new WeakMap,ae);const Mt=class Mt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Je,this.ui=new Xe(this)}};o(Mt,"register",()=>customElements.define("ui-stack-layout",Mt));let ut=Mt;var x,L,le;let Ye=(le=class{constructor(t){n(this,x,void 0);n(this,L,{});c(this,x,t),this.events=new H}get localStoragePrefix(){return i(this,x).getAttribute("local-storage-prefix")}set localStoragePrefix(t){i(this,x).setAttribute("local-storage-prefix",t)}get enableLocalStorage(){return i(this,x).hasAttribute("enable-local-storage")}set enableLocalStorage(t){t?i(this,x).setAttribute("enable-local-storage",""):i(this,x).removeAttribute("enable-local-storage")}get(t){return i(this,L)[t]}set(t,e,s=!1){if(s&&this.enableLocalStorage){const l=JSON.parse(localStorage.getItem(this.localStoragePrefix+t.toString())||"null");i(this,L)[t]=l??e}else i(this,L)[t]=e;this.enableLocalStorage&&localStorage.setItem(this.localStoragePrefix+t.toString(),JSON.stringify(i(this,L)[t])),this.events.dispatch(t,i(this,L)[t])}update(t,e){if(typeof e!="function")throw"callback is not a function";this.set(t,e(i(this,L)[t]))}on(t,e,s=!1){if(typeof e!="function")throw"callback is not a function";return s&&e(this.get(t)),this.events.on(t,e)}},x=new WeakMap,L=new WeakMap,le);const Tt=class Tt extends HTMLElement{constructor(){super(),this.ui=new Ye(this)}};o(Tt,"register",()=>customElements.define("ui-store",Tt));let pt=Tt;const Fe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
<slot></slot>
`,zt=class zt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ri}};o(zt,"register",()=>customElements.define("ui-primary",zt));let mt=zt;const oi=a`
<style>
    :host {
        font-size: 0.9rem;
        font-family: var(--ui-fontFamily);
