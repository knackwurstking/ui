...
`;var y,x,L,Wt;let Te=(Wt=class{constructor(t,e){n(this,y,void 0);n(this,x,void 0);n(this,L,void 0);l(this,y,t),l(this,x,e),this.events=new $,l(this,L,document.createElement("h4")),i(this,L).slot="title",i(this,y).appendChild(i(this,L))}get dialog(){return i(this,x)}get fullscreen(){return i(this,y).hasAttribute("fullscreen")}set fullscreen(t){t?i(this,y).setAttribute("fullscreen",""):i(this,y).removeAttribute("fullscreen")}get title(){return i(this,L).innerText}set title(t){i(this,L).innerText=t}open(t=!1){t?i(this,x).showModal():i(this,x).show(),this.events.dispatch("open",null)}close(){i(this,x).close(),this.events.dispatch("close",null)}},y=new WeakMap,x=new WeakMap,L=new WeakMap,Wt);var N,J;const mt=class mt extends HTMLElement{constructor(){super();n(this,N,()=>this.ui.close());n(this,J,()=>this.ui.close());this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Me,this.ui=new Te(this,this.shadowRoot.querySelector("dialog"))}connectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.addEventListener("click",i(this,J)),e.addEventListener("click",i(this,N))}disconnectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.removeEventListener("click",i(this,J)),e.removeEventListener("click",i(this,N))}};N=new WeakMap,J=new WeakMap,r(mt,"register",()=>customElements.define("ui-dialog",mt));let tt=mt;const Jt="1",Ee=a`
<style></style>
<slot></slot>
