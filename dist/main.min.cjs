...
<slot></slot>
`;var d,_t;let xe=(_t=class{constructor(t){a(this,d,void 0);c(this,d,t),this.removeRipple=null}get color(){return i(this,d).getAttribute("color")}set color(t){i(this,d).setAttribute("color",t)}get ghost(){return i(this,d).hasAttribute("ghost")}set ghost(t){t?i(this,d).setAttribute("ghost",""):i(this,d).removeAttribute("ghost")}disable(){i(this,d).setAttribute("disabled","")}enable(){i(this,d).removeAttribute("disabled")}enableRipple(){this.removeRipple||(this.removeRipple=Bt(i(this,d),{centered:!0}),i(this,d).removeAttribute("no-ripple"))}disableRipple(){this.removeRipple&&(this.removeRipple(),this.removeRipple=null,i(this,d).setAttribute("no-ripple",""))}},d=new WeakMap,_t);const N=class N extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ke,this.setAttribute("role","button"),this.cleanup=new h,this.ui=new xe(this)}connectedCallback(){!this.hasAttribute("no-ripple")&&!this.ui.removeRipple&&this.ui.enableRipple()}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,s){switch(t){case"no-ripple":s!==null?this.ui.disableRipple():this.ui.enableRipple();break}}};o(N,"register",()=>{console.debug("register web component: ui-icon-button"),customElements.define("ui-icon-button",N)}),o(N,"observedAttributes",["no-ripple"]);let G=N;const Ce=l`
<style>
    :host {
        display: block;
        width: 100%;
...
`,Vt=class Vt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ii}};o(Vt,"register",()=>{console.debug("register svg component: svg-settings"),customElements.define("svg-settings",Vt)});let kt=Vt;const si=l`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,Zt=class Zt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=si}};o(Zt,"register",()=>{console.debug("register svg component: svg-today-outline"),customElements.define("svg-today-outline",Zt)});let xt=Zt;function ri(){K.register(),G.register(),Q.register(),_.register(),et.register(),it.register(),st.register(),nt.register(),F.register(),at.register(),ct.register(),lt.register(),ht.register(),ut.register(),dt.register(),pt.register(),U.register(),ot.register(),rt.register(),gt.register(),tt.register()}function oi(){mt.register(),bt.register(),ft.register(),vt.register(),wt.register(),yt.register(),kt.register(),xt.register()}exports.SvgBackArrowNavigation=mt;exports.SvgChevronDown=bt;exports.SvgClose=ft;exports.SvgDeleteRecycleBin=vt;exports.SvgEdit2=wt;exports.SvgPDFDocument=yt;exports.SvgSettings=kt;exports.SvgTodayOutline=xt;exports.UIAppBar=K;exports.UIButton=Q;exports.UIContainer=_;exports.UIDialog=tt;exports.UIFlexGrid=st;exports.UIFlexGridItem=et;exports.UIFlexGridRow=it;exports.UIIconButton=G;exports.UIInput=nt;exports.UILabel=rt;exports.UILang=lt;exports.UILangType=ct;exports.UIPrimary=ot;exports.UISecondary=U;exports.UISelect=at;exports.UISelectOption=F;exports.UISpinner=ht;exports.UIStackLayout=dt;exports.UIStackLayoutPage=ut;exports.UIStore=pt;exports.UIThemeHandler=gt;exports.js=be;exports.registerSVGComponents=oi;exports.registerWebComponents=ri;
