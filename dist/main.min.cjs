...
`;var M,_t;let Ce=(_t=class{constructor(t){n(this,M,void 0);c(this,M,t)}getLeftSlot(){return[...i(this,M).querySelectorAll('[slot="left"]')]}getCenterSlot(){return[...i(this,M).querySelectorAll('[slot="center"]')]}getRightSlot(){return[...i(this,M).querySelectorAll('[slot="right"]')]}},M=new WeakMap,_t);const vt=class vt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ke,this.ui=new Ce(this)}};o(vt,"register",()=>customElements.define("ui-app-bar",vt));let F=vt;const Me=a`
<style>
    :host {
        display: flex !important;
        align-items: center;
...
`;var k,p,C,ie;let Re=(ie=class{constructor(t,e){n(this,k,void 0);n(this,p,void 0);n(this,C,void 0);c(this,k,t),c(this,p,e),this.events=new H,c(this,C,document.createElement("h4")),i(this,C).slot="title",i(this,k).appendChild(i(this,C))}get dialog(){return i(this,p)}get fullscreen(){return i(this,k).hasAttribute("fullscreen")}set fullscreen(t){t?i(this,k).setAttribute("fullscreen",""):i(this,k).removeAttribute("fullscreen")}get title(){return i(this,C).innerText}set title(t){i(this,C).innerText=t}open(t=!1,e=!0){const s=i(this,p).inert;i(this,p).inert=e,t?i(this,p).showModal():i(this,p).show(),this.events.dispatch("open",null),i(this,p).inert=s}close(){i(this,p).close(),this.events.dispatch("close",null)}},k=new WeakMap,p=new WeakMap,C=new WeakMap,ie);var J,V;const wt=class wt extends HTMLElement{constructor(){super();n(this,J,()=>this.ui.close());n(this,V,()=>this.ui.close());this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ae,this.ui=new Re(this,this.shadowRoot.querySelector("dialog"))}connectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.addEventListener("click",i(this,V)),e.addEventListener("click",i(this,J))}disconnectedCallback(){const e=this.shadowRoot.querySelector(".header ui-icon-button");e.removeEventListener("click",i(this,V)),e.removeEventListener("click",i(this,J))}};J=new WeakMap,V=new WeakMap,o(wt,"register",()=>customElements.define("ui-dialog",wt));let et=wt;const Wt="1",$e=a`
<style></style>
<slot></slot>
`,U=class U extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=$e,this._updateStyle()}attributeChangedCallback(t,e,s){switch(t){case"flex":this._updateStyle({flex:s||Wt});break}}_updateStyle({flex:t=Wt}={}){this.shadowRoot.querySelector("style").textContent=`
            :host {
                flex: ${t};
            }
        `}};o(U,"register",()=>customElements.define("ui-flex-grid-item",U)),o(U,"observedAttributes",["flex"]);let it=U;const Ft="0",je=a`
<style></style>
<slot></slot>
`,q=class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=je,this._updateStyle()}attributeChangedCallback(t,e,s){switch(t){case"gap":this._updateStyle({gap:s||Ft});break}}_updateStyle({gap:t=Ft}={}){this.shadowRoot.querySelector("style").textContent=`
            :host {
                display: flex !important;
...
`;let ze=class{constructor(){this.events=new H,this.input}};const P=class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(de.content.cloneNode(!0)),this.ui=new ze,this.create()}attributeChangedCallback(t,e,s){switch(t){case"type":s===null?this.ui.input.type="text":this.ui.input.type=s;break;case"value":s===null?this.ui.input.value="":this.ui.input.value=s;break;case"placeholder":s===null?this.ui.input.placeholder="":this.ui.input.placeholder=s;break;case"invalid":this.ui.input.ariaInvalid=s;break;case"min":s===null?this.ui.input.min="":this.ui.input.min=s;break;case"max":s===null?this.ui.input.max="":this.ui.input.max=s;break}}create(){this.ui.input=this.shadowRoot.querySelector("input"),this.ui.input.type=this.getAttribute("type")||"text"}};o(P,"register",customElements.define("ui-input",P)),o(P,"observedAttributes",["type","value","placeholder","invalid","min","max"]);let ot=P;const Ue=a`
<style>
    :host {
        display: none;
        align-items: center;
...
<slot></slot>
`;var y,se;let qe=(se=class{constructor(t){n(this,y,void 0);c(this,y,t)}get value(){return i(this,y).getAttribute("value")}set value(t){i(this,y).setAttribute("value",t)}get selected(){return i(this,y).hasAttribute("selected")}set selected(t){t?i(this,y).setAttribute("selected",""):i(this,y).removeAttribute("selected")}},y=new WeakMap,se);const yt=class yt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ue,this.setAttribute("role","button"),this.ui=new qe(this)}};o(yt,"register",()=>customElements.define("ui-select-option",yt));let B=yt;const Oe=a`
<style>
    * {
        box-sizing: border-box;
    }
...
`;let Pe=class{constructor(){this.events=new H}};var X;const xt=class xt extends HTMLElement{constructor(){super();n(this,X,async e=>{(e.composedPath()||[]).forEach(s=>{s instanceof B&&([...this.querySelectorAll("ui-select-option")].forEach(l=>l.removeAttribute("selected")),s.setAttribute("selected",""),this.ui.events.dispatch("change",s))})});this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Oe,this.cleanup=[],this.ui=new Pe}connectedCallback(){const e=this.shadowRoot.querySelector(".options"),s=this.onClickOptions.bind(this);e.addEventListener("click",s),this.cleanup.push(()=>{this.removeEventListener("click",s),e.removeEventListener("click",this.onClickOptions)}),this.style.setProperty("--items-length",this.querySelectorAll("ui-select-option").length.toString())}disconnectedCallback(){this.cleanup.forEach(e=>e()),this.cleanup=[]}async onClickOptions(e){this.classList.toggle("open")?(e.stopPropagation(),this.addEventListener("click",i(this,X))):setTimeout(()=>this.removeEventListener("click",i(this,X)))}};X=new WeakMap,o(xt,"register",()=>customElements.define("ui-select",xt));let nt=xt;var Y,S,K,re;let De=(re=class{constructor(t){n(this,Y,void 0);n(this,S,void 0);n(this,K,void 0);c(this,Y,t),c(this,S,new H),this.langType=null}getFallbackElement(){return i(this,Y).querySelector("ui-lang-type[fallback]")}new(t,e){this.langType=t,c(this,K,e),i(this,S).dispatch("change",this.langType)}get(t,e){var s,l;return((l=(s=i(this,K))==null?void 0:s[t])==null?void 0:l[e])||null}on(t,e,s=!1){if(typeof e!="function")throw"callback is not a function";return s&&e(this.langType),i(this,S).on(t,e)}},Y=new WeakMap,S=new WeakMap,K=new WeakMap,re);const D=class D extends HTMLElement{constructor(){super(),this.ui=new De(this)}attributeChangedCallback(t,e,s){switch(t){case"current":s!==null&&this._loadLanguage(s);break}}async _loadLanguage(t){const e=this.querySelector(`ui-lang-type[name="${t}"]`)||this.ui.getFallbackElement();if(!e)return;if(!e.ui.href)throw"Missing href attribute!";const s=await fetch(e.ui.href);this.ui.new(e,await s.json())}};o(D,"register",()=>customElements.define("ui-lang",D)),o(D,"observedAttributes",["current"]);let at=D;var g,oe;let Ze=(oe=class{constructor(t){n(this,g,void 0);c(this,g,t)}get name(){return i(this,g).getAttribute("name")}set name(t){i(this,g).setAttribute("name",t)}get href(){return i(this,g).getAttribute("href")}set href(t){i(this,g).setAttribute("href",t)}get fallback(){return i(this,g).hasAttribute("fallback")}set fallback(t){t?i(this,g).setAttribute("fallback",""):i(this,g).removeAttribute("fallback")}},g=new WeakMap,oe);const Lt=class Lt extends HTMLElement{constructor(){super(),this.ui=new Ze(this)}};o(Lt,"register",()=>customElements.define("ui-lang-type",Lt));let lt=Lt;const Ne=a`
<style>
    .background {
        z-index: 999;
        position: absolute;
...
`,kt=class kt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ne}};o(kt,"register",()=>customElements.define("ui-spinner",kt));let ct=kt;const Be=a`
    <style>
        :host {
            display: block !important;
            position: absolute !important;
    ...
    <slot></slot>
`;var A,ne;let Je=(ne=class{constructor(t){n(this,A,void 0);c(this,A,t)}get name(){return i(this,A).getAttribute("name")}set name(t){i(this,A).setAttribute("name",t)}},A=new WeakMap,ne);const Ct=class Ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Be,this.ui=new Je(this)}};o(Ct,"register",()=>customElements.define("ui-stack-layout-page",Ct));let ht=Ct;const Ve=a`
    <style>
        :host {
            display: block !important;
            position: relative !important;
    ...
    <slot></slot>
`;var T,E,R,ae;let Xe=(ae=class{constructor(t){n(this,T,void 0);n(this,E,!1);n(this,R,{});c(this,T,t),this.events=new H,this.stack=[]}registerPage(t,e){i(this,R)[t]=e}unregisterPage(t){delete i(this,R)[t]}lock(){c(this,E,!0)}unlock(){c(this,E,!1)}goBack(){if(!this.stack.length||i(this,E))return;const t=this.stack.pop();i(this,T).removeChild(t),this.stack.length&&i(this,T).appendChild(this.stack[this.stack.length-1]),this.dispatchChangeEvent()}setPage(t){if(!i(this,E)){if(this.stack.push(i(this,T).appendChild(i(this,R)[t]().children[0])),this.stack.length>1){const e=this.stack[this.stack.length-2];e.parentElement.removeChild(e)}this.dispatchChangeEvent()}}async dispatchChangeEvent(){this.events.dispatch("change",{newPage:this.stack[this.stack.length-1]||null,oldPage:this.stack[this.stack.length-2]||null})}},T=new WeakMap,E=new WeakMap,R=new WeakMap,ae);const Mt=class Mt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ve,this.ui=new Xe(this)}};o(Mt,"register",()=>customElements.define("ui-stack-layout",Mt));let dt=Mt;var x,L,le;let Ye=(le=class{constructor(t){n(this,x,void 0);n(this,L,{});c(this,x,t),this.events=new H}get localStoragePrefix(){return i(this,x).getAttribute("local-storage-prefix")}set localStoragePrefix(t){i(this,x).setAttribute("local-storage-prefix",t)}get enableLocalStorage(){return i(this,x).hasAttribute("enable-local-storage")}set enableLocalStorage(t){t?i(this,x).setAttribute("enable-local-storage",""):i(this,x).removeAttribute("enable-local-storage")}get(t){return i(this,L)[t]}set(t,e,s=!1){if(s&&this.enableLocalStorage){const l=JSON.parse(localStorage.getItem(this.localStoragePrefix+t.toString())||"null");i(this,L)[t]=l??e}else i(this,L)[t]=e;this.enableLocalStorage&&localStorage.setItem(this.localStoragePrefix+t.toString(),JSON.stringify(i(this,L)[t])),this.events.dispatch(t,i(this,L)[t])}update(t,e){if(typeof e!="function")throw"callback is not a function";this.set(t,e(i(this,L)[t]))}on(t,e,s=!1){if(typeof e!="function")throw"callback is not a function";return s&&e(this.get(t)),this.events.on(t,e)}},x=new WeakMap,L=new WeakMap,le);const Tt=class Tt extends HTMLElement{constructor(){super(),this.ui=new Ye(this)}};o(Tt,"register",()=>customElements.define("ui-store",Tt));let ut=Tt;const Ke=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,Ht=class Ht extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Qe}};o(Ht,"register",()=>customElements.define("ui-svg-chevron-down",Ht));let Zt=Ht;const We=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,St=class St extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=We}};o(St,"register",()=>customElements.define("ui-svg-close",St));let Nt=St;const Fe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,At=class At extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Fe}};o(At,"register",()=>customElements.define("ui-svg-delete-recycle-bin",At));let Bt=At;const Ge=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,Rt=class Rt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ge}};o(Rt,"register",()=>customElements.define("ui-svg-edit2",Rt));let Jt=Rt;const _e=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
>
`,$t=class $t extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=_e}};o($t,"register",()=>customElements.define("ui-svg-pdf-document",$t));let Vt=$t;const ti=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,It=class It extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ei}};o(It,"register",()=>customElements.define("ui-svg-today-outline",It));let Yt=It;const v={BackArrowNavigation:Dt,ChevronDown:Zt,Close:Nt,DeleteRecycleBin:Bt,Edit2:Jt,PDFDocument:Vt,Settings:Xt,TodayOutline:Yt},ii=a`
<style>
    :host {
        position: relative !important;
        display: flex !important;
...
`;var h,$,Q,W,j,ce;let si=(ce=class{constructor(t){n(this,h,void 0);n(this,$,!1);n(this,Q,async()=>{[...i(this,h).querySelectorAll('[slot="input"]')].forEach(t=>t.click())});n(this,W,async t=>{t.stopPropagation()});n(this,j,void 0);c(this,h,t)}get primary(){return i(this,h).getAttribute("primary")}set primary(t){i(this,h).setAttribute("primary",t)}get secondary(){return i(this,h).getAttribute("secondary")}set secondary(t){i(this,h).setAttribute("secondary",t)}getInputSlot(){return[...i(this,h).querySelectorAll('[slot="input"]')]}enableRipple(){i(this,j)||(this.removeRipple=qt(i(this,h)),i(this,h).style.cursor="pointer",this._startInputHandling())}disableRipple(){i(this,j)&&i(this,j).call(this),this._stopInputHandling()}_startInputHandling(){i(this,$)||(i(this,h).addEventListener("click",i(this,Q)),this.getInputSlot().forEach(t=>{t.addEventListener("click",i(this,W))}),c(this,$,!0))}_stopInputHandling(){i(this,h).removeEventListener("click",i(this,Q)),[...i(this,h).querySelectorAll('[slot="input"]')].forEach(t=>{t.removeEventListener("click",i(this,W))}),c(this,$,!1)}},h=new WeakMap,$=new WeakMap,Q=new WeakMap,W=new WeakMap,j=new WeakMap,ce);const Z=class Z extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ii,this.ui=new si(this)}attributeChangedCallback(t,e,s){switch(t){case"ripple":s!==null?this.ui.enableRipple():this.ui.disableRipple();break;case"primary":this.shadowRoot.querySelector("ui-primary").innerHTML=s||"";break;case"secondary":this.shadowRoot.querySelector("ui-secondary").innerHTML=s||"";break}}};o(Z,"register",()=>customElements.define("ui-label",Z)),o(Z,"observedAttributes",["ripple","secondary","primary"]);let pt=Z;const ri=a`
<style>
    :host {
        font-size: 1.1rem;
