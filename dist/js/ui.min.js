...
function D(n, e) {
  e = { ...S, ...e };
  let t = null, l = null, r = null, a = !1, o = "", d = "";
  const v = (s) => {
    ...
    !t && Array.from(u.classList).includes("draggable") && (l = (/* @__PURE__ */ new Date()).getTime(), t = u, r && clearTimeout(r), r = setTimeout(() => {
      t && (o = t.style.color, d = t.style.backgroundColor, t.style.color = "var(--ui-primary-text)", t.style.backgroundColor = "var(--ui-primary)", n.classList.add("ui-dragging"), a = !0, e != null && e.onDragStart && e.onDragStart());
    }, 200));
  }, p = (s) => {
    if (!l || !t) return;
    ...
    let i = document.elementFromPoint(u.clientX, u.clientY);
    if (i) {
      for (; !i.classList.contains("draggable") && i.parentElement; )
        i = i.parentElement;
      i.classList.contains("draggable") && ((() => {
        ...
        return !1;
      })() ? n.insertBefore(t, i) : n.insertBefore(t, i.nextElementSibling));
    }
  }, f = () => {
    r !== null && (clearTimeout(r), r = null), t && (t.style.color = o, t.style.backgroundColor = d, t = null), l = null, n.classList.remove("ui-dragging"), a && (a = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
...
function $(n, e) {
  ...
  let t = null;
  const l = (d) => {
    t = m(d, e), n.addEventListener("pointermove", a);
  }, r = () => {
    n.removeEventListener("pointermove", a), h(t), t = null;
  }, a = () => r(), o = (d) => {
    t = m(d, e), h(t), t = null;
  };
