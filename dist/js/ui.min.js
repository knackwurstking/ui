...
function L(n, e, t) {
  ...
  return e.draggable = !0, e.ondragstart = (r) => {
    ...
    r.preventDefault(), [...n.children].forEach((l, i) => {
      if (i === a) {
...
function w(n, e) {
  e = { ...S, ...e };
  let t = null, a = null, r = null, l = !1, i = "", c = "";
  const v = (s) => {
    ...
    !t && Array.from(u.classList).includes("draggable") && (a = (/* @__PURE__ */ new Date()).getTime(), t = u, r && clearTimeout(r), r = setTimeout(() => {
      t && (i = t.style.color, c = t.style.backgroundColor, t.style.color = "var(--ui-primary-text)", t.style.backgroundColor = "var(--ui-primary)", n.classList.add("ui-dragging"), l = !0, e != null && e.onDragStart && e.onDragStart());
    }, 200));
  }, p = (s) => {
    if (!a || !t) return;
    ...
    s.preventDefault(), l || (l = !0, e != null && e.onDragStart && e.onDragStart());
    let u;
    ...
    r !== null && (clearTimeout(r), r = null), t && (t.style.color = i, t.style.backgroundColor = c, t = null), a = null, n.classList.remove("ui-dragging"), l && (l = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
...
function D(n, e) {
  ...
  return n.classList.add("ripple-container"), n.style.overflow = "hidden", e.usePointer ? (n.addEventListener("pointerdown", a), n.addEventListener("pointerup", r), n.addEventListener("pointerleave", r)) : n.addEventListener("click", i), () => {
...
function T(n) {
  function e(t) {
    fetch(t.template).then((a) => a.text()).then((a) => {
      const r = document.querySelector("head > title");
      r !== null && (r.innerHTML = t.title), document.body.innerHTML = a, t.scripts.forEach((l) => {
        const i = document.createElement("script");
        i.setAttribute("data-template", t.template), i.src = l.src, document.body.appendChild(i);
      });
    }).catch((a) => alert(a));
  }
  window.addEventListener("hashchange", () => {
    const t = window.location.hash.replace("#", ""), a = Object.keys(n).find((r) => t.startsWith(r));
    e(a !== void 0 ? n[a] : n["/"]);
