...
function $(n, t) {
  ...
  const u = (i) => {
    ...
    if (c) {
      ...
      c.classList.contains("draggable") && ((() => {
        let g = e == null ? void 0 : e.previousElementSibling;
        for (; g; ) {
          if (g === c)
            return !0;
  ...
  return [...n.children].forEach((i) => {
    i.classList.add("draggable"), i.onmousedown = u, i.ontouchstart = u, i.onmousemove = m, i.ontouchmove = m, n.onmouseleave = i.onmouseup = d, i.ontouchend = d;
  }), () => {
...
function w(n, t) {
  ...
  async function l(r) {
    ...
    if ((e == null ? void 0 : e.href) !== void 0 && n) {
      ...
      n.innerHTML = u, e.scripts !== void 0 && e.scripts.forEach((m) => {
        const d = document.createElement("script");
        d.setAttribute("data-template", e.href), d.src = m.src, n.appendChild(d);
      });
    }
...
function I(n) {
  return Object.entries(n).map(
    ([t, e]) => `${t.replace(/[A-Z]/g, (l) => `-${l.toLowerCase()}`)}:${e}`
  ).join(";") + ";";
}
export {
  E as Events,
