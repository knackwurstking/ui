...
class T {
  ...
  removeListener(e, t) {
    ...
    for (const c of this.listeners[e])
      c === t && (this.listeners[e].splice(r, 1), s = !0), r++;
    if (!s)
...
function M(n, e = {}) {
  ...
  const r = (l) => {
    ...
    n.classList.add("ripple-container"), n.addEventListener("pointerdown", r), n.addEventListener("pointerup", c), n.addEventListener("pointerleave", c), s = !1;
  }, i = () => {
    n.classList.remove("ripple-container"), n.removeEventListener("pointerdown", r), n.removeEventListener("pointerup", c), n.removeEventListener("pointerleave", c), s = !0;
  };
  return e && o(), {
    /**
...
class m extends HTMLButtonElement {
  constructor() {
    super();
  }
  /**
...
class x extends HTMLLabelElement {
  constructor() {
    super();
  }
  /**
...
class g extends HTMLSpanElement {
  constructor() {
    super();
  }
  /**
...
class L extends HTMLSpanElement {
  constructor() {
    super();
  }
  /**
...
async function H() {
  customElements.define("ui-app-bar", p), customElements.define("ui-button", f), customElements.define("ui-icon-button", m), customElements.define("ui-container", b), customElements.define("ui-flex-grid-item", h), customElements.define("ui-flex-grid-row", y), customElements.define("ui-label", x), customElements.define("ui-primary", g), customElements.define("ui-secondary", L), customElements.define("ui-select", E);
}
const O = {
  ...k,
  wc: w,
