 ...
 */
const ve = globalThis, Ze = ve.ShadowRoot && (ve.ShadyCSS === void 0 || ve.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ze = Symbol(), rt = /* @__PURE__ */ new WeakMap();
let vt = class {
  constructor(e, t, o) {
...
const jt = (i) => new vt(typeof i == "string" ? i : i + "", void 0, ze), g = (i, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Et, defineProperty: At, getOwnPropertyDescriptor: Ut, getOwnPropertyNames: It, getOwnPropertySymbols: Dt, getPrototypeOf: Rt } = Object, P = globalThis, ot = P.trustedTypes, Bt = ot ? ot.emptyScript : "", Oe = P.reactiveElementPolyfillSupport, K = (i, e) => i, ye = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Bt : null;
      break;
...
Z.elementStyles = [], Z.shadowRootOptions = { mode: "open" }, Z[K("elementProperties")] = /* @__PURE__ */ new Map(), Z[K("finalized")] = /* @__PURE__ */ new Map(), Oe == null || Oe({ ReactiveElement: Z }), (P.reactiveElementVersions ?? (P.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const X = globalThis, be = X.trustedTypes, nt = be ? be.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, yt = "$lit$", L = `lit$${Math.random().toFixed(9).slice(2)}$`, bt = "?" + L, Vt = `<${bt}>`, A = document, J = () => A.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Fe = Array.isArray, Ht = (i) => Fe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", je = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, lt = />/g, M = RegExp(`>|${je}(?:([^\\s"'>=/]+)(${je}*=${je}*(?:[^ 	
...
const Tt = (i, e) => {
  ...
  for (let p = 0; p < t; p++) {
    const h = i[p];
    let f, v, c = -1, m = 0;
    for (; m < h.length && (n.lastIndex = m, v = n.exec(h), v !== null); ) m = n.lastIndex, n === Y ? v[1] === "!--" ? n = at : v[1] !== void 0 ? n = lt : v[2] !== void 0 ? (mt.test(v[2]) && (r = RegExp("</" + v[2], "g")), n = M) : v[3] !== void 0 && (n = M) : n === M ? v[0] === ">" ? (n = r ?? Y, c = -1) : v[1] === void 0 ? c = -2 : (c = n.lastIndex - v[2].length, f = v[1], n = v[3] === void 0 ? M : v[3] === '"' ? ht : ct) : n === ht || n === ct ? n = M : n === at || n === lt ? n = Y : (n = M, r = void 0);
    const b = n === M && i[p + 1].startsWith("/>") ? " " : "";
    s += n === Y ? h + Vt : c >= 0 ? (o.push(f), h.slice(0, c) + yt + h.slice(c) + L + b) : h + L + (c === -2 ? p : b);
  }
...
class ee {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const p = e.length - 1, h = this.parts, [f, v] = Tt(e, t);
...
class ae {
  ...
  $(e) {
    ...
    if (((s = this._$AH) == null ? void 0 : s._$AD) === r) this._$AH.p(t);
      ...
      const n = new Zt(r, this), p = n.u(this.options);
...
Me == null || Me(ee, ae), (X.litHtmlVersions ?? (X.litHtmlVersions = [])).push("3.2.1");
const Wt = (i, e, t) => {
...
function Jt(i, e) {
  ...
  const h = (c) => {
    ...
    !t && Array.from(m.classList).includes("draggable") && (o = (/* @__PURE__ */ new Date()).getTime(), t = m, r && clearTimeout(r), r = setTimeout(() => {
      t && (n = t.style.color, p = t.style.backgroundColor, t.style.color = "hsl(var(--ui-hsl-primary-text))", t.style.backgroundColor = "hsl(var(--ui-hsl-primary))", i.classList.add("dragging"), s = !0, e != null && e.onDragStart && e.onDragStart());
    }, 200));
  }, f = (c) => {
    if (!o || !t) return;
    ...
    if (b) {
      ...
      b.classList.contains("draggable") && ((() => {
        ...
        return !1;
      })() ? i.insertBefore(t, b) : i.insertBefore(
        t,
        b.nextElementSibling
      ));
    }
  }, v = () => {
    r !== null && (clearTimeout(r), r = null), t && (t.style.color = n, t.style.backgroundColor = p, t = null), o = null, i.classList.remove("dragging"), s && (s = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
  return [...i.children].forEach((c) => {
    c.classList.add("draggable"), c.onmousedown = h, c.ontouchstart = h, c.onmousemove = f, c.ontouchmove = f, c.onmouseup = v, c.ontouchend = v;
  }), () => {
    [...i.children].forEach(
      (c) => {
        c.classList.remove("draggable"), c.onmousedown = null, c.ontouchstart = null, c.onmousemove = null, c.ontouchmove = null, c.onmouseup = null, c.ontouchend = null;
      }
    );
  };
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const br = { attribute: !0, type: String, converter: ye, reflect: !1, hasChanged: Ne }, mr = (i = br, e, t) => {
...
function a(i) {
  return (e, t) => typeof t == "object" ? mr(i, e, t) : ((o, r, s) => {
...
var _r = Object.defineProperty, wr = Object.getOwnPropertyDescriptor, We = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? wr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && _r(e, t, r), r;
};
...
const Wi = te;
var Cr = Object.defineProperty, $r = Object.getOwnPropertyDescriptor, xr = (i, e, t, o) => {
...
const Yi = De;
var kr = Object.defineProperty, Sr = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
...
const Ki = re;
var Lr = Object.defineProperty, Pr = Object.getOwnPropertyDescriptor, Ke = (i, e, t, o) => {
...
const Xi = ie;
var Or = Object.defineProperty, jr = Object.getOwnPropertyDescriptor, le = (i, e, t, o) => {
...
let U = class extends u {
  constructor() {
    super(...arguments), this.disabled = !1, this.ripple = !1, this.role = "button", this.tabIndex = 0, this.rippleCleanUp = null;
  }
  static get styles() {
    return g`
            :host {
...
const Mr = U;
var Er = Object.defineProperty, Ar = Object.getOwnPropertyDescriptor, ce = (i, e, t, o) => {
...
let I = class extends u {
  constructor() {
    super(...arguments), this.ghost = !1, this.disabled = !1, this.ripple = !1, this.role = "button", this.tabIndex = 0, this.rippleCleanUp = null;
  }
  static get styles() {
    return g`
            :host {
...
const Ji = I;
var Ur = Object.defineProperty, Ir = Object.getOwnPropertyDescriptor, G = (i, e, t, o) => {
...
const Qi = $;
var Dr = Object.defineProperty, Rr = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
...
let D = class extends u {
  constructor() {
    super(...arguments), this.title = "", this.gap = Br, this.open = !1, this.noFold = !1;
  }
  static get styles() {
    return g`
            * {
...
const Vr = D;
var Hr = Object.defineProperty, Gr = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Gr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Hr(e, t, r), r;
};
let oe = class extends u {
  ...
  firstUpdated(i) {
    this.classList.add("has-backdrop-blur"), this.addEventListener("click", () => {
      this.open = !1;
    });
  }
  updated(i) {
    [...this.children].forEach(async (e) => {
      e instanceof Vr && e.addEventListener("unfold", this.handleUnfold);
    });
  }
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
...
const eo = oe;
var Tr = Object.defineProperty, Zr = Object.getOwnPropertyDescriptor, zr = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Zr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Tr(e, t, r), r;
};
let Re = class extends u {
  static get styles() {
    return g`
...
const to = Re;
var Nr = Object.defineProperty, Fr = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
const ro = R;
var qr = Object.defineProperty, Wr = Object.getOwnPropertyDescriptor, ue = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Wr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
var Yr = Object.defineProperty, Kr = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
...
const io = V;
var Xr = Object.defineProperty, Jr = Object.getOwnPropertyDescriptor, xt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Jr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const oo = me;
var Qr = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, O = (i, e, t, o) => {
...
const so = w;
var ti = Object.defineProperty, ri = Object.getOwnPropertyDescriptor, k = (i, e, t, o) => {
  ...
  render() {
    return l`
            <div class="container has-backdrop-blur">
                ${this.title ? l`<ui-secondary class="title">
                          ${this.title}
                      </ui-secondary>` : ""}
                ...
                <input
                    ...
                    @keydown=${(i) => {
      var e, t;
      this.noSubmit || i.key !== "Enter" || (t = (e = this.shadowRoot) == null ? void 0 : e.querySelector(
        'ui-icon-button[name="submit"]'
      )) == null || t.click();
    }}
                    @input=${(i) => {
      this.value = i.currentTarget.value, this.storage && (localStorage.setItem(
        this.storagePrefix + this.storageKey,
        this.value
      ), this.noSubmit && this.dispatchEvent(new Event("change")));
    }}
                />
...
const no = _;
var ii = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, Je = (i, e, t, o) => {
...
const ao = se;
var si = Object.defineProperty, ni = Object.getOwnPropertyDescriptor, Qe = (i, e, t, o) => {
 ...
 */
const gt = (i) => i ?? y;
var ai = Object.defineProperty, li = Object.getOwnPropertyDescriptor, T = (i, e, t, o) => {
...
const lo = x;
var ci = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, Se = (i, e, t, o) => {
...
const co = q;
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, kt = (i, e, t, o) => {
...
const ho = _e;
var di = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, St = (i, e, t, o) => {
...
const po = we;
var fi = Object.defineProperty, vi = Object.getOwnPropertyDescriptor, yi = (i, e, t, o) => {
...
const go = Ce;
var _i = Object.defineProperty, wi = Object.getOwnPropertyDescriptor, et = (i, e, t, o) => {
...
const vo = Ve;
var ki = Object.defineProperty, Si = Object.getOwnPropertyDescriptor, j = (i, e, t, o) => {
...
const tt = C;
var Li = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
const yo = $e;
var Oi = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
...
const bo = W;
var Mi = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, Ai = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ei(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const mo = He;
var Ui = Object.defineProperty, Ii = Object.getOwnPropertyDescriptor, Di = (i, e, t, o) => {
...
const _o = Ge;
var Ri = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, ge = (i, e, t, o) => {
...
export {
  ...
  po as UISpinner,
  uo as UIStackLayout,
  go as UIStackLayoutPage,
  fo as UIStore,
  vo as UISvg,
  tt as UIText,
  lo as UITextarea,
  wo as UIThemeHandler,
  g as css,
  Zi as draggable,
