 ...
 */
const ve = globalThis, Ne = ve.ShadowRoot && (ve.ShadyCSS === void 0 || ve.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Fe = Symbol(), st = /* @__PURE__ */ new WeakMap();
let mt = class {
  constructor(e, t, o) {
...
const Et = (i) => new mt(typeof i == "string" ? i : i + "", void 0, Fe), g = (i, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: It, defineProperty: Dt, getOwnPropertyDescriptor: Rt, getOwnPropertyNames: Bt, getOwnPropertySymbols: Vt, getPrototypeOf: Ht } = Object, M = globalThis, at = M.trustedTypes, Gt = at ? at.emptyScript : "", Me = M.reactiveElementPolyfillSupport, Q = (i, e) => i, ye = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Gt : null;
      break;
  ...
  return t;
} }, qe = (i, e) => !It(i, e), lt = { attribute: !0, type: String, converter: ye, reflect: !1, hasChanged: qe };
...
z.elementStyles = [], z.shadowRootOptions = { mode: "open" }, z[Q("elementProperties")] = /* @__PURE__ */ new Map(), z[Q("finalized")] = /* @__PURE__ */ new Map(), Me == null || Me({ ReactiveElement: z }), (M.reactiveElementVersions ?? (M.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ee = globalThis, be = ee.trustedTypes, ct = be ? be.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, _t = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + j, Tt = `<${wt}>`, D = document, te = () => D.createComment(""), re = (i) => i === null || typeof i != "object" && typeof i != "function", Ye = Array.isArray, Zt = (i) => Ye(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ae = `[ 	
\f\r]`, J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ht = /-->/g, pt = />/g, U = RegExp(`>|${Ae}(?:([^\\s"'>=/]+)(${Ae}*=${Ae}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ut = /'/g, dt = /"/g, Ct = /^(?:script|style|textarea|title)$/i, zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = zt(1), N = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), gt = /* @__PURE__ */ new WeakMap(), I = D.createTreeWalker(D, 129);
function $t(i, e) {
    ...
    for (; (r = I.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const f of r.getAttributeNames()) if (f.endsWith(_t)) {
          ...
          c.push({ type: 1, index: s, name: _[2], strings: h, ctor: _[1] === "." ? qt : _[1] === "?" ? Yt : _[1] === "@" ? Xt : xe }), r.removeAttribute(f);
...
class he {
  ...
  _$AI(e, t = this) {
    e = F(this, e, t), re(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== N && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Zt(e) ? this.k(e) : this._(e);
  }
  O(e) {
...
class xe {
  ...
  _$AI(e, t = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) e = F(this, e, t, 0), n = !re(e) || e !== this._$AH && e !== N, n && (this._$AH = e);
    else {
      const p = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = F(this, p[o + c], t, c), v === N && (v = this._$AH[c]), n || (n = !re(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
const Ee = ee.litHtmlPolyfillSupport;
Ee == null || Ee(ie, he), (ee.litHtmlVersions ?? (ee.litHtmlVersions = [])).push("3.2.1");
const Kt = (i, e, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wr = { attribute: !0, type: String, converter: ye, reflect: !1, hasChanged: qe }, Cr = (i = wr, e, t) => {
...
const eo = ne;
var Ar = Object.defineProperty, Er = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
const to = B;
var Rr = Object.defineProperty, Br = Object.getOwnPropertyDescriptor, T = (i, e, t, o) => {
...
const ro = S;
var Vr = Object.defineProperty, Hr = Object.getOwnPropertyDescriptor, Se = (i, e, t, o) => {
...
], q.prototype, "noFold", 2);
q = Se([
  d("ui-drawer-group")
], q);
const Gr = q;
var Tr = Object.defineProperty, Zr = Object.getOwnPropertyDescriptor, Qe = (i, e, t, o) => {
...
const oo = Ve;
var qr = Object.defineProperty, Yr = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
...
const so = V;
var Xr = Object.defineProperty, Wr = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
...
var Kr = Object.defineProperty, Jr = Object.getOwnPropertyDescriptor, ge = (i, e, t, o) => {
...
const no = H;
var Qr = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, Lt = (i, e, t, o) => {
...
const ao = me;
var ti = Object.defineProperty, ri = Object.getOwnPropertyDescriptor, A = (i, e, t, o) => {
...
const lo = $;
var ii = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, P = (i, e, t, o) => {
    ...
    return l`
            <div class="container has-backdrop-blur">
                ...
                <input
                    ...
                    @keydown=${(e) => {
      var t, o;
      this.noSubmit || e.key !== "Enter" || (o = (t = this.shadowRoot) == null ? void 0 : t.querySelector(
...
const co = C;
var si = Object.defineProperty, ni = Object.getOwnPropertyDescriptor, et = (i, e, t, o) => {
...
const ho = le;
var ai = Object.defineProperty, li = Object.getOwnPropertyDescriptor, tt = (i, e, t, o) => {
...
const po = L;
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, Pe = (i, e, t, o) => {
...
const uo = W;
var di = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
const go = _e;
var fi = Object.defineProperty, vi = Object.getOwnPropertyDescriptor, Ot = (i, e, t, o) => {
...
const vo = He;
var _i = Object.defineProperty, wi = Object.getOwnPropertyDescriptor, jt = (i, e, t, o) => {
...
const yo = Ce;
var Ci = Object.defineProperty, $i = Object.getOwnPropertyDescriptor, rt = (i, e, t, o) => {
...
const mo = Ge;
var Li = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, E = (i, e, t, o) => {
...
const it = x;
var Oi = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, Mt = (i, e, t, o) => {
...
const _o = $e;
var Mi = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Oe = (i, e, t, o) => {
...
const Co = Te;
var Di = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, Bi = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ri(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Di(e, t, r), r;
};
...
const $o = Ze;
var Vi = Object.defineProperty, Hi = Object.getOwnPropertyDescriptor, fe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Hi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
let G = class extends u {
  constructor() {
    super(...arguments), this.auto = !1, this.theme = "original", this.themesPath = "/themes", this.media = null;
  }
  get target() {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), console.debug("attributeChangedCallback:", i, t), i) {
      case "auto":
        this.handleAuto();
        break;
      case "mode":
...
export {
  ...
  fo as UISpinner,
  vo as UIStackLayout,
  yo as UIStackLayoutPage,
  bo as UIStore,
  mo as UISvg,
  it as UIText,
  po as UITextarea,
  xo as UIThemeHandler,
  g as css,
  Fi as draggable,
