 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: At, defineProperty: Et, getOwnPropertyDescriptor: Ut, getOwnPropertyNames: It, getOwnPropertySymbols: Rt, getPrototypeOf: Dt } = Object, P = globalThis, ot = P.trustedTypes, Bt = ot ? ot.emptyScript : "", Oe = P.reactiveElementPolyfillSupport, K = (i, e) => i, ye = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Bt : null;
      break;
  ...
  return t;
} }, Ne = (i, e) => !At(i, e), st = { attribute: !0, type: String, converter: ye, reflect: !1, hasChanged: Ne };
...
class z extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(K("properties"))) {
      const t = this.properties, o = [...It(t), ...Rt(t)];
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = o.getPropertyOptions(r), u = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((s = n.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? n.converter : ye;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const X = globalThis, be = X.trustedTypes, nt = be ? be.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, yt = "$lit$", L = `lit$${Math.random().toFixed(9).slice(2)}$`, bt = "?" + L, Vt = `<${bt}>`, E = document, J = () => E.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Fe = Array.isArray, Ht = (i) => Fe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Me = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, lt = />/g, j = RegExp(`>|${Me}(?:([^\\s"'>=/]+)(${Me}*=${Me}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, pt = /"/g, mt = /^(?:script|style|textarea|title)$/i, Gt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = Gt(1), Z = Symbol.for("lit-noChange"), y = Symbol.for("lit-nothing"), ut = /* @__PURE__ */ new WeakMap(), A = E.createTreeWalker(E, 129);
function _t(i, e) {
...
const Tt = (i, e) => {
  ...
  for (let u = 0; u < t; u++) {
    const p = i[u];
    let f, v, c = -1, m = 0;
    for (; m < p.length && (n.lastIndex = m, v = n.exec(p), v !== null); ) m = n.lastIndex, n === Y ? v[1] === "!--" ? n = at : v[1] !== void 0 ? n = lt : v[2] !== void 0 ? (mt.test(v[2]) && (r = RegExp("</" + v[2], "g")), n = j) : v[3] !== void 0 && (n = j) : n === j ? v[0] === ">" ? (n = r ?? Y, c = -1) : v[1] === void 0 ? c = -2 : (c = n.lastIndex - v[2].length, f = v[1], n = v[3] === void 0 ? j : v[3] === '"' ? pt : ct) : n === pt || n === ct ? n = j : n === at || n === lt ? n = Y : (n = j, r = void 0);
    const b = n === j && i[u + 1].startsWith("/>") ? " " : "";
    s += n === Y ? p + Vt : c >= 0 ? (o.push(f), p.slice(0, c) + yt + p.slice(c) + L + b) : p + L + (c === -2 ? u : b);
  }
...
class ee {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const u = e.length - 1, p = this.parts, [f, v] = Tt(e, t);
    if (this.el = ee.createElement(f, o), A.currentNode = this.el.content, t === 2 || t === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (r = A.nextNode()) !== null && p.length < u; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const c of r.getAttributeNames()) if (c.endsWith(yt)) {
          const m = v[n++], b = r.getAttribute(c).split(L), S = /([.?@])?(.*)/.exec(m);
          p.push({ type: 1, index: s, name: S[2], strings: b, ctor: S[1] === "." ? Zt : S[1] === "?" ? Nt : S[1] === "@" ? Ft : xe }), r.removeAttribute(c);
        } else c.startsWith(L) && (p.push({ type: 6, index: s }), r.removeAttribute(c));
        if (mt.test(r.tagName)) {
          const c = r.textContent.split(L), m = c.length - 1;
          if (m > 0) {
            r.textContent = be ? be.emptyScript : "";
            for (let b = 0; b < m; b++) r.append(c[b], J()), A.nextNode(), p.push({ type: 2, index: ++s });
            r.append(c[m], J());
          }
        }
      } else if (r.nodeType === 8) if (r.data === bt) p.push({ type: 2, index: s });
      else {
        let c = -1;
        for (; (c = r.data.indexOf(L, c + 1)) !== -1; ) p.push({ type: 7, index: s }), c += L.length - 1;
      }
      s++;
    }
  }
...
function N(i, e, t = i, o) {
  ...
  return (r == null ? void 0 : r.constructor) !== s && ((u = r == null ? void 0 : r._$AO) == null || u.call(r, !1), s === void 0 ? r = void 0 : (r = new s(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = N(i, r._$AS(i, e.values), r, o)), e;
}
class zt {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: o } = this._$AD, r = ((e == null ? void 0 : e.creationScope) ?? E).importNode(t, !0);
    A.currentNode = r;
    let s = A.nextNode(), n = 0, u = 0, p = o[0];
    for (; p !== void 0; ) {
      if (n === p.index) {
        let f;
        p.type === 2 ? f = new ae(s, s.nextSibling, this, e) : p.type === 1 ? f = new p.ctor(s, p.name, p.strings, this, e) : p.type === 6 && (f = new qt(s, this, e)), this._$AV.push(f), p = o[++u];
      }
      n !== (p == null ? void 0 : p.index) && (s = A.nextNode(), n++);
    }
...
class ae {
  ...
  _(e) {
    this._$AH !== y && Q(this._$AH) ? this._$AA.nextSibling.data = e : this.T(E.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
  ...
  _$AC(e) {
    ...
    return t === void 0 && ut.set(e.strings, t = new ee(e)), t;
  }
  k(e) {
...
class xe {
  ...
  _$AI(e, t = this, o, r) {
    ...
    if (s === void 0) e = N(this, e, t, 0), n = !Q(e) || e !== this._$AH && e !== Z, n && (this._$AH = e);
      ...
      const u = e;
      let p, f;
      for (e = s[0], p = 0; p < s.length - 1; p++) f = N(this, u[o + p], t, p), f === Z && (f = this._$AH[p]), n || (n = !Q(f) || f !== this._$AH[p]), f === y ? e = y : e !== y && (e += (f ?? "") + s[p + 1]), this._$AH[p] = f;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
var ft;
h._$litElement$ = !0, h.finalized = !0, (ft = globalThis.litElementHydrateSupport) == null || ft.call(globalThis, { LitElement: h });
...
function Jt(i, e) {
  ...
  return [...i.children].forEach((c) => {
    c.classList.add("draggable"), c.onmousedown = p, c.ontouchstart = p, c.onmousemove = f, c.ontouchmove = f, i.onmouseleave = c.onmouseup = v, c.ontouchend = v;
  }), () => {
...
function ke(i, e) {
  ...
  let t = null;
  const o = (u) => {
    t = Ue(u, e), i.addEventListener("pointermove", s);
  }, r = () => {
    i.removeEventListener("pointermove", s), Ie(t), t = null;
  }, s = () => r(), n = (u) => {
    t = Ue(u, e), Ie(t), t = null;
  };
...
const _r = { attribute: !0, type: String, converter: ye, reflect: !1, hasChanged: Ne }, wr = (i = _r, e, t) => {
  ...
  if (s === void 0 && globalThis.litPropertyMetadata.set(r, s = /* @__PURE__ */ new Map()), s.set(t.name, i), o === "accessor") {
    ...
    return { set(u) {
      ...
      e.set.call(this, u), this.requestUpdate(n, p, i);
    }, init(u) {
  ...
  if (o === "setter") {
    ...
    return function(u) {
      const p = this[n];
      e.call(this, u), this.requestUpdate(n, p, i);
    };
  }
...
let te = class extends h {
  ...
  render() {
    return l` <ui-text style="font-size: 0.9rem;">${this.message}</ui-text> `;
  }
  firstUpdated(i) {
...
const Qi = ie;
var jr = Object.defineProperty, Ar = Object.getOwnPropertyDescriptor, le = (i, e, t, o) => {
...
const eo = I;
var Rr = Object.defineProperty, Dr = Object.getOwnPropertyDescriptor, G = (i, e, t, o) => {
...
const to = $;
var Br = Object.defineProperty, Vr = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
const Gr = R;
var Tr = Object.defineProperty, zr = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
...
const oo = D;
var Yr = Object.defineProperty, Kr = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Kr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
 ...
 */
const gt = (i) => i ?? y;
var ci = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, T = (i, e, t, o) => {
...
const po = x;
var ui = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, Se = (i, e, t, o) => {
...
const mo = $e;
var ji = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
...
const _o = W;
var Ei = Object.defineProperty, Ui = Object.getOwnPropertyDescriptor, Ii = (i, e, t, o) => {
...
const wo = He;
var Ri = Object.defineProperty, Di = Object.getOwnPropertyDescriptor, Bi = (i, e, t, o) => {
...
const Co = Ge;
var Vi = Object.defineProperty, Hi = Object.getOwnPropertyDescriptor, ge = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Hi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
