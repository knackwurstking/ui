 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Et, defineProperty: Rt, getOwnPropertyDescriptor: Dt, getOwnPropertyNames: Vt, getOwnPropertySymbols: Ut, getPrototypeOf: Bt } = Object, O = globalThis, Ke = O.trustedTypes, Ht = Ke ? Ke.emptyScript : "", $e = O.reactiveElementPolyfillSupport, Y = (i, e) => i, ce = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ht : null;
      break;
  ...
  return t;
} }, He = (i, e) => !Et(i, e), Je = { attribute: !0, type: String, converter: ce, reflect: !1, hasChanged: He };
...
\f\r]`, q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, et = /-->/g, tt = />/g, A = RegExp(`>|${ke}(?:([^\\s"'>=/]+)(${ke}*=${ke}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), rt = /'/g, it = /"/g, mt = /^(?:script|style|textarea|title)$/i, Zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), a = Zt(1), B = Symbol.for("lit-noChange"), y = Symbol.for("lit-nothing"), ot = /* @__PURE__ */ new WeakMap(), E = R.createTreeWalker(R, 129);
function _t(i, e) {
...
const It = (i, e) => {
  ...
  for (let u = 0; u < t; u++) {
    const c = i[u];
    let v, b, g = -1, m = 0;
    for (; m < c.length && (n.lastIndex = m, b = n.exec(c), b !== null); ) m = n.lastIndex, n === q ? b[1] === "!--" ? n = et : b[1] !== void 0 ? n = tt : b[2] !== void 0 ? (mt.test(b[2]) && (r = RegExp("</" + b[2], "g")), n = A) : b[3] !== void 0 && (n = A) : n === A ? b[0] === ">" ? (n = r ?? q, g = -1) : b[1] === void 0 ? g = -2 : (g = n.lastIndex - b[2].length, v = b[1], n = b[3] === void 0 ? A : b[3] === '"' ? it : rt) : n === it || n === rt ? n = A : n === et || n === tt ? n = q : (n = A, r = void 0);
    const h = n === A && i[u + 1].startsWith("/>") ? " " : "";
...
class J {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    if (this.el = J.createElement(v, o), E.currentNode = this.el.content, t === 2 || t === 3) {
      ...
      if (r.nodeType === 1) {
        ...
        if (mt.test(r.tagName)) {
          ...
          if (m > 0) {
            ...
            for (let h = 0; h < m; h++) r.append(g[h], W()), E.nextNode(), c.push({ type: 2, index: ++s });
            r.append(g[m], W());
          }
        }
...
let D = class extends p {
  constructor() {
    super(...arguments), this.rippleCleanUp = null, this.disabled = !1, this.ripple = !1;
  }
  static get styles() {
    return f`
            :host {
...
var Ar = Object.defineProperty, Er = Object.getOwnPropertyDescriptor, oe = (i, e, t, o) => {
...
let G = class extends p {
  constructor() {
    super(...arguments), this.rippleCleanUp = null, this.ghost = !1, this.disabled = !1, this.ripple = !1;
  }
  static get styles() {
    return f`
            :host {
...
let C = class extends p {
  ...
  render() {
    this.setAttribute("role", "input"), console.debug(
...
var ji = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Ce = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ai(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
var Ei = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, le = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ri(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
