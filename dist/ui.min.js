 ...
 */
const ye = globalThis, Ne = ye.ShadowRoot && (ye.ShadyCSS === void 0 || ye.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Fe = Symbol(), st = /* @__PURE__ */ new WeakMap();
let mt = class {
  constructor(e, t, o) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: It, defineProperty: Dt, getOwnPropertyDescriptor: Rt, getOwnPropertyNames: Bt, getOwnPropertySymbols: Vt, getPrototypeOf: Ht } = Object, M = globalThis, at = M.trustedTypes, Gt = at ? at.emptyScript : "", Me = M.reactiveElementPolyfillSupport, Q = (i, e) => i, be = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Gt : null;
      break;
  ...
  return t;
} }, qe = (i, e) => !It(i, e), lt = { attribute: !0, type: String, converter: be, reflect: !1, hasChanged: qe };
...
N.elementStyles = [], N.shadowRootOptions = { mode: "open" }, N[Q("elementProperties")] = /* @__PURE__ */ new Map(), N[Q("finalized")] = /* @__PURE__ */ new Map(), Me == null || Me({ ReactiveElement: N }), (M.reactiveElementVersions ?? (M.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ee = globalThis, me = ee.trustedTypes, ct = me ? me.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, _t = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + j, Tt = `<${wt}>`, D = document, te = () => D.createComment(""), re = (i) => i === null || typeof i != "object" && typeof i != "function", Ye = Array.isArray, Zt = (i) => Ye(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ee = `[ 	
\f\r]`, J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ht = /-->/g, pt = />/g, U = RegExp(`>|${Ee}(?:([^\\s"'>=/]+)(${Ee}*=${Ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ut = /'/g, dt = /"/g, Ct = /^(?:script|style|textarea|title)$/i, zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = zt(1), F = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), gt = /* @__PURE__ */ new WeakMap(), I = D.createTreeWalker(D, 129);
function $t(i, e) {
    ...
    for (; (r = I.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const f of r.getAttributeNames()) if (f.endsWith(_t)) {
          ...
          c.push({ type: 1, index: s, name: _[2], strings: h, ctor: _[1] === "." ? qt : _[1] === "?" ? Yt : _[1] === "@" ? Xt : ke }), r.removeAttribute(f);
...
function q(i, e, t = i, o) {
  ...
  return (r == null ? void 0 : r.constructor) !== s && ((p = r == null ? void 0 : r._$AO) == null || p.call(r, !1), s === void 0 ? r = void 0 : (r = new s(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = q(i, r._$AS(i, e.values), r, o)), e;
}
class Ft {
  constructor(e, t) {
...
class he {
  ...
  _$AI(e, t = this) {
    e = q(this, e, t), re(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== F && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Zt(e) ? this.k(e) : this._(e);
  }
  O(e) {
...
class ke {
  ...
  _$AI(e, t = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) e = q(this, e, t, 0), n = !re(e) || e !== this._$AH && e !== F, n && (this._$AH = e);
    else {
      const p = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = q(this, p[o + c], t, c), v === F && (v = this._$AH[c]), n || (n = !re(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
const no = H;
var Wr = Object.defineProperty, Kr = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
...
var Jr = Object.defineProperty, Qr = Object.getOwnPropertyDescriptor, fe = (i, e, t, o) => {
 ...
 */
const yt = (i) => i ?? b;
var hi = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, z = (i, e, t, o) => {
...
const xo = Ze;
var Hi = Object.defineProperty, Gi = Object.getOwnPropertyDescriptor, ve = (i, e, t, o) => {
