 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: At, defineProperty: Et, getOwnPropertyDescriptor: Ut, getOwnPropertyNames: It, getOwnPropertySymbols: Dt, getPrototypeOf: Rt } = Object, P = globalThis, ot = P.trustedTypes, Bt = ot ? ot.emptyScript : "", Oe = P.reactiveElementPolyfillSupport, K = (i, e) => i, ye = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Bt : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const X = globalThis, be = X.trustedTypes, nt = be ? be.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, yt = "$lit$", L = `lit$${Math.random().toFixed(9).slice(2)}$`, bt = "?" + L, Vt = `<${bt}>`, E = document, J = () => E.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Fe = Array.isArray, Ht = (i) => Fe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", je = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, lt = />/g, M = RegExp(`>|${je}(?:([^\\s"'>=/]+)(${je}*=${je}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, ht = /"/g, mt = /^(?:script|style|textarea|title)$/i, Gt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = Gt(1), z = Symbol.for("lit-noChange"), y = Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), A = E.createTreeWalker(E, 129);
function _t(i, e) {
...
class ee {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    for (; (r = A.nextNode()) !== null && h.length < p; ) {
      if (r.nodeType === 1) {
        ...
        if (mt.test(r.tagName)) {
          ...
          if (m > 0) {
            ...
            for (let b = 0; b < m; b++) r.append(c[b], J()), A.nextNode(), h.push({ type: 2, index: ++s });
            r.append(c[m], J());
          }
        }
...
class Zt {
  ...
  u(e) {
    ...
    A.currentNode = r;
    let s = A.nextNode(), n = 0, p = 0, h = o[0];
    for (; h !== void 0; ) {
      if (n === h.index) {
        let f;
      ...
      n !== (h == null ? void 0 : h.index) && (s = A.nextNode(), n++);
    }
...
const bo = W;
var Mi = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Ei = (i, e, t, o) => {
...
let H = class extends u {
  ...
  firstUpdated(i) {
    this.hasAttribute("theme") || this.handleTheme();
  }
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "auto":
