...
class j {
  constructor(e, t = !0) {
    this.url = "", this.json = !0, this.socket = null, this.events = new y(), this.reconnectInterval = 1e3, this.timeout = null, this.open = !1, this.onClose = () => {
    }, this.url = e, this.json = t;
  }
  isOpen() {
    return this.open;
  }
  async connect() {
    this.socket && this.close(), this.socket = new WebSocket(this.url), this.socket.onopen = () => {
      this.open = !0, this.events.dispatch("open", this), this.socket.onclose = () => {
        this.timeout !== null && (clearTimeout(this.timeout), this.timeout = null), this.open && (this.open = !1, this.events.dispatch("close", this)), this.timeout = setTimeout(
        ...
        this.events.dispatch(
          "message",
          this.json ? JSON.parse(await e.data.text()) : await e.data.text()
        );
      };
    }, this.socket.addEventListener("error", () => {
      this.socket && (this.events.dispatch("error", this), this.socket.close());
    });
  }
  close() {
    if (this.timeout && (clearTimeout(this.timeout), this.timeout = null), this.socket) {
...
function L(r, e) {
  e = { ...w, ...e };
  let t = null, s = null, n = null, i = !1, o = "", u = "";
  const p = (a) => {
    const c = a.currentTarget;
    !t && Array.from(c.classList).includes("draggable") && (s = (/* @__PURE__ */ new Date()).getTime(), t = c, n && clearTimeout(n), n = setTimeout(() => {
      t && (o = t.style.color, u = t.style.backgroundColor, t.style.color = "var(--ui-primary-text)", t.style.backgroundColor = "var(--ui-primary)", r.classList.add("ui-dragging"), i = !0, e != null && e.onDragStart && e.onDragStart());
    }, 200));
  }, v = (a) => {
    if (!s || !t) return;
    ...
    a.preventDefault(), i || (i = !0, e != null && e.onDragStart && e.onDragStart());
    let c;
    if (window.TouchEvent && a instanceof TouchEvent) {
      const h = a.targetTouches[0];
      c = {
        clientX: h.clientX,
        clientY: h.clientY
      };
    ...
    if (l) {
      for (; !l.classList.contains("draggable") && l.parentElement; )
        l = l.parentElement;
      l.classList.contains("draggable") && ((() => {
        ...
        return !1;
      })() ? r.insertBefore(t, l) : r.insertBefore(
        t,
        l.nextElementSibling
      ));
    }
  }, f = () => {
    n !== null && (clearTimeout(n), n = null), t && (t.style.color = o, t.style.backgroundColor = u, t = null), s = null, r.classList.remove("ui-dragging"), i && (i = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
  return [...r.children].forEach((a) => {
    a.classList.add("draggable"), a.onmousedown = p, a.ontouchstart = p, a.onmousemove = v, a.ontouchmove = v, r.onmouseleave = a.onmouseup = f, a.ontouchend = f;
  }), () => {
    [...r.children].forEach(
      (a) => {
