let $e = null;
function Mt() {
  return $e === null && ($e = Array.from(document.styleSheets).map((i) => {
 ...
 */
const ce = globalThis, Be = ce.ShadowRoot && (ce.ShadyCSS === void 0 || ce.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ue = Symbol(), We = /* @__PURE__ */ new WeakMap();
let yt = class {
  constructor(e, t, o) {
    if (this._$cssResult$ = !0, o !== Ue) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (Be && e === void 0) {
      ...
      o && (e = We.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && We.set(t, e));
    }
    return e;
  }
  toString() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: At, defineProperty: Rt, getOwnPropertyDescriptor: Dt, getOwnPropertyNames: Vt, getOwnPropertySymbols: Bt, getPrototypeOf: Ut } = Object, O = globalThis, Je = O.trustedTypes, Ht = Je ? Je.emptyScript : "", ke = O.reactiveElementPolyfillSupport, W = (i, e) => i, he = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ht : null;
      break;
  ...
  return t;
} }, He = (i, e) => !At(i, e), Qe = { attribute: !0, type: String, converter: he, reflect: !1, hasChanged: He };
...
class H extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(W("properties"))) {
      const t = this.properties, o = [...Vt(t), ...Bt(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of o) t.unshift(Ke(r));
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && o.reflect === !0) {
      const n = (((s = o.converter) == null ? void 0 : s.toAttribute) !== void 0 ? o.converter : he).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = o.getPropertyOptions(r), p = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((s = n.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? n.converter : he;
...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[W("elementProperties")] = /* @__PURE__ */ new Map(), H[W("finalized")] = /* @__PURE__ */ new Map(), ke == null || ke({ ReactiveElement: H }), (O.reactiveElementVersions ?? (O.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const K = globalThis, pe = K.trustedTypes, et = pe ? pe.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, bt = "$lit$", P = `lit$${Math.random().toFixed(9).slice(2)}$`, mt = "?" + P, Gt = `<${mt}>`, D = document, J = () => D.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Ge = Array.isArray, Tt = (i) => Ge(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Se = `[ 	
\f\r]`, X = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, tt = /-->/g, rt = />/g, A = RegExp(`>|${Se}(?:([^\\s"'>=/]+)(${Se}*=${Se}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, ot = /"/g, _t = /^(?:script|style|textarea|title)$/i, Zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), a = Zt(1), G = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), st = /* @__PURE__ */ new WeakMap(), R = D.createTreeWalker(D, 129);
function wt(i, e) {
...
const It = (i, e) => {
  ...
  let r, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = X;
  for (let p = 0; p < t; p++) {
    const c = i[p];
    let v, y, g = -1, m = 0;
    for (; m < c.length && (n.lastIndex = m, y = n.exec(c), y !== null); ) m = n.lastIndex, n === X ? y[1] === "!--" ? n = tt : y[1] !== void 0 ? n = rt : y[2] !== void 0 ? (_t.test(y[2]) && (r = RegExp("</" + y[2], "g")), n = A) : y[3] !== void 0 && (n = A) : n === A ? y[0] === ">" ? (n = r ?? X, g = -1) : y[1] === void 0 ? g = -2 : (g = n.lastIndex - y[2].length, v = y[1], n = y[3] === void 0 ? A : y[3] === '"' ? ot : it) : n === ot || n === it ? n = A : n === tt || n === rt ? n = X : (n = A, r = void 0);
    const h = n === A && i[p + 1].startsWith("/>") ? " " : "";
    s += n === X ? c + Gt : g >= 0 ? (o.push(v), c.slice(0, g) + bt + c.slice(g) + P + h) : c + P + (g === -2 ? p : h);
  }
...
class ee {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const p = e.length - 1, c = this.parts, [v, y] = It(e, t);
    if (this.el = ee.createElement(v, o), R.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (r = R.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const g of r.getAttributeNames()) if (g.endsWith(bt)) {
          const m = y[n++], h = r.getAttribute(g).split(P), _ = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: s, name: _[2], strings: h, ctor: _[1] === "." ? Nt : _[1] === "?" ? Ft : _[1] === "@" ? qt : me }), r.removeAttribute(g);
        ...
        if (_t.test(r.tagName)) {
          ...
          if (m > 0) {
            ...
            for (let h = 0; h < m; h++) r.append(g[h], J()), R.nextNode(), c.push({ type: 2, index: ++s });
            r.append(g[m], J());
          }
        }
...
function T(i, e, t = i, o) {
  ...
  return (r == null ? void 0 : r.constructor) !== s && ((p = r == null ? void 0 : r._$AO) == null || p.call(r, !1), s === void 0 ? r = void 0 : (r = new s(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = T(i, r._$AS(i, e.values), r, o)), e;
}
class zt {
  constructor(e, t) {
  ...
  u(e) {
    ...
    R.currentNode = r;
    let s = R.nextNode(), n = 0, p = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let v;
        c.type === 2 ? v = new ie(s, s.nextSibling, this, e) : c.type === 1 ? v = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (v = new Yt(s, this, e)), this._$AV.push(v), c = o[++p];
      }
      n !== (c == null ? void 0 : c.index) && (s = R.nextNode(), n++);
    }
...
class ie {
  ...
  _$AI(e, t = this) {
    e = T(this, e, t), Q(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== G && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Tt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== b && Q(this._$AH) ? this._$AA.nextSibling.data = e : this.T(D.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = ee.createElement(wt(o.h, o.h[0]), this.options)), o);
  ...
  _$AC(e) {
    ...
    return t === void 0 && st.set(e.strings, t = new ee(e)), t;
  }
  k(e) {
    Ge(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, r = 0;
    for (const s of e) r === t.length ? t.push(o = new ie(this.O(J()), this.O(J()), this, this.options)) : o = t[r], o._$AI(s), r++;
...
class me {
  ...
  _$AI(e, t = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) e = T(this, e, t, 0), n = !Q(e) || e !== this._$AH && e !== G, n && (this._$AH = e);
    else {
      const p = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = T(this, p[o + c], t, c), v === G && (v = this._$AH[c]), n || (n = !Q(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
Le == null || Le(ee, ie), (K.litHtmlVersions ?? (K.litHtmlVersions = [])).push("3.2.1");
const Xt = (i, e, t) => {
  const o = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = o._$litPart$;
  if (r === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    o._$litPart$ = r = new ie(e.insertBefore(J(), s), s, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
/**
...
function Qt(i, e) {
  ...
  const y = (h) => {
    ...
    if (!p && (/* @__PURE__ */ new Date()).getTime() - o < 200) {
      let L, x;
      if (h instanceof TouchEvent) {
        const Xe = h.targetTouches[0];
        L = Math.abs(r - Xe.clientX), x = Math.abs(s - Xe.clientY);
      } else
...
function _e(i, e) {
  ...
  let t = null;
  const o = (p) => {
    t = Me(p, e), i.addEventListener("pointermove", s);
  }, r = () => {
    i.removeEventListener("pointermove", s), je(t), t = null;
  }, s = () => r(), n = (p) => {
    t = Me(p, e), je(t), t = null;
  };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mr = { attribute: !0, type: String, converter: he, reflect: !1, hasChanged: He }, _r = (i = mr, e, t) => {
...
], de.prototype, "position", 2);
Ie([
  l({ type: Boolean, attribute: "fixed", reflect: !0 })
], de.prototype, "fixed", 2);
de = Ie([
  d("ui-app-bar")
], de);
var Pr = Object.defineProperty, Or = Object.getOwnPropertyDescriptor, ze = (i, e, t, o) => {
...
ze([
  l({ type: Boolean, attribute: "hidden", reflect: !0 })
], fe.prototype, "hidden", 2);
fe = ze([
  d("ui-app-bar-item")
], fe);
var Mr = Object.defineProperty, jr = Object.getOwnPropertyDescriptor, oe = (i, e, t, o) => {
...
let V = class extends u {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "ripple":
        this.rippleCleanUp !== null && (this.rippleCleanUp(), this.rippleCleanUp = null), t !== null && (this.rippleCleanUp = _e(this));
        break;
    }
  }
};
...
], V.prototype, "ripple", 2);
V = oe([
  d("ui-button")
], V);
var Er = Object.defineProperty, Ar = Object.getOwnPropertyDescriptor, se = (i, e, t, o) => {
...
se([
  l({ type: Boolean, attribute: "ripple" })
], Z.prototype, "ripple", 2);
Z = se([
  d("ui-icon-button")
], Z);
var Rr = Object.defineProperty, Dr = Object.getOwnPropertyDescriptor, B = (i, e, t, o) => {
...
], M.prototype, "noFooter", 2);
B([
  l({ type: Boolean, attribute: "open", reflect: !0 })
], M.prototype, "open", 2);
B([
  l({ type: Boolean, attribute: "modal", reflect: !0 })
], M.prototype, "modal", 2);
B([
  l({ type: Boolean, attribute: "inert", reflect: !0 })
], M.prototype, "inert", 2);
M = B([
  d("ui-dialog")
], M);
var Vr = Object.defineProperty, Br = Object.getOwnPropertyDescriptor, we = (i, e, t, o) => {
...
], I.prototype, "noFold", 2);
I = we([
  d("ui-drawer-group")
], I);
var Ur = Object.defineProperty, Hr = Object.getOwnPropertyDescriptor, Ne = (i, e, t, o) => {
...
let ge = class extends u {
  ...
  updated(i) {
    [...this.children].forEach(async (e) => {
      e instanceof I && e.addEventListener("unfold", this.handleUnfold);
    });
  }
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
...
var Nr = Object.defineProperty, Fr = Object.getOwnPropertyDescriptor, ne = (i, e, t, o) => {
...
var qr = Object.defineProperty, Yr = Object.getOwnPropertyDescriptor, le = (i, e, t, o) => {
...
let N = class extends u {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "gap":
        t ? this.style.setProperty("--_gap", t || ct) : this.style.removeProperty("--_gap");
        break;
      case "justify":
        t ? this.style.setProperty("--_justify", t || "") : this.style.removeProperty("--_justify");
        break;
...
var Kr = Object.defineProperty, Jr = Object.getOwnPropertyDescriptor, E = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Jr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  ...
  render() {
    ...
    return a`
            <div class="container has-backdrop-blur">
                ${this.title ? a`<ui-secondary class="title">
                          ${this.title}
                      </ui-secondary>` : ""}
...
var ti = Object.defineProperty, ri = Object.getOwnPropertyDescriptor, Fe = (i, e, t, o) => {
...
var ii = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, qe = (i, e, t, o) => {
 ...
 */
const ht = (i) => i ?? b;
var si = Object.defineProperty, ni = Object.getOwnPropertyDescriptor, U = (i, e, t, o) => {
...
var ci = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, Ce = (i, e, t, o) => {
...
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
var bi = Object.defineProperty, mi = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
...
Ye([
  l({ type: Boolean, attribute: "storage", reflect: !0 })
], be.prototype, "storage", 2);
Ye([
  l({ type: String, attribute: "storage-prefix", reflect: !0 })
], be.prototype, "storagePrefix", 2);
be = Ye([
  d("ui-store")
], be);
...
var xi = Object.defineProperty, $i = Object.getOwnPropertyDescriptor, Y = (i, e, t, o) => {
...
var ji = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, xe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ei(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
let re = class extends u {
  ...
  async enableRipple() {
    ...
    i && (this.rippleCleanUp = _e(i), this.role = "button", this.style.cursor = "pointer", this.addEventListener("click", this.clickHandler), [...this.children].forEach((t) => {
...
], re.prototype, "primary", 2);
xe([
  l({ type: String, attribute: "secondary", reflect: !0 })
], re.prototype, "secondary", 2);
xe([
  l({ type: Boolean, attribute: "ripple", reflect: !0 })
], re.prototype, "ripple", 2);
re = xe([
  d("ui-label")
], re);
var Ai = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, ae = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ri(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
export {
  ...
  ge as UIDrawer,
  I as UIDrawerGroup,
  lt as UIDrawerGroupItem,
  N as UIFlexGrid,
  ve as UIFlexGridItem,
  z as UIFlexGridRow,
  Z as UIIconButton,
  $ as UIInput,
  re as UILabel,
