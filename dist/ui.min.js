...
const jt = (i) => new vt(typeof i == "string" ? i : i + "", void 0, ze), f = (i, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: At, defineProperty: Ut, getOwnPropertyDescriptor: It, getOwnPropertyNames: Dt, getOwnPropertySymbols: Rt, getPrototypeOf: Bt } = Object, M = globalThis, ot = M.trustedTypes, Vt = ot ? ot.emptyScript : "", Oe = M.reactiveElementPolyfillSupport, J = (i, e) => i, ve = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Vt : null;
      break;
  ...
  return t;
} }, Ne = (i, e) => !At(i, e), st = { attribute: !0, type: String, converter: ve, reflect: !1, hasChanged: Ne };
...
class Z extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    const { get: r, set: s } = It(this.prototype, e) ?? { get() {
      return this[t];
    }, set(n) {
      this[t] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(J("properties"))) {
      const t = this.properties, o = [...Dt(t), ...Rt(t)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Q = globalThis, ye = Q.trustedTypes, nt = ye ? ye.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, yt = "$lit$", O = `lit$${Math.random().toFixed(9).slice(2)}$`, bt = "?" + O, Ht = `<${bt}>`, I = document, ee = () => I.createComment(""), te = (i) => i === null || typeof i != "object" && typeof i != "function", Fe = Array.isArray, Gt = (i) => Fe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Me = `[ 	
\f\r]`, K = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, lt = />/g, A = RegExp(`>|${Me}(?:([^\\s"'>=/]+)(${Me}*=${Me}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, ht = /"/g, mt = /^(?:script|style|textarea|title)$/i, Tt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = Tt(1), z = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), U = I.createTreeWalker(I, 129);
function _t(i, e) {
...
const Zt = (i, e) => {
  ...
  for (let p = 0; p < t; p++) {
    const c = i[p];
    let v, y, g = -1, m = 0;
    for (; m < c.length && (n.lastIndex = m, y = n.exec(c), y !== null); ) m = n.lastIndex, n === K ? y[1] === "!--" ? n = at : y[1] !== void 0 ? n = lt : y[2] !== void 0 ? (mt.test(y[2]) && (r = RegExp("</" + y[2], "g")), n = A) : y[3] !== void 0 && (n = A) : n === A ? y[0] === ">" ? (n = r ?? K, g = -1) : y[1] === void 0 ? g = -2 : (g = n.lastIndex - y[2].length, v = y[1], n = y[3] === void 0 ? A : y[3] === '"' ? ht : ct) : n === ht || n === ct ? n = A : n === at || n === lt ? n = K : (n = A, r = void 0);
    const h = n === A && i[p + 1].startsWith("/>") ? " " : "";
    s += n === K ? c + Ht : g >= 0 ? (o.push(v), c.slice(0, g) + yt + c.slice(g) + O + h) : c + O + (g === -2 ? p : h);
  }
...
class re {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    for (; (r = U.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const g of r.getAttributeNames()) if (g.endsWith(yt)) {
          const m = y[n++], h = r.getAttribute(g).split(O), _ = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: s, name: _[2], strings: h, ctor: _[1] === "." ? Nt : _[1] === "?" ? Ft : _[1] === "@" ? qt : $e }), r.removeAttribute(g);
      ...
      } else if (r.nodeType === 8) if (r.data === bt) c.push({ type: 2, index: s });
      else {
        let g = -1;
...
class zt {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (n === c.index) {
        let v;
        c.type === 2 ? v = new ce(s, s.nextSibling, this, e) : c.type === 1 ? v = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (v = new Yt(s, this, e)), this._$AV.push(v), c = o[++p];
      }
...
class ce {
  ...
  _$AI(e, t = this) {
    e = N(this, e, t), te(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== z && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Gt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = re.createElement(_t(o.h, o.h[0]), this.options)), o);
...
var gt;
u._$litElement$ = !0, u.finalized = !0, (gt = globalThis.litElementHydrateSupport) == null || gt.call(globalThis, { LitElement: u });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mr = { attribute: !0, type: String, converter: ve, reflect: !1, hasChanged: Ne }, _r = (i = mr, e, t) => {
...
var wr = Object.defineProperty, Cr = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
...
const qi = ie;
var $r = Object.defineProperty, xr = Object.getOwnPropertyDescriptor, kr = (i, e, t, o) => {
...
const Yi = De;
var Sr = Object.defineProperty, Lr = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
...
const Xi = oe;
var Pr = Object.defineProperty, Or = Object.getOwnPropertyDescriptor, We = (i, e, t, o) => {
...
const Wi = se;
var Mr = Object.defineProperty, jr = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
...
const Er = D;
var Ar = Object.defineProperty, Ur = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
const Ki = R;
var Ir = Object.defineProperty, Dr = Object.getOwnPropertyDescriptor, G = (i, e, t, o) => {
...
const Ji = k;
var Rr = Object.defineProperty, Br = Object.getOwnPropertyDescriptor, ke = (i, e, t, o) => {
...
const Vr = F;
var Hr = Object.defineProperty, Gr = Object.getOwnPropertyDescriptor, Ke = (i, e, t, o) => {
...
const eo = Re;
var Nr = Object.defineProperty, Fr = Object.getOwnPropertyDescriptor, ue = (i, e, t, o) => {
...
const to = B;
var qr = Object.defineProperty, Yr = Object.getOwnPropertyDescriptor, xt = (i, e, t, o) => {
...
var Xr = Object.defineProperty, Wr = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
...
const ro = V;
var Kr = Object.defineProperty, Jr = Object.getOwnPropertyDescriptor, kt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Jr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const io = me;
var Qr = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, E = (i, e, t, o) => {
...
const oo = $;
var ti = Object.defineProperty, ri = Object.getOwnPropertyDescriptor, L = (i, e, t, o) => {
...
const lo = Y;
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, St = (i, e, t, o) => {
...
const co = _e;
var di = Object.defineProperty, fi = Object.getOwnPropertyDescriptor, Lt = (i, e, t, o) => {
...
const ho = we;
var gi = Object.defineProperty, vi = Object.getOwnPropertyDescriptor, yi = (i, e, t, o) => {
...
const po = Be;
var bi = Object.defineProperty, mi = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
const go = Ve;
var ki = Object.defineProperty, Si = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
...
const vo = X;
var Li = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, W = (i, e, t, o) => {
...
const Ot = j;
var Oi = Object.defineProperty, Mi = Object.getOwnPropertyDescriptor, ji = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Mi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Oi(e, t, r), r;
};
let He = class extends Ot {
  constructor() {
...
const yo = He;
var Ei = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Ui = (i, e, t, o) => {
...
const bo = Ge;
var Ii = Object.defineProperty, Di = Object.getOwnPropertyDescriptor, fe = (i, e, t, o) => {
...
let H = class extends u {
  constructor() {
    super(...arguments), this.auto = !1, this.mode = null, this.themesPath = "/themes", this.media = null;
  }
  get target() {
...
export {
  ...
  ho as UISpinner,
  po as UIStackLayout,
  uo as UIStackLayoutPage,
  fo as UIStore,
  go as UISvg,
  Ot as UIText,
  ao as UITextarea,
  mo as UIThemeHandler,
  f as css,
  Ti as draggable,
  Bi as globalStylesToShadowRoot,
  l as html,
  zi as isAndroid,
  Zi as ripple,
  Ni as styles,
