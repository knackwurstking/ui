 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: sr, defineProperty: nr, getOwnPropertyDescriptor: ar, getOwnPropertyNames: lr, getOwnPropertySymbols: cr, getPrototypeOf: pr } = Object, O = globalThis, st = O.trustedTypes, ur = st ? st.emptyScript : "", Me = O.reactiveElementPolyfillSupport, X = (i, e) => i, be = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? ur : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, me = J.trustedTypes, at = me ? me.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, wt = "$lit$", P = `lit$${Math.random().toFixed(9).slice(2)}$`, Ct = "?" + P, hr = `<${Ct}>`, U = document, Q = () => U.createComment(""), ee = (i) => i === null || typeof i != "object" && typeof i != "function", We = Array.isArray, dr = (i) => We(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", je = `[ 	
\f\r]`, K = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, lt = /-->/g, ct = />/g, A = RegExp(`>|${je}(?:([^\\s"'>=/]+)(${je}*=${je}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), pt = /'/g, ut = /"/g, $t = /^(?:script|style|textarea|title)$/i, gr = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), d = gr(1), R = Symbol.for("lit-noChange"), y = Symbol.for("lit-nothing"), ht = /* @__PURE__ */ new WeakMap(), E = U.createTreeWalker(U, 129);
function xt(i, e) {
...
const fr = (i, e) => {
  ...
  for (let p = 0; p < t; p++) {
    const c = i[p];
    let v, b, l = -1, _ = 0;
    for (; _ < c.length && (n.lastIndex = _, b = n.exec(c), b !== null); ) _ = n.lastIndex, n === K ? b[1] === "!--" ? n = lt : b[1] !== void 0 ? n = ct : b[2] !== void 0 ? ($t.test(b[2]) && (r = RegExp("</" + b[2], "g")), n = A) : b[3] !== void 0 && (n = A) : n === A ? b[0] === ">" ? (n = r ?? K, l = -1) : b[1] === void 0 ? l = -2 : (l = n.lastIndex - b[2].length, v = b[1], n = b[3] === void 0 ? A : b[3] === '"' ? ut : pt) : n === ut || n === pt ? n = A : n === lt || n === ct ? n = K : (n = A, r = void 0);
    ...
    for (; (r = E.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const l of r.getAttributeNames()) if (l.endsWith(wt)) {
          ...
          c.push({ type: 1, index: s, name: L[2], strings: m, ctor: L[1] === "." ? yr : L[1] === "?" ? br : L[1] === "@" ? mr : Se }), r.removeAttribute(l);
...
class le {
  ...
  _$AC(e) {
    ...
    return t === void 0 && ht.set(e.strings, t = new te(e)), t;
  }
  k(e) {
...
var xr = Object.defineProperty, kr = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
...
const Qi = re;
var Sr = Object.defineProperty, Lr = Object.getOwnPropertyDescriptor, Pr = (i, e, t, o) => {
...
const to = ie;
var jr = Object.defineProperty, Ar = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
...
const kt = Tr(Be);
var zr = Object.defineProperty, Zr = Object.getOwnPropertyDescriptor, ue = (i, e, t, o) => {
...
const no = Ve;
var Jr = Object.defineProperty, Qr = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
...
const po = C;
var li = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, S = (i, e, t, o) => {
...
const uo = w;
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, Qe = (i, e, t, o) => {
...
const ho = ne;
var hi = Object.defineProperty, di = Object.getOwnPropertyDescriptor, et = (i, e, t, o) => {
...
const bo = He;
var ki = Object.defineProperty, Si = Object.getOwnPropertyDescriptor, Ot = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Si(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const rt = $;
var ji = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Mt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ai(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
