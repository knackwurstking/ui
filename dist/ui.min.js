 ...
 */
const ae = globalThis, Ue = ae.ShadowRoot && (ae.ShadyCSS === void 0 || ae.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Be = Symbol(), We = /* @__PURE__ */ new WeakMap();
let yt = class {
  constructor(e, t, o) {
...
}, Ke = Ue ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: At, defineProperty: Rt, getOwnPropertyDescriptor: Dt, getOwnPropertyNames: Vt, getOwnPropertySymbols: Ut, getPrototypeOf: Bt } = Object, O = globalThis, Je = O.trustedTypes, Ht = Je ? Je.emptyScript : "", ke = O.reactiveElementPolyfillSupport, Y = (i, e) => i, ce = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ht : null;
      break;
  ...
  return t;
} }, He = (i, e) => !At(i, e), Qe = { attribute: !0, type: String, converter: ce, reflect: !1, hasChanged: He };
...
U.elementStyles = [], U.shadowRootOptions = { mode: "open" }, U[Y("elementProperties")] = /* @__PURE__ */ new Map(), U[Y("finalized")] = /* @__PURE__ */ new Map(), ke == null || ke({ ReactiveElement: U }), (O.reactiveElementVersions ?? (O.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const X = globalThis, he = X.trustedTypes, et = he ? he.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, bt = "$lit$", P = `lit$${Math.random().toFixed(9).slice(2)}$`, mt = "?" + P, Gt = `<${mt}>`, R = document, W = () => R.createComment(""), K = (i) => i === null || typeof i != "object" && typeof i != "function", Ge = Array.isArray, Tt = (i) => Ge(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Se = `[ 	
\f\r]`, q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, tt = /-->/g, rt = />/g, E = RegExp(`>|${Se}(?:([^\\s"'>=/]+)(${Se}*=${Se}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, ot = /"/g, _t = /^(?:script|style|textarea|title)$/i, Zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), a = Zt(1), B = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), st = /* @__PURE__ */ new WeakMap(), A = R.createTreeWalker(R, 129);
function wt(i, e) {
...
const It = (i, e) => {
  ...
  for (let u = 0; u < t; u++) {
    const c = i[u];
    let v, y, g = -1, m = 0;
    for (; m < c.length && (n.lastIndex = m, y = n.exec(c), y !== null); ) m = n.lastIndex, n === q ? y[1] === "!--" ? n = tt : y[1] !== void 0 ? n = rt : y[2] !== void 0 ? (_t.test(y[2]) && (r = RegExp("</" + y[2], "g")), n = E) : y[3] !== void 0 && (n = E) : n === E ? y[0] === ">" ? (n = r ?? q, g = -1) : y[1] === void 0 ? g = -2 : (g = n.lastIndex - y[2].length, v = y[1], n = y[3] === void 0 ? E : y[3] === '"' ? ot : it) : n === ot || n === it ? n = E : n === tt || n === rt ? n = q : (n = E, r = void 0);
...
class J {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const u = e.length - 1, c = this.parts, [v, y] = It(e, t);
...
class re {
  ...
  _$AI(e, t = this) {
    e = H(this, e, t), K(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Tt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== b && K(this._$AH) ? this._$AA.nextSibling.data = e : this.T(R.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = J.createElement(wt(o.h, o.h[0]), this.options)), o);
...
class be {
  ...
  _$AI(e, t = this, o, r) {
    ...
    if (s === void 0) e = H(this, e, t, 0), n = !K(e) || e !== this._$AH && e !== B, n && (this._$AH = e);
      ...
      const u = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = H(this, u[o + c], t, c), v === B && (v = this._$AH[c]), n || (n = !K(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
Le == null || Le(J, re), (X.litHtmlVersions ?? (X.litHtmlVersions = [])).push("3.2.1");
const Xt = (i, e, t) => {
...
var vt;
p._$litElement$ = !0, p.finalized = !0, (vt = globalThis.litElementHydrateSupport) == null || vt.call(globalThis, { LitElement: p });
...
function me(i, e) {
  ...
  let t = null;
  const o = (u) => {
    t = Me(u, e), i.addEventListener("pointermove", s);
  }, r = () => {
    i.removeEventListener("pointermove", s), je(t), t = null;
  }, s = () => r(), n = (u) => {
    t = Me(u, e), je(t), t = null;
  };
...
let D = class extends p {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "ripple":
        this.rippleCleanUp !== null && (this.rippleCleanUp(), this.rippleCleanUp = null), t !== null && (this.rippleCleanUp = me(this));
        break;
    }
  }
};
...
var Rr = Object.defineProperty, Dr = Object.getOwnPropertyDescriptor, _e = (i, e, t, o) => {
...
var Vr = Object.defineProperty, Ur = Object.getOwnPropertyDescriptor, we = (i, e, t, o) => {
...
var Br = Object.defineProperty, Hr = Object.getOwnPropertyDescriptor, Ne = (i, e, t, o) => {
...
Ye([
  l({ type: Boolean, attribute: "storage", reflect: !0 })
], ye.prototype, "storage", 2);
Ye([
  l({ type: String, attribute: "storage-prefix", reflect: !0 })
], ye.prototype, "storagePrefix", 2);
ye = Ye([
  d("ui-store")
], ye);
...
let te = class extends p {
  ...
  async enableRipple() {
    ...
    i && (this.rippleCleanUp = me(i), this.role = "button", this.style.cursor = "pointer", this.addEventListener("click", this.clickHandler), [...this.children].forEach((t) => {
