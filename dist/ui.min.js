let Oe = null;
function Mt() {
  return Oe === null && (Oe = Array.from(document.styleSheets).map((i) => {
...
function At(i, e, t) {
  ...
  return e.draggable = !0, e.ondragstart = (r) => {
    r.dataTransfer && (r.dataTransfer.effectAllowed = "move", r.dataTransfer.dropEffect = "move"), i.classList.add("ui-dragging"), t.onDragStart && t.onDragStart(o);
    ...
    r.preventDefault(), r.dataTransfer && (r.dataTransfer.dropEffect = "move"), i.classList.remove("ui-dragging"), t.onDragEnd && t.onDragEnd(o), [...i.children].forEach((s) => {
      s.style.background = "inherit", s.style.color = "inherit";
    });
  }, () => {
...
function Ut(i, e) {
  e = { ...Et, ...e };
  let t = null, o = null, r = null, s = !1, n = "", p = "";
  const c = (l) => {
    const _ = l.currentTarget;
    !t && Array.from(_.classList).includes("draggable") && (o = (/* @__PURE__ */ new Date()).getTime(), t = _, r && clearTimeout(r), r = setTimeout(() => {
      t && (n = t.style.color, p = t.style.backgroundColor, t.style.color = "var(--ui-primary-text)", t.style.backgroundColor = "var(--ui-primary)", i.classList.add("ui-dragging"), s = !0, e != null && e.onDragStart && e.onDragStart());
    }, 200));
  }, v = (l) => {
    if (!o || !t) return;
    if (!s && (/* @__PURE__ */ new Date()).getTime() - o < 200) {
      y();
      return;
    }
    l.preventDefault(), s || (s = !0, e != null && e.onDragStart && e.onDragStart());
    let _;
    if (l instanceof TouchEvent) {
      const L = l.targetTouches[0];
      _ = {
        clientX: L.clientX,
        clientY: L.clientY
      };
    ...
    let m = document.elementFromPoint(_.clientX, _.clientY);
    if (m) {
      for (; !m.classList.contains("draggable") && m.parentElement; )
        m = m.parentElement;
      m.classList.contains("draggable") && ((() => {
        let ve = t == null ? void 0 : t.previousElementSibling;
        for (; ve; ) {
          if (ve === m)
            return !0;
          ve = ve.previousElementSibling;
        }
        return !1;
      })() ? i.insertBefore(t, m) : i.insertBefore(t, m.nextElementSibling));
    }
  }, y = () => {
    r !== null && (clearTimeout(r), r = null), t && (t.style.color = n, t.style.backgroundColor = p, t = null), o = null, i.classList.remove("ui-dragging"), s && (s = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
  return [...i.children].forEach((l) => {
    l.classList.add("draggable"), l.onmousedown = c, l.ontouchstart = c, l.onmousemove = v, l.ontouchmove = v, i.onmouseleave = l.onmouseup = y, l.ontouchend = y;
  }), () => {
    [...i.children].forEach((l) => {
      l.classList.remove("draggable"), l.onmousedown = null, l.ontouchstart = null, l.onmousemove = null, l.ontouchmove = null, i.onmouseleave = l.onmouseup = null, l.ontouchend = null;
    });
  };
}
...
function Se(i, e) {
  ...
  let t = null;
  const o = (p) => {
    t = Ie(p, e), i.addEventListener("pointermove", s);
  }, r = () => {
    i.removeEventListener("pointermove", s), Re(t), t = null;
  }, s = () => r(), n = (p) => {
    t = Ie(p, e), Re(t), t = null;
  };
...
const Ni = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  start: Ie,
  stop: Re
}, Symbol.toStringTag, { value: "Module" })), f = String.raw, Fi = String.raw;
function qi() {
  return /(android)/i.test(navigator.userAgent);
}
function Wi(i) {
  return Object.entries(i).map(([e, t]) => `${e.replace(/[A-Z]/g, (o) => `-${o.toLowerCase()}`)}:${t}`).join(";") + ";";
}
const It = f`
 ...
 */
const ye = globalThis, Ne = ye.ShadowRoot && (ye.ShadyCSS === void 0 || ye.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Fe = Symbol(), it = /* @__PURE__ */ new WeakMap();
let _t = class {
  constructor(e, t, o) {
...
}, ot = Ne ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: or, defineProperty: sr, getOwnPropertyDescriptor: nr, getOwnPropertyNames: ar, getOwnPropertySymbols: lr, getPrototypeOf: cr } = Object, O = globalThis, st = O.trustedTypes, pr = st ? st.emptyScript : "", Me = O.reactiveElementPolyfillSupport, X = (i, e) => i, be = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? pr : null;
      break;
  ...
  return t;
} }, qe = (i, e) => !or(i, e), nt = { attribute: !0, type: String, converter: be, reflect: !1, hasChanged: qe };
...
class Z extends HTMLElement {
  ...
  static createProperty(e, t = nt) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.elementProperties.set(e, t), !t.noAccessor) {
      ...
      r !== void 0 && sr(this.prototype, e, r);
    }
  }
  static getPropertyDescriptor(e, t, o) {
    const { get: r, set: s } = nr(this.prototype, e) ?? { get() {
      return this[t];
    }, set(n) {
      this[t] = n;
    } };
    return { get() {
      ...
      s.call(this, n), this.requestUpdate(e, p, o);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(X("properties"))) {
      const t = this.properties, o = [...ar(t), ...lr(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of o) t.unshift(ot(r));
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && o.reflect === !0) {
      const n = (((s = o.converter) == null ? void 0 : s.toAttribute) !== void 0 ? o.converter : be).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = o.getPropertyOptions(r), p = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((s = n.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? n.converter : be;
      this._$Em = r, this[r] = p.fromAttribute(t, n.type), this._$Em = null;
    }
  }
  requestUpdate(e, t, o) {
    if (e !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(e)), !(o.hasChanged ?? qe)(this[e], t)) return;
      this.P(e, t, o);
    }
...
Z.elementStyles = [], Z.shadowRootOptions = { mode: "open" }, Z[X("elementProperties")] = /* @__PURE__ */ new Map(), Z[X("finalized")] = /* @__PURE__ */ new Map(), Me == null || Me({ ReactiveElement: Z }), (O.reactiveElementVersions ?? (O.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, me = J.trustedTypes, at = me ? me.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, wt = "$lit$", P = `lit$${Math.random().toFixed(9).slice(2)}$`, Ct = "?" + P, hr = `<${Ct}>`, U = document, Q = () => U.createComment(""), ee = (i) => i === null || typeof i != "object" && typeof i != "function", We = Array.isArray, ur = (i) => We(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", je = `[ 	
\f\r]`, K = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, lt = /-->/g, ct = />/g, A = RegExp(`>|${je}(?:([^\\s"'>=/]+)(${je}*=${je}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), pt = /'/g, ht = /"/g, $t = /^(?:script|style|textarea|title)$/i, dr = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), d = dr(1), N = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), ut = /* @__PURE__ */ new WeakMap(), E = U.createTreeWalker(U, 129);
function xt(i, e) {
...
const gr = (i, e) => {
  ...
  let r, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = K;
  for (let p = 0; p < t; p++) {
    const c = i[p];
    let v, y, l = -1, _ = 0;
    for (; _ < c.length && (n.lastIndex = _, y = n.exec(c), y !== null); ) _ = n.lastIndex, n === K ? y[1] === "!--" ? n = lt : y[1] !== void 0 ? n = ct : y[2] !== void 0 ? ($t.test(y[2]) && (r = RegExp("</" + y[2], "g")), n = A) : y[3] !== void 0 && (n = A) : n === A ? y[0] === ">" ? (n = r ?? K, l = -1) : y[1] === void 0 ? l = -2 : (l = n.lastIndex - y[2].length, v = y[1], n = y[3] === void 0 ? A : y[3] === '"' ? ht : pt) : n === ht || n === pt ? n = A : n === lt || n === ct ? n = K : (n = A, r = void 0);
    const m = n === A && i[p + 1].startsWith("/>") ? " " : "";
    s += n === K ? c + hr : l >= 0 ? (o.push(v), c.slice(0, l) + wt + c.slice(l) + P + m) : c + P + (l === -2 ? p : m);
  }
  return [xt(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class te {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const p = e.length - 1, c = this.parts, [v, y] = gr(e, t);
    if (this.el = te.createElement(v, o), E.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (r = E.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const l of r.getAttributeNames()) if (l.endsWith(wt)) {
          const _ = y[n++], m = r.getAttribute(l).split(P), L = /([.?@])?(.*)/.exec(_);
          c.push({ type: 1, index: s, name: L[2], strings: m, ctor: L[1] === "." ? vr : L[1] === "?" ? yr : L[1] === "@" ? br : ke }), r.removeAttribute(l);
        } else l.startsWith(P) && (c.push({ type: 6, index: s }), r.removeAttribute(l));
        if ($t.test(r.tagName)) {
          const l = r.textContent.split(P), _ = l.length - 1;
          if (_ > 0) {
            r.textContent = me ? me.emptyScript : "";
            for (let m = 0; m < _; m++) r.append(l[m], Q()), E.nextNode(), c.push({ type: 2, index: ++s });
            r.append(l[_], Q());
          }
        }
      } else if (r.nodeType === 8) if (r.data === Ct) c.push({ type: 2, index: s });
      else {
        let l = -1;
        for (; (l = r.data.indexOf(P, l + 1)) !== -1; ) c.push({ type: 7, index: s }), l += P.length - 1;
      }
      s++;
    }
  }
...
function F(i, e, t = i, o) {
  var n, p;
  if (e === N) return e;
  let r = o !== void 0 ? (n = t._$Co) == null ? void 0 : n[o] : t._$Cl;
  const s = ee(e) ? void 0 : e._$litDirective$;
  return (r == null ? void 0 : r.constructor) !== s && ((p = r == null ? void 0 : r._$AO) == null || p.call(r, !1), s === void 0 ? r = void 0 : (r = new s(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = F(i, r._$AS(i, e.values), r, o)), e;
}
class fr {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: o } = this._$AD, r = ((e == null ? void 0 : e.creationScope) ?? U).importNode(t, !0);
    E.currentNode = r;
    let s = E.nextNode(), n = 0, p = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let v;
        c.type === 2 ? v = new le(s, s.nextSibling, this, e) : c.type === 1 ? v = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (v = new mr(s, this, e)), this._$AV.push(v), c = o[++p];
      }
      n !== (c == null ? void 0 : c.index) && (s = E.nextNode(), n++);
    }
    return E.currentNode = U, r;
  }
  p(e) {
    let t = 0;
...
class le {
  ...
  constructor(e, t, o, r) {
    this.type = 2, this._$AH = b, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = o, this.options = r, this._$Cv = (r == null ? void 0 : r.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = F(this, e, t), ee(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== N && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ur(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== b && ee(this._$AH) ? this._$AA.nextSibling.data = e : this.T(U.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = te.createElement(xt(o.h, o.h[0]), this.options)), o);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === r) this._$AH.p(t);
    else {
      const n = new fr(r, this), p = n.u(this.options);
      n.p(t), this.T(p), this._$AH = n;
    }
  }
  _$AC(e) {
    let t = ut.get(e.strings);
    return t === void 0 && ut.set(e.strings, t = new te(e)), t;
  }
  k(e) {
    We(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, r = 0;
    for (const s of e) r === t.length ? t.push(o = new le(this.O(Q()), this.O(Q()), this, this.options)) : o = t[r], o._$AI(s), r++;
...
class ke {
  ...
  constructor(e, t, o, r, s) {
    this.type = 1, this._$AH = b, this._$AN = void 0, this.element = e, this.name = t, this._$AM = r, this.options = s, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = b;
  }
  _$AI(e, t = this, o, r) {
    const s = this.strings;
    let n = !1;
    if (s === void 0) e = F(this, e, t, 0), n = !ee(e) || e !== this._$AH && e !== N, n && (this._$AH = e);
    else {
      const p = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = F(this, p[o + c], t, c), v === N && (v = this._$AH[c]), n || (n = !ee(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
Ae == null || Ae(te, le), (J.litHtmlVersions ?? (J.litHtmlVersions = [])).push("3.2.1");
const _r = (i, e, t) => {
  const o = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = o._$litPart$;
  if (r === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    o._$litPart$ = r = new le(e.insertBefore(Q(), s), s, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
/**
...
let h = class extends Z {
  ...
  update(e) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = _r(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var vt;
h._$litElement$ = !0, h.finalized = !0, (vt = globalThis.litElementHydrateSupport) == null || vt.call(globalThis, { LitElement: h });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wr = { attribute: !0, type: String, converter: be, reflect: !1, hasChanged: qe }, Cr = (i = wr, e, t) => {
  ...
  if (s === void 0 && globalThis.litPropertyMetadata.set(r, s = /* @__PURE__ */ new Map()), s.set(t.name, i), o === "accessor") {
    ...
    return { set(p) {
      ...
      e.set.call(this, p), this.requestUpdate(n, c, i);
    }, init(p) {
      return p !== void 0 && this.P(n, void 0, i), p;
    } };
  }
  if (o === "setter") {
    const { name: n } = t;
    return function(p) {
      const c = this[n];
      e.call(this, p), this.requestUpdate(n, c, i);
    };
  }
  throw Error("Unsupported decorator location: " + o);
};
function a(i) {
  return (e, t) => typeof t == "object" ? Cr(i, e, t) : ((o, r, s) => {
...
var $r = Object.defineProperty, xr = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? xr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
...
let re = class extends h {
  ...
  render() {
    return d` <ui-text style="font-size: 0.9rem;">${this.message}</ui-text> `;
  }
  firstUpdated(i) {
...
Ye([
  a({ type: String, attribute: "variant", reflect: !0 })
], re.prototype, "variant", 2);
Ye([
  a({ type: String, attribute: "message" })
], re.prototype, "message", 2);
re = Ye([
  u("ui-alert")
], re);
const Ji = re;
var Sr = Object.defineProperty, kr = Object.getOwnPropertyDescriptor, Lr = (i, e, t, o) => {
...
const Qi = De;
var Pr = Object.defineProperty, Or = Object.getOwnPropertyDescriptor, Ke = (i, e, t, o) => {
...
Ke([
  a({ type: String, attribute: "position", reflect: !0 })
], ie.prototype, "position", 2);
Ke([
  a({ type: Boolean, attribute: "fixed", reflect: !0 })
], ie.prototype, "fixed", 2);
ie = Ke([
  u("ui-app-bar")
], ie);
const eo = ie;
var Mr = Object.defineProperty, jr = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
...
Xe([
  a({ type: String, attribute: "name", reflect: !0 })
], oe.prototype, "name", 2);
Xe([
  a({ type: Boolean, attribute: "hidden", reflect: !0 })
], oe.prototype, "hidden", 2);
oe = Xe([
  u("ui-app-bar-item")
], oe);
const to = oe;
var Ar = Object.defineProperty, Er = Object.getOwnPropertyDescriptor, ce = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Er(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Ar(e, t, r), r;
};
let I = class extends h {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "ripple":
        this.rippleCleanUp !== null && (this.rippleCleanUp(), this.rippleCleanUp = null), t !== null && (this.rippleCleanUp = Se(this));
        break;
    }
  }
};
ce([
  a({ type: String, attribute: "color", reflect: !0 })
], I.prototype, "color", 2);
ce([
  a({ type: String, attribute: "variant", reflect: !0 })
], I.prototype, "variant", 2);
ce([
  a({ type: Boolean, attribute: "disabled" })
], I.prototype, "disabled", 2);
ce([
  a({ type: Boolean, attribute: "ripple" })
], I.prototype, "ripple", 2);
I = ce([
  u("ui-button")
], I);
const Ur = I;
var Ir = Object.defineProperty, Rr = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Rr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
pe([
  a({ type: Boolean, attribute: "ghost" })
], R.prototype, "ghost", 2);
pe([
  a({ type: Boolean, attribute: "disabled" })
...
pe([
  a({ type: Boolean, attribute: "ripple" })
], R.prototype, "ripple", 2);
R = pe([
  u("ui-icon-button")
], R);
const ro = R;
var Dr = Object.defineProperty, Br = Object.getOwnPropertyDescriptor, T = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Br(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Dr(e, t, r), r;
};
let x = class extends h {
  ...
  show() {
    ...
    const i = this.shadowRoot.querySelector("dialog");
    if (i === null) return;
    const e = i.inert;
    i.inert = this.inert, this.modal ? i.showModal() : i.show(), i.inert = e, this.dispatchEvent(new Event("open"));
  }
  close() {
...
T([
  a({ type: String, attribute: "title", reflect: !0 })
], x.prototype, "title", 2);
T([
  a({ type: Boolean, attribute: "fullscreen", reflect: !0 })
], x.prototype, "fullscreen", 2);
T([
  a({ type: Boolean, attribute: "no-footer", reflect: !0 })
], x.prototype, "noFooter", 2);
T([
  a({ type: Boolean, attribute: "open", reflect: !0 })
], x.prototype, "open", 2);
T([
  a({ type: Boolean, attribute: "modal", reflect: !0 })
], x.prototype, "modal", 2);
T([
  a({ type: Boolean, attribute: "inert", reflect: !0 })
], x.prototype, "inert", 2);
x = T([
  u("ui-dialog")
], x);
const io = x;
var Vr = Object.defineProperty, Hr = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
...
let D = class extends h {
  constructor() {
    super(...arguments), this.title = "", this.gap = Gr, this.open = !1, this.noFold = !1;
  }
  static get styles() {
    return g`
            * {
...
he([
  a({ type: String, attribute: "gap" })
], D.prototype, "gap", 2);
he([
  a({ type: Boolean, attribute: "open", reflect: !0 })
], D.prototype, "open", 2);
he([
  a({ type: Boolean, attribute: "no-fold", reflect: !0 })
], D.prototype, "noFold", 2);
D = he([
  u("ui-drawer-group")
], D);
const Tr = D;
var zr = Object.defineProperty, Zr = Object.getOwnPropertyDescriptor, Je = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Zr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && zr(e, t, r), r;
};
let se = class extends h {
  constructor() {
    super(...arguments), this.open = !1, this.role = "button", this.handleUnfold = (i) => {
  ...
  updated(i) {
    [...this.children].forEach(async (e) => {
      e instanceof Tr && e.addEventListener("unfold", this.handleUnfold);
    });
  }
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
...
Je([
  a({ type: String, attribute: "width", reflect: !0 })
...
const oo = se;
var Nr = Object.defineProperty, Fr = Object.getOwnPropertyDescriptor, qr = (i, e, t, o) => {
...
Be = qr([
  u("ui-drawer-group-item")
], Be);
const so = Be;
var Wr = Object.defineProperty, Yr = Object.getOwnPropertyDescriptor, ue = (i, e, t, o) => {
...
let B = class extends h {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "gap":
        t ? this.style.setProperty("--_gap", t || dt) : this.style.removeProperty("--_gap");
        break;
      case "justify":
...
ue([
  a({ type: String, attribute: "justify" })
], B.prototype, "justify", 2);
ue([
  a({ type: String, attribute: "align" })
], B.prototype, "align", 2);
ue([
  a({ type: String, attribute: "wrap" })
], B.prototype, "wrap", 2);
B = ue([
  u("ui-flex-grid")
], B);
const no = B;
var Kr = Object.defineProperty, Xr = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Xr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "flex":
        ...
        break;
      case "direction":
        t ? this.style.setProperty("--_direction", t) : this.style.removeProperty("--_direction");
        break;
      case "justify":
        t ? this.style.setProperty("--_justify", t) : this.style.removeProperty("--_justify");
        break;
...
de([
  a({ type: Number, attribute: "flex" })
], V.prototype, "flex", 2);
de([
  a({ type: String, attribute: "direction", reflect: !0 })
], V.prototype, "direction", 2);
de([
  a({ type: String, attribute: "justify" })
], V.prototype, "justify", 2);
de([
  a({ type: String, attribute: "align" })
], V.prototype, "align", 2);
V = de([
...
var Jr = Object.defineProperty, Qr = Object.getOwnPropertyDescriptor, ge = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Qr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Jr(e, t, r), r;
};
const gt = "0";
let H = class extends h {
  constructor() {
    super(...arguments), this.gap = gt;
  }
  static get styles() {
    return g`
            :host {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "gap":
        t ? this.style.setProperty("--_gap", t || gt) : this.style.removeProperty("--_gap");
        break;
      case "justify":
        t ? this.style.setProperty("--_justify", t || "") : this.style.removeProperty("--_justify");
        break;
...
const ao = H;
var ei = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, St = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ti(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && ei(e, t, r), r;
};
let _e = class extends h {
  constructor() {
    super(...arguments), this.checked = !1, this.role = "checkbox";
  }
  static get styles() {
    return g`
            :host {
...
St([
  a({ type: Boolean, attribute: "checked", reflect: !0 })
], _e.prototype, "checked", 2);
_e = St([
  u("ui-check")
], _e);
const lo = _e;
var ri = Object.defineProperty, ii = Object.getOwnPropertyDescriptor, M = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ii(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && ri(e, t, r), r;
};
let C = class extends h {
  constructor() {
    super(...arguments), this.title = "", this.type = "", this.value = "", this.placeholder = "", this.invalid = !1, this.min = "", this.max = "", this.role = "input";
  }
  static get styles() {
    return g`
            * {
  ...
  render() {
    return d`
            <div class="container">
                ${this.title ? d` <ui-secondary class="title"> ${this.title} </ui-secondary> ` : ""}
                <input
                    type="${this.type}"
                    value="${this.value}"
...
M([
  a({ type: String, attribute: "type", reflect: !0 })
], C.prototype, "type", 2);
M([
...
M([
  a({ type: Boolean, attribute: "invalid", reflect: !0 })
], C.prototype, "invalid", 2);
M([
  a({ type: String, attribute: "min", reflect: !0 })
], C.prototype, "min", 2);
M([
  a({ type: String, attribute: "max", reflect: !0 })
], C.prototype, "max", 2);
C = M([
  u("ui-input")
], C);
const co = C;
var oi = Object.defineProperty, si = Object.getOwnPropertyDescriptor, k = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? si(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && oi(e, t, r), r;
};
let w = class extends h {
  constructor() {
    super(...arguments), this.title = "", this.value = "", this.placeholder = "", this.invalid = !1, this.noSubmit = !1, this.storage = !1, this.storagePrefix = "", this.storageKey = "", this.role = "search";
  }
  static get styles() {
    return g`
            * {
    ...
    return d`
            <div class="container">
                ...
                <input
                    ...
                    @keydown=${(i) => {
      var e, t;
      this.noSubmit || i.key !== "Enter" || (t = (e = this.shadowRoot) == null ? void 0 : e.querySelector('ui-icon-button[name="submit"]')) == null || t.click();
    }}
                    @input=${(i) => {
      this.value = i.currentTarget.value, this.storage && localStorage.setItem(this.storagePrefix + this.storageKey, this.value), this.noSubmit && this.dispatchEvent(new Event("change"));
    }}
                />
  ...
  firstUpdated(i) {
    if (super.firstUpdated(i), this.storage) {
      const e = localStorage.getItem(this.storagePrefix + this.storageKey) || this.value;
...
k([
  a({ type: Boolean, attribute: "no-submit", reflect: !0 })
], w.prototype, "noSubmit", 2);
k([
  a({ type: Boolean, attribute: "storage", reflect: !0 })
], w.prototype, "storage", 2);
k([
  a({ type: String, attribute: "storage-prefix", reflect: !0 })
], w.prototype, "storagePrefix", 2);
k([
  a({ type: String, attribute: "storage-key", reflect: !0 })
], w.prototype, "storageKey", 2);
w = k([
  u("ui-search")
], w);
const po = w;
var ni = Object.defineProperty, ai = Object.getOwnPropertyDescriptor, Qe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ai(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && ni(e, t, r), r;
};
let ne = class extends h {
  ...
  render() {
    !this.open && !this.keepOpen ? this.role = "button" : this.role = null;
  ...
  async optionsClickHandler(i) {
    i.composedPath().forEach((e) => {
      e instanceof q && ([...this.querySelectorAll("ui-select-option")].forEach(
        (t) => t.removeAttribute("selected")
      ), e.setAttribute("selected", ""), this.dispatchEvent(new Event("change")));
    });
  }
  options() {
    return [...this.children].filter((i) => i instanceof q);
  }
  selected() {
...
Qe([
  a({ type: Boolean, attribute: "keep-open", reflect: !0 })
], ne.prototype, "keepOpen", 2);
ne = Qe([
  u("ui-select")
], ne);
const ho = ne;
var li = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, et = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ci(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && li(e, t, r), r;
};
let q = class extends h {
  constructor() {
    super(...arguments), this.value = "", this.selected = !1, this.role = "button";
  }
  static get styles() {
    return g`
            :host {
...
et([
  a({ type: String, attribute: "value", reflect: !0 })
], q.prototype, "value", 2);
et([
  a({ type: Boolean, attribute: "selected", reflect: !0 })
 ...
 */
const ft = (i) => i ?? b;
var pi = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, z = (i, e, t, o) => {
...
let S = class extends h {
  constructor() {
    super(...arguments), this.title = "", this.value = "", this.placeholder = "", this.invalid = !1, this.role = "textbox";
  }
  static get styles() {
    return g`
            * {
...
z([
  a({ type: Number, attribute: "rows", reflect: !0 })
], S.prototype, "rows", 2);
z([
  a({ type: Number, attribute: "cols", reflect: !0 })
], S.prototype, "cols", 2);
S = z([
  u("ui-textarea")
], S);
const uo = S;
var ui = Object.defineProperty, di = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? di(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
Le([
  a({ type: String, attribute: "href", reflect: !0 })
], W.prototype, "href", 2);
Le([
  a({ type: Boolean, attribute: "fallback", reflect: !0 })
], W.prototype, "fallback", 2);
W = Le([
  u("ui-lang-type")
], W);
const go = W;
var gi = Object.defineProperty, fi = Object.getOwnPropertyDescriptor, kt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? fi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && gi(e, t, r), r;
};
let we = class extends h {
  constructor() {
    super(...arguments), this.data = {}, this.events = new ze(), this.current = "";
  }
  static get styles() {
    return g`
            :host {
...
kt([
  a({ type: String, attribute: "current", reflect: !0 })
], we.prototype, "current", 2);
we = kt([
  u("ui-lang")
], we);
const fo = we;
var vi = Object.defineProperty, yi = Object.getOwnPropertyDescriptor, Lt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? yi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
Lt([
  a({ type: Boolean, attribute: "nobg", reflect: !0 })
], Ce.prototype, "nobg", 2);
Ce = Lt([
  u("ui-spinner")
], Ce);
const vo = Ce;
var bi = Object.defineProperty, mi = Object.getOwnPropertyDescriptor, _i = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? mi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && bi(e, t, r), r;
};
let Ve = class extends h {
  constructor() {
    super(...arguments), this.events = new ze(), this.stack = [], this.onpopstate = () => {
  ...
  async setPage(i, e = null, t = !1) {
    var s;
    if (this.lockNavigation) return;
    if (!(i in this.pages))
      throw new Error(`page "${i}" not found`);
...
const yo = Ve;
var wi = Object.defineProperty, Ci = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ci(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && wi(e, t, r), r;
};
...
$e = Pt([
  u("ui-stack-layout-page")
], $e);
const bo = $e;
var $i = Object.defineProperty, xi = Object.getOwnPropertyDescriptor, tt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? xi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && $i(e, t, r), r;
};
let ae = class extends h {
  constructor() {
    super(...arguments), this.data = {}, this.events = new ze(), this.storage = !1, this.storagePrefix = "";
  }
  static get styles() {
    return g`
            :host {
...
tt([
  a({ type: Boolean, attribute: "storage", reflect: !0 })
], ae.prototype, "storage", 2);
tt([
  a({ type: String, attribute: "storage-prefix", reflect: !0 })
], ae.prototype, "storagePrefix", 2);
ae = tt([
  u("ui-store")
], ae);
const mo = ae;
var Si = Object.defineProperty, ki = Object.getOwnPropertyDescriptor, Li = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ki(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const _o = He;
var Pi = Object.defineProperty, Oi = Object.getOwnPropertyDescriptor, j = (i, e, t, o) => {
...
let $ = class extends h {
  constructor() {
    super(...arguments), this.family = "var(--ui-fontFamily)", this.size = "var(--ui-fontSize)", this.mono = 0, this.casl = 1, this.wght = 400, this.slnt = 0, this.crsv = 0.5;
  }
  static get styles() {
    return g`
            :host {
  ...
  render() {
    return this.style.setProperty("--_family", this.family), this.style.setProperty("--_size", this.size), this.style.setProperty("--_mono", this.mono.toString()), this.style.setProperty("--_casl", this.casl.toString()), this.style.setProperty("--_wght", this.wght.toString()), this.style.setProperty("--_slnt", this.slnt.toString()), this.style.setProperty("--_crsv", this.crsv.toString()), d`<slot></slot>`;
  }
};
j([
  a({ type: String, attribute: "family", reflect: !0 })
], $.prototype, "family", 2);
j([
  a({ type: String, attribute: "size", reflect: !0 })
], $.prototype, "size", 2);
j([
  a({ type: Number, attribute: "mono", reflect: !0 })
], $.prototype, "mono", 2);
j([
  a({ type: Number, attribute: "casl", reflect: !0 })
], $.prototype, "casl", 2);
j([
  a({ type: Number, attribute: "wght", reflect: !0 })
], $.prototype, "wght", 2);
j([
  a({ type: Number, attribute: "slnt", reflect: !0 })
], $.prototype, "slnt", 2);
j([
  a({ type: Number, attribute: "crsv", reflect: !0 })
], $.prototype, "crsv", 2);
$ = j([
  u("ui-text")
], $);
const rt = $;
var Mi = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, Ot = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? ji(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Mi(e, t, r), r;
};
let xe = class extends rt {
  constructor() {
    super(...arguments), this.mono = 0.25, this.casl = 1, this.wght = 750, this.slnt = 0;
  }
  render() {
    switch (this.level) {
      case 6:
...
Ot([
  a({ type: Number, attribute: "level", reflect: !0 })
], xe.prototype, "level", 2);
xe = Ot([
  u("ui-heading")
], xe);
const wo = xe;
var Ai = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, Pe = (i, e, t, o) => {
...
let Y = class extends h {
  ...
  render() {
    return d`
            <div>
                <span>
                    ${this.primary ? d`<ui-primary>${this.primary}</ui-primary>` : ""}
                    ${this.secondary ? d`<ui-secondary>${this.secondary}</ui-secondary>` : ""}
                </span>
  ...
  async enableRipple() {
    ...
    i && (this.rippleCleanUp = Se(i), this.role = "button", this.style.cursor = "pointer", this.addEventListener("click", this.clickHandler), [...this.children].forEach((t) => {
      t.addEventListener("click", this.childClickHandler);
    }));
  }
  async disableRipple() {
    this.rippleCleanUp && (this.style.cursor = "default", this.role = null, this.rippleCleanUp(), this.rippleCleanUp = null, this.removeEventListener("click", this.clickHandler), [...this.children].forEach((i) => {
      i.removeEventListener("click", this.childClickHandler);
    }));
  }
};
Pe([
  a({ type: String, attribute: "primary", reflect: !0 })
], Y.prototype, "primary", 2);
Pe([
  a({ type: String, attribute: "secondary", reflect: !0 })
], Y.prototype, "secondary", 2);
Pe([
  a({ type: Boolean, attribute: "ripple", reflect: !0 })
], Y.prototype, "ripple", 2);
Y = Pe([
  u("ui-label")
], Y);
const Co = Y;
var Ui = Object.defineProperty, Ii = Object.getOwnPropertyDescriptor, Ri = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ii(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Ui(e, t, r), r;
};
let Ge = class extends rt {
  constructor() {
    super(...arguments), this.size = "1.1rem", this.wght = 425;
  }
};
Ge = Ri([
  u("ui-primary")
...
const $o = Ge;
var Di = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, Vi = (i, e, t, o) => {
...
let Te = class extends rt {
  constructor() {
    super(...arguments), this.size = "0.9rem", this.wght = 350, this.slnt = -15;
  }
};
Te = Vi([
  u("ui-secondary")
...
const xo = Te;
var Hi = Object.defineProperty, Gi = Object.getOwnPropertyDescriptor, fe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Gi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Hi(e, t, r), r;
};
let G = class extends h {
  constructor() {
    super(...arguments), this.themesPath = "themes", this.media = null;
  }
  get target() {
  ...
  handleTheme() {
    ...
    ), i.querySelectorAll("link.theme").forEach((t) => {
      i.removeChild(t);
    });
    const e = document.createElement("link");
    e.classList.add("theme"), e.rel = "stylesheet", e.href = `${this.themesPath}/${this.theme}.css`, i.appendChild(e);
  }
};
fe([
  a({ type: Boolean, attribute: "auto", reflect: !0 })
], G.prototype, "auto", 2);
fe([
  a({ type: String, attribute: "mode", reflect: !0 })
], G.prototype, "mode", 2);
fe([
  a({ type: String, attribute: "theme", reflect: !0 })
], G.prototype, "theme", 2);
fe([
  a({ type: String, attribute: "themes-path", reflect: !0 })
], G.prototype, "themesPath", 2);
G = fe([
  u("ui-theme-handler")
], G);
const So = G;
export {
  ...
  vo as UISpinner,
  yo as UIStackLayout,
  bo as UIStackLayoutPage,
  mo as UIStore,
  _o as UISvg,
  rt as UIText,
  uo as UITextarea,
  So as UIThemeHandler,
  Fi as css,
  Zi as draggable,
  Ti as globalStylesToShadowRoot,
  f as html,
  qi as isAndroid,
  Ni as ripple,
  Wi as styles,
