...
function Me(i, e, t) {
  ...
  return e.draggable = !0, e.ondragstart = (r) => {
    r.dataTransfer && (r.dataTransfer.effectAllowed = "move", r.dataTransfer.dropEffect = "move"), t.onDragStart && t.onDragStart(o);
  }, e.ondragover = (r) => (r.preventDefault(), !1), e.ondragenter = (r) => {
    r.preventDefault(), [...i.children].forEach((n, s) => {
      if (s === o) {
    ...
    r.preventDefault(), r.dataTransfer && (r.dataTransfer.dropEffect = "move"), t.onDragEnd && t.onDragEnd(o), [...i.children].forEach((n) => {
      n.style.background = "inherit", n.style.color = "inherit";
    });
  }, () => {
...
function xe(i, e) {
  e = { ...be, ...e };
  let t = null, o = null, r, n, s = null, c = !1, l = "", h = "";
  const p = (a) => {
    ...
    if (!t && Array.from(m.classList).includes("draggable")) {
      ...
      o = (/* @__PURE__ */ new Date()).getTime(), t = m, s && clearTimeout(s), s = setTimeout(() => {
        t && (l = t.style.color, h = t.style.backgroundColor, t.style.color = "var(--ui-primary-fg)", t.style.backgroundColor = "var(--ui-primary)", i.classList.add("dragging"), c = !0, e != null && e.onDragStart && e.onDragStart());
      }, 200);
    }
  }, d = (a) => {
    if (!o || !t) return;
    if (!c && (/* @__PURE__ */ new Date()).getTime() - o < 200) {
      let v, C;
      if (a instanceof TouchEvent) {
        const oe = a.targetTouches[0];
        v = Math.abs(r - oe.clientX), C = Math.abs(n - oe.clientY);
      } else
        v = Math.abs(r - a.clientX), C = Math.abs(n - a.clientY);
      if ((v > C ? v : C) < 24)
        return;
      f();
      return;
    ...
    if (_) {
      ...
      _.classList.contains("draggable") && ((() => {
        let C = t == null ? void 0 : t.previousElementSibling;
        for (; C; ) {
          if (C === _)
            return !0;
        ...
        return !1;
      })() ? i.insertBefore(t, _) : i.insertBefore(
        t,
        _.nextElementSibling
      ));
    }
  }, f = () => {
    s !== null && (clearTimeout(s), s = null), t && (t.style.color = l, t.style.backgroundColor = h, t = null), o = null, i.classList.remove("dragging"), c && (c = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
...
function Ae(i, e) {
  ...
  let t = null;
  const o = (c) => {
    t = q(c, e), i.addEventListener("pointermove", n);
  }, r = () => {
    i.removeEventListener("pointermove", n), J(t), t = null;
  }, n = () => r(), s = (c) => {
    t = q(c, e), J(t), t = null;
  };
  return i.classList.add("ripple-container"), i.style.overflow = "hidden", e.useClick === !0 ? i.addEventListener("click", s) : (i.addEventListener("pointerdown", o), i.addEventListener("pointerup", r), i.addEventListener("pointerleave", r)), () => {
    if (i.classList.remove("ripple-container"), e.useClick === !0) {
      i.removeEventListener("click", s);
      return;
    }
    i.removeEventListener("pointerdown", o), i.removeEventListener("pointerup", r), i.removeEventListener("pointerleave", r), i.removeEventListener("pointermove", n);
  };
}
function q(i, e) {
...
const u = String.raw, Ht = String.raw;
function Gt(i) {
 ...
 */
const T = globalThis, K = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Q = Symbol(), ie = /* @__PURE__ */ new WeakMap();
let Ce = class {
  constructor(e, t, o) {
  ...
  get styleSheet() {
    ...
    if (K && e === void 0) {
      ...
      o && (e = ie.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && ie.set(t, e));
    }
    return e;
  }
  toString() {
...
const Ke = (i) => new Ce(typeof i == "string" ? i : i + "", void 0, Q), Qe = (i, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: tt, defineProperty: rt, getOwnPropertyDescriptor: ot, getOwnPropertyNames: it, getOwnPropertySymbols: nt, getPrototypeOf: st } = Object, w = globalThis, se = w.trustedTypes, lt = se ? se.emptyScript : "", F = w.reactiveElementPolyfillSupport, j = (i, e) => i, U = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? lt : null;
      break;
  ...
  return t;
} }, ee = (i, e) => !tt(i, e), le = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: ee };
...
class x extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    ...
    return { get() {
      ...
      n.call(this, s), this.requestUpdate(e, c, o);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(j("properties"))) {
      const t = this.properties, o = [...it(t), ...nt(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of o) t.unshift(ne(r));
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && o.reflect === !0) {
      const s = (((n = o.converter) == null ? void 0 : n.toAttribute) !== void 0 ? o.converter : U).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const s = o.getPropertyOptions(r), c = typeof s.converter == "function" ? { fromAttribute: s.converter } : ((n = s.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? s.converter : U;
      this._$Em = r, this[r] = c.fromAttribute(t, s.type), this._$Em = null;
    }
  }
  requestUpdate(e, t, o) {
    if (e !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(e)), !(o.hasChanged ?? ee)(this[e], t)) return;
      this.P(e, t, o);
    }
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[j("elementProperties")] = /* @__PURE__ */ new Map(), x[j("finalized")] = /* @__PURE__ */ new Map(), F == null || F({ ReactiveElement: x }), (w.reactiveElementVersions ?? (w.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const H = globalThis, D = H.trustedTypes, ae = D ? D.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ve = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, ye = "?" + y, at = `<${ye}>`, M = document, G = () => M.createComment(""), P = (i) => i === null || typeof i != "object" && typeof i != "function", te = Array.isArray, ct = (i) => te(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", X = `[ 	
\f\r]`, R = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ce = /-->/g, de = />/g, L = RegExp(`>|${X}(?:([^\\s"'>=/]+)(${X}*=${X}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), he = /'/g, ue = /"/g, we = /^(?:script|style|textarea|title)$/i, dt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), ke = dt(1), A = Symbol.for("lit-noChange"), g = Symbol.for("lit-nothing"), pe = /* @__PURE__ */ new WeakMap(), $ = M.createTreeWalker(M, 129);
function Le(i, e) {
...
const ht = (i, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = i[c];
    let h, p, d = -1, f = 0;
    for (; f < l.length && (s.lastIndex = f, p = s.exec(l), p !== null); ) f = s.lastIndex, s === R ? p[1] === "!--" ? s = ce : p[1] !== void 0 ? s = de : p[2] !== void 0 ? (we.test(p[2]) && (r = RegExp("</" + p[2], "g")), s = L) : p[3] !== void 0 && (s = L) : s === L ? p[0] === ">" ? (s = r ?? R, d = -1) : p[1] === void 0 ? d = -2 : (d = s.lastIndex - p[2].length, h = p[1], s = p[3] === void 0 ? L : p[3] === '"' ? ue : he) : s === ue || s === he ? s = L : s === ce || s === de ? s = R : (s = L, r = void 0);
    const a = s === L && i[c + 1].startsWith("/>") ? " " : "";
    n += s === R ? l + at : d >= 0 ? (o.push(h), l.slice(0, d) + ve + l.slice(d) + y + a) : l + y + (d === -2 ? c : a);
  }
  return [Le(i, n + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class Z {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let n = 0, s = 0;
    const c = e.length - 1, l = this.parts, [h, p] = ht(e, t);
    if (this.el = Z.createElement(h, o), $.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (r = $.nextNode()) !== null && l.length < c; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const d of r.getAttributeNames()) if (d.endsWith(ve)) {
          const f = p[s++], a = r.getAttribute(d).split(y), m = /([.?@])?(.*)/.exec(f);
          l.push({ type: 1, index: n, name: m[2], strings: a, ctor: m[1] === "." ? pt : m[1] === "?" ? gt : m[1] === "@" ? ft : N }), r.removeAttribute(d);
        } else d.startsWith(y) && (l.push({ type: 6, index: n }), r.removeAttribute(d));
        if (we.test(r.tagName)) {
          const d = r.textContent.split(y), f = d.length - 1;
          if (f > 0) {
            r.textContent = D ? D.emptyScript : "";
            for (let a = 0; a < f; a++) r.append(d[a], G()), $.nextNode(), l.push({ type: 2, index: ++n });
            r.append(d[f], G());
          }
        }
      } else if (r.nodeType === 8) if (r.data === ye) l.push({ type: 2, index: n });
      else {
        let d = -1;
        for (; (d = r.data.indexOf(y, d + 1)) !== -1; ) l.push({ type: 7, index: n }), d += y.length - 1;
      }
      n++;
    }
  }
...
function E(i, e, t = i, o) {
  var s, c;
  if (e === A) return e;
  let r = o !== void 0 ? (s = t._$Co) == null ? void 0 : s[o] : t._$Cl;
  const n = P(e) ? void 0 : e._$litDirective$;
  return (r == null ? void 0 : r.constructor) !== n && ((c = r == null ? void 0 : r._$AO) == null || c.call(r, !1), n === void 0 ? r = void 0 : (r = new n(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = E(i, r._$AS(i, e.values), r, o)), e;
}
class ut {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: o } = this._$AD, r = ((e == null ? void 0 : e.creationScope) ?? M).importNode(t, !0);
    $.currentNode = r;
    let n = $.nextNode(), s = 0, c = 0, l = o[0];
    for (; l !== void 0; ) {
      if (s === l.index) {
        let h;
        l.type === 2 ? h = new B(n, n.nextSibling, this, e) : l.type === 1 ? h = new l.ctor(n, l.name, l.strings, this, e) : l.type === 6 && (h = new mt(n, this, e)), this._$AV.push(h), l = o[++c];
      }
      s !== (l == null ? void 0 : l.index) && (n = $.nextNode(), s++);
    }
    return $.currentNode = M, r;
  }
  p(e) {
    let t = 0;
...
class B {
  ...
  constructor(e, t, o, r) {
    this.type = 2, this._$AH = g, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = o, this.options = r, this._$Cv = (r == null ? void 0 : r.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = E(this, e, t), P(e) ? e === g || e == null || e === "" ? (this._$AH !== g && this._$AR(), this._$AH = g) : e !== this._$AH && e !== A && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ct(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== g && P(this._$AH) ? this._$AA.nextSibling.data = e : this.T(M.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = Z.createElement(Le(o.h, o.h[0]), this.options)), o);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === r) this._$AH.p(t);
    else {
      const s = new ut(r, this), c = s.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let o, r = 0;
    for (const n of e) r === t.length ? t.push(o = new B(this.O(G()), this.O(G()), this, this.options)) : o = t[r], o._$AI(n), r++;
...
class N {
  ...
  constructor(e, t, o, r, n) {
    this.type = 1, this._$AH = g, this._$AN = void 0, this.element = e, this.name = t, this._$AM = r, this.options = n, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = g;
  }
  _$AI(e, t = this, o, r) {
    const n = this.strings;
    let s = !1;
    if (n === void 0) e = E(this, e, t, 0), s = !P(e) || e !== this._$AH && e !== A, s && (this._$AH = e);
    else {
      const c = e;
      let l, h;
      for (e = n[0], l = 0; l < n.length - 1; l++) h = E(this, c[o + l], t, l), h === A && (h = this._$AH[l]), s || (s = !P(h) || h !== this._$AH[l]), h === g ? e = g : e !== g && (e += (h ?? "") + n[l + 1]), this._$AH[l] = h;
    }
    s && !r && this.j(e);
  }
  j(e) {
...
class ft extends N {
  ...
  _$AI(e, t = this) {
    ...
    const o = this._$AH, r = e === g && o !== g || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, n = e !== g && (o === g || r);
...
Y == null || Y(Z, B), (H.litHtmlVersions ?? (H.litHtmlVersions = [])).push("3.2.1");
const _t = (i, e, t) => {
  const o = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = o._$litPart$;
  if (r === void 0) {
    const n = (t == null ? void 0 : t.renderBefore) ?? null;
    o._$litPart$ = r = new B(e.insertBefore(G(), n), n, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
/**
...
var me;
S._$litElement$ = !0, S.finalized = !0, (me = globalThis.litElementHydrateSupport) == null || me.call(globalThis, { LitElement: S });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ct = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: ee }, vt = (i = Ct, e, t) => {
  const { kind: o, metadata: r } = t;
  let n = globalThis.litPropertyMetadata.get(r);
  if (n === void 0 && globalThis.litPropertyMetadata.set(r, n = /* @__PURE__ */ new Map()), n.set(t.name, i), o === "accessor") {
    const { name: s } = t;
    return { set(c) {
      const l = e.get.call(this);
      e.set.call(this, c), this.requestUpdate(s, l, i);
    }, init(c) {
  ...
  if (o === "setter") {
    ...
    return function(c) {
      const l = this[s];
      e.call(this, c), this.requestUpdate(s, l, i);
    };
  }
  throw Error("Unsupported decorator location: " + o);
};
function k(i) {
  return (e, t) => typeof t == "object" ? vt(i, e, t) : ((o, r, n) => {
    const s = r.hasOwnProperty(n);
    return r.constructor.createProperty(n, s ? { ...o, wrapped: !0 } : o), s ? Object.getOwnPropertyDescriptor(r, n) : void 0;
  })(i, e, t);
}
var yt = Object.defineProperty, wt = Object.getOwnPropertyDescriptor, V = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? wt(e, t) : e, n = i.length - 1, s; n >= 0; n--)
    (s = i[n]) && (r = (o ? s(e, t, r) : s(r)) || r);
  return o && r && yt(e, t, r), r;
};
let b = class extends S {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      ...
      case "family":
        if (t === null) {
          this.style.removeProperty(`--ui-text-${i}`);
          return;
        }
        this.style.setProperty(`--ui-text-${i}`, t);
        break;
    }
  }
};
V([
  k({ type: Number, attribute: "casl" })
], b.prototype, "casl", 2);
V([
  k({ type: Number, attribute: "mono" })
], b.prototype, "mono", 2);
V([
  k({ type: Number, attribute: "slnt" })
], b.prototype, "slnt", 2);
V([
  k({ type: String, attribute: "size" })
], b.prototype, "size", 2);
V([
  k({ type: String, attribute: "family" })
], b.prototype, "family", 2);
b = V([
  re("ui-text")
], b);
var kt = Object.defineProperty, Lt = Object.getOwnPropertyDescriptor, $t = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Lt(e, t) : e, n = i.length - 1, s; n >= 0; n--)
    (s = i[n]) && (r = (o ? s(e, t, r) : s(r)) || r);
  return o && r && kt(e, t, r), r;
};
...
var St = Object.defineProperty, Mt = Object.getOwnPropertyDescriptor, z = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Mt(e, t) : e, n = i.length - 1, s; n >= 0; n--)
    (s = i[n]) && (r = (o ? s(e, t, r) : s(r)) || r);
  return o && r && St(e, t, r), r;
};
const fe = "gruvbox";
let O = class extends S {
  constructor() {
    super(...arguments), this.media = null, this.auto = !1, this.mode = null, this.theme = fe;
  }
  get target() {
  ...
  handleTheme() {
    const i = document.head, e = "/themes";
    i.querySelectorAll("link.theme").forEach((o) => {
      i.removeChild(o);
    });
    const t = document.createElement("link");
    t.classList.add("theme"), t.rel = "stylesheet", t.href = `${e}/${this.theme || fe}.css`, i.appendChild(t);
  }
};
z([
  k()
...
export {
  ...
  Ht as css,
  Vt as draggable,
  $e as globalStyleSheets,
  xt as globalStylesToShadowRoot,
  u as html,
  jt as isAndroid,
  Rt as ripple,
  Gt as styles,
