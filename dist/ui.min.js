let Le = null;
function Mt() {
  return Le === null && (Le = Array.from(document.styleSheets).map((i) => {
...
function Ut(i, e) {
  e = { ...Et, ...e };
  let t = null, o = null, r = null, s = !1, n = "", u = "";
  const c = (l) => {
    ...
    !t && Array.from(_.classList).includes("draggable") && (o = (/* @__PURE__ */ new Date()).getTime(), t = _, r && clearTimeout(r), r = setTimeout(() => {
      t && (n = t.style.color, u = t.style.backgroundColor, t.style.color = "var(--ui-primary-text)", t.style.backgroundColor = "var(--ui-primary)", i.classList.add("ui-dragging"), s = !0, e != null && e.onDragStart && e.onDragStart());
    }, 200));
  }, v = (l) => {
    if (!o || !t) return;
    ...
    let b = document.elementFromPoint(_.clientX, _.clientY);
    if (b) {
      for (; !b.classList.contains("draggable") && b.parentElement; )
        b = b.parentElement;
      b.classList.contains("draggable") && ((() => {
        let ge = t == null ? void 0 : t.previousElementSibling;
        for (; ge; ) {
          if (ge === b)
            return !0;
        ...
        return !1;
      })() ? i.insertBefore(t, b) : i.insertBefore(t, b.nextElementSibling));
    }
  }, m = () => {
    r !== null && (clearTimeout(r), r = null), t && (t.style.color = n, t.style.backgroundColor = u, t = null), o = null, i.classList.remove("ui-dragging"), s && (s = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
  return [...i.children].forEach((l) => {
    l.classList.add("draggable"), l.onmousedown = c, l.ontouchstart = c, l.onmousemove = v, l.ontouchmove = v, i.onmouseleave = l.onmouseup = m, l.ontouchend = m;
  }), () => {
...
function It(i, e) {
  ...
  let t = null;
  const o = (u) => {
    t = Ee(u, e), i.addEventListener("pointermove", s);
  }, r = () => {
    i.removeEventListener("pointermove", s), Ue(t), t = null;
  }, s = () => r(), n = (u) => {
    t = Ee(u, e), Ue(t), t = null;
  };
 ...
 */
const fe = globalThis, ze = fe.ShadowRoot && (fe.ShadyCSS === void 0 || fe.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ze = Symbol(), rt = /* @__PURE__ */ new WeakMap();
let bt = class {
  constructor(e, t, o) {
  ...
  get styleSheet() {
    ...
    if (ze && e === void 0) {
      ...
      o && (e = rt.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && rt.set(t, e));
    }
    return e;
  }
  toString() {
...
const ir = (i) => new bt(typeof i == "string" ? i : i + "", void 0, Ze), g = (i, ...e) => {
  const t = i.length === 1 ? i[0] : e.reduce((o, r, s) => o + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(r) + i[s + 1], i[0]);
  return new bt(t, i, Ze);
}, or = (i, e) => {
  if (ze) i.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
  else for (const t of e) {
    const o = document.createElement("style"), r = fe.litNonce;
    r !== void 0 && o.setAttribute("nonce", r), o.textContent = t.cssText, i.appendChild(o);
  }
}, it = ze ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: sr, defineProperty: nr, getOwnPropertyDescriptor: ar, getOwnPropertyNames: lr, getOwnPropertySymbols: cr, getPrototypeOf: ur } = Object, O = globalThis, ot = O.trustedTypes, pr = ot ? ot.emptyScript : "", Pe = O.reactiveElementPolyfillSupport, K = (i, e) => i, ve = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? pr : null;
      break;
  ...
  return t;
} }, Ne = (i, e) => !sr(i, e), st = { attribute: !0, type: String, converter: ve, reflect: !1, hasChanged: Ne };
...
class z extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of o) t.unshift(it(r));
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && o.reflect === !0) {
      const n = (((s = o.converter) == null ? void 0 : s.toAttribute) !== void 0 ? o.converter : ve).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = o.getPropertyOptions(r), u = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((s = n.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? n.converter : ve;
      this._$Em = r, this[r] = u.fromAttribute(t, n.type), this._$Em = null;
    }
  }
  requestUpdate(e, t, o) {
    if (e !== void 0) {
      if (o ?? (o = this.constructor.getPropertyOptions(e)), !(o.hasChanged ?? Ne)(this[e], t)) return;
      this.P(e, t, o);
    }
...
z.elementStyles = [], z.shadowRootOptions = { mode: "open" }, z[K("elementProperties")] = /* @__PURE__ */ new Map(), z[K("finalized")] = /* @__PURE__ */ new Map(), Pe == null || Pe({ ReactiveElement: z }), (O.reactiveElementVersions ?? (O.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const X = globalThis, ye = X.trustedTypes, nt = ye ? ye.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, _t = "$lit$", P = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + P, hr = `<${wt}>`, U = document, J = () => U.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Fe = Array.isArray, dr = (i) => Fe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Oe = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, lt = />/g, A = RegExp(`>|${Oe}(?:([^\\s"'>=/]+)(${Oe}*=${Oe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, ut = /"/g, $t = /^(?:script|style|textarea|title)$/i, gr = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), d = gr(1), I = Symbol.for("lit-noChange"), y = Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), E = U.createTreeWalker(U, 129);
function Ct(i, e) {
...
const fr = (i, e) => {
  ...
  let r, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = Y;
  for (let u = 0; u < t; u++) {
    const c = i[u];
    let v, m, l = -1, _ = 0;
    for (; _ < c.length && (n.lastIndex = _, m = n.exec(c), m !== null); ) _ = n.lastIndex, n === Y ? m[1] === "!--" ? n = at : m[1] !== void 0 ? n = lt : m[2] !== void 0 ? ($t.test(m[2]) && (r = RegExp("</" + m[2], "g")), n = A) : m[3] !== void 0 && (n = A) : n === A ? m[0] === ">" ? (n = r ?? Y, l = -1) : m[1] === void 0 ? l = -2 : (l = n.lastIndex - m[2].length, v = m[1], n = m[3] === void 0 ? A : m[3] === '"' ? ut : ct) : n === ut || n === ct ? n = A : n === at || n === lt ? n = Y : (n = A, r = void 0);
    const b = n === A && i[u + 1].startsWith("/>") ? " " : "";
    s += n === Y ? c + hr : l >= 0 ? (o.push(v), c.slice(0, l) + _t + c.slice(l) + P + b) : c + P + (l === -2 ? u : b);
  }
  return [Ct(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class ee {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const u = e.length - 1, c = this.parts, [v, m] = fr(e, t);
    if (this.el = ee.createElement(v, o), E.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (r = E.nextNode()) !== null && c.length < u; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const l of r.getAttributeNames()) if (l.endsWith(_t)) {
          const _ = m[n++], b = r.getAttribute(l).split(P), L = /([.?@])?(.*)/.exec(_);
          c.push({ type: 1, index: s, name: L[2], strings: b, ctor: L[1] === "." ? yr : L[1] === "?" ? mr : L[1] === "@" ? br : Ce }), r.removeAttribute(l);
        ...
        if ($t.test(r.tagName)) {
          ...
          if (_ > 0) {
            ...
            for (let b = 0; b < _; b++) r.append(l[b], J()), E.nextNode(), c.push({ type: 2, index: ++s });
            r.append(l[_], J());
          }
        }
      } else if (r.nodeType === 8) if (r.data === wt) c.push({ type: 2, index: s });
      else {
        let l = -1;
...
function Z(i, e, t = i, o) {
  ...
  return (r == null ? void 0 : r.constructor) !== s && ((u = r == null ? void 0 : r._$AO) == null || u.call(r, !1), s === void 0 ? r = void 0 : (r = new s(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = Z(i, r._$AS(i, e.values), r, o)), e;
}
class vr {
  constructor(e, t) {
  ...
  u(e) {
    ...
    E.currentNode = r;
    let s = E.nextNode(), n = 0, u = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let v;
        c.type === 2 ? v = new le(s, s.nextSibling, this, e) : c.type === 1 ? v = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (v = new _r(s, this, e)), this._$AV.push(v), c = o[++u];
      }
...
class le {
  ...
  _$AI(e, t = this) {
    e = Z(this, e, t), Q(e) ? e === y || e == null || e === "" ? (this._$AH !== y && this._$AR(), this._$AH = y) : e !== this._$AH && e !== I && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : dr(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== y && Q(this._$AH) ? this._$AA.nextSibling.data = e : this.T(U.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = ee.createElement(Ct(o.h, o.h[0]), this.options)), o);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === r) this._$AH.p(t);
    else {
      const n = new vr(r, this), u = n.u(this.options);
      n.p(t), this.T(u), this._$AH = n;
    }
  }
  _$AC(e) {
    let t = pt.get(e.strings);
    return t === void 0 && pt.set(e.strings, t = new ee(e)), t;
  }
  k(e) {
    Fe(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, r = 0;
    for (const s of e) r === t.length ? t.push(o = new le(this.O(J()), this.O(J()), this, this.options)) : o = t[r], o._$AI(s), r++;
...
class Ce {
  ...
  _$AI(e, t = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) e = Z(this, e, t, 0), n = !Q(e) || e !== this._$AH && e !== I, n && (this._$AH = e);
    else {
      const u = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = Z(this, u[o + c], t, c), v === I && (v = this._$AH[c]), n || (n = !Q(v) || v !== this._$AH[c]), v === y ? e = y : e !== y && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
Me == null || Me(ee, le), (X.litHtmlVersions ?? (X.litHtmlVersions = [])).push("3.2.1");
const wr = (i, e, t) => {
  const o = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = o._$litPart$;
  if (r === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    o._$litPart$ = r = new le(e.insertBefore(J(), s), s, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
/**
...
var ft;
p._$litElement$ = !0, p.finalized = !0, (ft = globalThis.litElementHydrateSupport) == null || ft.call(globalThis, { LitElement: p });
const je = globalThis.litElementPolyfillSupport;
je == null || je({ LitElement: p });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $r = { attribute: !0, type: String, converter: ve, reflect: !1, hasChanged: Ne }, Cr = (i = $r, e, t) => {
...
var xr = Object.defineProperty, Sr = Object.getOwnPropertyDescriptor, qe = (i, e, t, o) => {
...
const eo = Ie;
var Or = Object.defineProperty, Mr = Object.getOwnPropertyDescriptor, We = (i, e, t, o) => {
...
], re.prototype, "fixed", 2);
re = We([
  h("ui-app-bar")
], re);
const to = re;
var jr = Object.defineProperty, Ar = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
...
], ie.prototype, "hidden", 2);
ie = Ye([
  h("ui-app-bar-item")
], ie);
const ro = ie;
var Er = Object.defineProperty, Ur = Object.getOwnPropertyDescriptor, xe = (i, e, t, o) => {
...
let N = class extends p {
  constructor() {
    super(...arguments), this.disabled = !1, this.role = "button", this.tabIndex = 0;
  }
  static get styles() {
    return g`
            :host {
...
const Ir = N;
var Dr = Object.defineProperty, Rr = Object.getOwnPropertyDescriptor, Se = (i, e, t, o) => {
...
let F = class extends p {
  constructor() {
    super(...arguments), this.ghost = !1, this.disabled = !1, this.role = "button", this.tabIndex = 0;
  }
  static get styles() {
    return g`
            :host {
...
const io = F;
var Br = Object.defineProperty, Vr = Object.getOwnPropertyDescriptor, T = (i, e, t, o) => {
...
const xt = Tr(De);
var zr = Object.defineProperty, Zr = Object.getOwnPropertyDescriptor, ce = (i, e, t, o) => {
...
const Fr = D;
var qr = Object.defineProperty, Wr = Object.getOwnPropertyDescriptor, Ke = (i, e, t, o) => {
...
let R = class extends p {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "gap":
        t ? this.style.setProperty("--_gap", t || ht) : this.style.removeProperty("--_gap");
        break;
      case "justify":
...
const ao = R;
var ei = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
var ri = Object.defineProperty, ii = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      ...
      case "align":
        ...
        break;
      case "wrap":
        t === null ? this.style.removeProperty("--_wrap") : this.style.setProperty("--_wrap", "wrap");
        break;
    }
  }
};
he([
  a({ type: String, attribute: "gap", reflect: !0 })
], V.prototype, "gap", 2);
he([
  a({ type: String, attribute: "justify", reflect: !0 })
], V.prototype, "justify", 2);
he([
  a({ type: String, attribute: "align", reflect: !0 })
], V.prototype, "align", 2);
he([
  a({ type: Boolean, attribute: "wrap", reflect: !0 })
], V.prototype, "wrap", 2);
V = he([
  h("ui-flex-grid-row")
], V);
const lo = V;
var oi = Object.defineProperty, si = Object.getOwnPropertyDescriptor, St = (i, e, t, o) => {
...
const po = w;
var ui = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
...
], se.prototype, "keepOpen", 2);
se = Xe([
  h("ui-select")
], se);
const ho = se;
var hi = Object.defineProperty, di = Object.getOwnPropertyDescriptor, Je = (i, e, t, o) => {
 ...
 */
const gt = (i) => i ?? y;
var gi = Object.defineProperty, fi = Object.getOwnPropertyDescriptor, G = (i, e, t, o) => {
...
const go = S;
var vi = Object.defineProperty, yi = Object.getOwnPropertyDescriptor, ke = (i, e, t, o) => {
...
const fo = W;
var mi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, kt = (i, e, t, o) => {
...
let be = class extends p {
  constructor() {
    super(...arguments), this.data = {}, this.events = new Te(), this.current = "";
  }
  static get styles() {
    return g`
            :host {
...
const vo = be;
var _i = Object.defineProperty, wi = Object.getOwnPropertyDescriptor, Lt = (i, e, t, o) => {
...
const yo = _e;
var $i = Object.defineProperty, Ci = Object.getOwnPropertyDescriptor, xi = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ci(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
let Be = class extends p {
  constructor() {
    super(...arguments), this.events = new Te(), this.stack = [], this.onpopstate = () => {
...
const mo = Be;
var Si = Object.defineProperty, ki = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
we = Pt([
  h("ui-stack-layout-page")
], we);
const bo = we;
var Li = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, Qe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Pi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Li(e, t, r), r;
};
let ne = class extends p {
  constructor() {
    super(...arguments), this.data = {}, this.events = new Te(), this.storage = !1, this.storagePrefix = "";
  }
  static get styles() {
    return g`
            :host {
...
Qe([
  a({ type: Boolean, attribute: "storage", reflect: !0 })
], ne.prototype, "storage", 2);
Qe([
  a({ type: String, attribute: "storage-prefix", reflect: !0 })
], ne.prototype, "storagePrefix", 2);
ne = Qe([
  h("ui-store")
], ne);
const _o = ne;
var Oi = Object.defineProperty, Mi = Object.getOwnPropertyDescriptor, j = (i, e, t, o) => {
...
const et = C;
var ji = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Ot = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ai(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const wo = $e;
var Ei = Object.defineProperty, Ui = Object.getOwnPropertyDescriptor, tt = (i, e, t, o) => {
...
const $o = ae;
var Ii = Object.defineProperty, Di = Object.getOwnPropertyDescriptor, Ri = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Di(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const xo = He;
var Ti = Object.defineProperty, Gi = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
