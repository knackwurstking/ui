 ...
 */
const be = globalThis, Ne = be.ShadowRoot && (be.ShadyCSS === void 0 || be.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Fe = Symbol(), st = /* @__PURE__ */ new WeakMap();
let mt = class {
  constructor(e, t, o) {
  ...
  get styleSheet() {
    ...
    if (Ne && e === void 0) {
      ...
      o && (e = st.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && st.set(t, e));
    }
    return e;
  }
  toString() {
...
}, nt = Ne ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: It, defineProperty: Dt, getOwnPropertyDescriptor: Rt, getOwnPropertyNames: Bt, getOwnPropertySymbols: Vt, getPrototypeOf: Ht } = Object, M = globalThis, at = M.trustedTypes, Gt = at ? at.emptyScript : "", Me = M.reactiveElementPolyfillSupport, Q = (i, e) => i, me = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Gt : null;
      break;
  ...
  return t;
} }, qe = (i, e) => !It(i, e), lt = { attribute: !0, type: String, converter: me, reflect: !1, hasChanged: qe };
...
class F extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    const { get: r, set: s } = Rt(this.prototype, e) ?? { get() {
      return this[t];
    }, set(n) {
      this[t] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Q("properties"))) {
      const t = this.properties, o = [...Bt(t), ...Vt(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of o) t.unshift(nt(r));
  ...
  _$EC(e, t) {
    ...
    if (r !== void 0 && o.reflect === !0) {
      const n = (((s = o.converter) == null ? void 0 : s.toAttribute) !== void 0 ? o.converter : me).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = o.getPropertyOptions(r), p = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((s = n.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? n.converter : me;
...
F.elementStyles = [], F.shadowRootOptions = { mode: "open" }, F[Q("elementProperties")] = /* @__PURE__ */ new Map(), F[Q("finalized")] = /* @__PURE__ */ new Map(), Me == null || Me({ ReactiveElement: F }), (M.reactiveElementVersions ?? (M.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ee = globalThis, _e = ee.trustedTypes, ct = _e ? _e.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, _t = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + j, Tt = `<${wt}>`, D = document, te = () => D.createComment(""), re = (i) => i === null || typeof i != "object" && typeof i != "function", Ye = Array.isArray, Zt = (i) => Ye(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ee = `[ 	
\f\r]`, J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ht = /-->/g, pt = />/g, U = RegExp(`>|${Ee}(?:([^\\s"'>=/]+)(${Ee}*=${Ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ut = /'/g, dt = /"/g, Ct = /^(?:script|style|textarea|title)$/i, zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = zt(1), q = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), gt = /* @__PURE__ */ new WeakMap(), I = D.createTreeWalker(D, 129);
function $t(i, e) {
...
const Nt = (i, e) => {
  ...
  for (let p = 0; p < t; p++) {
    const c = i[p];
    let v, y, f = -1, m = 0;
    for (; m < c.length && (n.lastIndex = m, y = n.exec(c), y !== null); ) m = n.lastIndex, n === J ? y[1] === "!--" ? n = ht : y[1] !== void 0 ? n = pt : y[2] !== void 0 ? (Ct.test(y[2]) && (r = RegExp("</" + y[2], "g")), n = U) : y[3] !== void 0 && (n = U) : n === U ? y[0] === ">" ? (n = r ?? J, f = -1) : y[1] === void 0 ? f = -2 : (f = n.lastIndex - y[2].length, v = y[1], n = y[3] === void 0 ? U : y[3] === '"' ? dt : ut) : n === dt || n === ut ? n = U : n === ht || n === pt ? n = J : (n = U, r = void 0);
    const h = n === U && i[p + 1].startsWith("/>") ? " " : "";
    s += n === J ? c + Tt : f >= 0 ? (o.push(v), c.slice(0, f) + _t + c.slice(f) + j + h) : c + j + (f === -2 ? p : h);
  }
  return [$t(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class ie {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const p = e.length - 1, c = this.parts, [v, y] = Nt(e, t);
    if (this.el = ie.createElement(v, o), I.currentNode = this.el.content, t === 2 || t === 3) {
      const f = this.el.content.firstChild;
      f.replaceWith(...f.childNodes);
    }
    for (; (r = I.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const f of r.getAttributeNames()) if (f.endsWith(_t)) {
          const m = y[n++], h = r.getAttribute(f).split(j), _ = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: s, name: _[2], strings: h, ctor: _[1] === "." ? qt : _[1] === "?" ? Yt : _[1] === "@" ? Xt : Se }), r.removeAttribute(f);
        } else f.startsWith(j) && (c.push({ type: 6, index: s }), r.removeAttribute(f));
        if (Ct.test(r.tagName)) {
          const f = r.textContent.split(j), m = f.length - 1;
          if (m > 0) {
            r.textContent = _e ? _e.emptyScript : "";
            for (let h = 0; h < m; h++) r.append(f[h], te()), I.nextNode(), c.push({ type: 2, index: ++s });
            r.append(f[m], te());
          }
        }
        ...
        let f = -1;
        for (; (f = r.data.indexOf(j, f + 1)) !== -1; ) c.push({ type: 7, index: s }), f += j.length - 1;
      }
      s++;
    }
  }
...
function Y(i, e, t = i, o) {
  var n, p;
  if (e === q) return e;
  let r = o !== void 0 ? (n = t._$Co) == null ? void 0 : n[o] : t._$Cl;
  const s = re(e) ? void 0 : e._$litDirective$;
  return (r == null ? void 0 : r.constructor) !== s && ((p = r == null ? void 0 : r._$AO) == null || p.call(r, !1), s === void 0 ? r = void 0 : (r = new s(i), r._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = r : t._$Cl = r), r !== void 0 && (e = Y(i, r._$AS(i, e.values), r, o)), e;
}
class Ft {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: o } = this._$AD, r = ((e == null ? void 0 : e.creationScope) ?? D).importNode(t, !0);
    I.currentNode = r;
    let s = I.nextNode(), n = 0, p = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let v;
        c.type === 2 ? v = new he(s, s.nextSibling, this, e) : c.type === 1 ? v = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (v = new Wt(s, this, e)), this._$AV.push(v), c = o[++p];
      }
      n !== (c == null ? void 0 : c.index) && (s = I.nextNode(), n++);
    }
...
class he {
  ...
  _$AI(e, t = this) {
    e = Y(this, e, t), re(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Zt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== b && re(this._$AH) ? this._$AA.nextSibling.data = e : this.T(D.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = ie.createElement($t(o.h, o.h[0]), this.options)), o);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === r) this._$AH.p(t);
    else {
      const n = new Ft(r, this), p = n.u(this.options);
      n.p(t), this.T(p), this._$AH = n;
    }
  }
  _$AC(e) {
    let t = gt.get(e.strings);
    return t === void 0 && gt.set(e.strings, t = new ie(e)), t;
  }
  k(e) {
    Ye(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, r = 0;
    for (const s of e) r === t.length ? t.push(o = new he(this.O(te()), this.O(te()), this, this.options)) : o = t[r], o._$AI(s), r++;
...
class Se {
  ...
  _$AI(e, t = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) e = Y(this, e, t, 0), n = !re(e) || e !== this._$AH && e !== q, n && (this._$AH = e);
    else {
      const p = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = Y(this, p[o + c], t, c), v === q && (v = this._$AH[c]), n || (n = !re(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
const Ae = ee.litHtmlPolyfillSupport;
Ae == null || Ae(ie, he), (ee.litHtmlVersions ?? (ee.litHtmlVersions = [])).push("3.2.1");
const Kt = (i, e, t) => {
  const o = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = o._$litPart$;
  if (r === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    o._$litPart$ = r = new he(e.insertBefore(te(), s), s, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
/**
...
function tr(i, e) {
  e = { ...er, ...e };
  let t = null, o = null, r, s, n = null, p = !1, c = "", v = "";
  const y = (h) => {
    ...
    if (!t && Array.from(_.classList).includes("draggable")) {
      ...
      o = (/* @__PURE__ */ new Date()).getTime(), t = _, n && clearTimeout(n), n = setTimeout(() => {
        t && (c = t.style.color, v = t.style.backgroundColor, t.style.color = "hsl(var(--ui-hsl-primary-text))", t.style.backgroundColor = "hsl(var(--ui-hsl-primary))", i.classList.add("dragging"), p = !0, e != null && e.onDragStart && e.onDragStart());
      }, 200);
    }
  }, f = (h) => {
    if (!o || !t) return;
    if (!p && (/* @__PURE__ */ new Date()).getTime() - o < 200) {
      let O, k;
      if (h instanceof TouchEvent) {
        const ot = h.targetTouches[0];
        O = Math.abs(r - ot.clientX), k = Math.abs(s - ot.clientY);
      } else
        O = Math.abs(r - h.clientX), k = Math.abs(s - h.clientY);
      if ((O > k ? O : k) < 24)
        return;
      m();
      return;
    }
    h.preventDefault(), p || (p = !0, e != null && e.onDragStart && e.onDragStart());
    let _;
    if (h instanceof TouchEvent) {
      const O = h.targetTouches[0];
      _ = {
        clientX: O.clientX,
        clientY: O.clientY
      };
    ...
    if (w) {
      ...
      w.classList.contains("draggable") && ((() => {
        let k = t == null ? void 0 : t.previousElementSibling;
        for (; k; ) {
          if (k === w)
            return !0;
    ...
    n !== null && (clearTimeout(n), n = null), t && (t.style.color = c, t.style.backgroundColor = v, t = null), o = null, i.classList.remove("dragging"), p && (p = !1, e != null && e.onDragEnd && e.onDragEnd());
  };
  return [...i.children].forEach((h) => {
    h.classList.add("draggable"), h.onmousedown = y, h.ontouchstart = y, h.onmousemove = f, h.ontouchmove = f, h.onmouseup = m, h.ontouchend = m;
  }), () => {
    [...i.children].forEach(
      (h) => {
...
function Le(i, e) {
  ...
  let t = null;
  const o = (p) => {
    t = De(p, e), i.addEventListener("pointermove", s);
  }, r = () => {
    i.removeEventListener("pointermove", s), Re(t), t = null;
  }, s = () => r(), n = (p) => {
    t = De(p, e), Re(t), t = null;
  };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wr = { attribute: !0, type: String, converter: me, reflect: !1, hasChanged: qe }, Cr = (i = wr, e, t) => {
...
var $r = Object.defineProperty, xr = Object.getOwnPropertyDescriptor, We = (i, e, t, o) => {
...
const Ji = oe;
var kr = Object.defineProperty, Sr = Object.getOwnPropertyDescriptor, Lr = (i, e, t, o) => {
...
], se.prototype, "fixed", 2);
se = Ke([
  d("ui-app-bar")
], se);
const eo = se;
var jr = Object.defineProperty, Mr = Object.getOwnPropertyDescriptor, Je = (i, e, t, o) => {
...
], ne.prototype, "hidden", 2);
ne = Je([
  d("ui-app-bar-item")
], ne);
const to = ne;
var Er = Object.defineProperty, Ar = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
let R = class extends u {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "ripple":
        this.rippleCleanUp !== null && (this.rippleCleanUp(), this.rippleCleanUp = null), t !== null && (this.rippleCleanUp = Le(this));
        break;
    }
  }
};
...
const Ur = R;
var Ir = Object.defineProperty, Dr = Object.getOwnPropertyDescriptor, ue = (i, e, t, o) => {
...
const ro = B;
var Rr = Object.defineProperty, Br = Object.getOwnPropertyDescriptor, z = (i, e, t, o) => {
...
const io = S;
var Vr = Object.defineProperty, Hr = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
...
], V.prototype, "noFold", 2);
V = de([
  d("ui-drawer-group")
], V);
const Tr = V;
var Zr = Object.defineProperty, zr = Object.getOwnPropertyDescriptor, Qe = (i, e, t, o) => {
...
const so = Ve;
var Yr = Object.defineProperty, Xr = Object.getOwnPropertyDescriptor, ge = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Xr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
let H = class extends u {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "gap":
        t ? this.style.setProperty("--_gap", t || ft) : this.style.removeProperty("--_gap");
        break;
      case "justify":
...
const no = H;
var Wr = Object.defineProperty, Kr = Object.getOwnPropertyDescriptor, fe = (i, e, t, o) => {
...
var Jr = Object.defineProperty, Qr = Object.getOwnPropertyDescriptor, ve = (i, e, t, o) => {
...
let T = class extends u {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "gap":
        t ? this.style.setProperty("--_gap", t || vt) : this.style.removeProperty("--_gap");
        break;
      case "justify":
        t ? this.style.setProperty("--_justify", t || "") : this.style.removeProperty("--_justify");
        break;
...
const ao = T;
var ei = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, Lt = (i, e, t, o) => {
...
const lo = we;
var ri = Object.defineProperty, ii = Object.getOwnPropertyDescriptor, E = (i, e, t, o) => {
...
const co = $;
var oi = Object.defineProperty, si = Object.getOwnPropertyDescriptor, P = (i, e, t, o) => {
...
const ho = C;
var ni = Object.defineProperty, ai = Object.getOwnPropertyDescriptor, et = (i, e, t, o) => {
...
let le = class extends u {
  ...
  async optionsClickHandler(i) {
    i.composedPath().forEach((e) => {
      e instanceof X && ([...this.querySelectorAll("ui-select-option")].forEach(
        (t) => t.removeAttribute("selected")
      ), e.setAttribute("selected", ""), this.dispatchEvent(new Event("change")));
    });
  }
  options() {
    return [...this.children].filter((i) => i instanceof X);
  }
  selected() {
...
], le.prototype, "keepOpen", 2);
le = et([
  d("ui-select")
], le);
const po = le;
var li = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, tt = (i, e, t, o) => {
 ...
 */
const yt = (i) => i ?? b;
var hi = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, N = (i, e, t, o) => {
...
const uo = L;
var ui = Object.defineProperty, di = Object.getOwnPropertyDescriptor, Pe = (i, e, t, o) => {
...
const go = W;
var gi = Object.defineProperty, fi = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
const fo = Ce;
var vi = Object.defineProperty, yi = Object.getOwnPropertyDescriptor, Ot = (i, e, t, o) => {
...
const yo = He;
var wi = Object.defineProperty, Ci = Object.getOwnPropertyDescriptor, jt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ci(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const bo = xe;
var $i = Object.defineProperty, xi = Object.getOwnPropertyDescriptor, rt = (i, e, t, o) => {
...
rt([
  a({ type: Boolean, attribute: "storage", reflect: !0 })
], ce.prototype, "storage", 2);
rt([
  a({ type: String, attribute: "storage-prefix", reflect: !0 })
], ce.prototype, "storagePrefix", 2);
ce = rt([
  d("ui-store")
], ce);
const mo = ce;
...
const _o = Ge;
var Pi = Object.defineProperty, Oi = Object.getOwnPropertyDescriptor, A = (i, e, t, o) => {
...
const it = x;
var ji = Object.defineProperty, Mi = Object.getOwnPropertyDescriptor, Mt = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Mi(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const wo = ke;
var Ei = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Oe = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ai(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Ei(e, t, r), r;
};
let K = class extends u {
  ...
  async enableRipple() {
    ...
    i && (this.rippleCleanUp = Le(i), this.role = "button", this.style.cursor = "pointer", this.addEventListener("click", this.clickHandler), [...this.children].forEach((t) => {
...
const $o = Te;
var Ri = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, Vi = (i, e, t, o) => {
...
const xo = Ze;
var Hi = Object.defineProperty, Gi = Object.getOwnPropertyDescriptor, ye = (i, e, t, o) => {
