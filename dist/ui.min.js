 ...
 */
const ge = globalThis, Ze = ge.ShadowRoot && (ge.ShadyCSS === void 0 || ge.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ze = Symbol(), rt = /* @__PURE__ */ new WeakMap();
let yt = class {
  constructor(e, t, o) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ut, defineProperty: It, getOwnPropertyDescriptor: Dt, getOwnPropertyNames: Rt, getOwnPropertySymbols: Bt, getPrototypeOf: Vt } = Object, M = globalThis, ot = M.trustedTypes, Ht = ot ? ot.emptyScript : "", Oe = M.reactiveElementPolyfillSupport, J = (i, e) => i, ve = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ht : null;
      break;
  ...
  return t;
} }, Ne = (i, e) => !Ut(i, e), st = { attribute: !0, type: String, converter: ve, reflect: !1, hasChanged: Ne };
...
class Z extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(J("properties"))) {
      const t = this.properties, o = [...Rt(t), ...Bt(t)];
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const n = o.getPropertyOptions(r), p = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((s = n.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? n.converter : ve;
...
Z.elementStyles = [], Z.shadowRootOptions = { mode: "open" }, Z[J("elementProperties")] = /* @__PURE__ */ new Map(), Z[J("finalized")] = /* @__PURE__ */ new Map(), Oe == null || Oe({ ReactiveElement: Z }), (M.reactiveElementVersions ?? (M.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Q = globalThis, ye = Q.trustedTypes, nt = ye ? ye.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, bt = "$lit$", O = `lit$${Math.random().toFixed(9).slice(2)}$`, mt = "?" + O, Gt = `<${mt}>`, I = document, ee = () => I.createComment(""), te = (i) => i === null || typeof i != "object" && typeof i != "function", Fe = Array.isArray, Tt = (i) => Fe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Me = `[ 	
\f\r]`, K = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, lt = />/g, A = RegExp(`>|${Me}(?:([^\\s"'>=/]+)(${Me}*=${Me}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, ht = /"/g, _t = /^(?:script|style|textarea|title)$/i, Zt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), l = Zt(1), z = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), U = I.createTreeWalker(I, 129);
function wt(i, e) {
...
const zt = (i, e) => {
  ...
  for (let p = 0; p < t; p++) {
    const c = i[p];
    let v, y, g = -1, m = 0;
    for (; m < c.length && (n.lastIndex = m, y = n.exec(c), y !== null); ) m = n.lastIndex, n === K ? y[1] === "!--" ? n = at : y[1] !== void 0 ? n = lt : y[2] !== void 0 ? (_t.test(y[2]) && (r = RegExp("</" + y[2], "g")), n = A) : y[3] !== void 0 && (n = A) : n === A ? y[0] === ">" ? (n = r ?? K, g = -1) : y[1] === void 0 ? g = -2 : (g = n.lastIndex - y[2].length, v = y[1], n = y[3] === void 0 ? A : y[3] === '"' ? ht : ct) : n === ht || n === ct ? n = A : n === at || n === lt ? n = K : (n = A, r = void 0);
    const h = n === A && i[p + 1].startsWith("/>") ? " " : "";
    s += n === K ? c + Gt : g >= 0 ? (o.push(v), c.slice(0, g) + bt + c.slice(g) + O + h) : c + O + (g === -2 ? p : h);
  }
  return [wt(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class re {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const p = e.length - 1, c = this.parts, [v, y] = zt(e, t);
    if (this.el = re.createElement(v, o), U.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (r = U.nextNode()) !== null && c.length < p; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const g of r.getAttributeNames()) if (g.endsWith(bt)) {
          const m = y[n++], h = r.getAttribute(g).split(O), _ = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: s, name: _[2], strings: h, ctor: _[1] === "." ? Ft : _[1] === "?" ? qt : _[1] === "@" ? Yt : $e }), r.removeAttribute(g);
        } else g.startsWith(O) && (c.push({ type: 6, index: s }), r.removeAttribute(g));
        if (_t.test(r.tagName)) {
          const g = r.textContent.split(O), m = g.length - 1;
          if (m > 0) {
            r.textContent = ye ? ye.emptyScript : "";
            for (let h = 0; h < m; h++) r.append(g[h], ee()), U.nextNode(), c.push({ type: 2, index: ++s });
            r.append(g[m], ee());
          }
        }
      } else if (r.nodeType === 8) if (r.data === mt) c.push({ type: 2, index: s });
      else {
        let g = -1;
        for (; (g = r.data.indexOf(O, g + 1)) !== -1; ) c.push({ type: 7, index: s }), g += O.length - 1;
      }
      s++;
    }
  }
...
class Nt {
  ...
  u(e) {
    const { el: { content: t }, parts: o } = this._$AD, r = ((e == null ? void 0 : e.creationScope) ?? I).importNode(t, !0);
    U.currentNode = r;
    let s = U.nextNode(), n = 0, p = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let v;
        c.type === 2 ? v = new ce(s, s.nextSibling, this, e) : c.type === 1 ? v = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (v = new Xt(s, this, e)), this._$AV.push(v), c = o[++p];
      }
      n !== (c == null ? void 0 : c.index) && (s = U.nextNode(), n++);
    }
...
class ce {
  ...
  _$AI(e, t = this) {
    e = N(this, e, t), te(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== z && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Tt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== b && te(this._$AH) ? this._$AA.nextSibling.data = e : this.T(I.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: o } = e, r = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = re.createElement(wt(o.h, o.h[0]), this.options)), o);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === r) this._$AH.p(t);
    else {
      const n = new Nt(r, this), p = n.u(this.options);
      n.p(t), this.T(p), this._$AH = n;
    }
  }
  _$AC(e) {
    let t = pt.get(e.strings);
    return t === void 0 && pt.set(e.strings, t = new re(e)), t;
  }
  k(e) {
    Fe(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, r = 0;
    for (const s of e) r === t.length ? t.push(o = new ce(this.O(ee()), this.O(ee()), this, this.options)) : o = t[r], o._$AI(s), r++;
...
class $e {
  ...
  _$AI(e, t = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) e = N(this, e, t, 0), n = !te(e) || e !== this._$AH && e !== z, n && (this._$AH = e);
    else {
      const p = e;
      let c, v;
      for (e = s[0], c = 0; c < s.length - 1; c++) v = N(this, p[o + c], t, c), v === z && (v = this._$AH[c]), n || (n = !te(v) || v !== this._$AH[c]), v === b ? e = b : e !== b && (e += (v ?? "") + s[c + 1]), this._$AH[c] = v;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
je == null || je(re, ce), (Q.litHtmlVersions ?? (Q.litHtmlVersions = [])).push("3.2.1");
const Wt = (i, e, t) => {
  const o = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = o._$litPart$;
  if (r === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    o._$litPart$ = r = new ce(e.insertBefore(ee(), s), s, void 0, t ?? {});
  }
  return r._$AI(i), r;
};
/**
...
function er(i, e) {
  ...
  const y = (h) => {
    ...
    if (!p && (/* @__PURE__ */ new Date()).getTime() - o < 200) {
      let P, x;
      if (h instanceof TouchEvent) {
        const tt = h.targetTouches[0];
        P = Math.abs(r - tt.clientX), x = Math.abs(s - tt.clientY);
      } else
        P = Math.abs(r - h.clientX), x = Math.abs(s - h.clientY);
      if ((P > x ? P : x) < 24)
        return;
      m();
      return;
  ...
  return [...i.children].forEach((h) => {
    h.classList.add("draggable"), h.onmousedown = y, h.ontouchstart = y, h.onmousemove = g, h.ontouchmove = g, h.onmouseup = m, h.ontouchend = m;
  }), () => {
    [...i.children].forEach(
      (h) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _r = { attribute: !0, type: String, converter: ve, reflect: !1, hasChanged: Ne }, wr = (i = _r, e, t) => {
...
var Cr = Object.defineProperty, $r = Object.getOwnPropertyDescriptor, Ye = (i, e, t, o) => {
...
const Xi = De;
var Lr = Object.defineProperty, Pr = Object.getOwnPropertyDescriptor, Xe = (i, e, t, o) => {
...
const Ki = se;
var jr = Object.defineProperty, Er = Object.getOwnPropertyDescriptor, he = (i, e, t, o) => {
...
let D = class extends u {
  ...
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
      case "ripple":
        this.rippleCleanUp !== null && (this.rippleCleanUp(), this.rippleCleanUp = null), t !== null && (this.rippleCleanUp = xe(this));
        break;
    }
  }
};
...
const Ar = D;
var Ur = Object.defineProperty, Ir = Object.getOwnPropertyDescriptor, pe = (i, e, t, o) => {
...
const Qi = k;
var Br = Object.defineProperty, Vr = Object.getOwnPropertyDescriptor, ke = (i, e, t, o) => {
...
], F.prototype, "noFold", 2);
F = ke([
  d("ui-drawer-group")
], F);
const Hr = F;
var Gr = Object.defineProperty, Tr = Object.getOwnPropertyDescriptor, Ke = (i, e, t, o) => {
...
let ne = class extends u {
  ...
  updated(i) {
    [...this.children].forEach(async (e) => {
      e instanceof Hr && e.addEventListener("unfold", this.handleUnfold);
    });
  }
  attributeChangedCallback(i, e, t) {
    switch (super.attributeChangedCallback(i, e, t), i) {
...
const eo = ne;
var Zr = Object.defineProperty, zr = Object.getOwnPropertyDescriptor, Nr = (i, e, t, o) => {
...
const to = Re;
var Fr = Object.defineProperty, qr = Object.getOwnPropertyDescriptor, ue = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? qr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Fr(e, t, r), r;
};
const ut = "0";
...
const ro = B;
var Yr = Object.defineProperty, Xr = Object.getOwnPropertyDescriptor, kt = (i, e, t, o) => {
...
var Wr = Object.defineProperty, Kr = Object.getOwnPropertyDescriptor, de = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Kr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const io = V;
var Jr = Object.defineProperty, Qr = Object.getOwnPropertyDescriptor, St = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Qr(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
  return o && r && Jr(e, t, r), r;
};
...
const oo = me;
var ei = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, E = (i, e, t, o) => {
...
const so = $;
var ri = Object.defineProperty, ii = Object.getOwnPropertyDescriptor, L = (i, e, t, o) => {
...
const no = C;
var oi = Object.defineProperty, si = Object.getOwnPropertyDescriptor, Je = (i, e, t, o) => {
 ...
 */
const ft = (i) => i ?? b;
var li = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, T = (i, e, t, o) => {
...
const lo = S;
var hi = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, Se = (i, e, t, o) => {
...
const co = Y;
var ui = Object.defineProperty, di = Object.getOwnPropertyDescriptor, Lt = (i, e, t, o) => {
...
const ho = _e;
var fi = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, Pt = (i, e, t, o) => {
...
const po = we;
var vi = Object.defineProperty, yi = Object.getOwnPropertyDescriptor, bi = (i, e, t, o) => {
...
const uo = Be;
var mi = Object.defineProperty, _i = Object.getOwnPropertyDescriptor, Ot = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? _i(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
const fo = Ce;
var wi = Object.defineProperty, Ci = Object.getOwnPropertyDescriptor, et = (i, e, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ci(e, t) : e, s = i.length - 1, n; s >= 0; s--)
    (n = i[s]) && (r = (o ? n(e, t, r) : n(r)) || r);
...
et([
  a({ type: Boolean, attribute: "storage", reflect: !0 })
], le.prototype, "storage", 2);
et([
  a({ type: String, attribute: "storage-prefix", reflect: !0 })
], le.prototype, "storagePrefix", 2);
le = et([
  d("ui-store")
], le);
const go = le;
var $i = Object.defineProperty, xi = Object.getOwnPropertyDescriptor, ki = (i, e, t, o) => {
...
const vo = Ve;
var Si = Object.defineProperty, Li = Object.getOwnPropertyDescriptor, Le = (i, e, t, o) => {
...
let X = class extends u {
  ...
  async enableRipple() {
    ...
    i && (this.rippleCleanUp = xe(i), this.role = "button", this.style.cursor = "pointer", this.addEventListener("click", this.clickHandler), [...this.children].forEach((t) => {
...
], X.prototype, "primary", 2);
Le([
  a({ type: String, attribute: "secondary", reflect: !0 })
], X.prototype, "secondary", 2);
Le([
  a({ type: Boolean, attribute: "ripple", reflect: !0 })
], X.prototype, "ripple", 2);
X = Le([
  d("ui-label")
], X);
const yo = X;
var Pi = Object.defineProperty, Oi = Object.getOwnPropertyDescriptor, W = (i, e, t, o) => {
...
], j.prototype, "family", 2);
j = W([
  d("ui-text")
], j);
const Mt = j;
var Mi = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, Ei = (i, e, t, o) => {
...
const mo = Ge;
var Di = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, fe = (i, e, t, o) => {
...
let H = class extends u {
  constructor() {
    super(...arguments), this.auto = !1, this.mode = null, this.theme = gt, this.themesPath = "/themes", this.media = null;
  }
  get target() {
  ...
  handleTheme() {
    ...
    e.classList.add("theme"), e.rel = "stylesheet", e.href = `${this.themesPath}/${this.theme || gt}.css`, i.appendChild(e);
  }
};
fe([
...
export {
  ...
  po as UISpinner,
  uo as UIStackLayout,
  fo as UIStackLayoutPage,
  go as UIStore,
  vo as UISvg,
  Mt as UIText,
  lo as UITextarea,
  _o as UIThemeHandler,
  f as css,
  Zi as draggable,
