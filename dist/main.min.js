...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Y(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
...
const z = class z extends HTMLElement {
  constructor() {
    ...
    `);
    r(this, "shadowTemplate", () => l`<slot></slot>`);
...
}), r(A, "observedAttributes", ["storageprefix"]);
let ut = A;
...
}), r(E, "observedAttributes", ["auto", "mode"]);
let pt = E;
...
let gt = N;
function Ht() {
  Z.register(), K.register(), X.register(), B.register(), Q.register(), W.register(), U.register(), _.register(), G.register(), I.register(), tt.register(), et.register(), rt.register(), nt.register(), L.register(), st.register(), lt.register(), at.register(), ct.register(), ht.register(), dt.register(), ut.register(), gt.register(), it.register(), ot.register(), S.register(), pt.register();
}
export {
  K as UIAppBar,
  Z as UIAppBarItem,
