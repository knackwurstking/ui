...
var Ze = (i, t, e) => t in i ? Ve(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var r = (i, t, e) => (Ze(i, typeof t != "symbol" ? t + "" : t, e), e), Pt = (i, t, e) => {
  if (!t.has(i))
...
}, a = (i, t, e, o) => (Pt(i, t, "write to private field"), o ? o.call(i, e) : t.set(i, e), e);
var h = (i, t, e) => (Pt(i, t, "access private method"), e);
var d;
class Q {
  constructor() {
    /**
  ...
  removeListener(t, e) {
    ...
    let o = !1, l = 0;
    for (const Ot of s(this, d)[t])
      Ot === e && (s(this, d)[t].splice(l, 1), o = !0), l++;
    if (!o)
...
function qt(i, t = {}) {
  ...
  return i.classList.add("ripple-container"), i.style.overflow = "hidden", i.addEventListener("pointerdown", o), i.addEventListener("pointerup", l), i.addEventListener("pointerleave", l), () => {
    i.classList.remove("ripple-container"), i.removeEventListener("pointerdown", o), i.removeEventListener("pointerup", l), i.removeEventListener("pointerleave", l);
  };
}
...
const Xe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ripple: Je,
  utils: Xe
}, Symbol.toStringTag, { value: "Module" })), ge = document.createElement("template");
ge.innerHTML = `
<style>
    :host {
        display: flex;
...
let Ke = (ee = class {
  ...
  getLeftSlot() {
    return [...s(this, x).querySelectorAll('[slot="left"]')];
  }
  getCenterSlot() {
    return [...s(this, x).querySelectorAll('[slot="center"]')];
  }
  getRightSlot() {
    return [...s(this, x).querySelectorAll('[slot="right"]')];
  }
}, x = new WeakMap(), ee);
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0)), this.ui = new Ke(this);
  }
};
r(mt, "register", () => customElements.define("ui-app-bar", mt));
let G = mt;
...
let Qe = (se = class {
  ...
  constructor(t) {
    /** @type {Button} */
    n(this, q, void 0);
    a(this, q, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = qt(s(this, q), { centered: !0 }));
  }
  disableRipple() {
...
const H = class H extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(me.content.cloneNode(!0)), this.ui = new Qe(this);
  }
  connectedCallback() {
...
r(H, "register", () => customElements.define("ui-button", H)), r(H, "observedAttributes", ["no-ripple"]);
let F = H;
...
let Ge = (ie = class {
  ...
  constructor(t) {
    /** @type {IconButton} */
    n(this, O, void 0);
    a(this, O, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = qt(s(this, O), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(fe.content.cloneNode(!0)), this.ui = new Ge(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
r(R, "register", () => customElements.define("ui-icon-button", R)), r(R, "observedAttributes", ["no-ripple"]);
let _ = R;
...
let Fe = (oe = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, y, void 0);
    a(this, w, t), a(this, b, e), this.events = new Q(), a(this, y, document.createElement("h4")), s(this, y).slot = "title", s(this, w).appendChild(s(this, y));
  }
  get dialog() {
    return s(this, b);
  }
  open(t = !1) {
    t ? s(this, b).showModal() : s(this, b).show();
  }
  close() {
    s(this, b).close();
  }
  get fullscreen() {
    return s(this, w).hasAttribute("fullscreen");
  }
  set fullscreen(t) {
    t ? s(this, w).setAttribute("fullscreen", "") : s(this, w).removeAttribute("fullscreen");
  }
  get title() {
    return s(this, y).innerText;
  }
  set title(t) {
    s(this, y).innerText = t;
  }
}, w = new WeakMap(), b = new WeakMap(), y = new WeakMap(), oe);
var P, V;
const vt = class vt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(we.content.cloneNode(!0)), this.ui = new Fe(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
P = new WeakMap(), V = new WeakMap(), r(vt, "register", () => customElements.define("ui-dialog", vt));
let et = vt;
const Ft = "1", be = document.createElement("template");
be.innerHTML = `
<style></style>
<slot></slot>
`;
...
const A = class A extends HTMLElement {
  constructor() {
     ...
     */
    n(this, Z);
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(be.content.cloneNode(!0)), h(this, Z, Vt).call(this);
  }
  /**
   * @param {string} name
  ...
  attributeChangedCallback(e, o, l) {
    switch (e) {
      case "flex":
        h(this, Z, Vt).call(this, { flex: l || Ft });
        break;
    }
  }
};
Z = new WeakSet(), Vt = function({ flex: e = Ft } = {}) {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                flex: ${e};
            }
        `;
}, r(A, "register", () => customElements.define("ui-flex-grid-item", A)), r(A, "observedAttributes", ["flex"]);
let st = A;
const _t = "0", ye = document.createElement("template");
ye.innerHTML = `
<style></style>
<slot></slot>
`;
...
const $ = class $ extends HTMLElement {
  constructor() {
     ...
     */
    n(this, W);
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ye.content.cloneNode(!0)), h(this, W, Zt).call(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
  ...
  attributeChangedCallback(e, o, l) {
    switch (e) {
      case "gap":
        h(this, W, Zt).call(this, { gap: l || _t });
        break;
    }
  }
};
W = new WeakSet(), Zt = function({ gap: e = _t } = {}) {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                display: flex;
        ...
        `;
}, r($, "register", () => customElements.define("ui-flex-grid-row", $)), r($, "observedAttributes", ["gap"]);
let it = $;
const te = "0", xe = document.createElement("template");
xe.innerHTML = `
<style></style>
<slot></slot>
`;
...
const j = class j extends HTMLElement {
  constructor() {
     ...
     */
    n(this, D);
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(xe.content.cloneNode(!0)), h(this, D, Wt).call(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
  ...
  attributeChangedCallback(e, o, l) {
    switch (e) {
      case "gap":
        h(this, D, Wt).call(this, { gap: l || te });
        break;
    }
  }
};
D = new WeakSet(), Wt = function({ gap: e = te } = {}) {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                display: flex;
        ...
        `;
}, r(j, "register", () => customElements.define("ui-flex-grid", j)), r(j, "observedAttributes", ["gap"]);
let ot = j;
...
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Le.content.cloneNode(!0)), this.ui = new _e(this);
  }
};
r(wt, "register", () => customElements.define("ui-select-option", wt));
let U = wt;
...
const bt = class bt extends HTMLElement {
  constructor() {
    ...
    n(this, k, (e) => {
      (e.composedPath() || []).forEach((o) => {
        o instanceof U && ([...this.querySelectorAll("ui-select-option")].forEach(
          (l) => l.removeAttribute("selected")
        ), o.setAttribute("selected", ""), this.dispatchEvent(new CustomEvent("change", { detail: o })));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0));
  }
  connectedCallback() {
    var e;
    (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", s(this, J)), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var e;
    this.removeEventListener("click", s(this, k)), (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", s(this, J));
  }
};
J = new WeakMap(), k = new WeakMap(), r(bt, "register", () => customElements.define("ui-select", bt));
let rt = bt;
var B, C, X, ne;
let ts = (ne = class {
  /** @param {Lang} root */
  constructor(t) {
     ...
     */
    n(this, X, void 0);
    a(this, B, t), a(this, C, new Q()), this.langType = null;
  }
  /** @returns {import("./lang-type").LangType} */
  getFallbackElement() {
    return s(this, B).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, a(this, X, e), s(this, C).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var o;
    return (o = s(this, X)) == null ? void 0 : o[t][e];
  }
  /**
   * @param {"change"} key
...
}, B = new WeakMap(), C = new WeakMap(), X = new WeakMap(), ne);
var yt, Ce;
const N = class N extends HTMLElement {
  ...
  attributeChangedCallback(e, o, l) {
    switch (e) {
      case "current":
        l !== null && h(this, yt, Ce).call(this, l);
        break;
    }
  }
};
yt = new WeakSet(), Ce = async function(e) {
  const o = this.querySelector(`ui-lang-type[name="${e}"]`) || this.ui.getFallbackElement();
  if (!o)
    return;
  if (!o.ui.href)
    throw "Missing href attribute!";
  const l = await fetch(o.ui.href);
  this.ui.new(o, await l.json());
...
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.ui = new es(this);
  }
};
r(xt, "register", () => customElements.define("ui-lang-type", xt));
let lt = xt;
...
let ss = (ae = class {
  ...
  */
  ...
  get name() {
    return s(this, E).getAttribute("name");
  }
  set name(t) {
    s(this, E).setAttribute("name", t);
  }
}, E = new WeakMap(), ae);
const Lt = class Lt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ee.content.cloneNode(!0)), this.ui = new ss(this);
  }
};
r(Lt, "register", () => customElements.define("ui-stack-layout-page", Lt));
let at = Lt;
const Me = document.createElement("template");
Me.innerHTML = `
    <style>
...
let is = (ce = class {
  ...
  constructor(t) {
     ...
     */
    n(this, M, {});
    a(this, L, t), this.events = new Q(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    t.ontransitionend = () => {
      t.ontransitionend = null, s(this, L).removeChild(t);
    }, this.stack.length && s(this, L).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      s(this, L).appendChild(s(this, M)[t]().children[0])
    ), this.stack.length > 1) {
...
}, L = new WeakMap(), M = new WeakMap(), ce);
const kt = class kt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Me.content.cloneNode(!0)), this.ui = new is(this);
  }
};
r(kt, "register", () => customElements.define("ui-stack-layout", kt));
let ct = kt;
var f, v, he;
let os = (he = class {
  /**
...
}, f = new WeakMap(), v = new WeakMap(), he);
const Ct = class Ct extends HTMLElement {
  constructor() {
    super(), this.ui = new os(this);
  }
  /*
...
r(Ct, "register", () => customElements.define("ui-store", Ct));
let ht = Ct;
...
const Mt = class Mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Te.content.cloneNode(!0));
  }
};
...
const St = class St extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(He.content.cloneNode(!0));
  }
};
...
const Tt = class Tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Re.content.cloneNode(!0));
  }
};
...
const Ht = class Ht extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ae.content.cloneNode(!0));
  }
};
...
const Rt = class Rt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild($e.content.cloneNode(!0));
  }
};
r(Rt, "register", () => customElements.define("ui-svg-pdf-document", Rt));
let Kt = Rt;
...
const At = class At extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(je.content.cloneNode(!0));
  }
};
...
const $t = class $t extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ne.content.cloneNode(!0));
  }
};
r($t, "register", () => customElements.define("ui-svg-today-outline", $t));
let Gt = $t;
const g = {
  ...
  Settings: Qt,
  TodayOutline: Gt
}, ze = document.createElement("template");
ze.innerHTML = `
<style>
    :host {
        position: relative;
...
let rs = (de = class {
  ...
  enableRipple() {
    s(this, T) || (this.removeRipple = qt(s(this, c)), s(this, c).style.cursor = "pointer", h(this, jt, Ie).call(this));
  }
  disableRipple() {
    s(this, T) && s(this, T).call(this), h(this, Nt, Ue).call(this);
  }
}, c = new WeakMap(), S = new WeakMap(), Y = new WeakMap(), K = new WeakMap(), T = new WeakMap(), jt = new WeakSet(), Ie = function() {
  s(this, S) || (s(this, c).addEventListener("click", s(this, Y)), this.getInputSlot().forEach((t) => {
    t.addEventListener("click", s(this, K));
  }), a(this, S, !0));
}, Nt = new WeakSet(), Ue = function() {
  s(this, c).removeEventListener("click", s(this, Y)), [...s(this, c).querySelectorAll('[slot="input"]')].forEach((t) => {
    t.removeEventListener("click", s(this, K));
  }), a(this, S, !1);
}, de);
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ze.content.cloneNode(!0)), this.ui = new rs(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
const zt = class zt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(qe.content.cloneNode(!0));
  }
};
...
const It = class It extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Oe.content.cloneNode(!0));
  }
};
r(It, "register", () => customElements.define("ui-secondary", It));
let pt = It;
var p, Ut, Pe;
class ns {
  constructor() {
  ...
  enableAutoMode() {
    ...
    a(this, p, window.matchMedia("(prefers-color-scheme: dark)")), s(this, p).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(s(this, p));
  }
  disableAutoMode() {
    h(this, Ut, Pe).call(this);
  }
  /**
   * @param {string} name
   * @param {string} href
...
p = new WeakMap(), Ut = new WeakSet(), Pe = function() {
  s(this, p) && (s(this, p).removeEventListener("change", this.mediaChangeHandler), a(this, p, null));
};
const I = class I extends HTMLElement {
  constructor() {
    super(), this.ui = new ns();
  }
  attributeChangedCallback(t, e, o) {
    switch (t) {
      case "auto":
...
r(I, "register", () => customElements.define("ui-theme-handler", I)), r(I, "observedAttributes", ["auto", "mode"]);
let gt = I;
...
async function as() {
  G.register(), _.register(), F.register(), tt.register(), st.register(), it.register(), ot.register(), U.register(), rt.register(), lt.register(), nt.register(), at.register(), ct.register(), ht.register(), pt.register(), ut.register(), dt.register(), gt.register(), et.register();
}
async function cs() {
