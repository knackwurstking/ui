...
r(z, "register", () => customElements.define("ui-stack-layout-page", z)), r(z, "observedAttributes", ["name"]);
let de = z;
...
`;
var f, u, E, F, G, M, ze, At, Ne, jt, nt;
let ts = (nt = class {
  /** @param {Label} root */
  constructor(e) {
    n(this, ze);
  ...
  enableRipple() {
    s(this, M) || (this.removeRipple = Pe(s(this, f)), s(this, f).style.cursor = "pointer", d(this, ze, At).call(this));
  }
  disableRipple() {
    s(this, M) && s(this, M).call(this), d(this, Ne, jt).call(this);
  }
}, f = new WeakMap(), u = new WeakMap(), E = new WeakMap(), F = new WeakMap(), G = new WeakMap(), M = new WeakMap(), ze = new WeakSet(), At = function() {
