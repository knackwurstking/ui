...
const Ei = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: He
}, Symbol.toStringTag, { value: "Module" })), Lt = "1", Re = n`
<style></style>
<slot></slot>
`;
let $e = class {
...
r(U, "register", () => {
  W.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", U);
});
let Pt = U;
const Pe = n`
<style>
...
let Ve = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = xt(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
  }
  disableRipple() {
...
r(lt, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", lt);
});
let Kt = lt;
const Ue = n`
<style>
...
r(dt, "register", () => {
  Tt.register(), At.register(), W.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", dt);
});
let It = dt;
...
`, pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = oi, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
`, gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ri, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let ai = (de = class {
  ...
  enableRipple() {
    i(this, A) || (this.removeRipple = xt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
...
const V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ni, this.cleanup = new h(), this.ui = new ai(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(V, "register", () => {
  G.register(), J.register(), customElements.get("ui-label") || customElements.define("ui-label", V);
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new li(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ce.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new ci(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(O, "register", () => {
  Rt.register(), G.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", O);
}), r(O, "observedAttributes", ["title"]);
let ee = O;
...
r(ft, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", ft);
});
let I = ft;
const pi = n`
<style>
...
K = new WeakMap(), // }}}
r(bt, "register", () => {
  Ht.register(), I.register(), customElements.get("ui-select") || customElements.define("ui-select", bt);
});
let se = bt;
var L, R, Q, ge;
let mi = (ge = class {
