...
var r = (s, t, e) => (ae(s, typeof t != "symbol" ? t + "" : t, e), e), Vt = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
};
var i = (s, t, e) => (Vt(s, t, "read from private field"), e ? e.call(s) : t.get(s)), n = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, c = (s, t, e, o) => (Vt(s, t, "write to private field"), o ? o.call(s, e) : t.set(s, e), e);
const Zt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class R {
  ...
  off(t, e) {
    ...
    for (const w of i(this, u)[t])
      w === e && (i(this, u)[t].splice(l, 1), o = !0), l++;
    if (!o)
...
function At(s, t = {}) {
  ...
  return s.classList.add("ripple-container"), s.style.overflow = "hidden", s.addEventListener("pointerdown", o), s.addEventListener("pointerup", l), s.addEventListener("pointerleave", l), () => {
...
const a = String.raw, pe = String.raw, fe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  css: pe,
  html: a,
  isAndroid: ge
  ...
  ripple: ue,
  utils: fe
}, Symbol.toStringTag, { value: "Module" })), ve = a`
<style>
    :host {
        display: flex;
        position: absolute;
...
const gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ve, this.ui = new be(this);
  }
};
...
let ye = (Yt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = At(i(this, D), { centered: !0 }));
  }
  disableRipple() {
...
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = we, this.ui = new ye(this);
  }
  connectedCallback() {
...
r($, "register", () => customElements.define("ui-button", $)), r($, "observedAttributes", ["no-ripple"]);
let W = $;
const xe = a`
<style>
    :host {
...
let Le = (Kt = class {
  ...
  constructor(t) {
    /** @type {IconButton} */
    n(this, V, void 0);
    c(this, V, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = At(i(this, V), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
const A = class A extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = xe, this.ui = new Le(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
r(pt, "register", () => customElements.define("ui-container", pt));
let G = pt;
const Ce = a`
<style>
    :host dialog * {
...
let Me = (Qt = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, L, void 0);
    c(this, y, t), c(this, x, e), this.events = new R(), c(this, L, document.createElement("h4")), i(this, L).slot = "title", i(this, y).appendChild(i(this, L));
  }
  get dialog() {
    return i(this, x);
  }
...
}, y = new WeakMap(), x = new WeakMap(), L = new WeakMap(), Qt);
var Z, N;
const ft = class ft extends HTMLElement {
  constructor() {
    super();
    n(this, Z, () => this.ui.events.dispatch("close", null));
    n(this, N, () => this.ui.close());
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ce, this.ui = new Me(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    const e = this.shadowRoot.querySelector(".header ui-icon-button");
    e.addEventListener("click", i(this, N)), e.addEventListener("click", i(this, Z));
  }
  disconnectedCallback() {
    const e = this.shadowRoot.querySelector(".header ui-icon-button");
    e.removeEventListener("click", i(this, N)), e.removeEventListener("click", i(this, Z));
  }
};
Z = new WeakMap(), N = new WeakMap(), r(ft, "register", () => customElements.define("ui-dialog", ft));
let _ = ft;
const Nt = "1", Te = a`
<style></style>
<slot></slot>
...
r(j, "register", () => customElements.define("ui-flex-grid-item", j)), r(j, "observedAttributes", ["flex"]);
let tt = j;
const Jt = "0", Ee = a`
<style></style>
<slot></slot>
...
r(I, "register", () => customElements.define("ui-flex-grid-row", I)), r(I, "observedAttributes", ["gap"]);
let et = I;
const Bt = "0", He = a`
<style></style>
<slot></slot>
...
r(U, "register", () => customElements.define("ui-flex-grid", U)), r(U, "observedAttributes", ["gap"]);
let it = U;
const Se = a`
<style>
    :host {
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.ui = new Re(this);
  }
};
r(mt, "register", () => customElements.define("ui-select-option", mt));
let P = mt;
const $e = a`
<style>
    * {
  ...
  constructor() {
    ...
    n(this, J, async (e) => {
      (e.composedPath() || []).forEach((o) => {
        o instanceof P && ([...this.querySelectorAll("ui-select-option")].forEach(
          (l) => l.removeAttribute("selected")
        ), o.setAttribute("selected", ""), this.ui.events.dispatch("change", o));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = $e, this.cleanup = [], this.ui = new Ae();
  }
  // }}}
  connectedCallback() {
...
J = new WeakMap(), // }}}
r(vt, "register", () => customElements.define("ui-select", vt));
let st = vt;
var B, M, X, Ft;
let je = (Ft = class {
  /** @param {Lang} root */
  constructor(t) {
     ...
     */
    n(this, X, void 0);
    c(this, B, t), c(this, M, new R()), this.langType = null;
  }
  /** @returns {import("./lang-type").LangType} */
  getFallbackElement() {
    return i(this, B).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, c(this, X, e), i(this, M).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var o;
    return (o = i(this, X)) == null ? void 0 : o[t][e];
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, o = !1) {
    ...
    return o && e(this.langType), i(this, M).on(t, e);
  }
}, B = new WeakMap(), M = new WeakMap(), X = new WeakMap(), Ft);
...
r(z, "register", () => customElements.define("ui-lang", z)), r(z, "observedAttributes", ["current"]);
let ot = z;
var g, Gt;
let Ie = (Gt = class {
  /**
...
r(bt, "register", () => customElements.define("ui-lang-type", bt));
let rt = bt;
const Ue = a`
    <style>
        :host {
...
let ze = (_t = class {
  ...
  */
  ...
  get name() {
    return i(this, T).getAttribute("name");
  }
  set name(t) {
    i(this, T).setAttribute("name", t);
  }
}, T = new WeakMap(), _t);
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ue, this.ui = new ze(this);
  }
};
r(wt, "register", () => customElements.define("ui-stack-layout-page", wt));
let nt = wt;
const qe = a`
    <style>
        :host {
...
let Oe = (te = class {
  ...
  constructor(t) {
     ...
     */
    n(this, E, {});
    c(this, C, t), this.events = new R(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    t.ontransitionend = () => {
      t.ontransitionend = null, i(this, C).removeChild(t);
    }, this.stack.length && i(this, C).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      i(this, C).appendChild(i(this, E)[t]().children[0])
    ), this.stack.length > 1) {
...
}, C = new WeakMap(), E = new WeakMap(), te);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = qe, this.ui = new Oe(this);
  }
};
...
}, v = new WeakMap(), b = new WeakMap(), ee);
...
r(kt, "register", () => customElements.define("ui-svg-chevron-down", kt));
let It = kt;
const Ze = a`
<style>
    :host {
...
r(Mt, "register", () => customElements.define("ui-svg-delete-recycle-bin", Mt));
let zt = Mt;
const Je = a`
<style>
    :host {
...
r(Tt, "register", () => customElements.define("ui-svg-edit2", Tt));
let qt = Tt;
const Be = a`
<style>
    :host {
...
r(Et, "register", () => customElements.define("ui-svg-pdf-document", Et));
let Ot = Et;
const Xe = a`
<style>
    :host {
...
r(Ht, "register", () => customElements.define("ui-svg-settings", Ht));
let Pt = Ht;
const Ye = a`
<style>
    :host {
...
r(St, "register", () => customElements.define("ui-svg-today-outline", St));
let Dt = St;
const f = {
...
let Qe = (ie = class {
  ...
  enableRipple() {
    i(this, S) || (this.removeRipple = At(i(this, h)), i(this, h).style.cursor = "pointer", this._startInputHandling());
  }
  disableRipple() {
    i(this, S) && i(this, S).call(this), this._stopInputHandling();
  }
  _startInputHandling() {
    i(this, H) || (i(this, h).addEventListener("click", i(this, Y)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", i(this, K));
    }), c(this, H, !0));
  }
  _stopInputHandling() {
    i(this, h).removeEventListener("click", i(this, Y)), [...i(this, h).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, K));
    }), c(this, H, !1);
  }
}, h = new WeakMap(), H = new WeakMap(), Y = new WeakMap(), K = new WeakMap(), S = new WeakMap(), ie);
const q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ke, this.ui = new Qe(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
r(q, "register", () => customElements.define("ui-label", q)), r(q, "observedAttributes", ["ripple", "secondary", "primary"]);
let ct = q;
const We = a`
<style>
    :host {
...
class Ge {
  ...
  enableAutoMode() {
    ...
    c(this, p, window.matchMedia("(prefers-color-scheme: dark)")), i(this, p).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, p));
  }
  disableAutoMode() {
    this.removeMedia();
  }
   ...
   */
  removeMedia() {
    i(this, p) && (i(this, p).removeEventListener("change", this.mediaChangeHandler), c(this, p, null));
  }
}
p = new WeakMap();
const O = class O extends HTMLElement {
  constructor() {
    super(), this.ui = new Ge();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue 
...
r(O, "register", () => customElements.define("ui-theme-handler", O)), r(O, "observedAttributes", ["auto", "mode"]);
let ut = O;
...
async function ti() {
  Q.register(), F.register(), W.register(), G.register(), tt.register(), et.register(), it.register(), P.register(), st.register(), rt.register(), ot.register(), nt.register(), at.register(), lt.register(), dt.register(), ht.register(), ct.register(), ut.register(), _.register();
}
async function ei() {
