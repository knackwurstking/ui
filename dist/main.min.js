...
function Rt(o, t = {}) {
  ...
  const e = () => {
    ...
    o.draggable = !0, o.ondragstart = (l) => {
      ...
      const Y = parseInt(l.dataTransfer.getData("text/plain"), 10);
      t.onDragEnd && t.onDragEnd(Y, a);
    };
  }, i = () => {
...
class d {
  ...
  off(t, e) {
    ...
    let i = !1, r = 0;
    for (const a of h(this, c)[t])
      a === e && (h(this, c)[t].splice(r, 1), i = !0), r++;
    if (!i)
...
const p = class p extends HTMLElement {
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "noripple":
        i !== null ? typeof this.removeRippleCallback == "function" && (this.removeRippleCallback(), this.removeRippleCallback = null) : typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = u(this));
        break;
    }
  }
};
...
const g = class g extends HTMLElement {
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "noripple":
        i !== null ? typeof this.removeRippleCallback == "function" && (this.removeRippleCallback(), this.removeRippleCallback = null) : typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = u(this, { centered: !0 }));
        break;
    }
  }
};
...
`, b = class b extends HTMLElement {
  ...
  shadowRender() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), r = (a) => a.preventDefault();
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set justify(t) {
        ...
        this.root.setAttribute("justify", t);
      },
      get align() {
      ...
      set align(t) {
        ...
        this.root.setAttribute("align", t);
      }
    }, this.shadowRender();
  }
  shadowRender() {
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "gap":
        ...
        break;
      case "justify":
        this.style.justifyContent = i;
        break;
      case "align":
        this.style.alignItems = i;
        break;
    }
  }
};
...
}), s(y, "observedAttributes", ["gap", "justify", "align"]);
let U = y;
...
const P = class P extends HTMLElement {
  ...
  shadowRender() {
    ...
    const t = (i) => {
      ...
      this.classList.toggle("open") ? (i.stopPropagation(), this.addEventListener("click", r)) : setTimeout(() => this.removeEventListener("click", r));
    };
