...
o(S, "register", () => {
  A.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", S);
});
let wt = S;
const re = n`
    <style>
...
o(N, "register", () => {
  customElements.get("svg-download") || customElements.define("svg-download", N);
});
let Et = N;
const ge = n`
<style>
...
o(V, "register", () => {
  customElements.get("svg-recycle") || customElements.define("svg-recycle", V);
});
let Tt = V;
const fe = n`
<style>
...
o(K, "register", () => {
  ht.register(), T.register(), A.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", K);
});
let zt = K;
const jt = 150, xe = n`
    <style>
...
`, C = class C extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = He, this.cleanup = new a(), this.ui = {
       ...
       */
      getValue() {
        const t = this.root.getAttribute("value");
        switch (this.getType()) {
          case "number":
...
o(x, "register", () => {
  p.register(), T.register(), ut.register(), customElements.get("ui-search") || customElements.define("ui-search", x);
