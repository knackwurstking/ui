...
var r = (o, t, e) => St(o, typeof t != "symbol" ? t + "" : t, e), Mt = (o, t, e) => t.has(o) || yt("Cannot " + e);
var h = (o, t, e) => (Mt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), wt = (o, t, e) => t.has(o) ? yt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const kt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
}), r(M, "observedAttributes", ["auto", "mode"]);
let ft = M;
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {}, this.shadowRender();
