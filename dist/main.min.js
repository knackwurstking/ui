...
var r = (o, t, e) => Yt(o, typeof t != "symbol" ? t + "" : t, e), Xt = (o, t, e) => t.has(o) || qt("Cannot " + e);
...
function Pt(o, t, { onDragStart: e = null, onDragging: i = null, onDragEnd: s = null } = {}) {
  const l = () => {
    ...
    t.draggable = !0, t.ondragstart = (d) => {
      ...
      d.preventDefault(), d.dataTransfer.dropEffect = "move", s && s(h), [...o.children].forEach((m) => {
        m.style.background = "inherit", m.style.color = "inherit";
      });
    };
  }, u = () => {
...
function Zt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  let i = null, s = null, l = null, u = null, c = null, h = !1, d = null, m = null;
  const Y = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, u = n.clientY, s = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
    ...
    c !== null && (clearTimeout(c), c = null), i && (i.style.color = d, i.style.backgroundColor = m, i = null), s = null, o.classList.remove("dragging"), h && (t && t(), h = !1);
  };
  function Ot(n, v) {
...
r(B, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", B);
});
let it = B;
...
}), r(E, "observedAttributes", ["gap", "justify", "align"]);
let at = E;
...
const A = class A extends HTMLElement {
  ...
  static createAction({
    ...
    l.ui.flex = i, l.slot = "actions", l.innerHTML = a`
        ...
        `;
    let u;
    return s && (u = l.querySelector("ui-button"), u.ui.events.on("click", s)), {
      container: l,
      action: u
    };
  }
