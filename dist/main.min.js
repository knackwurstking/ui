...
var Ct = (s, t, e) => t in s ? kt(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var r = (s, t, e) => Ct(s, typeof t != "symbol" ? t + "" : t, e), xt = (s, t, e) => t.has(s) || mt("Cannot " + e);
var c = (s, t, e) => (xt(s, t, "read from private field"), e ? e.call(s) : t.get(s)), bt = (s, t, e) => t.has(s) ? mt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(s) : t.set(s, e);
const ft = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function St(s, t = {}) {
  ...
  const e = () => {
    ...
    s.draggable = !0, s.ondragstart = (a) => {
      a.dataTransfer.effectAllowed = "move", a.dataTransfer.dropEffect = "move", a.dataTransfer.setData(
        "text/plain",
        l.toString()
      ), t.onDragStart && t.onDragStart(l);
    }, s.ondragover = (a) => (a.preventDefault(), !1), s.ondragenter = (a) => {
      a.preventDefault(), t.onDragging && t.onDragging(l);
    }, s.ondrop = (a) => {
...
class d {
  ...
  on(t, e) {
    ...
    return c(this, u)[t] || (c(this, u)[t] = []), c(this, u)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let i = !1, o = 0;
    for (const l of c(this, u)[t])
      l === e && (c(this, u)[t].splice(o, 1), i = !0), o++;
    if (!i)
...
function J(s, t = {}) {
  ...
  return s.classList.add("ripple-container"), s.style.overflow = "hidden", t.useClick === !0 ? s.addEventListener("click", (l) => {
    e = vt(l, t), wt(e);
  }) : (s.addEventListener("pointerdown", i), s.addEventListener("pointerup", o), s.addEventListener("pointerleave", o)), () => {
    s.classList.remove("ripple-container"), s.removeEventListener("pointerdown", i), s.removeEventListener("pointerup", o), s.removeEventListener("pointerleave", o);
  };
}
function Et() {
...
const Ht = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: Et
}, Symbol.toStringTag, { value: "Module" })), q = class q extends HTMLElement {
  constructor() {
...
r(q, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", q);
});
let X = q;
...
r($, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", $);
});
let B = $;
const g = class g extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.renderCleanUp = new h(), this.removeRippleCallback = null, this.ui = {
      root: this,
      /**
  ...
  render() {
    ...
    const t = async () => this.ui.events.dispatch("click", this);
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "noripple":
        i !== null ? typeof this.removeRippleCallback == "function" && (this.removeRippleCallback(), this.removeRippleCallback = null) : typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = J(
          this,
          { centered: !0 }
        ));
        break;
...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new h(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
       ...
       */
      open(t = !1, e = !0) {
        const i = this.root.shadowRoot.querySelector("dialog"), o = i.inert;
        i.inert = e, t ? i.showModal() : i.show(), this.events.dispatch("open", null), i.inert = o;
      },
      close() {
...
r(b, "register", () => {
  customElements.get("ui-dialog") || customElements.define("ui-dialog", b);
}), r(b, "observedAttributes", ["title"]);
let _ = b;
const f = class f extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.renderCleanUp = new h(), this.ui = {
      root: this,
      /**
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = `
        ...
        `, this.shadowRoot.querySelector("aside").addEventListener("click", (t) => t.stopPropagation());
  }
  render() {
    ...
    this.addEventListener("click", t), this.renderCleanUp.add(
      () => {
        this.removeEventListener("click", t);
      }
    );
...
r(f, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", f);
}), r(f, "observedAttributes", ["open"]);
let U = f;
...
r(v, "register", () => {
  customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", v);
...
const w = class w extends HTMLElement {
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "flex":
        const o = this.shadowRoot.querySelector('style[name="flex"]');
        o.textContent = `
                    :host {
                        flex: ${i || 1};
                    }
...
const y = class y extends HTMLElement {
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "gap":
        const o = this.shadowRoot.querySelector('style[name="gap"]');
        o.textContent = `
                    :host > ::slotted(*) {
...
r(k, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", k);
...
const V = class V extends HTMLElement {
  constructor() {
    ...
    `);
    r(this, "shadowTemplate", () => n`<slot></slot>`);
...
r(C, "register", () => {
  H.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
  ...
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.setAttribute("role", "button"), this.ui = {
      ...
      setValue(e) {
        ...
        this.root.setAttribute("value", e);
      },
      getSelected() {
...
r(F, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", F);
});
let L = F;
const D = class D extends HTMLElement {
  constructor() {
    ...
    }, this.cleanup = new h(), this.shadowRender();
  }
  connectedCallback() {
    const e = this.shadowRoot.querySelector(".options"), i = async (l) => {
      (l.composedPath() || []).forEach((a) => {
        a instanceof L && ([...this.querySelectorAll("ui-select-option")].forEach(
          (Z) => Z.removeAttribute("selected")
        ), a.setAttribute("selected", ""), this.ui.events.dispatch("change", a));
      });
    }, o = (l) => {
      this.classList.toggle("open") ? (l.stopPropagation(), this.addEventListener("click", i)) : setTimeout(
        () => this.removeEventListener("click", i)
      );
    };
    e.addEventListener("click", o), this.cleanup.add(() => {
      this.removeEventListener("click", o), e.removeEventListener("click", o);
...
`, S = class S extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = `
            ...
            <div class="container">
                <slot name="title"></slot>
                <input type="search" />
                <ui-icon-button ghost>${Tt}</ui-icon-button>
            </div>
    ...
    {
      this.ui.input = this.shadowRoot.querySelector("input"), this.ui.input.type = "text", this.ui.input.onkeydown = async (e) => {
        this.ui.hasSubmit() && e.key === "Enter" && this.ui.submit.click();
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "title":
        let o = this.querySelector('[slot="title"]');
        i === null && o && (this.removeChild(o), o = null), o || (o = new p(), o.slot = "title", this.appendChild(o)), o.innerHTML = i || "";
        break;
      case "value":
        this.ui.setValue(i);
        break;
...
r(O, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", O);
});
let lt = O;
...
r(N, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", N);
});
let ut = N;
const K = class K extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setName(e) {
        e === null && this.root.removeAttribute("name"), this.root.setAttribute("name", e);
      }
    }, this.shadowRender();
  }
  connectedCallback() {
...
const R = class R extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      _goBack() {
        const e = this.root.removeChild(this.stack.pop());
       ...
       */
      setPage(e, i = null, o = !1) {
        if (this.lock) return;
        const l = this.pages[e]();
        this.stack.push(this.root.appendChild(l)), typeof i == "function" && setTimeout(() => i(l));
        let a = null;
        this.stack.length > 1 && !o && (a = this.stack[this.stack.length - 2], a.parentElement.removeChild(a)), this.dispatchChangeEvent(a), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
...
r(R, "register", () => {
  M.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", R);
}), r(R, "observedAttributes", ["use-history"]);
let dt = R;
...
}), r(A, "observedAttributes", ["use-storage", "storage-prefix"]);
let ct = A;
...
let gt = Y;
function Mt() {
  B.register(), X.register(), Q.register(), W.register(), G.register(), _.register(), tt.register(), I.register(), U.register(), et.register(), it.register(), rt.register(), st.register(), at.register(), L.register(), nt.register(), lt.register(), ht.register(), ut.register(), dt.register(), M.register(), ct.register(), gt.register(), ot.register(), H.register(), p.register(), pt.register();
}
export {
  X as UIAppBar,
  B as UIAppBarItem,
