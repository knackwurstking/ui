...
var s = (o, t, e) => (jt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), l = (o, t, e) => {
  if (t.has(o))
...
const a = String.raw, ze = String.raw;
class c {
  constructor() {
    this.callbacks = [];
  }
...
const Si = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: a,
  isAndroid: Se
}, Symbol.toStringTag, { value: "Module" })), Tt = "1", qe = a`
<style></style>
<slot></slot>
`;
let je = class {
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ni, this.cleanup = new c(), this.ui = new ai(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Le.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new li(this);
  }
  connectedCallback() {
    const t = (i) => {
