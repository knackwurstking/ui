...
var Pt = (o, t, e) => t in o ? Vt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Pt(o, typeof t != "symbol" ? t + "" : t, e), Xt = (o, t, e) => t.has(o) || qt("Cannot " + e);
...
function Bt(o, t, { onDragStart: e = null, onDragging: i = null, onDragEnd: s = null } = {}) {
  const l = () => {
    const p = [...o.children].indexOf(t);
    t.draggable = !0, t.ondragstart = (u) => {
      u.dataTransfer.effectAllowed = "move", u.dataTransfer.dropEffect = "move", e && e(p);
    }, t.ondragover = (u) => (u.preventDefault(), !1), t.ondragenter = (u) => {
      u.preventDefault(), [...o.children].forEach((m, Y) => {
        if (Y === p) {
      ...
      u.preventDefault(), u.dataTransfer.dropEffect = "move", s && s(p), [...o.children].forEach((m) => {
        m.style.background = "inherit", m.style.color = "inherit";
      });
    };
  }, h = () => {
  ...
  return l(), {
     ...
     */
    update(c) {
      Object.hasOwn(c, "onDragStart") && (e = c.onDragStart), Object.hasOwn(c, "onDragging") && (i = c.onDragStart), Object.hasOwn(c, "onDragEnd") && (s = c.onDragEnd);
    },
    destroy: h
  };
}
function Jt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  let i = null, s = null, l = null, h = null, c = null, p = !1, u = null, m = null;
  const Y = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, h = n.clientY, s = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
      u = i.style.color, m = i.style.backgroundColor, i.style.color = "var(--ui-primary-color)", i.style.backgroundColor = "var(--ui-primary-bgColor)", o.classList.add("dragging"), p = !0, e && e();
    }, 200));
  }, Tt = (n) => {
    if (!s || !i) return;
    if (!p && (/* @__PURE__ */ new Date()).getTime() - s < 200) {
      const Mt = Math.abs(l - n.clientX), Ht = Math.abs(h - n.clientY);
      if ((Mt > Ht ? Mt : Ht) < 24)
        return;
      I();
      return;
    }
    n.preventDefault(), p || (p = !0, e && e());
    ...
    for (; !g.classList.contains("draggable") && g.parentElement; )
      g = g.parentElement;
    g.classList.contains("draggable") && Ft(i, g);
  }, I = () => {
    c !== null && (clearTimeout(c), c = null), i && (i.style.color = u, i.style.backgroundColor = m, i = null), s = null, o.classList.remove("dragging"), p && (t && t(), p = !1);
  };
  function Ft(n, v) {
    Yt(n, v) ? o.insertBefore(n, v) : o.insertBefore(n, v.nextElementSibling);
  }
  function Yt(n, v) {
...
class d {
  ...
  on(t, e) {
    ...
    return f(this, b)[t] || (f(this, b)[t] = []), f(this, b)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const l of f(this, b)[t])
      l === e && (f(this, b)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
const a = String.raw, U = String.raw, Ut = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: jt,
  Events: d,
  css: U,
  ...
  isAndroid: Kt,
  ripple: Dt
}, Symbol.toStringTag, { value: "Module" })), V = class V extends HTMLElement {
  constructor() {
...
r(V, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", V);
});
let it = V;
...
r(P, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", P);
});
let ot = P;
...
}), r(k, "observedAttributes", ["noripple"]);
let rt = k;
...
}), r(x, "observedAttributes", ["noripple"]);
let st = x;
const X = class X extends HTMLElement {
  constructor() {
...
r(X, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", X);
});
let nt = X;
const Qt = a`
...
`, C = class C extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new jt(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
...
r(C, "register", () => {
  customElements.get("ui-dialog") || customElements.define("ui-dialog", C);
}), r(C, "observedAttributes", ["title"]);
let at = C;
...
r(B, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", B);
});
let lt = B;
const Ot = a`
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
r(E, "register", () => {
  customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", E);
}), r(E, "observedAttributes", ["title"]);
let ct = E;
...
}), r(A, "observedAttributes", ["gap", "justify", "align"]);
let ht = A;
...
r(L, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", L);
}), r(L, "observedAttributes", ["gap"]);
let pt = L;
...
}), r(S, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let gt = S;
...
}), r(T, "observedAttributes", ["ripple", "secondary", "primary"]);
let bt = T;
...
r(Z, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", Z);
});
let mt = Z;
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Wt}</ui-icon-button>
      </div>
...
r(K, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", K);
});
let F = K;
const Q = class Q extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <div class="options">
        <div class="icon"><ui-svg>${Ot}</ui-svg></div>
    ...
    const t = (i) => {
      const s = async (l) => {
        (l.composedPath() || []).forEach((h) => {
          h instanceof F && ([...this.querySelectorAll("ui-select-option")].forEach(
...
r(q, "register", () => {
  customElements.get("ui-textarea") || customElements.define("ui-textarea", q);
}), r(q, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
r(z, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", z);
}), r(z, "observedAttributes", ["current"]);
let kt = z;
...
r($, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", $);
}), r($, "observedAttributes", ["name"]);
let Et = $;
...
r(G, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", G);
});
let At = G;
...
r(O, "register", () => {
  customElements.get("ui-theme-handler") || customElements.define("ui-theme-handler", O);
}), r(O, "observedAttributes", ["auto", "mode"]);
let Lt = O;
...
r(_, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", _);
});
let St = _;
function It() {
  ot.register(), it.register(), rt.register(), st.register(), nt.register(), at.register(), ut.register(), ct.register(), lt.register(), dt.register(), ht.register(), pt.register(), gt.register(), ft.register(), vt.register(), F.register(), yt.register(), wt.register(), xt.register(), kt.register(), Ct.register(), Rt.register(), Et.register(), At.register(), St.register(), bt.register(), mt.register(), w.register(), Lt.register();
}
export {
  it as UIAppBar,
  ot as UIAppBarItem,
  ...
  Ct as UISpinner,
  Rt as UIStackLayout,
  Et as UIStackLayoutPage,
  At as UIStore,
  Lt as UIThemeHandler,
  It as register,
  Ut as utils
};
