...
var yt = (o, e, t) => e in o ? bt(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var r = (o, e, t) => (yt(o, typeof e != "symbol" ? e + "" : e, t), t), He = (o, e, t) => {
  if (!e.has(o))
    throw TypeError("Cannot " + t);
};
var i = (o, e, t) => (He(o, e, "read from private field"), t ? t.call(o) : e.get(o)), l = (o, e, t) => {
  if (e.has(o))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(o) : e.set(o, t);
}, a = (o, e, t, s) => (He(o, e, "write to private field"), s ? s.call(o, t) : e.set(o, t), t);
var h = (o, e, t) => (He(o, e, "access private method"), t);
class qe {
  constructor(e = !1) {
  ...
  removeListener(e, t) {
    ...
    let s = !1, n = 0;
    for (const Te of this.listeners[e])
      Te === t && (this.listeners[e].splice(n, 1), s = !0), n++;
    if (!s)
...
const ae = class ae extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ye.content.cloneNode(!0)), this.ui = new Tt(this);
  }
};
r(ae, "register", () => customElements.define("ui-app-bar", ae));
let J = ae;
...
let Ht = (Ze = class {
  ...
  constructor(e) {
    /** @type {Button} */
    l(this, j, void 0);
    a(this, j, e), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = Me(i(this, j), { centered: !0 }));
  }
  disableRipple() {
...
const y = class y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ke.content.cloneNode(!0)), this.ui = new Ht(this);
  }
  connectedCallback() {
...
r(y, "register", () => customElements.define("ui-button", y)), r(y, "observedAttributes", ["no-ripple"]);
let X = y;
...
let Rt = (Pe = class {
  ...
  constructor(e) {
    /** @type {IconButton} */
    l(this, N, void 0);
    a(this, N, e), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = Me(i(this, N), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
const x = class x extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Qe.content.cloneNode(!0)), this.ui = new Rt(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
r(x, "register", () => customElements.define("ui-icon-button", x)), r(x, "observedAttributes", ["no-ripple"]);
let Y = x;
...
r(ce, "register", () => customElements.define("ui-container", ce));
let K = ce;
...
const L = class L extends HTMLElement {
  ...
  connectedCallback() {
    h(this, I, Re).call(this);
  }
  attributeChangedCallback(t, s, n) {
    switch (t) {
      case "flex":
        a(this, z, n !== null ? n : "1"), h(this, I, Re).call(this);
        break;
    }
  }
};
z = new WeakMap(), I = new WeakSet(), Re = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                flex: ${i(this, z)};
            }
        `;
}, r(L, "register", () => customElements.define("ui-flex-grid-item", L)), r(L, "observedAttributes", ["flex"]);
let Q = L;
...
const C = class C extends HTMLElement {
  constructor() {
    ...
    /** @type {string | null} */
    l(this, U, "0");
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Fe.content.cloneNode(!0));
  }
  connectedCallback() {
    h(this, q, $e).call(this);
  }
  attributeChangedCallback(t, s, n) {
    switch (t) {
      case "gap":
        a(this, U, n !== null ? n : "0"), h(this, q, $e).call(this);
        break;
    }
  }
};
U = new WeakMap(), q = new WeakSet(), $e = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --row-gap: ${i(this, U)};
                display: flex;
        ...
        `;
}, r(C, "register", () => customElements.define("ui-flex-grid-row", C)), r(C, "observedAttributes", ["gap"]);
let B = C;
...
const k = class k extends HTMLElement {
  constructor() {
    ...
    /** @type {string | null} */
    l(this, O, "0");
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(_e.content.cloneNode(!0));
  }
  connectedCallback() {
    h(this, he, et).call(this);
  }
  attributeChangedCallback(t, s, n) {
    switch (t) {
      case "gap":
...
O = new WeakMap(), he = new WeakSet(), et = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --gap: ${i(this, O)};
                display: flex;
        ...
        `;
}, r(k, "register", () => customElements.define("ui-flex-grid", k)), r(k, "observedAttributes", ["gap"]);
let G = k;
...
const E = class E extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(tt.content.cloneNode(!0)), this.ui = new $t();
  }
  attributeChangedCallback(e, t, s) {
    switch (e) {
      case "value":
...
r(E, "register", () => customElements.define("ui-select-option", E)), r(E, "observedAttributes", ["value", "selected"]);
let A = E;
...
const de = class de extends HTMLElement {
  constructor() {
    ...
    /** @param {Event} ev */
    l(this, Z, (t) => {
      this.classList.toggle("open") ? (t.stopPropagation(), this.addEventListener("click", i(this, g))) : setTimeout(
        () => this.removeEventListener("click", i(this, g))
      );
    });
    /** @param {MouseEvent | PointerEvent} ev */
    l(this, g, (t) => {
      (t.composedPath() || []).forEach((s) => {
        s instanceof A && ([...this.querySelectorAll("ui-select-option")].forEach(
  ...
  connectedCallback() {
    var t;
    (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", i(this, Z)), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", i(this, g)), (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", i(this, Z));
  }
};
Z = new WeakMap(), g = new WeakMap(), r(de, "register", () => customElements.define("ui-select", de));
let F = de;
var P, f, D, De;
let St = (De = class {
  /** @param {Lang} root */
  constructor(e) {
     ...
     */
    l(this, D, void 0);
    a(this, P, e), a(this, f, new qe()), this.langType = null;
  }
  /** @returns {import("./lang-type").LangType} */
  getFallbackElement() {
    return i(this, P).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(e, t) {
    this.langType = e, a(this, D, t), i(this, f).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(e, t) {
    var s;
    return (s = i(this, D)) == null ? void 0 : s[e][t];
  }
  /**
   * @param {"change"} key
  ...
  on(e, t, s = !1) {
    ...
    return s && t(this.langType), i(this, f).addListener(e, t);
  }
}, P = new WeakMap(), f = new WeakMap(), D = new WeakMap(), De);
var ue, ot;
const M = class M extends HTMLElement {
  ...
  attributeChangedCallback(t, s, n) {
    switch (t) {
      case "current":
        n !== null && h(this, ue, ot).call(this, n);
        break;
    }
  }
};
ue = new WeakSet(), ot = async function(t) {
...
}, r(M, "register", () => customElements.define("ui-lang", M)), r(M, "observedAttributes", ["current"]);
let _ = M, At = class {
  constructor() {
...
r(T, "register", () => customElements.define("ui-lang-type", T)), r(T, "observedAttributes", ["name", "href", "fallback"]);
let ee = T;
...
const H = class H extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(it.content.cloneNode(!0)), this.ui = new jt();
  }
  attributeChangedCallback(e, t, s) {
    switch (e) {
      case "name":
...
r(H, "register", () => customElements.define("ui-stack-layout-page", H)), r(H, "observedAttributes", ["name"]);
let te = H;
...
r(pe, "register", () => customElements.define("ui-stack-layout", pe));
let se = pe;
var v, Ve;
let Nt = (Ve = class {
  constructor() {
    l(this, v, void 0);
    a(this, v, new qe()), this.localStoragePrefix = "", this.enableLocalStorage = !1, this.stores = {};
  }
  /**
   * @param {string} key
   */
  ...
  set(e, t, s = !1) {
    if (s && this.enableLocalStorage) {
      ...
      this.stores[e] = t;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + e, JSON.stringify(this.stores[e])), i(this, v).dispatchWithData(e, this.stores[e]);
  }
  /**
   * @param {string} key
  ...
  on(e, t, s = !1) {
    if (typeof t != "function")
      throw "callback is not a function";
    return s && t(this.get(e)), i(this, v).addListener(e, t);
  }
}, v = new WeakMap(), Ve);
const R = class R extends HTMLElement {
  constructor() {
    super(), this.ui = new Nt();
  }
  attributeChangedCallback(e, t, s) {
    switch (e) {
...
r(R, "register", () => customElements.define("ui-store", R)), r(R, "observedAttributes", ["local-storage-prefix", "enable-local-storage"]);
let oe = R;
...
r(ge, "register", () => customElements.define("ui-svg-chevron-down", ge));
let Ae = ge;
...
const fe = class fe extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(at.content.cloneNode(!0));
  }
};
r(fe, "register", () => customElements.define("ui-svg-delete-recycle-bin", fe));
let je = fe;
...
r(ve, "register", () => customElements.define("ui-svg-edit2", ve));
let Ne = ve;
...
r(we, "register", () => customElements.define("ui-svg-pdf-document", we));
let ze = we;
...
r(be, "register", () => customElements.define("ui-svg-settings", be));
let Ie = be;
...
r(ye, "register", () => customElements.define("ui-svg-today-outline", ye));
let Ue = ye;
const p = {
  BackArrowNavigation: Se,
  ChevronDown: Ae,
  DeleteRecycleBin: je,
  Edit2: Ne,
  PDFDocument: ze,
...
<slot></slot>
`;
var u, d, w, V, W, b, xe, mt, Le, gt, We;
let zt = (We = class {
  /** @param {Label} root */
  constructor(e) {
    l(this, xe);
    ...
    l(this, d, null);
    l(this, w, !1);
    l(this, V, async () => !!i(this, d) && i(this, d).click());
    l(this, W, async (e) => e.stopPropagation());
    /** @type {() => void} */
    l(this, b, void 0);
    a(this, u, e);
  }
  enableRipple() {
    i(this, b) || (this.removeRipple = Me(i(this, u)), i(this, u).style.cursor = "pointer", h(this, xe, mt).call(this));
  }
  disableRipple() {
    i(this, b) && i(this, b).call(this), h(this, Le, gt).call(this);
  }
}, u = new WeakMap(), d = new WeakMap(), w = new WeakMap(), V = new WeakMap(), W = new WeakMap(), b = new WeakMap(), xe = new WeakSet(), mt = function() {
  i(this, w) || (a(this, d, i(this, u).querySelector("input")), i(this, d) && (i(this, u).addEventListener("click", i(this, V)), i(this, d).addEventListener("click", i(this, W))), a(this, w, !0));
}, Le = new WeakSet(), gt = function() {
  i(this, d) && (i(this, u).removeEventListener("click", i(this, V)), i(this, d).removeEventListener("click", i(this, W))), a(this, w, !1);
}, We);
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(pt.content.cloneNode(!0)), this.ui = new zt(this);
  }
  attributeChangedCallback(e, t, s) {
    switch (e) {
      case "ripple":
...
r($, "register", () => customElements.define("ui-label", $)), r($, "observedAttributes", ["ripple"]);
let ie = $;
...
r(Ce, "register", () => customElements.define("ui-primary", Ce));
let re = Ce;
...
r(ke, "register", () => customElements.define("ui-secondary", ke));
let ne = ke;
var c, Ee, wt;
class It {
  constructor() {
  ...
  enableAutoMode() {
    if (this.removeMode(), i(this, c)) {
      this.mediaChangeHandler(i(this, c));
      return;
    }
    a(this, c, window.matchMedia("(prefers-color-scheme: dark)")), i(this, c).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, c));
  }
  disableAutoMode() {
    h(this, Ee, wt).call(this);
  }
  /**
   * @param {string} name
   * @param {string} href
...
c = new WeakMap(), Ee = new WeakSet(), wt = function() {
  i(this, c) && (i(this, c).removeEventListener("change", this.mediaChangeHandler), a(this, c, null));
};
const S = class S extends HTMLElement {
  constructor() {
    super(), this.ui = new It();
  }
  attributeChangedCallback(e, t, s) {
    switch (e) {
      case "auto":
...
r(S, "register", () => customElements.define("ui-theme-handler", S)), r(S, "observedAttributes", ["auto", "mode"]);
let le = S;
...
async function qt() {
  J.register(), Y.register(), X.register(), K.register(), Q.register(), B.register(), G.register(), A.register(), F.register(), ee.register(), _.register(), te.register(), se.register(), oe.register(), ne.register(), re.register(), ie.register(), le.register();
}
async function Ot() {
  p.BackArrowNavigation.register(), p.ChevronDown.register(), p.DeleteRecycleBin.register(), p.Edit2.register(), p.PDFDocument.register(), p.Settings.register(), p.TodayOutline.register();
}
const Bt = {
  ...Mt,
  wc: Ut,
