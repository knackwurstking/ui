...
var ne = (s, t, e) => t in s ? re(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var r = (s, t, e) => (ne(s, typeof t != "symbol" ? t + "" : t, e), e), Dt = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
};
var i = (s, t, e) => (Dt(s, t, "read from private field"), e ? e.call(s) : t.get(s)), n = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, l = (s, t, e, o) => (Dt(s, t, "write to private field"), o ? o.call(s, e) : t.set(s, e), e);
const Vt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const ut = class ut extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = fe, this.ui = new me(this);
  }
};
r(ut, "register", () => customElements.define("ui-app-bar", ut));
let K = ut;
const ve = `
<style>
    :host {
...
let be = (Xt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = $t(i(this, P), { centered: !0 }));
  }
  disableRipple() {
...
let ye = (Yt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = $t(i(this, D), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
}, w = new WeakMap(), y = new WeakMap(), x = new WeakMap(), Kt);
var V, Z;
const gt = class gt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Le, this.ui = new ke(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
V = new WeakMap(), Z = new WeakMap(), r(gt, "register", () => customElements.define("ui-dialog", gt));
let G = gt;
const Zt = "1", Ce = `
<style></style>
<slot></slot>
`, A = class A extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ce, this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
`, j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
const ft = class ft extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ee, this.ui = new He(this);
  }
};
...
const mt = class mt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = [], this.ui = new Re();
  }
  // }}}
  connectedCallback() {
...
N = new WeakMap(), // }}}
r(mt, "register", () => customElements.define("ui-select", mt));
let it = mt;
var J, C, B, Wt;
let $e = (Wt = class {
  /** @param {Lang} root */
...
}, J = new WeakMap(), C = new WeakMap(), B = new WeakMap(), Wt);
const U = class U extends HTMLElement {
  constructor() {
    super(), this.ui = new $e(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.ui = new Ae(this);
  }
};
r(vt, "register", () => customElements.define("ui-lang-type", vt));
let ot = vt;
const je = `
    <style>
        :host {
...
const bt = class bt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = je, this.ui = new Ie(this);
  }
};
...
}, m = new WeakMap(), v = new WeakMap(), te);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.ui = new qe(this);
  }
};
r(yt, "register", () => customElements.define("ui-store", yt));
let at = yt;
const Oe = `
<style>
    :host {
...
r(xt, "register", () => customElements.define("ui-svg-back-arrow-navigation", xt));
let At = xt;
const Pe = `
<style>
    :host {
...
r(Et, "register", () => customElements.define("ui-svg-settings", Et));
let Ot = Et;
const Be = `
<style>
    :host {
...
let Ye = (ee = class {
  ...
  enableRipple() {
    i(this, H) || (this.removeRipple = $t(i(this, c)), i(this, c).style.cursor = "pointer", this._startInputHandling());
  }
  disableRipple() {
...
}, c = new WeakMap(), E = new WeakMap(), X = new WeakMap(), Y = new WeakMap(), H = new WeakMap(), ee);
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Xe, this.ui = new Ye(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
r(St, "register", () => customElements.define("ui-primary", St));
let ct = St;
const Qe = `
<style>
    :host {
...
r(Rt, "register", () => customElements.define("ui-secondary", Rt));
let ht = Rt;
var p;
class We {
  constructor() {
...
async function Ge() {
  K.register(), W.register(), Q.register(), F.register(), _.register(), tt.register(), et.register(), O.register(), it.register(), ot.register(), st.register(), rt.register(), nt.register(), at.register(), ht.register(), ct.register(), lt.register(), dt.register(), G.register();
}
async function _e() {
