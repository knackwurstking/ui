...
const m = class m extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
            ...
            <slot></slot>
        `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = p(
      this,
      { centered: !0 }
    ));
  }
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "noripple":
        i !== null ? typeof this.removeRippleCallback == "function" && (this.removeRippleCallback(), this.removeRippleCallback = null) : typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = p(
          this,
          { centered: !0 }
        ));
        break;
...
const C = class C extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = p(this.root), this.root.style.cursor = "pointer", this.startInputHandling());
      },
      disableRipple() {
...
r(C, "register", () => {
  M.register(), g.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
  ...
  connectedCallback() {
    const e = this.shadowRoot.querySelector(".options"), i = async (l) => {
      (l.composedPath() || []).forEach((a) => {
        a instanceof H && ([...this.querySelectorAll("ui-select-option")].forEach(
...
r(Y, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", Y);
});
let dt = Y;
const J = class J extends HTMLElement {
  constructor() {
...
r(J, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", J);
});
let q = J;
...
r(E, "register", () => {
  q.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", E);
...
r(K, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", K);
});
let gt = K;
function Mt() {
  B.register(), X.register(), Q.register(), W.register(), G.register(), _.register(), tt.register(), I.register(), U.register(), et.register(), it.register(), rt.register(), st.register(), at.register(), H.register(), nt.register(), lt.register(), ht.register(), dt.register(), ct.register(), q.register(), ut.register(), gt.register(), ot.register(), M.register(), g.register(), pt.register();
}
export {
  X as UIAppBar,
  B as UIAppBarItem,
