...
var r = (o, t, e) => $t(o, typeof t != "symbol" ? t + "" : t, e), Ft = (o, t, e) => t.has(o) || Et("Cannot " + e);
var b = (o, t, e) => (Ft(o, t, "read from private field"), e ? e.call(o) : t.get(o)), At = (o, t, e) => t.has(o) ? Et("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
class Tt {
  constructor() {
    this.callbacks = [];
  }
...
function Dt(o, t, e = {}) {
  ...
  const i = () => {
    const u = [...o.children].indexOf(t);
    t.draggable = !0, t.ondragstart = (c) => {
      c.dataTransfer.effectAllowed = "move", c.dataTransfer.dropEffect = "move", e.onDragStart && e.onDragStart(u);
    }, t.ondragover = (c) => (c.preventDefault(), !1), t.ondragenter = (c) => {
      c.preventDefault(), [...o.children].forEach((g, a) => {
        if (a === u) {
      ...
      }), e.onDragging && e.onDragging(u);
    }, t.ondrop = (c) => {
      c.preventDefault(), c.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(u), [...o.children].forEach((g) => {
        g.style.background = "inherit", g.style.color = "inherit";
      });
    };
  }, s = () => {
...
function Vt(o, { onDragEnd: t = null }) {
  let e = null, i = null;
  const s = (a) => {
    if (!i && !e && Array.from(a.target.classList).includes("draggable")) {
      const d = !!a.targetTouches && a.targetTouches[0] || a;
      e = a.target, o.append(i = a.target.cloneNode(!0)), i.className = "dragging";
      const m = d.pageX - i.offsetWidth / 2 + "px", G = d.pageY - i.offsetHeight / 2 + "px";
      i.style.willChange = "transform", i.style.transform = `translate(${m}, ${G})`;
    }
  }, l = (a) => {
    if (i && e) {
      const d = !!a.targetTouches && a.targetTouches[0] || a, m = d.pageX - i.offsetWidth / 2 + "px", G = d.pageY - i.offsetHeight / 2 + "px";
      i.style.transform = `translate(${m}, ${G})`;
      const Rt = Array.from(
        document.elementFromPoint(d.clientX, d.clientY).children
      ).find((zt) => zt.classList.contains("draggable")) || null;
      Rt && c(e, Rt);
    }
  }, u = () => {
    i && o.removeChild(i), t && t(), i = null, e = null;
  };
  function c(a, d) {
    g(a, d) ? o.insertBefore(a, d) : o.insertBefore(a, d.nextElementSibling);
  }
  function g(a, d) {
  ...
  Array.from(o.children).forEach((a) => {
    a.classList.add("draggable"), a.onmousedown = s, a.ontouchstart = s, a.onmousemove = l, a.ontouchmove = l, a.onmouseup = u, a.ontouchend = u;
  });
}
var p;
class h {
...
const n = String.raw, Q = String.raw, Bt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: Tt,
  Events: h,
  createDraggable: Dt,
  createMobileDraggable: Vt,
  createRipple: f,
  css: Q,
  defaultRippleOptions: Ht,
  html: n,
  isAndroid: Ot
...
`, k = class k extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Tt(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new h(),
      get title() {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Pt}</ui-icon-button>
      </div>
...
const J = class J extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="options">
        <div class="icon"><ui-svg>${qt}</ui-svg></div>
    ...
    const t = (i) => {
      const s = async (l) => {
        (l.composedPath() || []).forEach((u) => {
          u instanceof $ && ([...this.querySelectorAll("ui-select-option")].forEach(
...
let Ct = N;
function Jt() {
  U.register(), _.register(), I.register(), tt.register(), et.register(), it.register(), st.register(), rt.register(), ot.register(), nt.register(), at.register(), lt.register(), ct.register(), ut.register(), pt.register(), $.register(), gt.register(), bt.register(), ft.register(), mt.register(), vt.register(), wt.register(), yt.register(), kt.register(), Ct.register(), dt.register(), ht.register(), v.register(), xt.register();
}
export {
  _ as UIAppBar,
  U as UIAppBarItem,
