...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ye, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new ke(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
let Fe = (ae = class {
  ...
  set(t, e, s = !1) {
    if (s && this.enableLocalStorage) {
      ...
      i(this, x)[t] = e;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + t.toString(), JSON.stringify(i(this, x)[t])), this.events.dispatch(t, i(this, x)[t]);
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
}, k = new WeakMap(), x = new WeakMap(), ae);
...
let Xt = mt;
function ki() {
  ft.register(), wt.register(), vt.register(), yt.register(), Ct.register(), Mt.register(), Tt.register(), St.register(), Q.register(), Rt.register(), jt.register(), $t.register(), qt.register(), zt.register(), Nt.register(), Dt.register(), K.register(), At.register(), Ht.register(), Pt.register(), kt.register();
}
function xi() {
...
export {
  ...
  ri as js,
  xi as registerSVGComponents,
  ki as registerWebComponents
};
