...
var He = (i, t, e) => t in i ? Te(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var r = (i, t, e) => (He(i, typeof t != "symbol" ? t + "" : t, e), e), Vt = (i, t, e) => {
  if (!t.has(i))
...
const pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Oe, this.ui = new qe(this);
  }
};
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0)), this.ui = new Pe(this);
  }
  connectedCallback() {
...
const A = class A extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ae.content.cloneNode(!0)), this.ui = new De(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
const ft = class ft extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ce.content.cloneNode(!0)), this.ui = new Ze(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
let _ = ft;
const Jt = "1", he = document.createElement("template");
he.innerHTML = `
<style></style>
<slot></slot>
`;
...
let tt = $;
const Bt = "0", de = document.createElement("template");
de.innerHTML = `
<style></style>
<slot></slot>
`;
...
let et = j;
const Xt = "0", ue = document.createElement("template");
ue.innerHTML = `
<style></style>
<slot></slot>
`;
...
let Ye = (Gt = class {
  ...
  constructor(t) {
     ...
     */
    n(this, B, void 0);
    l(this, J, t), l(this, k, new H()), this.langType = null;
  }
   ...
   */
  new(t, e) {
    this.langType = t, l(this, B, e), s(this, k).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  on(t, e, o = !1) {
    ...
    return o && e(this.langType), s(this, k).on(t, e);
  }
}, J = new WeakMap(), k = new WeakMap(), B = new WeakMap(), Gt);
...
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0)), this.ui = new Qe(this);
  }
};
...
let We = (ee = class {
  ...
  constructor(t) {
     ...
     */
    n(this, M, {});
    l(this, C, t), this.events = new H(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    t.ontransitionend = () => {
      t.ontransitionend = null, s(this, C).removeChild(t);
    }, this.stack.length && s(this, C).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      s(this, C).appendChild(s(this, M)[t]().children[0])
    ), this.stack.length > 1) {
...
}, C = new WeakMap(), M = new WeakMap(), ee);
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(me.content.cloneNode(!0)), this.ui = new We(this);
  }
};
