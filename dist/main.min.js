...
const m = class m extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.isOpen = !1, this.ui = {
      root: this,
      /**
      ...
      set open(t) {
        this.root.isOpen = t, t !== null ? this.events.dispatch("open", this.root) : this.events.dispatch("close", this.root);
      }
    }, this.shadowRender();
  }
  shadowRender() {
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set title(t) {
        ...
        !t && e && this.root.removeChild(e), t && (e || (e = new S(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t);
      },
      get type() {
...
r(A, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", A);
}), r(A, "observedAttributes", ["nobg"]);
let ht = A;
