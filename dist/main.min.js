...
var qt = (o, e, t) => e in o ? Ut(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var r = (o, e, t) => (qt(o, typeof e != "symbol" ? e + "" : e, t), t), Ze = (o, e, t) => {
  if (!e.has(o))
    throw TypeError("Cannot " + t);
};
var s = (o, e, t) => (Ze(o, e, "read from private field"), t ? t.call(o) : e.get(o)), n = (o, e, t) => {
  if (e.has(o))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(o) : e.set(o, t);
}, a = (o, e, t, i) => (Ze(o, e, "write to private field"), i ? i.call(o, t) : e.set(o, t), t);
var d = (o, e, t) => (Ze(o, e, "access private method"), t);
var c;
class _ {
  constructor() {
    /**
  ...
  removeListener(e, t) {
    ...
    let i = !1, l = 0;
    for (const Oe of s(this, c)[e])
      Oe === t && (s(this, c)[e].splice(l, 1), i = !0), l++;
    if (!i)
...
const Dt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ripple: Zt,
  utils: Dt
}, Symbol.toStringTag, { value: "Module" })), ct = document.createElement("template");
ct.innerHTML = `
<style>
    :host {
        display: flex;
...
let Jt = (Ge = class {
  ...
  getLeftSlot() {
    return [...s(this, y).querySelectorAll('[slot="left"]')];
  }
  getCenterSlot() {
    return [...s(this, y).querySelectorAll('[slot="center"]')];
  }
  getRightSlot() {
    return [...s(this, y).querySelectorAll('[slot="right"]')];
  }
}, y = new WeakMap(), Ge);
...
r(we, "register", () => customElements.define("ui-app-bar", we));
let ee = we;
...
let Bt = (_e = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Pe(s(this, P), { centered: !0 }));
  }
  disableRipple() {
...
r(T, "register", () => customElements.define("ui-button", T)), r(T, "observedAttributes", ["no-ripple"]);
let te = T;
...
let Xt = (et = class {
  ...
  constructor(e) {
    /** @type {IconButton} */
    n(this, O, void 0);
    a(this, O, e), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = Pe(s(this, O), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
const S = class S extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(dt.content.cloneNode(!0)), this.ui = new Xt(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
r(S, "register", () => customElements.define("ui-icon-button", S)), r(S, "observedAttributes", ["no-ripple"]);
let se = S;
...
r(be, "register", () => customElements.define("ui-container", be));
let ie = be;
...
let Yt = (tt = class {
  ...
  constructor(e, t) {
    ...
    /** @type {HTMLElement} */
    n(this, b, void 0);
    a(this, v, e), a(this, w, t), this.events = new _(), a(this, b, document.createElement("h4")), s(this, b).slot = "title", s(this, v).appendChild(s(this, b));
  }
  get dialog() {
    return s(this, w);
  }
  open(e = !1) {
    e ? s(this, w).showModal() : s(this, w).show();
  }
  close() {
    s(this, w).close();
  }
  get fullscreen() {
    return s(this, v).hasAttribute("fullscreen");
  }
  set fullscreen(e) {
    e ? s(this, v).setAttribute("fullscreen", "") : s(this, v).removeAttribute("fullscreen");
  }
  get title() {
    return s(this, b).innerText;
  }
  set title(e) {
    s(this, b).innerText = e;
  }
}, v = new WeakMap(), w = new WeakMap(), b = new WeakMap(), tt);
var Z, W;
const ye = class ye extends HTMLElement {
  constructor() {
    super();
    n(this, Z, () => this.ui.events.dispatchWithData("close", null));
    n(this, W, () => this.ui.close());
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(pt.content.cloneNode(!0)), this.ui = new Yt(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    const t = this.shadowRoot.querySelector("header ui-icon-button");
    t.addEventListener("click", s(this, W)), t.addEventListener("click", s(this, Z));
  }
  disconnectedCallback() {
    const t = this.shadowRoot.querySelector("header ui-icon-button");
    t.removeEventListener("click", s(this, W)), t.removeEventListener("click", s(this, Z));
  }
};
Z = new WeakMap(), W = new WeakMap(), r(ye, "register", () => customElements.define("ui-dialog", ye));
let oe = ye;
...
const H = class H extends HTMLElement {
  ...
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "flex":
        a(this, D, l !== null ? l : "1"), d(this, V, We).call(this);
        break;
    }
  }
};
D = new WeakMap(), V = new WeakSet(), We = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                flex: ${s(this, D)};
            }
        `;
}, r(H, "register", () => customElements.define("ui-flex-grid-item", H)), r(H, "observedAttributes", ["flex"]);
let re = H;
...
const R = class R extends HTMLElement {
  ...
  connectedCallback() {
    d(this, B, De).call(this);
  }
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "gap":
        a(this, J, l !== null ? l : "0"), d(this, B, De).call(this);
        break;
    }
  }
};
J = new WeakMap(), B = new WeakSet(), De = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --row-gap: ${s(this, J)};
                display: flex;
        ...
        `;
}, r(R, "register", () => customElements.define("ui-flex-grid-row", R)), r(R, "observedAttributes", ["gap"]);
let ne = R;
...
const $ = class $ extends HTMLElement {
  constructor() {
    ...
    /** @type {string | null} */
    n(this, X, "0");
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ft.content.cloneNode(!0));
  }
  connectedCallback() {
    d(this, xe, vt).call(this);
  }
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "gap":
...
X = new WeakMap(), xe = new WeakSet(), vt = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --gap: ${s(this, X)};
                display: flex;
        ...
        `;
}, r($, "register", () => customElements.define("ui-flex-grid", $)), r($, "observedAttributes", ["gap"]);
let le = $;
...
const ke = class ke extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(wt.content.cloneNode(!0)), this.ui = new Kt(this);
  }
};
r(ke, "register", () => customElements.define("ui-select-option", ke));
let q = ke;
...
const Le = class Le extends HTMLElement {
  constructor() {
    ...
    /** @param {Event} ev */
    n(this, Y, (t) => {
      this.classList.toggle("open") ? (t.stopPropagation(), this.addEventListener("click", s(this, k))) : setTimeout(
    ...
    n(this, k, (t) => {
      (t.composedPath() || []).forEach((i) => {
        i instanceof q && ([...this.querySelectorAll("ui-select-option")].forEach(
          (l) => l.removeAttribute("selected")
        ), i.setAttribute("selected", ""), this.dispatchEvent(new CustomEvent("change", { detail: i })));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(bt.content.cloneNode(!0));
  }
  connectedCallback() {
    var t;
    (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", s(this, Y)), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", s(this, k)), (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", s(this, Y));
  }
};
Y = new WeakMap(), k = new WeakMap(), r(Le, "register", () => customElements.define("ui-select", Le));
let ae = Le;
var K, L, Q, it;
let Qt = (it = class {
  /** @param {Lang} root */
  constructor(e) {
     ...
     */
    n(this, Q, void 0);
    a(this, K, e), a(this, L, new _()), this.langType = null;
  }
   ...
   */
  new(e, t) {
    this.langType = e, a(this, Q, t), s(this, L).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(e, t) {
    var i;
    return (i = s(this, Q)) == null ? void 0 : i[e][t];
  }
  /**
   * @param {"change"} key
...
}, K = new WeakMap(), L = new WeakMap(), Q = new WeakMap(), it);
var Ce, yt;
const A = class A extends HTMLElement {
  ...
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "current":
        l !== null && d(this, Ce, yt).call(this, l);
        break;
    }
  }
};
Ce = new WeakSet(), yt = async function(t) {
...
}, r(A, "register", () => customElements.define("ui-lang", A)), r(A, "observedAttributes", ["current"]);
let ce = A, Ft = class {
  constructor() {
...
r(j, "register", () => customElements.define("ui-lang-type", j)), r(j, "observedAttributes", ["name", "href", "fallback"]);
let he = j;
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(xt.content.cloneNode(!0)), this.ui = new Gt();
  }
  attributeChangedCallback(e, t, i) {
    switch (e) {
      case "name":
...
r(N, "register", () => customElements.define("ui-stack-layout-page", N)), r(N, "observedAttributes", ["name"]);
let de = N;
...
let _t = (ot = class {
  ...
  constructor(e) {
     ...
     */
    n(this, C, {});
    a(this, x, e), this.events = new _(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    e.ontransitionend = () => {
      e.ontransitionend = null, s(this, x).removeChild(e);
    }, this.stack.length && s(this, x).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(e) {
    if (this.stack.push(
      // @ts-expect-error
      s(this, x).appendChild(s(this, C)[e]().children[0])
    ), this.stack.length > 1) {
...
}, x = new WeakMap(), C = new WeakMap(), ot);
const Ee = class Ee extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(kt.content.cloneNode(!0)), this.ui = new _t(this);
  }
};
r(Ee, "register", () => customElements.define("ui-stack-layout", Ee));
let ue = Ee;
var m, rt;
let es = (rt = class {
  constructor() {
    /** @type {any} */
    n(this, m, {});
    this.events = new _(), this.localStoragePrefix = "", this.enableLocalStorage = !1;
  }
  /**
   * @param {keyof T} key
   */
...
r(z, "register", () => customElements.define("ui-store", z)), r(z, "observedAttributes", ["local-storage-prefix", "enable-local-storage"]);
let pe = z;
...
r(Me, "register", () => customElements.define("ui-svg-back-arrow-navigation", Me));
let Ve = Me;
...
r(Te, "register", () => customElements.define("ui-svg-chevron-down", Te));
let Je = Te;
...
r(Se, "register", () => customElements.define("ui-svg-close", Se));
let Be = Se;
const Mt = document.createElement("template");
Mt.innerHTML = `
<style>
...
r(He, "register", () => customElements.define("ui-svg-delete-recycle-bin", He));
let Xe = He;
...
r(Re, "register", () => customElements.define("ui-svg-edit2", Re));
let Ye = Re;
...
r($e, "register", () => customElements.define("ui-svg-pdf-document", $e));
let Ke = $e;
const Ht = document.createElement("template");
Ht.innerHTML = `
<style>
...
r(Ae, "register", () => customElements.define("ui-svg-settings", Ae));
let Qe = Ae;
...
`;
const je = class je extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Rt.content.cloneNode(!0));
  }
};
r(je, "register", () => customElements.define("ui-svg-today-outline", je));
let Fe = je;
const p = {
  BackArrowNavigation: Ve,
  ChevronDown: Je,
  Close: Be,
  DeleteRecycleBin: Xe,
  Edit2: Ye,
...
`;
var f, u, E, F, G, M, Ne, At, ze, jt, nt;
let ts = (nt = class {
  /** @param {Label} root */
  constructor(e) {
    n(this, Ne);
    ...
    n(this, u, null);
    n(this, E, !1);
    n(this, F, async () => !!s(this, u) && s(this, u).click());
    n(this, G, async (e) => e.stopPropagation());
    /** @type {() => void} */
    n(this, M, void 0);
    a(this, f, e);
  }
  enableRipple() {
    s(this, M) || (this.removeRipple = Pe(s(this, f)), s(this, f).style.cursor = "pointer", d(this, Ne, At).call(this));
  }
  disableRipple() {
    s(this, M) && s(this, M).call(this), d(this, ze, jt).call(this);
  }
}, f = new WeakMap(), u = new WeakMap(), E = new WeakMap(), F = new WeakMap(), G = new WeakMap(), M = new WeakMap(), Ne = new WeakSet(), At = function() {
  s(this, E) || (a(this, u, s(this, f).querySelector("input")), s(this, u) && (s(this, f).addEventListener("click", s(this, F)), s(this, u).addEventListener("click", s(this, G))), a(this, E, !0));
}, ze = new WeakSet(), jt = function() {
  s(this, u) && (s(this, f).removeEventListener("click", s(this, F)), s(this, u).removeEventListener("click", s(this, G))), a(this, E, !1);
}, nt);
const I = class I extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild($t.content.cloneNode(!0)), this.ui = new ts(this);
  }
  attributeChangedCallback(e, t, i) {
    switch (e) {
      case "ripple":
...
const Ue = class Ue extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(zt.content.cloneNode(!0));
  }
};
...
async function os() {
  ee.register(), se.register(), te.register(), ie.register(), re.register(), ne.register(), le.register(), q.register(), ae.register(), he.register(), ce.register(), de.register(), ue.register(), pe.register(), fe.register(), me.register(), ge.register(), ve.register(), oe.register();
}
async function rs() {
