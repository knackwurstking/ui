...
function Bt(o, t, { onDragStart: e = null, onDragging: i = null, onDragEnd: r = null } = {}) {
  const l = () => {
    ...
    t.draggable = !0, t.ondragstart = (h) => {
      ...
      h.preventDefault(), [...o.children].forEach((f, Y) => {
        if (Y === u) {
          f.style.background = "var(--ui-primary-bgColor)", f.style.color = "var(--ui-primary-color)";
          return;
        }
...
function Jt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  ...
  const Y = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, d = n.clientY, r = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
      h = i.style.color, f = i.style.backgroundColor, i.style.color = "var(--ui-primary-color)", i.style.backgroundColor = "var(--ui-primary-bgColor)", o.classList.add("dragging"), u = !0, e && e();
    }, 200));
  }, Tt = (n) => {
    if (!r || !i) return;
...
let Lt = U;
function It() {
  ot.register(), it.register(), rt.register(), st.register(), nt.register(), ct.register(), ht.register(), dt.register(), ut.register(), X.register(), at.register(), lt.register(), pt.register(), ft.register(), mt.register(), V.register(), vt.register(), yt.register(), kt.register(), wt.register(), xt.register(), Et.register(), Ct.register(), Rt.register(), Lt.register(), gt.register(), bt.register(), w.register(), At.register();
}
export {
  Pt as CleanUp,
  b as Events,
