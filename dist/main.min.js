...
var s = (o, t, e) => Ct(o, typeof t != "symbol" ? t + "" : t, e), xt = (o, t, e) => t.has(o) || gt("Cannot " + e);
var h = (o, t, e) => (xt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), bt = (o, t, e) => t.has(o) ? gt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const mt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
s(x, "register", () => {
  customElements.get("ui-search") || customElements.define("ui-search", x);
