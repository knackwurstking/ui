...
var At = (o, t, e) => t in o ? Et(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => At(o, typeof t != "symbol" ? t + "" : t, e), Lt = (o, t, e) => t.has(o) || ft("Cannot " + e);
var h = (o, t, e) => (Lt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), vt = (o, t, e) => t.has(o) ? ft("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const yt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function St(o, t = {}) {
  ...
  const e = () => {
    ...
    o.draggable = !0, o.ondragstart = (l) => {
      ...
      const X = parseInt(l.dataTransfer.getData("text/plain"), 10);
      t.onDragEnd && t.onDragEnd(X, a);
    };
  }, i = () => {
...
class d {
  ...
  off(t, e) {
    ...
    for (const a of h(this, c)[t])
      a === e && (h(this, c)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
const n = String.raw, Z = String.raw;
class Ct {
  constructor() {
    this.callbacks = [];
  }
...
}), r(p, "observedAttributes", ["noripple"]);
let Q = p;
...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Ct(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
      ...
      set title(t) {
        const e = this.root.shadowRoot.querySelector('[name="title"]');
        e.innerHTML = t || "";
      },
      get fullscreen() {
...
r(q, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", q);
});
let _ = q;
const Rt = n`
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
}), r(v, "observedAttributes", ["gap", "justify", "align"]);
let et = v;
...
r(y, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", y);
...
r(w, "register", () => {
  customElements.get("ui-check") || customElements.define("ui-check", w);
}), r(w, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let ot = w;
...
}), r(k, "observedAttributes", ["ripple", "secondary", "primary"]);
let rt = k;
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set title(t) {
        ...
        !t && e && this.root.removeChild(e), t && (e || (e = new L(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t);
      },
      get type() {
...
`, C = class C extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set storagekey(t) {
        this.storage && (this.value = localStorage.getItem(this.storageprefix + t) || "", this.events.dispatch("storage", this.value));
      },
      /**
       * @param {FocusOptions | null} [options]
       */
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Ht}</ui-icon-button>
      </div>
    ...
    const t = (i) => {
      const s = async (a) => {
        (a.composedPath() || []).forEach((l) => {
          l instanceof S && ([...this.querySelectorAll("ui-select-option")].forEach(
...
}), r(R, "observedAttributes", ["current"]);
let ct = R;
const F = class F extends HTMLElement {
  constructor() {
    super(), this.ui = {
...
r(E, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", E);
}), r(E, "observedAttributes", ["nobg"]);
let ht = E;
...
r(P, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", P);
});
let pt = P;
const Y = class Y extends HTMLElement {
  constructor() {
...
r(Y, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", Y);
});
let gt = Y;
...
let mt = J;
function jt() {
  K.register(), B.register(), Q.register(), W.register(), N.register(), G.register(), I.register(), U.register(), _.register(), tt.register(), et.register(), it.register(), ot.register(), nt.register(), at.register(), S.register(), lt.register(), dt.register(), ct.register(), ht.register(), pt.register(), ut.register(), gt.register(), mt.register(), rt.register(), st.register(), L.register(), bt.register();
}
export {
  B as UIAppBar,
  K as UIAppBarItem,
