  ...
  const t = () => {
    ...
    r.draggable = !0, r.ondragstart = (c) => {
      c.dataTransfer.effectAllowed = "move", c.dataTransfer.dropEffect = "move", c.dataTransfer.setData(
        "text/plain",
        a.toString()
      ), e.onDragStart && e.onDragStart(a);
    }, r.ondragover = (c) => (c.preventDefault(), !1), r.ondragenter = (c) => {
      c.preventDefault(), e.onDragging && e.onDragging(a);
    }, r.ondrop = (c) => {
...
class d {
  ...
  on(e, t) {
    ...
    return p(this, u)[e] || (p(this, u)[e] = []), p(this, u)[e].push(t), () => {
      this.off(e, t);
    };
  }
  // }}}
  ...
  off(e, t) {
    ...
    let o = !1, s = 0;
    for (const a of p(this, u)[e])
      a === t && (p(this, u)[e].splice(s, 1), o = !0), s++;
    if (!o)
...
function J(r, e = {}) {
  ...
  return r.classList.add("ripple-container"), r.style.overflow = "hidden", e.useClick === !0 ? r.addEventListener("click", (a) => {
    t = wt(a, e), yt(t);
...
const l = String.raw, h = String.raw;
class n {
  constructor() {
    this.callbacks = [];
  }
...
}), i(g, "observedAttributes", ["flex"]), i(g, "defaultFlex", "1");
let X = g;
...
}), i(m, "observedAttributes", ["gap"]), i(m, "defaultGap", "0");
let B = m;
...
const v = class v extends HTMLElement {
  constructor() {
    ...
    }, this.cleanup = new n(), this.shadowRender();
  }
  connectedCallback() {
...
`, P = class P extends HTMLElement {
  constructor() {
    ...
    }, this.cleanup = new n(), this.render({ ...this.ui.shadowAttr });
  }
  connectedCallback() {
    ...
    const s = this.shadowRoot.querySelector("dialog"), a = (c) => {
      c.preventDefault();
    };
    s.addEventListener("cancel", a), this.cleanup.add(() => {
      t.removeEventListener("click", o), s.removeEventListener("cancel", a);
    });
  }
  disconnectedCallback() {
    this.ui.cleanup.run(), this.cleanup.run();
...
const y = class y extends HTMLElement {
  constructor() {
    ...
    `);
    this.attachShadow({ mode: "open" }), this.cleanup = new n(), this.ui = {
      /** @private */
      root: this,
      cleanup: new n(),
      /** @type {HTMLElement} */
  ...
  connectedCallback() {
    ...
    this.addEventListener("click", t), this.ui.aside.addEventListener("click", o), this.cleanup.add(() => {
      this.ui.aside.removeEventListener("click", o), this.removeEventListener("click", t);
    });
  }
  disconnectedCallback() {
    this.ui.cleanup.run(), this.cleanup.run();
...
i(C, "register", () => {
  H.register(), f.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
  ...
  attributeChangedCallback(t, o, s) {
    switch (t) {
      case "title":
        ...
        if (s === null && a && (this.removeChild(a), a = null), s === null)
          return;
        a || (a = new f(), a.slot = "title", this.appendChild(a)), a.innerHTML = s;
        break;
      case "type":
...
const O = class O extends HTMLElement {
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), o = async (a) => {
      (a.composedPath() || []).forEach((c) => {
        c instanceof L && ([...this.querySelectorAll("ui-select-option")].forEach(
          (Z) => Z.removeAttribute("selected")
        ), c.setAttribute("selected", ""), this.ui.events.dispatch("change", c));
      });
    }, s = (a) => {
      this.classList.toggle("open") ? (a.stopPropagation(), this.addEventListener("click", o)) : setTimeout(
...
`, S = class S extends HTMLElement {
  ...
  attributeChangedCallback(t, o, s) {
    switch (t) {
      case "title":
        let a = this.querySelector('[slot="title"]');
        s === null && a && (this.removeChild(a), a = null), a || (a = new f(), a.slot = "title", this.appendChild(a)), a.innerHTML = s || "";
        break;
      case "value":
        this.ui.setValue(s);
        break;
  ...
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      setPage(t, o = null, s = !1) {
        if (this.lock) return;
        const a = this.pages[t]();
        this.stack.push(this.root.appendChild(a)), typeof o == "function" && setTimeout(() => o(a));
        let c = null;
        this.stack.length > 1 && !s && (c = this.stack[this.stack.length - 2], c.parentElement.removeChild(c)), this.dispatchChangeEvent(c), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
...
i(T, "register", () => {
  M.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", T);
...
i(R, "register", () => {
  customElements.get("ui-theme-handler") || customElements.define("ui-theme-handler", R);
}), i(R, "observedAttributes", ["auto", "mode"]);
let gt = R;
const Y = class Y extends HTMLElement {
  constructor() {
    super();
...
let mt = Y;
function $t() {
  _.register(), W.register(), I.register(), U.register(), tt.register(), et.register(), ot.register(), st.register(), it.register(), X.register(), B.register(), Q.register(), at.register(), lt.register(), L.register(), nt.register(), ht.register(), ct.register(), ut.register(), dt.register(), M.register(), pt.register(), mt.register(), rt.register(), H.register(), f.register(), gt.register();
}
export {
  W as UIAppBar,
  _ as UIAppBarItem,
