...
var r = (o, t, e) => (le(o, typeof t != "symbol" ? t + "" : t, e), e), Zt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var i = (o, t, e) => (Zt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), n = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, c = (o, t, e, s) => (Zt(o, t, "write to private field"), s ? s.call(o, e) : t.set(o, e), e);
var g;
class q {
  constructor() {
    /**
...
let pe = (Gt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Pt(i(this, p), { centered: !0 }), i(this, p).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
let me = (It = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Pt(i(this, d), { centered: !0 }), i(this, d).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const I = class I extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = fe, this.cleanup = new h(), this.ui = new ve(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
let Ee = (_t = class {
  ...
  enableRipple() {
    i(this, A) || (this.removeRipple = Pt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
...
let Re = (te = class {
  ...
  get value() {
    return i(this, v).getAttribute("value");
  }
  set value(t) {
    i(this, v).setAttribute("value", t);
  }
  get selected() {
    return i(this, v).hasAttribute("selected");
  }
  set selected(t) {
    t ? i(this, v).setAttribute("selected", "") : i(this, v).removeAttribute("selected");
  }
}, v = new WeakMap(), te);
...
class Je {
  ...
  enableAutoMode() {
    ...
    c(this, f, window.matchMedia("(prefers-color-scheme: dark)")), i(this, f).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, f));
  }
  disableAutoMode() {
    this.removeMedia();
  }
   ...
   */
  removeMedia() {
    i(this, f) && (i(this, f).removeEventListener("change", this.mediaChangeHandler), c(this, f, null));
  }
}
f = new WeakMap();
const J = class J extends HTMLElement {
...
r(at, "register", () => customElements.define("ui-svg-back-arrow-navigation", at));
let Bt = at;
const De = l`
<style>
    :host {
...
r(lt, "register", () => customElements.define("ui-svg-chevron-down", lt));
let Jt = lt;
const Xe = l`
<style>
    :host {
...
r(ct, "register", () => customElements.define("ui-svg-close", ct));
let Yt = ct;
const Fe = l`
<style>
    :host {
...
r(ht, "register", () => customElements.define("ui-svg-delete-recycle-bin", ht));
let Dt = ht;
const Ke = l`
<style>
    :host {
...
r(ut, "register", () => customElements.define("ui-svg-edit2", ut));
let Xt = ut;
const Qe = l`
<style>
    :host {
...
r(dt, "register", () => customElements.define("ui-svg-pdf-document", dt));
let Ft = dt;
const We = l`
<style>
    :host {
...
r(pt, "register", () => customElements.define("ui-svg-settings", pt));
let Kt = pt;
const Ge = l`
<style>
    :host {
...
r(gt, "register", () => customElements.define("ui-svg-today-outline", gt));
let Qt = gt;
export {
  Bt as SvgBackArrowNavigation,
  Jt as SvgChevronDown,
  Yt as SvgClose,
  Dt as SvgDeleteRecycleBin,
  Xt as SvgEdit2,
  Ft as SvgPDFDocument,
  Kt as SvgSettings,
