...
s(X, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", X);
});
let it = X;
...
s(B, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", B);
});
let nt = B;
const Zt = a`
...
s(D, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", D);
});
let bt = D;
const K = class K extends HTMLElement {
  constructor() {
    ...
    const t = (i) => {
      const r = async (l) => {
        (l.composedPath() || []).forEach((u) => {
          u instanceof F && ([...this.querySelectorAll("ui-select-option")].forEach(
...
s(W, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", W);
});
let vt = W;
const q = class q extends HTMLElement {
  constructor() {
...
}), s(z, "observedAttributes", ["current"]);
let wt = z;
...
}), s(O, "observedAttributes", ["auto", "mode"]);
let At = O;
...
let Lt = U;
function It() {
  ot.register(), it.register(), rt.register(), st.register(), nt.register(), ct.register(), ht.register(), dt.register(), ut.register(), V.register(), at.register(), lt.register(), pt.register(), mt.register(), ft.register(), F.register(), vt.register(), yt.register(), kt.register(), wt.register(), xt.register(), Et.register(), Ct.register(), Rt.register(), Lt.register(), gt.register(), bt.register(), w.register(), At.register();
}
export {
  Pt as CleanUp,
  b as Events,
