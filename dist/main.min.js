...
var s = (o, t, e) => xt(o, typeof t != "symbol" ? t + "" : t, e), Ct = (o, t, e) => t.has(o) || gt("Cannot " + e);
var h = (o, t, e) => (Ct(o, t, "read from private field"), e ? e.call(o) : t.get(o)), bt = (o, t, e) => t.has(o) ? gt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const mt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const R = class R extends HTMLElement {
  ...
  /** @param {string | null} value */
  setNoBg(t) {
    t === null ? this.shadowRoot.querySelector(".background").style.display = "none" : this.shadowRoot.querySelector(".background").style.display = null;
  }
};
s(R, "register", () => {
