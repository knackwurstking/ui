...
i(x, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", x);
}), i(x, "observedAttributes", ["open"]);
let U = x;
...
i(A, "register", () => {
  z.register(), k.register(), customElements.get("ui-label") || customElements.define("ui-label", A);
}), i(A, "observedAttributes", ["ripple", "secondary", "primary"]);
let st = A;
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), r = async (n) => {
      (n.composedPath() || []).forEach((l) => {
        l instanceof $ && ([...this.querySelectorAll("ui-select-option")].forEach(
...
}), i(R, "observedAttributes", ["current"]);
let ut = R;
...
i(L, "register", () => {
  q.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", L);
}), i(L, "observedAttributes", ["use-history"]);
let ct = L;
...
i(H, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", H);
}), i(H, "observedAttributes", ["use-storage", "storage-prefix"]);
let pt = H;
...
}), i(M, "observedAttributes", ["auto", "mode"]);
let gt = M;
const Y = class Y extends HTMLElement {
  constructor() {
    super();
...
let mt = Y;
function $t() {
  Q.register(), X.register(), W.register(), B.register(), _.register(), I.register(), et.register(), tt.register(), U.register(), it.register(), rt.register(), ot.register(), nt.register(), lt.register(), $.register(), at.register(), ht.register(), ut.register(), dt.register(), ct.register(), q.register(), pt.register(), mt.register(), st.register(), z.register(), k.register(), gt.register();
}
export {
  X as UIAppBar,
  Q as UIAppBarItem,
