...
const vt = class vt extends HTMLElement {
  ...
  disconnectedCallback() {
    var e;
    this.removeEventListener("click", s(this, E)), (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", s(this, Z));
  }
};
Z = new WeakMap(), E = new WeakMap(), r(vt, "register", () => customElements.define("ui-select", vt));
let it = vt;
var W, C, J, Gt;
let We = (Gt = class {
  /** @param {Lang} root */
