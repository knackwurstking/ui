...
W = new WeakMap(), D = new WeakSet(), Ze = function() {
  this.shadowRoot.querySelector("style").textContent = `
        ...
        `;
}, r(T, "register", () => customElements.define("ui-flex-grid-item", T)), r(T, "observedAttributes", ["flex"]);
let oe = T;
...
X = new WeakMap(), x = new WeakMap(), r(ke, "register", () => customElements.define("ui-select", ke));
let le = ke;
var Y, k, K, st;
let Kt = (st = class {
  /** @param {Lang} root */
  constructor(e) {
     ...
     */
    n(this, K, void 0);
    a(this, Y, e), a(this, k, new G()), this.langType = null;
  }
   ...
   */
  new(e, t) {
    this.langType = e, a(this, K, t), s(this, k).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
...
}, Y = new WeakMap(), k = new WeakMap(), K = new WeakMap(), st);
var Le, bt;
const $ = class $ extends HTMLElement {
  ...
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "current":
        l !== null && d(this, Le, bt).call(this, l);
        break;
    }
  }
};
Le = new WeakSet(), bt = async function(t) {
...
let Gt = (it = class {
  ...
  setPage(e) {
    if (this.stack.push(
      // @ts-expect-error
      s(this, y).appendChild(s(this, L)[e]().children[0])
    ), this.stack.length > 1) {
...
}, y = new WeakMap(), L = new WeakMap(), it);
...
r(Te, "register", () => customElements.define("ui-svg-delete-recycle-bin", Te));
let Be = Te;
const Mt = document.createElement("template");
Mt.innerHTML = `
<style>
