...
const v = class v extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
            ...
            <slot></slot>
        `;
    for (const [e, t] of Object.entries(v.defaultAttr))
      !this.hasAttribute(e) && t !== null && this.setAttribute(e, t);
  }
  render() {
  }
...
i(S, "register", () => {
  $.register(), w.register(), customElements.get("ui-label") || customElements.define("ui-label", S);
    ...
    switch (t) {
      case "title":
        ...
        if (s === null && n && (this.removeChild(n), n = null), s === null)
          return;
        n || (n = new w(), n.slot = "title", this.appendChild(n)), n.innerHTML = s;
        break;
      case "type":
...
`, E = class E extends HTMLElement {
  ...
  attributeChangedCallback(t, o, s) {
    switch (t) {
      case "title":
        let n = this.querySelector('[slot="title"]');
        s === null && n && (this.removeChild(n), n = null), n || (n = new w(), n.slot = "title", this.appendChild(n)), n.innerHTML = s || "";
        break;
      case "value":
        this.ui.setValue(s);
        break;
...
let mt = Y;
function $t() {
  Q.register(), X.register(), W.register(), B.register(), _.register(), I.register(), et.register(), tt.register(), U.register(), it.register(), st.register(), ot.register(), nt.register(), lt.register(), M.register(), at.register(), ht.register(), ut.register(), ct.register(), dt.register(), z.register(), pt.register(), mt.register(), rt.register(), $.register(), w.register(), gt.register();
}
export {
  X as UIAppBar,
  Q as UIAppBarItem,
