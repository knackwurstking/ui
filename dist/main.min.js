...
var Ce = (i, t, e) => t in i ? ke(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var r = (i, t, e) => (Ce(i, typeof t != "symbol" ? t + "" : t, e), e), Vt = (i, t, e) => {
  if (!t.has(i))
    throw TypeError("Cannot " + e);
};
var s = (i, t, e) => (Vt(i, t, "read from private field"), e ? e.call(i) : t.get(i)), n = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, l = (i, t, e, o) => (Vt(i, t, "write to private field"), o ? o.call(i, e) : t.set(i, e), e);
const Zt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function Ee(i, t = {}) {
  ...
  const e = () => {
    const b = [...i.parentNode.children].indexOf(i);
...
class H {
  ...
  off(t, e) {
    ...
    let o = !1, a = 0;
    for (const b of s(this, d)[t])
      b === e && (s(this, d)[t].splice(a, 1), o = !0), a++;
    if (!o)
...
let ze = (Kt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = jt(s(this, q), { centered: !0 }));
  }
  disableRipple() {
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0)), this.ui = new ze(this);
  }
  connectedCallback() {
...
let Ue = (Qt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = jt(s(this, P), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
const A = class A extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ae.content.cloneNode(!0)), this.ui = new Ue(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
let qe = (Wt = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, x, void 0);
    l(this, w, t), l(this, y, e), this.events = new H(), l(this, x, document.createElement("h4")), s(this, x).slot = "title", s(this, w).appendChild(s(this, x));
  }
  get dialog() {
    return s(this, y);
  }
...
const ft = class ft extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(le.content.cloneNode(!0)), this.ui = new qe(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    const e = this.shadowRoot.querySelector("header ui-icon-button");
    e.addEventListener("click", s(this, V)), e.addEventListener("click", s(this, D));
  }
  disconnectedCallback() {
    const e = this.shadowRoot.querySelector("header ui-icon-button");
    e.removeEventListener("click", s(this, V)), e.removeEventListener("click", s(this, D));
  }
};
...
`, $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
`, j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = De, this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
`, I = class I extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ze, this.ui = new Je(this);
  }
};
...
const bt = class bt extends HTMLElement {
  ...
  async onClickOptions(e) {
    this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", s(this, Z))) : setTimeout(
      () => this.removeEventListener("click", s(this, Z))
    );
  }
  // }}}
};
...
let Ye = (Gt = class {
  ...
  getFallbackElement() {
    return s(this, J).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, l(this, B, e), s(this, C).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var o;
    return (o = s(this, B)) == null ? void 0 : o[t][e];
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, o = !1) {
    ...
    return o && e(this.langType), s(this, C).on(t, e);
  }
...
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(he.content.cloneNode(!0)), this.ui = new We(this);
  }
};
...
let Fe = (se = class {
  ...
  set(t, e, o = !1) {
    if (o && this.enableLocalStorage) {
      ...
      s(this, v)[t] = e;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + t.toString(), JSON.stringify(s(this, v)[t])), this.events.dispatch(t, s(this, v)[t]);
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
}, f = new WeakMap(), v = new WeakMap(), se);
...
let Ge = (ie = class {
  ...
  enableRipple() {
    s(this, T) || (this.removeRipple = jt(s(this, c)), s(this, c).style.cursor = "pointer", this._startInputHandling());
  }
  disableRipple() {
    s(this, T) && s(this, T).call(this), this._stopInputHandling();
  }
  _startInputHandling() {
    s(this, S) || (s(this, c).addEventListener("click", s(this, X)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", s(this, Y));
    }), l(this, S, !0));
  }
  _stopInputHandling() {
    s(this, c).removeEventListener("click", s(this, X)), [...s(this, c).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", s(this, Y));
    }), l(this, S, !1);
  }
}, c = new WeakMap(), S = new WeakMap(), X = new WeakMap(), Y = new WeakMap(), T = new WeakMap(), ie);
const U = class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(we.content.cloneNode(!0)), this.ui = new Ge(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
async function es() {
  K.register(), W.register(), Q.register(), F.register(), G.register(), tt.register(), et.register(), st.register(), O.register(), it.register(), rt.register(), ot.register(), nt.register(), at.register(), lt.register(), dt.register(), ht.register(), ct.register(), ut.register(), _.register();
}
async function ss() {
