...
var Ct = (o, t, e) => t in o ? xt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var s = (o, t, e) => Ct(o, typeof t != "symbol" ? t + "" : t, e), At = (o, t, e) => t.has(o) || gt("Cannot " + e);
var h = (o, t, e) => (At(o, t, "read from private field"), e ? e.call(o) : t.get(o)), bt = (o, t, e) => t.has(o) ? gt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const mt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function Rt(o, t = {}) {
  ...
  const e = () => {
    ...
    o.draggable = !0, o.ondragstart = (a) => {
      ...
      a.preventDefault(), t.onDragging && t.onDragging(n);
    }, o.ondrop = (a) => {
...
class d {
  ...
  off(t, e) {
    ...
    for (const n of h(this, c)[t])
      n === e && (h(this, c)[t].splice(r, 1), i = !0), r++;
    if (!i)
...
const Mt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: l,
  isAndroid: Et
}, Symbol.toStringTag, { value: "Module" })), M = class M extends HTMLElement {
  constructor() {
...
s(M, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", M);
});
let B = M;
...
s(H, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", H);
});
let J = H;
...
}), s(p, "observedAttributes", ["noripple"]);
let K = p;
...
s(g, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", g);
}), s(g, "observedAttributes", ["noripple"]);
let Z = g;
...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new wt(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
  ...
  shadowRender() {
    this.shadowRenderCleanUp.run(), this.shadowRoot.innerHTML = l`
      <style>
        * {
          box-sizing: border-box;
        }
...
s(m, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", m);
}), s(m, "observedAttributes", ["open"]);
let W = m;
const kt = l`
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
`, f = class f extends HTMLElement {
  ...
  shadowRender() {
    ...
    `, this.shadowRoot.querySelector("ui-drawer-group-item").addEventListener("click", () => {
   ...
   */
  setGroupTitle(t) {
    let e = this.shadowRoot.querySelector(".title");
    if (!t) {
...
s(z, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", z);
});
let _ = z;
...
const k = class k extends HTMLElement {
   ...
   */
  setPrimary(t) {
    this.shadowRoot.querySelector("ui-primary").innerHTML = t || "";
  }
  /**
   * @param {string | null} value
   */
  setSecondary(t) {
    this.shadowRoot.querySelector("ui-secondary").innerHTML = t || "";
  }
  /** @private */
  enableRipple() {
...
s(k, "register", () => {
  customElements.get("ui-label") || customElements.define("ui-label", k);
}), s(k, "observedAttributes", ["ripple", "secondary", "primary"]);
let et = k;
...
s($, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", $);
});
let it = $;
...
const x = class x extends HTMLElement {
  ...
  setTitle(t) {
    ...
    !t && e && this.removeChild(e), t && (e || (e = new L(), e.slot = "title", this.appendChild(e)), e.innerHTML = t);
  }
  /**
...
const P = class P extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = `
            ...
            <div class="options">
                <div class="icon"><ui-svg>${kt}</ui-svg></div>
    ...
    const t = (i) => {
      const r = async (n) => {
        (n.composedPath() || []).forEach((a) => {
          a instanceof T && ([...this.querySelectorAll("ui-select-option")].forEach(
            (Y) => Y.removeAttribute("selected")
          ), a.setAttribute("selected", ""), this.ui.events.dispatch("change", a));
        });
      };
      this.classList.toggle("open") ? (i.stopPropagation(), this.addEventListener("click", r)) : setTimeout(
...
s(P, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", P);
});
let rt = P;
const Lt = l`
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, C = class C extends HTMLElement {
  ...
  shadowRender() {
    ...
    e.type = "search", e.addEventListener("keydown", async (r) => {
      this.ui.nosubmit || r.key === "Enter" && t.click();
    });
    let i = null;
  ...
  setStorageKey(t) {
    ...
    e.value = localStorage.getItem(this.ui.storageprefix + t) || "", this.ui.events.dispatch("storage", e.value);
  }
};
s(C, "register", () => {
  customElements.get("ui-search") || customElements.define("ui-search", C);
}), s(C, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
}), s(A, "observedAttributes", ["current"]);
let nt = A;
...
s(R, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", R);
}), s(R, "observedAttributes", ["nobg"]);
let lt = R;
...
s(F, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", F);
});
let ct = F;
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.pages = {}, this.stack = [], this.onpopstate = () => this.goBack(), this.ui = {
      ...
      set(t, e = null, i = !1) {
        ...
        this.root.stack.push(this.root.appendChild(r)), typeof e == "function" && setTimeout(() => e(r));
        let n = null;
  ...
  goBack() {
    ...
    this.stack.length > 0 && (this.stack[this.stack.length - 1].parentElement || this.appendChild(
...
s(O, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", O);
});
let dt = O;
...
}), s(E, "observedAttributes", ["storageprefix"]);
let ht = E;
const S = class S extends HTMLElement {
  constructor() {
    super(), this.mediaHandler = null, this.themes = {}, this.currentTheme = null, this.ui = {
      root: this,
      get auto() {
  ...
  setAuto(t, e = document.body) {
    if (t === null) {
      ...
      this.media.removeEventListener(
        "change",
        this.mediaHandler
      ), this.media = null, this.mediaHandler = null;
      return;
    }
...
}), s(S, "observedAttributes", ["auto", "mode"]);
let ut = S;
...
let pt = N;
function Ht() {
  J.register(), B.register(), K.register(), Z.register(), X.register(), Q.register(), _.register(), G.register(), W.register(), U.register(), I.register(), tt.register(), ot.register(), st.register(), T.register(), rt.register(), at.register(), nt.register(), lt.register(), dt.register(), ct.register(), ht.register(), pt.register(), et.register(), it.register(), L.register(), ut.register();
}
export {
  B as UIAppBar,
  J as UIAppBarItem,
