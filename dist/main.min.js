...
var ke = (o, t, e) => t in o ? Le(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => (ke(o, typeof t != "symbol" ? t + "" : t, e), e), At = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var i = (o, t, e) => (At(o, t, "read from private field"), e ? e.call(o) : t.get(o)), l = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, a = (o, t, e, s) => (At(o, t, "write to private field"), s ? s.call(o, e) : t.set(o, e), e);
var d = (o, t, e) => (At(o, t, "access private method"), e);
var c;
class Rt {
  constructor() {
    /**
  ...
  addListener(t, e) {
    ...
    return i(this, c)[t] || (i(this, c)[t] = []), i(this, c)[t].push(e), () => {
  ...
  removeListener(t, e) {
    ...
    let s = !1, n = 0;
    for (const $t of i(this, c)[t])
      $t === e && (i(this, c)[t].splice(n, 1), s = !0), n++;
    if (!s)
...
let $e = (Dt = class {
  ...
  getLeftSlot() {
    return [...i(this, f).querySelectorAll('[slot="left"]')];
  }
  getCenterSlot() {
    return [...i(this, f).querySelectorAll('[slot="center"]')];
  }
  getRightSlot() {
    return [...i(this, f).querySelectorAll('[slot="right"]')];
  }
}, f = new WeakMap(), Dt);
...
const dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Gt.content.cloneNode(!0)), this.ui = new $e(this);
  }
};
...
let Ae = (Vt = class {
  ...
  constructor(t) {
    /** @type {Button} */
    l(this, U, void 0);
    a(this, U, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = Ht(i(this, U), { centered: !0 }));
  }
  disableRipple() {
...
const L = class L extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ft.content.cloneNode(!0)), this.ui = new Ae(this);
  }
  connectedCallback() {
...
let je = (Wt = class {
  ...
  constructor(t) {
    /** @type {IconButton} */
    l(this, z, void 0);
    a(this, z, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = Ht(i(this, z), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
const k = class k extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(_t.content.cloneNode(!0)), this.ui = new je(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
const E = class E extends HTMLElement {
  constructor() {
    ...
    /** @type {string | null} */
    l(this, q, "1");
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ee.content.cloneNode(!0));
  }
  connectedCallback() {
    d(this, P, jt).call(this);
  }
  attributeChangedCallback(e, s, n) {
    switch (e) {
      case "flex":
        a(this, q, n !== null ? n : "1"), d(this, P, jt).call(this);
        break;
    }
  }
};
q = new WeakMap(), P = new WeakSet(), jt = function() {
...
const M = class M extends HTMLElement {
  constructor() {
    ...
    /** @type {string | null} */
    l(this, O, "0");
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(se.content.cloneNode(!0));
  }
  connectedCallback() {
    d(this, Z, Nt).call(this);
  }
  attributeChangedCallback(e, s, n) {
    switch (e) {
      case "gap":
        a(this, O, n !== null ? n : "0"), d(this, Z, Nt).call(this);
        break;
    }
  }
};
O = new WeakMap(), Z = new WeakSet(), Nt = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --row-gap: ${i(this, O)};
                display: flex;
...
const T = class T extends HTMLElement {
  constructor() {
    ...
    /** @type {string | null} */
    l(this, D, "0");
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ie.content.cloneNode(!0));
  }
  connectedCallback() {
    d(this, pt, oe).call(this);
  }
  attributeChangedCallback(e, s, n) {
    switch (e) {
      case "gap":
...
D = new WeakMap(), pt = new WeakSet(), oe = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --gap: ${i(this, D)};
                display: flex;
...
const S = class S extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(re.content.cloneNode(!0)), this.ui = new Ne();
  }
  attributeChangedCallback(t, e, s) {
    switch (t) {
      case "value":
...
r(S, "register", () => customElements.define("ui-select-option", S)), r(S, "observedAttributes", ["value", "selected"]);
let I = S;
...
const mt = class mt extends HTMLElement {
  constructor() {
    ...
    /** @param {Event} ev */
    l(this, V, (e) => {
      this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", i(this, v))) : setTimeout(
        () => this.removeEventListener("click", i(this, v))
      );
    });
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0));
  }
  connectedCallback() {
    var e;
    (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", i(this, V)), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var e;
    this.removeEventListener("click", i(this, v)), (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", i(this, V));
  }
};
V = new WeakMap(), v = new WeakMap(), r(mt, "register", () => customElements.define("ui-select", mt));
let et = mt;
var W, w, J, Jt;
let Ie = (Jt = class {
  /** @param {Lang} root */
  constructor(t) {
     ...
     */
    l(this, J, void 0);
    a(this, W, t), a(this, w, new Rt()), this.langType = null;
  }
   ...
   */
  new(t, e) {
    this.langType = t, a(this, J, e), i(this, w).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var s;
    return (s = i(this, J)) == null ? void 0 : s[t][e];
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, s = !1) {
    ...
    return s && e(this.langType), i(this, w).addListener(t, e);
  }
}, W = new WeakMap(), w = new WeakMap(), J = new WeakMap(), Jt);
var gt, le;
const R = class R extends HTMLElement {
  ...
  attributeChangedCallback(e, s, n) {
    switch (e) {
      case "current":
        n !== null && d(this, gt, le).call(this, n);
        break;
    }
  }
};
gt = new WeakSet(), le = async function(e) {
  const s = this.querySelector(`ui-lang-type[name="${e}"]`) || this.ui.getFallbackElement();
  if (!s)
    return;
  if (!s.ui.href)
    throw "Missing href attribute!";
  const n = await fetch(s.ui.href);
  this.ui.new(s, await n.json());
}, r(R, "register", () => customElements.define("ui-lang", R)), r(R, "observedAttributes", ["current"]);
let st = R, Ue = class {
  constructor() {
...
r(H, "register", () => customElements.define("ui-lang-type", H)), r(H, "observedAttributes", ["name", "href", "fallback"]);
let it = H;
...
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ae.content.cloneNode(!0)), this.ui = new ze();
  }
  attributeChangedCallback(t, e, s) {
    switch (t) {
      case "name":
...
let qe = (Xt = class {
  ...
  constructor(t) {
     ...
     */
    l(this, y, {});
    a(this, b, t), this.events = new Rt(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    t.ontransitionend = () => {
      t.ontransitionend = null, i(this, b).removeChild(t);
    }, this.stack.length && i(this, b).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      this.appendChild(i(this, y)[t]().children[0])
    ), this.stack.length > 1) {
...
}, b = new WeakMap(), y = new WeakMap(), Xt);
const ft = class ft extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ce.content.cloneNode(!0)), this.ui = new qe(this);
  }
};
r(ft, "register", () => customElements.define("ui-stack-layout", ft));
let rt = ft;
var p, Yt;
let Pe = (Yt = class {
  constructor() {
    /** @type {any} */
    l(this, p, {});
    this.events = new Rt(), this.localStoragePrefix = "", this.enableLocalStorage = !1;
  }
  /**
   * @param {keyof T} key
   */
  ...
  set(t, e, s = !1) {
    if (s && this.enableLocalStorage) {
      ...
      i(this, p)[t] = e;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + t.toString(), JSON.stringify(i(this, p)[t])), this.events.dispatchWithData(t, i(this, p)[t]);
  }
  /**
   * @template {keyof T} K
   * @param {K} key
  ...
  on(t, e, s = !1) {
    if (typeof e != "function")
      throw "callback is not a function";
    return s && e(this.get(t)), this.events.addListener(t, e);
  }
}, p = new WeakMap(), Yt);
const A = class A extends HTMLElement {
  constructor() {
    super(), this.ui = new Pe();
  }
  attributeChangedCallback(t, e, s) {
    switch (t) {
...
r(vt, "register", () => customElements.define("ui-svg-back-arrow-navigation", vt));
let It = vt;
...
r(wt, "register", () => customElements.define("ui-svg-chevron-down", wt));
let Ut = wt;
...
const bt = class bt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ue.content.cloneNode(!0));
  }
};
r(bt, "register", () => customElements.define("ui-svg-delete-recycle-bin", bt));
let zt = bt;
...
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(pe.content.cloneNode(!0));
  }
};
r(yt, "register", () => customElements.define("ui-svg-edit2", yt));
let qt = yt;
...
r(xt, "register", () => customElements.define("ui-svg-pdf-document", xt));
let Pt = xt;
...
const Ct = class Ct extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0));
  }
};
r(Ct, "register", () => customElements.define("ui-svg-settings", Ct));
let Ot = Ct;
...
r(Lt, "register", () => customElements.define("ui-svg-today-outline", Lt));
let Zt = Lt;
const g = {
...
<slot></slot>
`;
var m, u, x, X, Y, C, kt, we, Et, be, Bt;
let Oe = (Bt = class {
  /** @param {Label} root */
  constructor(t) {
    l(this, kt);
    ...
    l(this, Y, async (t) => t.stopPropagation());
    /** @type {() => void} */
    l(this, C, void 0);
    a(this, m, t);
  }
  enableRipple() {
    i(this, C) || (this.removeRipple = Ht(i(this, m)), i(this, m).style.cursor = "pointer", d(this, kt, we).call(this));
  }
  disableRipple() {
    i(this, C) && i(this, C).call(this), d(this, Et, be).call(this);
  }
}, m = new WeakMap(), u = new WeakMap(), x = new WeakMap(), X = new WeakMap(), Y = new WeakMap(), C = new WeakMap(), kt = new WeakSet(), we = function() {
  i(this, x) || (a(this, u, i(this, m).querySelector("input")), i(this, u) && (i(this, m).addEventListener("click", i(this, X)), i(this, u).addEventListener("click", i(this, Y))), a(this, x, !0));
}, Et = new WeakSet(), be = function() {
  i(this, u) && (i(this, m).removeEventListener("click", i(this, X)), i(this, u).removeEventListener("click", i(this, Y))), a(this, x, !1);
}, Bt);
const j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ve.content.cloneNode(!0)), this.ui = new Oe(this);
  }
  attributeChangedCallback(t, e, s) {
    switch (t) {
      case "ripple":
...
r(Mt, "register", () => customElements.define("ui-primary", Mt));
let at = Mt;
...
r(Tt, "register", () => customElements.define("ui-secondary", Tt));
let ct = Tt;
var h, St, Ce;
class Ze {
  constructor() {
...
async function Ve() {
  B.register(), Q.register(), K.register(), G.register(), F.register(), _.register(), tt.register(), I.register(), et.register(), it.register(), st.register(), ot.register(), rt.register(), nt.register(), ct.register(), at.register(), lt.register(), ht.register();
}
async function We() {
  g.BackArrowNavigation.register(), g.ChevronDown.register(), g.DeleteRecycleBin.register(), g.Edit2.register(), g.PDFDocument.register(), g.Settings.register(), g.TodayOutline.register();
}
const ss = {
  ...He,
  wc: De,
