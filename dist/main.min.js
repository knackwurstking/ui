...
function Yt(o, { onDragEnd: t = null, onDragStart: e = null }) {
  let i = null, s = null, a = null, c = !1, u = null, g = null;
  const F = (l) => {
    !i && Array.from(l.currentTarget.classList).includes("draggable") && (s = (/* @__PURE__ */ new Date()).getTime(), i = l.currentTarget, a || clearTimeout(a), a = setTimeout(() => {
      u = i.style.color, g = i.style.backgroundColor, i.style.color = "var(--ui-primary-color)", i.style.backgroundColor = "var(--ui-primary-bgColor)", o.classList.add("dragging"), c = !0, e && e();
    }, 200));
  }, Et = (l) => {
    if (!s || !i) return;
    if ((/* @__PURE__ */ new Date()).getTime() - s < 200) {
      _();
      return;
    }
    l.preventDefault(), c || (c = !0, e && e());
    const m = !!l.targetTouches && l.targetTouches[0] || l;
    ...
    a !== null && (clearTimeout(a), a = null), i && (i.style.color = u, i.style.backgroundColor = g, i = null), s = null, o.classList.remove("dragging"), c && (t && t(), c = !1);
  };
  function jt(l, m) {
    $t(l, m) ? o.insertBefore(l, m) : o.insertBefore(l, m.nextElementSibling);
  }
  function $t(l, m) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (l) => {
        l.classList.add("draggable"), l.onmousedown = F, l.ontouchstart = F, l.onmousemove = Et, l.ontouchmove = Et, l.onmouseup = _, l.ontouchend = _;
      }
    );
  })(), {
    destroy: () => {
...
class d {
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const a of b(this, p)[t])
      a === e && (b(this, p)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
function Tt(o, t) {
  ...
  if (t.centered)
    ...
    e.style.top = `${a.clientY - i.top}px`, e.style.left = `${a.clientX - i.left}px`;
  }
