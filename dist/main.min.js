...
var Te = (s, t, e) => t in s ? Se(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var r = (s, t, e) => (Te(s, typeof t != "symbol" ? t + "" : t, e), e), Vt = (s, t, e) => {
  if (!t.has(s))
...
}, l = (s, t, e, o) => (Vt(s, t, "write to private field"), o ? o.call(s, e) : t.set(s, e), e);
const Zt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class H {
  ...
  off(t, e) {
    ...
    for (const b of i(this, d)[t])
      b === e && (i(this, d)[t].splice(a, 1), o = !0), a++;
    if (!o)
...
function jt(s, t = {}) {
  ...
  return s.classList.add("ripple-container"), s.style.overflow = "hidden", s.addEventListener("pointerdown", o), s.addEventListener("pointerup", a), s.addEventListener("pointerleave", a), () => {
    s.classList.remove("ripple-container"), s.removeEventListener("pointerdown", o), s.removeEventListener("pointerup", a), s.removeEventListener("pointerleave", a);
  };
}
...
let qe = (Kt = class {
  ...
  constructor(t) {
    /** @type {Button} */
    n(this, q, void 0);
    l(this, q, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = jt(i(this, q), { centered: !0 }));
  }
  disableRipple() {
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0)), this.ui = new qe(this);
  }
  connectedCallback() {
...
r(gt, "register", () => customElements.define("ui-card", gt));
let F = gt;
const Ve = `
<style>
    :host {
...
r(mt, "register", () => customElements.define("ui-container", mt));
let G = mt;
...
let Ze = (Wt = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, x, void 0);
    l(this, w, t), l(this, y, e), this.events = new H(), l(this, x, document.createElement("h4")), i(this, x).slot = "title", i(this, w).appendChild(i(this, x));
  }
  get dialog() {
    return i(this, y);
  }
...
const ft = class ft extends HTMLElement {
  constructor() {
    super();
    n(this, D, () => this.ui.events.dispatch("close", null));
    n(this, V, () => this.ui.close());
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(le.content.cloneNode(!0)), this.ui = new Ze(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    const e = this.shadowRoot.querySelector("header ui-icon-button");
    e.addEventListener("click", i(this, V)), e.addEventListener("click", i(this, D));
  }
  disconnectedCallback() {
    const e = this.shadowRoot.querySelector("header ui-icon-button");
    e.removeEventListener("click", i(this, V)), e.removeEventListener("click", i(this, D));
  }
};
D = new WeakMap(), V = new WeakMap(), r(ft, "register", () => customElements.define("ui-dialog", ft));
let _ = ft;
const Jt = "1", ce = document.createElement("template");
ce.innerHTML = `
<style></style>
<slot></slot>
`;
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ce.content.cloneNode(!0)), this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
let tt = $;
const Bt = "0", he = document.createElement("template");
he.innerHTML = `
<style></style>
<slot></slot>
`;
...
let et = j;
const Xt = "0", de = document.createElement("template");
de.innerHTML = `
<style></style>
<slot></slot>
`;
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ue.content.cloneNode(!0)), this.ui = new Je(this);
  }
};
...
const bt = class bt extends HTMLElement {
  constructor() {
    ...
    n(this, Z, async (e) => {
      (e.composedPath() || []).forEach((o) => {
        o instanceof O && ([...this.querySelectorAll("ui-select-option")].forEach(
          (a) => a.removeAttribute("selected")
        ), o.setAttribute("selected", ""), this.ui.events.dispatch("change", o));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Be, this.cleanup = [], this.ui = new Xe();
  }
  // }}}
  connectedCallback() {
  ...
  async onClickOptions(e) {
    this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", i(this, Z))) : setTimeout(
      () => this.removeEventListener("click", i(this, Z))
    );
  }
  // }}}
};
...
let Ye = (Gt = class {
  ...
  constructor(t) {
     ...
     */
    n(this, B, void 0);
    l(this, J, t), l(this, C, new H()), this.langType = null;
  }
   ...
   */
  new(t, e) {
    this.langType = t, l(this, B, e), i(this, C).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var o;
    return (o = i(this, B)) == null ? void 0 : o[t][e];
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, o = !1) {
    ...
    return o && e(this.langType), i(this, C).on(t, e);
  }
}, J = new WeakMap(), C = new WeakMap(), B = new WeakMap(), Gt);
...
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(pe.content.cloneNode(!0)), this.ui = new Qe(this);
  }
};
...
let We = (ee = class {
  ...
  constructor(t) {
     ...
     */
    n(this, M, {});
    l(this, k, t), this.events = new H(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      i(this, k).appendChild(i(this, M)[t]().children[0])
    ), this.stack.length > 1) {
...
}, k = new WeakMap(), M = new WeakMap(), ee);
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0)), this.ui = new We(this);
  }
};
...
let Fe = (ie = class {
  ...
  constructor(t) {
    ...
    /** @type {any} */
    n(this, v, {});
    l(this, f, t), this.events = new H();
  }
  get localStoragePrefix() {
    return i(this, f).getAttribute("local-storage-prefix");
  }
  set localStoragePrefix(t) {
    i(this, f).setAttribute("local-storage-prefix", t);
  }
  get enableLocalStorage() {
    return i(this, f).hasAttribute("enable-local-storage");
  }
  set enableLocalStorage(t) {
    t ? i(this, f).setAttribute("enable-local-storage", "") : i(this, f).removeAttribute("enable-local-storage");
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
}, f = new WeakMap(), v = new WeakMap(), ie);
...
const Ct = class Ct extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(fe.content.cloneNode(!0));
  }
};
...
r(Et, "register", () => customElements.define("ui-svg-close", Et));
let Nt = Et;
...
r(St, "register", () => customElements.define("ui-svg-edit2", St));
let Ot = St;
...
r(Tt, "register", () => customElements.define("ui-svg-pdf-document", Tt));
let qt = Tt;
...
let Ge = (se = class {
  ...
  enableRipple() {
    i(this, T) || (this.removeRipple = jt(i(this, c)), i(this, c).style.cursor = "pointer", this._startInputHandling());
  }
  disableRipple() {
    i(this, T) && i(this, T).call(this), this._stopInputHandling();
  }
  _startInputHandling() {
    i(this, S) || (i(this, c).addEventListener("click", i(this, X)), this.getInputSlot().forEach((t) => {
...
}, c = new WeakMap(), S = new WeakMap(), X = new WeakMap(), Y = new WeakMap(), T = new WeakMap(), se);
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0)), this.ui = new Ge(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
r(N, "register", () => customElements.define("ui-label", N)), r(N, "observedAttributes", ["ripple", "secondary", "primary"]);
let ct = N;
...
const At = class At extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ce.content.cloneNode(!0));
  }
};
r(At, "register", () => customElements.define("ui-primary", At));
let ht = At;
...
async function ei() {
  K.register(), W.register(), Q.register(), F.register(), G.register(), tt.register(), et.register(), it.register(), O.register(), st.register(), rt.register(), ot.register(), nt.register(), at.register(), lt.register(), dt.register(), ht.register(), ct.register(), ut.register(), _.register();
}
async function ii() {
