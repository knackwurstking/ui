...
var s = (o, t, e) => (jt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), a = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, h = (o, t, e, i) => (jt(o, t, "write to private field"), i ? i.call(o, e) : t.set(o, e), e);
const Nt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const l = String.raw, ze = String.raw;
class c {
  constructor() {
    this.callbacks = [];
  }
...
const Si = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: l,
  isAndroid: Se
}, Symbol.toStringTag, { value: "Module" })), Tt = "1", qe = l`
<style></style>
<slot></slot>
`;
let je = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : Tt;
  }
  set flex(t) {
...
const q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = qe, this.cleanup = new c(), this.ui = new je(this), this.updateStyle();
  }
  connectedCallback() {
  }
...
const tt = class tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Be, this.cleanup = new c(), this.ui = new De(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let Ve = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Mt(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Fe, this.setAttribute("role", "button"), this.cleanup = new c(), this.ui = new Ve(this);
  }
  connectedCallback() {
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ye, this.setAttribute("role", "button"), this.cleanup = new c(), this.ui = new Je(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
`, et = class et extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Xe, this.cleanup = new c();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(lt, "register", () => {
  customElements.get("svg-edit") || customElements.define("svg-edit", lt);
});
let Kt = lt;
const _e = l`
<style>
...
r(at, "register", () => {
  customElements.get("svg-pdf") || customElements.define("svg-pdf", at);
});
let Qt = at;
const ti = l`
<style>
...
r(ht, "register", () => {
  customElements.get("svg-search") || customElements.define("svg-search", ht);
});
let St = ht;
const ii = l`
<style>
...
r(ut, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", ut);
});
let Gt = ut;
const si = l`
<style>
...
r(dt, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", dt);
});
let It = dt;
const oi = l`
<style>
...
r(pt, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", pt);
});
let Ut = pt;
const ri = l`
<style>
...
r(gt, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", gt);
});
let _t = gt;
const ni = l`
<style>
...
let li = (me = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    a(this, x, void 0);
    h(this, C, t), h(this, m, e), this.events = new v(), h(this, x, document.createElement("h4")), s(this, x).slot = "title", s(this, C).appendChild(s(this, x));
  }
  get fullscreen() {
    return s(this, C).hasAttribute("fullscreen");
  }
  set fullscreen(t) {
    t ? s(this, C).setAttribute("fullscreen", "") : s(this, C).removeAttribute("fullscreen");
  }
  get title() {
...
}, C = new WeakMap(), m = new WeakMap(), x = new WeakMap(), me);
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ni, this.cleanup = new c(), this.ui = new li(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
r(mt, "register", () => {
  I.register(), $t.register(), G.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", mt);
});
let te = mt;
const ee = 150, Le = document.createElement("template");
Le.innerHTML = `
    <style>
        * { box-sizing: border-box; }
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Le.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new ai(this);
  }
  connectedCallback() {
    const t = (i) => {
...
`, bt = class bt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = hi, this.cleanup = new c();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let di = (fe = class {
  ...
  enableRipple() {
    s(this, R) || (this.removeRipple = Mt(s(this, u)), s(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
...
}, u = new WeakMap(), A = new WeakMap(), X = new WeakMap(), K = new WeakMap(), R = new WeakMap(), fe);
const B = class B extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ui, this.cleanup = new c(), this.ui = new di(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(B, "register", () => {
  U.register(), H.register(), customElements.get("ui-label") || customElements.define("ui-label", B);
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ee.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new pi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(vt, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", vt);
});
let zt = vt;
...
const D = class D extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Me.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new gi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(D, "register", () => {
  zt.register(), U.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", D);
...
const F = class F extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Te.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new mi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(F, "register", () => {
  H.register(), customElements.get("ui-input") || customElements.define("ui-input", F);
...
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = fi, this.setAttribute("role", "button"), this.ui = new bi(this);
  }
};
r(wt, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", wt);
});
let _ = wt;
const vi = l`
<style>
...
const yt = class yt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = vi, this.cleanup = new c(), this.ui = new wi();
  }
  // }}}
  connectedCallback() {
...
Q = new WeakMap(), // }}}
r(yt, "register", () => {
  Rt.register(), _.register(), customElements.get("ui-select") || customElements.define("ui-select", yt);
});
let ne = yt;
const yi = l`
    <style>
...
const V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = yi, this.cleanup = new c(), this.ui = new ki(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(V, "register", () => {
  H.register(), I.register(), St.register(), customElements.get("ui-search") || customElements.define("ui-search", V);
...
}, L = new WeakMap(), $ = new WeakMap(), W = new WeakMap(), ve);
const Y = class Y extends HTMLElement {
  constructor() {
    super(), this.ui = new Ci(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
const kt = class kt extends HTMLElement {
  constructor() {
    super(), this.ui = new xi(this);
  }
};
r(kt, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", kt);
});
let ce = kt;
const Li = l`
<style>
...
`, Ct = class Ct extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Li, this.cleanup = new c();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ei, this.cleanup = new c(), this.ui = new Mi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(xt, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", xt);
});
let qt = xt;
const Ti = l`
    <style>
...
}, E = new WeakMap(), T = new WeakMap(), z = new WeakMap(), ke);
const Lt = class Lt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ti, this.cleanup = new c(), this.ui = new Hi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(Lt, "register", () => {
  qt.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", Lt);
});
let ue = Lt;
var y, k, Ce;
let Ai = (Ce = class {
...
}, y = new WeakMap(), k = new WeakMap(), Ce);
...
r(Et, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", Et);
});
let de = Et;
var b;
class Ri {
