...
var i = (s, e, t) => xt(s, typeof e != "symbol" ? e + "" : e, t), St = (s, e, t) => e.has(s) || bt("Cannot " + t);
var m = (s, e, t) => (St(s, e, "read from private field"), t ? t.call(s) : e.get(s)), ft = (s, e, t) => e.has(s) ? bt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(s) : e.set(s, t);
const vt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class g {
  ...
  on(e, t) {
    ...
    return m(this, p)[e] || (m(this, p)[e] = []), m(this, p)[e].push(t), () => {
      this.off(e, t);
    };
  }
  // }}}
  ...
  off(e, t) {
    ...
    let r = !1, o = 0;
    for (const n of m(this, p)[e])
      n === t && (m(this, p)[e].splice(o, 1), r = !0), o++;
    if (!r)
...
const Mt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: a,
  isAndroid: Et
}, Symbol.toStringTag, { value: "Module" })), w = class w extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set position(e) {
        if (e || (e = w.defaultAttributes.position), !e) {
...
i(w, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", w);
...
const d = class d extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.renderCleanUp = new l(), this.removeRippleCallback = null, this.ui = {
      root: this,
      /**
  ...
  render() {
    this.setAttribute("role", "button"), this.renderCleanUp.run();
...
const c = class c extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.renderCleanUp = new l(), this.removeRippleCallback = null, this.ui = {
      ...
      set noRipple(e) {
        if (e || (e = !!c.defaultAttributes.noRipple), !e) {
          this.root.removeAttribute("no-ripple");
          return;
        }
        this.root.setAttribute("no-ripple", "");
      ...
      set ghost(e) {
        if (e || (e = !!c.defaultAttributes.ghost), !e) {
      ...
      set disabled(e) {
        if (e || (e = !!c.defaultAttributes.disabled), !e) {
          this.root.removeAttribute("disabled");
          return;
        }
        this.root.setAttribute("disabled", "");
...
`, j = class j extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      open(t = !1, r = !0) {
        const o = this.dialog.inert;
        this.dialog.inert = r, t ? this.dialog.showModal() : this.dialog.show(), this.events.dispatch("open", null), this.dialog.inert = o;
      },
      close() {
  ...
  connectedCallback() {
    ...
    const o = this.shadowRoot.querySelector("dialog"), n = (h) => {
      h.preventDefault();
    };
    o.addEventListener("cancel", n), this.cleanup.add(() => {
      t.removeEventListener("click", r), o.removeEventListener("cancel", n);
    });
  }
  disconnectedCallback() {
...
const b = class b extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setFlex(t) {
        this.shadowAttr.flex = t || b.defaultFlex, this.root.shadowRender({ ...this.shadowAttr });
      }
...
i(b, "register", () => {
  customElements.get("ui-flex-grid-item") || customElements.define("ui-flex-grid-item", b);
}), i(b, "observedAttributes", ["flex"]), i(b, "defaultFlex", "1");
let it = b;
...
i(v, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", v);
...
i(S, "register", () => {
  $.register(), k.register(), customElements.get("ui-label") || customElements.define("ui-label", S);
    ...
    switch (t) {
      case "title":
        ...
        if (o === null && n && (this.removeChild(n), n = null), o === null)
          return;
        n || (n = new k(), n.slot = "title", this.appendChild(n)), n.innerHTML = o;
        break;
      case "type":
...
`, E = class E extends HTMLElement {
  ...
  attributeChangedCallback(t, r, o) {
    switch (t) {
      case "title":
        let n = this.querySelector('[slot="title"]');
        o === null && n && (this.removeChild(n), n = null), n || (n = new k(), n.slot = "title", this.appendChild(n)), n.innerHTML = o || "";
        break;
      case "value":
        this.ui.setValue(o);
        break;
  ...
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      setPage(t, r = null, o = !1) {
        ...
        let h = null;
        this.stack.length > 1 && !o && (h = this.stack[this.stack.length - 2], h.parentElement.removeChild(h)), this.dispatchChangeEvent(h), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
...
let mt = Y;
function $t() {
  Q.register(), X.register(), W.register(), B.register(), _.register(), I.register(), et.register(), tt.register(), U.register(), it.register(), rt.register(), ot.register(), nt.register(), lt.register(), M.register(), at.register(), ht.register(), ut.register(), dt.register(), ct.register(), z.register(), pt.register(), mt.register(), st.register(), $.register(), k.register(), gt.register();
}
export {
  X as UIAppBar,
  Q as UIAppBarItem,
