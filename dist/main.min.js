...
class c {
  ...
  off(e, t) {
    ...
    for (const n of p(this, d)[e])
      n === t && (p(this, d)[e].splice(o, 1), r = !0), o++;
    if (!r)
...
}), i(v, "observedAttributes", ["no-ripple"]);
let Q = v;
...
}), i(w, "observedAttributes", ["no-ripple"]);
let W = w;
...
`, y = class y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new l(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new c(),
      get title() {
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), r = async (n) => {
      (n.composedPath() || []).forEach((h) => {
        h instanceof H && ([...this.querySelectorAll("ui-select-option")].forEach(
...
}), i(T, "observedAttributes", ["use-storage", "storage-prefix"]);
let pt = T;
