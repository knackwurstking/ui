...
var St = (o, e, t) => e in o ? At(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var i = (o, e, t) => St(o, typeof e != "symbol" ? e + "" : e, t), Lt = (o, e, t) => e.has(o) || yt("Cannot " + t);
var p = (o, e, t) => (Lt(o, e, "read from private field"), t ? t.call(o) : e.get(o)), kt = (o, e, t) => e.has(o) ? yt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t);
const wt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const qt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  createRipple: B,
  css: c,
  defaultRippleOptions: Et,
  html: l,
  isAndroid: Rt
}, Symbol.toStringTag, { value: "Module" })), H = "1", m = class m extends HTMLElement {
  constructor() {
    super();
    i(this, "css", ({ flex: t = H }) => c`
        :host {
            flex: ${t};
        }
    `);
    i(this, "template", () => l`<slot></slot>`);
...
const v = class v extends HTMLElement {
  constructor() {
    ...
    `);
    i(this, "template", () => l`<slot></slot>`);
    this.attachShadow({ mode: "open" }), this.render(), this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      /**
...
const y = class y extends HTMLElement {
  constructor() {
    ...
    `);
    i(this, "template", () => l` <ui-svg><slot></slot></ui-svg> `);
    this.attachShadow({ mode: "open" }), this.render(), this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
...
`, V = class V extends HTMLElement {
  ...
  render() {
    let t = "";
    this.ui && (t = this.ui.getTitle()), this.shadowRoot.innerHTML = `
            <style>${this.css().trim()}</style>
            ${this.template().trim()}
        `, this.ui && (this.ui.dialog = this.shadowRoot.querySelector("dialog"), this.ui.h4 = (() => {
      const s = document.createElement("h4");
      return s.slot = "title", this.appendChild(s), s;
    })(), this.ui.setTitle(t));
  }
};
i(V, "register", () => {
...
i(x, "register", () => {
  z.register(), g.register(), customElements.get("ui-label") || customElements.define("ui-label", x);
...
`, G = class G extends HTMLElement {
  constructor() {
    ...
    `);
    i(this, "template", () => l`<slot></slot>`);
    this.attachShadow({ mode: "open" }), this.render(), this.setAttribute("role", "button"), this.ui = {
      /** @private */
      root: this,
      getValue() {
...
`, E = class E extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.render(), this.ui = {
      ...
      input: (() => {
        const t = this.shadowRoot.querySelector("input");
        t.type = "text", t.onkeydown = async (r) => {
          this.ui.hasSubmit() && r.key === "Enter" && this.ui.submit.click();
        }, t.oninput = async () => {
          this.ui.useStorage && (s !== null && clearTimeout(s), s = setTimeout(() => {
...
i(E, "register", () => {
  customElements.get("ui-search") || customElements.define("ui-search", E);
}), i(E, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
}), i(A, "observedAttributes", ["current"]);
let pt = A;
const J = class J extends HTMLElement {
  constructor() {
    super();
...
i(S, "register", () => {
  q.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", S);
}), i(S, "observedAttributes", ["use-history"]);
let mt = S;
...
i(L, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", L);
}), i(L, "observedAttributes", ["use-storage", "storage-prefix"]);
let bt = L;
...
}), i(T, "observedAttributes", ["auto", "mode"]);
let ft = T;
const X = class X extends HTMLElement {
  constructor() {
    super();
