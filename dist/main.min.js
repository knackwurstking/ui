...
var le = (o, t, e) => t in o ? ae(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => (le(o, typeof t != "symbol" ? t + "" : t, e), e), Xt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var i = (o, t, e) => (Xt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), n = (o, t, e) => {
  if (t.has(o))
...
class q {
  ...
  off(t, e) {
    ...
    let s = !1, a = 0;
    for (const L of i(this, g)[t])
      L === e && (i(this, g)[t].splice(a, 1), s = !0), a++;
    if (!s)
...
function Wt(o, t = {}) {
  ...
  return o.classList.add("ripple-container"), o.style.overflow = "hidden", t.useClick === !0 ? o.addEventListener("click", (L) => {
    e = Ft(L, t), Kt(e);
...
const st = class st extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = he, this.cleanup = new h(), this.ui = new ue(this);
  }
  connectedCallback() {
  }
...
r(st, "register", () => {
  console.debug("register web component: ui-app-bar"), customElements.define("ui-app-bar", st);
});
let Ct = st;
const de = l`
<style>
...
let pe = (Gt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Wt(i(this, p), { centered: !0 }), i(this, p).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = de, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new pe(this);
  }
  connectedCallback() {
...
let me = (It = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Wt(i(this, d), { centered: !0 }), i(this, d).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ge, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new me(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
r(j, "register", () => {
  console.debug("register web component: ui-icon-button"), customElements.define("ui-icon-button", j);
}), r(j, "observedAttributes", ["no-ripple"]);
let Mt = j;
const be = l`
<style>
    :host {
...
r(ot, "register", () => {
  console.debug("register web component: ui-container"), customElements.define("ui-container", ot);
});
let Et = ot;
const ve = l`
<style>
...
let fe = (Ut = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, x, void 0);
    c(this, k, t), c(this, m, e), this.events = new q(), c(this, x, document.createElement("h4")), i(this, x).slot = "title", i(this, k).appendChild(i(this, x));
  }
  get fullscreen() {
    return i(this, k).hasAttribute("fullscreen");
  }
  set fullscreen(t) {
    t ? i(this, k).setAttribute("fullscreen", "") : i(this, k).removeAttribute("fullscreen");
  }
  get title() {
...
}, k = new WeakMap(), m = new WeakMap(), x = new WeakMap(), Ut);
const rt = class rt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ve, this.cleanup = new h(), this.ui = new fe(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    ...
    const s = this.shadowRoot.querySelector("dialog"), a = (L) => {
      L.preventDefault();
    };
...
r(rt, "register", () => {
  console.debug("register web component: ui-dialog"), customElements.define("ui-dialog", rt);
});
let Ht = rt;
const Tt = "1", we = l`
<style></style>
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = we, this.cleanup = new h(), this.ui = new ye(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(N, "register", () => {
  console.debug("register web component: ui-flex-grid-item"), customElements.define("ui-flex-grid-item", N);
}), r(N, "observedAttributes", ["flex"]);
let At = N;
const St = "0", ke = l`
<style></style>
<slot></slot>
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ke, this.cleanup = new h(), this.ui = new xe(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let Le = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || $t;
  }
  set gap(t) {
    t === null ? this.root.removeAttribute("gap") : this.root.setAttribute("gap", t);
  }
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ce, this.cleanup = new h(), this.ui = new Le(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let Ee = (_t = class {
  ...
  enableRipple() {
    i(this, A) || (this.removeRipple = Wt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
   ...
   */
  startInputHandling() {
    i(this, T) || (i(this, u).addEventListener("click", i(this, Y)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", i(this, D));
    }), c(this, T, !0));
  }
  /**
   * @private
  ...
  stopInputHandling() {
    i(this, u).removeEventListener("click", i(this, Y)), [...i(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, D));
    }), c(this, T, !1);
  }
}, u = new WeakMap(), T = new WeakMap(), Y = new WeakMap(), D = new WeakMap(), A = new WeakMap(), _t);
const V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this.cleanup = new h(), this.ui = new Ee(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(V, "register", () => {
  console.debug("register web component: ui-label"), customElements.define("ui-label", V);
}), r(V, "observedAttributes", ["ripple", "secondary", "primary"]);
let zt = V;
const He = l`
<style>
    :host {
...
`, nt = class nt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = He, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(nt, "register", () => {
  console.debug("register web component: ui-primary"), customElements.define("ui-primary", nt);
});
let jt = nt;
const Te = l`
<style>
...
`, at = class at extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Te, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(at, "register", () => {
  console.debug("register web component: ui-secondary"), customElements.define("ui-secondary", at);
});
let F = at;
...
let Ae = class {
   ...
   */
  constructor(t) {
    this.root = t, this.events = new q(), this.input = this.root.shadowRoot.querySelector("input"), this.input.type = this.root.getAttribute("type") || "text", this.input.oninput = () => this.events.dispatch("input", this.value), this.input.onchange = () => this.events.dispatch("change", this.value);
  }
  /**
   * @param {string | null} v
   */
  set title(t) {
    ...
    t === null && e && (this.root.removeChild(e), e = null), e || (e = new F(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t || "";
  }
  get title() {
    var t;
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new Ae(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(O, "register", () => {
  console.debug("register web component: ui-input"), customElements.define("ui-input", O);
...
let Re = (te = class {
  ...
  get value() {
    return i(this, f).getAttribute("value");
  }
  set value(t) {
    i(this, f).setAttribute("value", t);
  }
  get selected() {
    return i(this, f).hasAttribute("selected");
  }
  set selected(t) {
    t ? i(this, f).setAttribute("selected", "") : i(this, f).removeAttribute("selected");
  }
}, f = new WeakMap(), te);
const lt = class lt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.setAttribute("role", "button"), this.ui = new Re(this);
  }
};
r(lt, "register", () => {
  console.debug("register web component: ui-select-option"), customElements.define("ui-select-option", lt);
});
let K = lt;
const $e = l`
<style>
  ...
  constructor() {
    ...
    n(this, W, async (e) => {
      (e.composedPath() || []).forEach((s) => {
        s instanceof K && ([...this.querySelectorAll("ui-select-option")].forEach(
          (a) => a.removeAttribute("selected")
        ), s.setAttribute("selected", ""), this.ui.events.dispatch("change", s));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = $e, this.cleanup = new h(), this.ui = new qe();
  }
  // }}}
  connectedCallback() {
...
W = new WeakMap(), // }}}
r(ct, "register", () => {
  console.debug("register web component: ui-select"), customElements.define("ui-select", ct);
});
let Pt = ct;
var C, S, X, ee;
let ze = (ee = class {
  ...
  constructor(t) {
     ...
     */
    n(this, X, void 0);
    c(this, C, t), c(this, S, new q()), this.langType = null;
  }
  get current() {
    return i(this, C).getAttribute("current");
  }
  set current(t) {
    t === null ? i(this, C).removeAttribute("current") : i(this, C).setAttribute("current", t);
  }
  /** @returns {import(".").UILangType} */
  getFallbackElement() {
    return i(this, C).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, c(this, X, e), i(this, S).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var s, a;
    return ((a = (s = i(this, X)) == null ? void 0 : s[t]) == null ? void 0 : a[e]) || null;
  }
  /**
   * @param {"change"} key
...
}, C = new WeakMap(), S = new WeakMap(), X = new WeakMap(), ee);
const B = class B extends HTMLElement {
  constructor() {
    super(), this.ui = new ze(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
let je = (ie = class {
  ...
  */
  ...
  get name() {
    return i(this, b).getAttribute("name");
  }
  set name(t) {
    i(this, b).setAttribute("name", t);
  }
  get href() {
    return i(this, b).getAttribute("href");
  }
  set href(t) {
    i(this, b).setAttribute("href", t);
  }
  get fallback() {
    return i(this, b).hasAttribute("fallback");
  }
  set fallback(t) {
    t ? i(this, b).setAttribute("fallback", "") : i(this, b).removeAttribute("fallback");
  }
}, b = new WeakMap(), ie);
...
r(ht, "register", () => {
  console.debug("register web component: ui-lang-type"), customElements.define("ui-lang-type", ht);
});
let Vt = ht;
const Ne = l`
<style>
...
`, ut = class ut extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ne, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(ut, "register", () => {
  console.debug("register web component: ui-spinner"), customElements.define("ui-spinner", ut);
});
let Ot = ut;
const Pe = l`
    <style>
...
let Ze = (se = class {
  ...
  */
  ...
  get name() {
    return i(this, R).getAttribute("name");
  }
  set name(t) {
    i(this, R).setAttribute("name", t);
  }
}, R = new WeakMap(), se);
const dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.cleanup = new h(), this.ui = new Ze(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(dt, "register", () => {
  console.debug("register web component: ui-stack-layout-page"), customElements.define("ui-stack-layout-page", dt);
});
let Bt = dt;
const Ve = l`
    <style>
...
let Oe = (oe = class {
  ...
  constructor(t) {
     ...
     */
    n(this, $, {});
    c(this, E, t), this.events = new q(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    i(this, E).removeChild(t), this.stack.length && i(this, E).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (!i(this, H)) {
      if (this.stack.push(
        // @ts-expect-error
        i(this, E).appendChild(i(this, $)[t]().children[0])
      ), this.stack.length > 1) {
...
}, E = new WeakMap(), H = new WeakMap(), $ = new WeakMap(), oe);
const pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.cleanup = new h(), this.ui = new Oe(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(pt, "register", () => {
  console.debug("register web component: ui-stack-layout"), customElements.define("ui-stack-layout", pt);
});
let Jt = pt;
var w, y, re;
let Be = (re = class {
  ...
  constructor(t) {
    ...
    /** @type {any} */
    n(this, y, {});
    c(this, w, t), this.events = new q();
  }
  get localStoragePrefix() {
    return i(this, w).getAttribute("local-storage-prefix");
  }
  set localStoragePrefix(t) {
    i(this, w).setAttribute("local-storage-prefix", t);
  }
  get enableLocalStorage() {
    return i(this, w).hasAttribute("enable-local-storage");
  }
  set enableLocalStorage(t) {
    t ? i(this, w).setAttribute("enable-local-storage", "") : i(this, w).removeAttribute("enable-local-storage");
  }
  /**
   * @template {keyof T} K
   * @param {K} key
  ...
  set(t, e, s = !1) {
    if (s && this.enableLocalStorage) {
      ...
      i(this, y)[t] = e;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + t.toString(), JSON.stringify(i(this, y)[t])), this.events.dispatch(t, i(this, y)[t]);
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
}, w = new WeakMap(), y = new WeakMap(), re);
const gt = class gt extends HTMLElement {
  constructor() {
    super(), this.ui = new Be(this);
  }
};
r(gt, "register", () => {
  console.debug("register web component: ui-store"), customElements.define("ui-store", gt);
});
let Yt = gt;
var v;
class Je {
  ...
  enableAutoMode() {
    if (this.removeMode(), i(this, v)) {
      this.mediaChangeHandler(i(this, v));
      return;
    }
    c(this, v, window.matchMedia("(prefers-color-scheme: dark)")), i(this, v).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, v));
  }
  disableAutoMode() {
    this.removeMedia();
  }
   ...
   */
  removeMedia() {
    i(this, v) && (i(this, v).removeEventListener("change", this.mediaChangeHandler), c(this, v, null));
  }
}
v = new WeakMap();
const J = class J extends HTMLElement {
  constructor() {
    super(), this.ui = new Je();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue 
...
r(mt, "register", () => {
  console.debug("register svg component: svg-back-arrow-navigation"), customElements.define("svg-back-arrow-navigation", mt);
});
let Q = mt;
Q.register();
const De = l`
...
r(bt, "register", () => {
  console.debug("register svg component: svg-chevron-down"), customElements.define("svg-chevron-down", bt);
});
let G = bt;
G.register();
const We = l`
...
r(vt, "register", () => {
  console.debug("register svg component: svg-close"), customElements.define("svg-close", vt);
});
let I = vt;
I.register();
const Xe = l`
...
r(ft, "register", () => {
  console.debug("register svg component: svg-delete-recycle-bin"), customElements.define("svg-delete-recycle-bin", ft);
});
let U = ft;
U.register();
const Fe = l`
...
r(wt, "register", () => {
  console.debug("register svg component: svg-edit2"), customElements.define("svg-edit2", wt);
});
let _ = wt;
_.register();
const Ke = l`
...
r(yt, "register", () => {
  console.debug("register svg component: svg-pdf-document"), customElements.define("svg-pdf-document", yt);
});
let tt = yt;
tt.register();
const Qe = l`
...
r(kt, "register", () => {
  console.debug("register svg component: svg-settings"), customElements.define("svg-settings", kt);
});
let et = kt;
et.register();
const Ge = l`
...
r(xt, "register", () => {
  console.debug("register svg component: svg-today-outline"), customElements.define("svg-today-outline", xt);
});
let it = xt;
it.register();
function gi() {
  Ct.register(), Mt.register(), Lt.register(), Et.register(), At.register(), Rt.register(), qt.register(), Nt.register(), K.register(), Pt.register(), Vt.register(), Zt.register(), Ot.register(), Bt.register(), Jt.register(), Yt.register(), F.register(), jt.register(), zt.register(), Dt.register(), Ht.register();
}
function mi() {
  Q.register(), G.register(), I.register(), U.register(), _.register(), tt.register(), et.register(), it.register();
}
export {
  Q as SvgBackArrowNavigation,
  G as SvgChevronDown,
  I as SvgClose,
  U as SvgDeleteRecycleBin,
  _ as SvgEdit2,
  tt as SvgPDFDocument,
  et as SvgSettings,
  it as SvgTodayOutline,
  Ct as UIAppBar,
  Lt as UIButton,
  Et as UIContainer,
  Ht as UIDialog,
  qt as UIFlexGrid,
  At as UIFlexGridItem,
  Rt as UIFlexGridRow,
  Mt as UIIconButton,
  Nt as UIInput,
  zt as UILabel,
  ...
  mi as registerSVGComponents,
  gi as registerWebComponents
};
