...
r(q, "register", () => {
  customElements.get("ui-flex-grid-row") || customElements.define("ui-flex-grid-row", q);
}), r(q, "observedAttributes", ["gap"]);
let W = q;
const At = "0", Pe = l`
<style></style>
<slot></slot>
...
r(j, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", j);
...
`, _ = class _ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = De, this.cleanup = new c(), this.ui = {
...
r(_, "register", () => {
  W.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", _);
});
let Ft = _;
const Fe = l`
    <style>
...
`, tt = class tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Fe, this.cleanup = new c(), this.ui = {
      enable: () => {
...
r(tt, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", tt);
});
let Bt = tt;
const Be = l`
<style>
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Be, this.setAttribute("role", "button"), this.cleanup = new c(), this.ui = new Ve(this);
  }
  connectedCallback() {
...
r(N, "register", () => {
  customElements.get("ui-button") || customElements.define("ui-button", N);
}), r(N, "observedAttributes", ["no-ripple", "color"]);
let Vt = N;
const Ye = l`
<style>
    * { box-sizing: border-box; }
...
r(Z, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", Z);
...
}, x = new WeakMap(), m = new WeakMap(), C = new WeakMap(), me);
...
r(mt, "register", () => {
  G.register(), $t.register(), W.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", mt);
});
let ee = mt;
const ie = 150, Le = document.createElement("template");
Le.innerHTML = `
    <style>
        * { box-sizing: border-box; }
...
r(P, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", P);
}), r(P, "observedAttributes", ["open"]);
let se = P;
const ci = l`
<style>
    :host {
...
let di = (fe = class {
  ...
  enableRipple() {
    s(this, A) || (this.removeRipple = Mt(s(this, u)), s(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
    s(this, A) && s(this, A).call(this), this.stopInputHandling();
  }
  /**
   * @private
   */
  startInputHandling() {
    s(this, H) || (s(this, u).addEventListener("click", s(this, J)), this.getInputSlot().forEach((t) => {
   ...
   */
  stopInputHandling() {
    s(this, u).removeEventListener("click", s(this, J)), [...s(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", s(this, X));
    }), h(this, H, !1);
  }
}, u = new WeakMap(), H = new WeakMap(), J = new WeakMap(), X = new WeakMap(), A = new WeakMap(), fe);
...
r(O, "register", () => {
  I.register(), T.register(), customElements.get("ui-label") || customElements.define("ui-label", O);
}), r(O, "observedAttributes", ["ripple", "secondary", "primary"]);
let oe = O;
...
r(D, "register", () => {
  zt.register(), I.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", D);
...
let mi = class {
  ...
  set title(t) {
    ...
    t === null && e && (this.root.removeChild(e), e = null), e || (e = new T(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t || "";
  }
  get title() {
    var t;
...
r(F, "register", () => {
  T.register(), customElements.get("ui-input") || customElements.define("ui-input", F);
  ...
  constructor() {
    ...
    a(this, K, async (e) => {
      (e.composedPath() || []).forEach((i) => {
        i instanceof U && ([...this.querySelectorAll("ui-select-option")].forEach(
...
K = new WeakMap(), // }}}
r(yt, "register", () => {
  Rt.register(), U.register(), customElements.get("ui-select") || customElements.define("ui-select", yt);
});
let le = yt;
const yi = l`
    <style>
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "title":
        ...
        i === null && n && (this.removeChild(n), n = null), n || (n = new T(), n.slot = "title", this.appendChild(n)), n.innerHTML = i || "";
        break;
      case "value":
        this.ui.value = i || "";
        break;
...
r(B, "register", () => {
  T.register(), G.register(), St.register(), customElements.get("ui-search") || customElements.define("ui-search", B);
...
let xi = (ve = class {
  ...
  constructor(t) {
     ...
     */
    a(this, Q, void 0);
    h(this, L, t), h(this, R, new v()), this.langType = null;
  }
  get current() {
   ...
   */
  new(t, e) {
    this.langType = t, h(this, Q, e), s(this, R).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var i, n;
    return ((n = (i = s(this, Q)) == null ? void 0 : i[t]) == null ? void 0 : n[e]) || null;
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, i = !1) {
    ...
    return i && e(this.langType), s(this, R).on(t, e);
  }
}, L = new WeakMap(), R = new WeakMap(), Q = new WeakMap(), ve);
...
}), r(V, "observedAttributes", ["current"]);
let ce = V;
var f, we;
let Ci = (we = class {
  /**
...
`, xt = class xt extends HTMLElement {
  constructor() {
...
r(xt, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", xt);
});
let ue = xt;
const Ei = l`
    <style>
...
let Mi = (ye = class {
  ...
  */
  ...
  get name() {
    return s(this, $).getAttribute("name");
  }
  set name(t) {
    s(this, $).setAttribute("name", t);
  }
}, $ = new WeakMap(), ye);
...
let Hi = (ke = class {
  ...
  setPage(t, e = !1) {
    if (s(this, M))
      return;
    this.stack.push(
      s(this, E).appendChild(s(this, S)[t]())
    );
    let i = null;
...
}, E = new WeakMap(), M = new WeakMap(), S = new WeakMap(), ke);
...
}, y = new WeakMap(), k = new WeakMap(), xe);
