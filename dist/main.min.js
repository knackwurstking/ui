...
var Et = (o, t, e) => t in o ? At(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Et(o, typeof t != "symbol" ? t + "" : t, e), St = (o, t, e) => t.has(o) || ft("Cannot " + e);
...
function Lt(o, t = {}) {
  ...
  const e = () => {
    ...
    o.draggable = !0, o.ondragstart = (l) => {
      ...
      const J = parseInt(l.dataTransfer.getData("text/plain"), 10);
      t.onDragEnd && t.onDragEnd(J, a);
    };
  }, i = () => {
...
const n = String.raw, B = String.raw;
class Ct {
  constructor() {
    this.callbacks = [];
  }
...
r(N, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", N);
});
let gt = N;
