...
var Dt = (o, t, e) => t in o ? Ft(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Dt(o, typeof t != "symbol" ? t + "" : t, e), Vt = (o, t, e) => t.has(o) || At("Cannot " + e);
var b = (o, t, e) => (Vt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), Lt = (o, t, e) => t.has(o) ? At("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
class Ht {
  constructor() {
    this.callbacks = [];
  }
...
function Ot(o, t, e = {}) {
  ...
  const i = () => {
    const c = [...o.children].indexOf(t);
    t.draggable = !0, t.ondragstart = (u) => {
      u.dataTransfer.effectAllowed = "move", u.dataTransfer.dropEffect = "move", e.onDragStart && e.onDragStart(c);
    }, t.ondragover = (u) => (u.preventDefault(), !1), t.ondragenter = (u) => {
      u.preventDefault(), [...o.children].forEach((g, F) => {
        if (F === c) {
      ...
      }), e.onDragging && e.onDragging(c);
    }, t.ondrop = (u) => {
      u.preventDefault(), u.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(c), [...o.children].forEach((g) => {
        g.style.background = "inherit", g.style.color = "inherit";
      });
    };
  }, s = () => {
...
function Yt(o, { onDragEnd: t = null, onDragStart: e = null }) {
  let i = null, s = null, l = null, c = !1, u = null, g = null;
  const F = (a) => {
    !i && Array.from(a.currentTarget.classList).includes("draggable") && (s = (/* @__PURE__ */ new Date()).getTime(), i = a.currentTarget, l || clearTimeout(l), l = setTimeout(() => {
      u = i.style.color, g = i.style.backgroundColor, i.style.color = "var(--ui-primary-color)", i.style.backgroundColor = "var(--ui-primary-bgColor)", c = !0, e && e();
    }, 250));
  }, Et = (a) => {
    if (!s || !i) return;
    if ((/* @__PURE__ */ new Date()).getTime() - s < 250) {
      _();
      return;
    }
    a.preventDefault(), c || (c = !0, e && e());
    const m = !!a.targetTouches && a.targetTouches[0] || a;
    let h = document.elementFromPoint(m.clientX, m.clientY);
    for (; !h.classList.contains("draggable") && h.parentElement; )
      h = h.parentElement;
    h.classList.contains("draggable") && jt(i, h);
  }, _ = () => {
    c && (clearTimeout(l), l = null, i.style.color = u, i.style.backgroundColor = g, i = null, s = null, c = !1, t && t());
  };
  function jt(a, m) {
    $t(a, m) ? o.insertBefore(a, m) : o.insertBefore(a, m.nextElementSibling);
  }
  function $t(a, m) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (a) => {
        a.classList.add("draggable"), a.onmousedown = F, a.ontouchstart = F, a.onmousemove = Et, a.ontouchmove = Et, a.onmouseup = _, a.ontouchend = _;
      }
    );
  })(), {
    destroy: () => {
...
class d {
  ...
  off(t, e) {
    ...
    for (const l of b(this, p)[t])
      l === e && (b(this, p)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
const n = String.raw, G = String.raw, Kt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: Ht,
  Events: d,
  createDraggable: Ot,
  createMobileDraggable: Yt,
  createRipple: f,
  css: G,
  defaultRippleOptions: qt,
  html: n,
  isAndroid: Bt
}, Symbol.toStringTag, { value: "Module" })), D = class D extends HTMLElement {
  constructor() {
...
r(D, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", D);
});
let U = D;
...
r(V, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", V);
});
let I = V;
...
}), r(y, "observedAttributes", ["noripple"]);
let tt = y;
...
}), r(w, "observedAttributes", ["noripple"]);
let et = w;
...
r(O, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", O);
});
let it = O;
const Pt = n`
...
`, k = class k extends HTMLElement {
  ...
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Ht(), this._title = t || "", this.ui = {
       ...
       */
      open(e = !1, i = !0) {
        const s = this.root.shadowRoot.querySelector("dialog"), l = s.inert;
        s.inert = i, e ? s.showModal() : s.show(), this.events.dispatch("open", null), s.inert = l;
      },
      close() {
  ...
  shadowRender() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), s = (l) => l.preventDefault();
...
r(B, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", B);
});
let nt = B;
...
}), r(R, "observedAttributes", ["gap", "justify", "align"]);
let lt = R;
...
}), r(A, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let ut = A;
...
}), r(L, "observedAttributes", ["ripple", "secondary", "primary"]);
let dt = L;
...
r(J, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", J);
});
let v = J;
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Jt}</ui-icon-button>
      </div>
...
r(X, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", X);
});
let $ = X;
const Z = class Z extends HTMLElement {
  ...
  shadowRender() {
    ...
    const t = (i) => {
      const s = async (l) => {
        (l.composedPath() || []).forEach((c) => {
          c instanceof $ && ([...this.querySelectorAll("ui-select-option")].forEach(
            (u) => u.removeAttribute("selected")
          ), c.setAttribute("selected", ""), this.ui.events.dispatch("change", c));
        });
      };
...
r(Z, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", Z);
});
let bt = Z;
...
r(M, "register", () => {
  customElements.get("ui-textarea") || customElements.define("ui-textarea", M);
}), r(M, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
}), r(H, "observedAttributes", ["current"]);
let ft = H;
...
r(K, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", K);
});
let vt = K;
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.pages = {}, this.stack = [], this.onpopstate = () => this.goBack(), this.ui = {
      ...
      set(t, e = null, i = !1) {
        ...
        this.root.stack.push(this.root.appendChild(s)), typeof e == "function" && e(s);
        let l = null;
...
r(Q, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", Q);
});
let kt = Q;
const W = class W extends HTMLElement {
  constructor() {
...
r(W, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", W);
});
let xt = W;
const j = class j extends HTMLElement {
  constructor() {
