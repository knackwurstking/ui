...
$t = new WeakSet(), si = function() {
  ...
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", Ft);
});
let we = Ft;
var Pt, ni;
...
let Me = Xt;
function Pi() {
  It.register(), ee.register(), re.register(), ie.register(), oe.register(), se.register(), ne.register(), ae.register(), ue.register(), ce.register(), le.register(), X.register(), Ut.register(), te.register(), de.register(), ge.register(), fe.register(), N.register(), me.register(), be.register(), ke.register(), ve.register(), ye.register(), we.register(), Ce.register(), xe.register(), Me.register(), he.register(), pe.register(), R.register(), Le.register();
}
export {
  zi as CleanUp,
  b as Events,
