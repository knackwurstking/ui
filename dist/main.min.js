...
var Xt = (o, t, e) => t in o ? Yt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var s = (o, t, e) => Xt(o, typeof t != "symbol" ? t + "" : t, e), Pt = (o, t, e) => t.has(o) || jt("Cannot " + e);
var m = (o, t, e) => (Pt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), et = (o, t, e) => t.has(o) ? jt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
class Bt {
  constructor() {
    this.callbacks = [];
  }
...
function Jt(o, t, { onDragStart: e = null, onDragging: i = null, onDragEnd: r = null } = {}) {
  const l = () => {
    ...
    t.draggable = !0, t.ondragstart = (h) => {
      ...
      h.preventDefault(), [...o.children].forEach(
        (b, Y) => {
          if (Y === u) {
            b.style.background = "var(--ui-primary)", b.style.color = "var(--ui-primary-fg)";
            return;
          }
          b.style.background = "inherit", b.style.color = "inherit";
        }
      ), i && i(u);
    }, t.ondrop = (h) => {
      h.preventDefault(), h.dataTransfer.dropEffect = "move", r && r(u), [...o.children].forEach((b) => {
        b.style.background = "inherit", b.style.color = "inherit";
      });
    };
  }, d = () => {
...
function Zt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  let i = null, r = null, l = null, d = null, c = null, u = !1, h = null, b = null;
  const Y = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, d = n.clientY, r = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
      h = i.style.color, b = i.style.backgroundColor, i.style.color = "var(--ui-primary-fg)", i.style.backgroundColor = "var(--ui-primary)", o.classList.add("dragging"), u = !0, e && e();
    }, 200));
  }, Ht = (n) => {
    if (!r || !i) return;
    if (!u && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const qt = Math.abs(l - n.clientX), zt = Math.abs(d - n.clientY);
      if ((qt > zt ? qt : zt) < 24)
        return;
      tt();
      return;
    ...
    for (; !p.classList.contains("draggable") && p.parentElement; )
      p = p.parentElement;
    p.classList.contains("draggable") && Ft(i, p);
  }, tt = () => {
    c !== null && (clearTimeout(c), c = null), i && (i.style.color = h, i.style.backgroundColor = b, i = null), r = null, o.classList.remove("dragging"), u && (t && t(), u = !1);
  };
  function Ft(n, v) {
    Vt(n, v) ? o.insertBefore(n, v) : o.insertBefore(n, v.nextElementSibling);
  }
  function Vt(n, v) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (n) => {
        n.classList.add("draggable"), n.onmousedown = Y, n.ontouchstart = Y, n.onmousemove = Ht, n.ontouchmove = Ht, n.onmouseup = tt, n.ontouchend = tt;
      }
    );
  })(), {
...
class f {
  ...
  on(t, e) {
    ...
    return m(this, g)[t] || (m(this, g)[t] = []), m(this, g)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
...
const a = String.raw, Mt = String.raw;
function It(o) {
...
const A = class A extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Bt(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new f(),
      get title() {
...
const S = class S extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
        ...
        `, this.ui.input = this.shadowRoot.querySelector("input"), this.addEventListener("click", m(this, N));
  }
  connectedCallback() {
  }
  disconnectedCallback() {
    ...
    const t = (i) => {
      const r = async (l) => {
        (l.composedPath() || []).forEach((d) => {
          d instanceof V && ([...this.querySelectorAll("ui-select-option")].forEach(
...
s(G, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", G);
});
let Ct = G;
...
s(_, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", _);
});
let At = _;
...
s(U, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", U);
});
let Lt = U;
...
s(I, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", I);
});
let Tt = I;
function te() {
  st.register(), rt.register(), nt.register(), at.register(), lt.register(), dt.register(), gt.register(), pt.register(), ht.register(), X.register(), ct.register(), ut.register(), ft.register(), vt.register(), yt.register(), V.register(), wt.register(), kt.register(), Ct.register(), xt.register(), Et.register(), At.register(), Rt.register(), Lt.register(), Tt.register(), bt.register(), mt.register(), w.register(), St.register();
}
export {
  Bt as CleanUp,
  f as Events,
  ...
  Et as UISpinner,
  At as UIStackLayout,
  Rt as UIStackLayoutPage,
  Lt as UIStore,
  kt as UITextarea,
  St as UIThemeHandler,
  Mt as css,
  Gt as draggable,
  a as html,
  Ut as isAndroid,
