...
const Ai = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: Se
}, Symbol.toStringTag, { value: "Module" })), Et = "1", je = n`
<style></style>
<slot></slot>
`;
let ze = class {
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ne, this.cleanup = new h(), this.ui = new Pe(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ze, this.cleanup = new h(), this.ui = new Ve(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(P, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", P);
...
const tt = class tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Oe, this.cleanup = new h(), this.ui = new Be(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(tt, "register", () => {
  U.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", tt);
});
let Ot = tt;
const De = n`
<style>
...
let Fe = (pe = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Lt(i(this, p), { centered: !0 }), i(this, p).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = De, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Fe(this);
  }
  connectedCallback() {
...
let Ye = (ge = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Lt(i(this, d), { centered: !0 }), i(this, d).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
r(gt, "register", () => {
  Ht.register(), Rt.register(), U.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", gt);
});
let _t = gt;
...
const B = class B extends HTMLLIElement {
  constructor() {
  ...
  connectedCallback() {
    this.ui.outside.addEventListener("click", (t) => {
      t.stopPropagation(), this.ui.open = !1;
    }), this.ui.aside.addEventListener("click", (t) => {
      t.stopPropagation();
    });
  }
  disconnectedCallback() {
  ...
  attributeChangedCallback(t, e, s) {
    switch (t) {
      case "open":
        s !== null ? this.ui.outside.classList.add("open") : this.ui.outside.classList.remove("open");
        break;
    }
  }
};
...
const D = class D extends HTMLUListElement {
  constructor() {
   ...
   */
  setTitle(t) {
    let e = this.querySelector('span[slot="title"]');
    if (!e) {
      const s = document.createElement("span");
      s.slot = "title";
    }
    e.innerHTML = t, this.appendChild(e);
  }
  /**
   * @private
   */
...
r(D, "register", () => {
  $t.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", D);
...
let pi = (fe = class {
  ...
  enableRipple() {
    i(this, $) || (this.removeRipple = Lt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
   ...
   */
  startInputHandling() {
    i(this, R) || (i(this, u).addEventListener("click", i(this, Q)), this.getInputSlot().forEach((t) => {
   ...
   */
  stopInputHandling() {
    i(this, u).removeEventListener("click", i(this, Q)), [...i(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, W));
    }), c(this, R, !1);
  }
}, u = new WeakMap(), R = new WeakMap(), Q = new WeakMap(), W = new WeakMap(), $ = new WeakMap(), fe);
...
r(F, "register", () => {
  St.register(), K.register(), customElements.get("ui-label") || customElements.define("ui-label", F);
}), r(F, "observedAttributes", ["ripple", "secondary", "primary"]);
let se = F;
...
r(J, "register", () => {
  K.register(), customElements.get("ui-input") || customElements.define("ui-input", J);
}), r(J, "observedAttributes", [
  "title",
  "type",
  "value",
  "placeholder",
...
const vt = class vt extends HTMLElement {
  ...
  async onClickOptions(e) {
    this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", i(this, G))) : setTimeout(
...
G = new WeakMap(), // }}}
r(vt, "register", () => {
  At.register(), _.register(), customElements.get("ui-select") || customElements.define("ui-select", vt);
});
let re = vt;
var E, S, I, ve;
let wi = (ve = class {
   ...
   */
  new(t, e) {
    this.langType = t, c(this, I, e), i(this, S).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var s, a;
    return ((a = (s = i(this, I)) == null ? void 0 : s[t]) == null ? void 0 : a[e]) || null;
  }
  /**
   * @param {"change"} key
...
}, E = new WeakMap(), S = new WeakMap(), I = new WeakMap(), ve);
...
r(Ct, "register", () => {
  qt.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", Ct);
});
let ce = Ct;
var k, C, Ce;
let Mi = (Ce = class {
...
r(X, "register", () => {
  customElements.get("ui-theme-handler") || customElements.define("ui-theme-handler", X);
}), r(X, "observedAttributes", ["auto", "mode"]);
let ue = X;
export {
  Ft as SvgAdd,
  Jt as SvgBackArrow,
