...
var Ut = (o, e, t) => e in o ? It(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var r = (o, e, t) => (Ut(o, typeof e != "symbol" ? e + "" : e, t), t), Oe = (o, e, t) => {
  if (!e.has(o))
...
let Vt = (Fe = class {
  ...
  getLeftSlot() {
    return [...s(this, b).querySelectorAll('[slot="left"]')];
  }
  getCenterSlot() {
    return [...s(this, b).querySelectorAll('[slot="center"]')];
  }
  getRightSlot() {
    return [...s(this, b).querySelectorAll('[slot="right"]')];
  }
}, b = new WeakMap(), Fe);
...
let Xt = (et = class {
  ...
  constructor(e, t) {
    ...
    n(this, w, void 0);
    a(this, g, e), a(this, w, t), this.events = new G();
  }
  get dialog() {
    return s(this, w);
  }
  ...
  get fullscreen() {
    return s(this, g).hasAttribute("fullscreen");
  }
  set fullscreen(e) {
    e ? s(this, g).setAttribute("fullscreen", "") : s(this, g).removeAttribute("fullscreen");
  }
  get title() {
    var e;
    return ((e = s(this, g).querySelector('[slot="title"]')) == null ? void 0 : e.innerHTML) || "";
  }
  set title(e) {
    const t = document.createElement("h4");
    t.innerText = e, t.slot = "title", s(this, g).appendChild(t);
  }
}, g = new WeakMap(), w = new WeakMap(), et);
var O, Z;
const be = class be extends HTMLElement {
  ...
  connectedCallback() {
    ...
    t.addEventListener("click", s(this, Z)), t.addEventListener("click", s(this, O));
  }
  disconnectedCallback() {
    const t = this.shadowRoot.querySelector("header ui-icon-button");
    t.removeEventListener("click", s(this, Z)), t.removeEventListener("click", s(this, O));
  }
};
O = new WeakMap(), Z = new WeakMap(), r(be, "register", () => customElements.define("ui-dialog", be));
let ie = be;
...
const S = class S extends HTMLElement {
  ...
  connectedCallback() {
    d(this, D, Ze).call(this);
  }
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "flex":
        a(this, W, l !== null ? l : "1"), d(this, D, Ze).call(this);
        break;
    }
  }
};
W = new WeakMap(), D = new WeakSet(), Ze = function() {
...
const H = class H extends HTMLElement {
  ...
  connectedCallback() {
    d(this, J, We).call(this);
  }
  attributeChangedCallback(t, i, l) {
    switch (t) {
      case "gap":
        a(this, V, l !== null ? l : "0"), d(this, J, We).call(this);
        break;
    }
  }
};
V = new WeakMap(), J = new WeakSet(), We = function() {
  this.shadowRoot.querySelector("style").textContent = `
            :host {
                --row-gap: ${s(this, V)};
                display: flex;
...
let Yt = (tt = class {
  ...
  set value(e) {
    s(this, m).setAttribute("value", e);
  }
  get selected() {
    return s(this, m).hasAttribute("selected");
  }
  set selected(e) {
    e ? s(this, m).setAttribute("selected", "") : s(this, m).removeAttribute("selected");
  }
}, m = new WeakMap(), tt);
...
let _t = (ot = class {
  ...
  set(e, t, i = !1) {
    if (i && this.enableLocalStorage) {
      ...
      s(this, f)[e] = t;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + e.toString(), JSON.stringify(s(this, f)[e])), this.events.dispatchWithData(e, s(this, f)[e]);
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
let es = (rt = class {
  ...
  enableRipple() {
    s(this, E) || (this.removeRipple = qe(s(this, v)), s(this, v).style.cursor = "pointer", d(this, je, $t).call(this));
  }
  disableRipple() {
    s(this, E) && s(this, E).call(this), d(this, Ne, At).call(this);
  }
}, v = new WeakMap(), u = new WeakMap(), C = new WeakMap(), Q = new WeakMap(), F = new WeakMap(), E = new WeakMap(), je = new WeakSet(), $t = function() {
  s(this, C) || (a(this, u, s(this, v).querySelector("input")), s(this, u) && (s(this, v).addEventListener("click", s(this, Q)), s(this, u).addEventListener("click", s(this, F))), a(this, C, !0));
}, Ne = new WeakSet(), At = function() {
  s(this, u) && (s(this, v).removeEventListener("click", s(this, Q)), s(this, u).removeEventListener("click", s(this, F))), a(this, C, !1);
}, rt);
...
r(z, "register", () => customElements.define("ui-label", z)), r(z, "observedAttributes", ["ripple"]);
let pe = z;
...
r(ze, "register", () => customElements.define("ui-primary", ze));
let ge = ze;
...
r(Ie, "register", () => customElements.define("ui-secondary", Ie));
let me = Ie;
var h, Ue, zt;
class ts {
  constructor() {
...
h = new WeakMap(), Ue = new WeakSet(), zt = function() {
...
async function is() {
  _.register(), te.register(), ee.register(), se.register(), oe.register(), re.register(), ne.register(), U.register(), le.register(), ce.register(), ae.register(), he.register(), de.register(), ue.register(), me.register(), ge.register(), pe.register(), fe.register(), ie.register();
}
async function os() {
