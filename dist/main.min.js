...
`, S = class S extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Te, this.cleanup = new c(), this.ui = {
      getFlex: () => this.hasAttribute("flex") ? this.getAttribute("flex") : Et,
      /**
       * @param {string | null} value
       */
      setFlex: (e) => {
        e === null ? this.removeAttribute("flex") : this.setAttribute("flex", e);
      }
    }, this.updateStyle();
  }
  connectedCallback() {
...
`, $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = He, this.cleanup = new c(), this.ui = {
      getGap: () => this.getAttribute("gap") || Mt,
      /**
       * @param {string | null} value
       */
      setGap: (e) => {
...
`, z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ae, this.cleanup = new c(), this.ui = {
      getGap: () => this.getAttribute("gap") || Tt,
      /**
       * @param {string | null} value
       */
      setGap: (e) => {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(t.content.cloneNode(!0)), this.cleanup = new c(), this.ui = {
       ...
       */
      setTitle: (e) => {
        let i = this.querySelector('[slot="title"]');
        e === null && i && (this.removeChild(i), i = null), i || (i = new E(), i.slot = "title", this.appendChild(i)), i.innerHTML = e || "";
      },
      getTitle: () => {
        var e;
        return ((e = this.querySelector('[slot="title"]')) == null ? void 0 : e.innerHTML) || null;
      },
      /**
       * @param {UIInputTypes} value
       */
      setType: (e) => {
        this.ui.input.value = e;
      },
      /**
       * @returns {UIInputTypes}
       */
      getType: () => this.ui.input.type || "text",
      /**
       * @param {UIInputTypeValues[T]} value
       */
      setValue: (e) => {
        this.ui.input.value = e.toString();
      },
      /**
      ...
      getValue: () => {
        switch (this.ui.input.type) {
          case "number":
            return this.ui.input.value ? new Number(this.ui.input.value) : NaN;
          default:
       ...
       */
      setPlaceholder: (e) => {
        this.ui.input.placeholder = e || "";
      },
      /**
       * @returns {string}
       */
      getPlaceholder: () => this.ui.input.placeholder,
      /**
       * @param {boolean} state
       */
      setInvalid: (e) => {
        this.ui.input.ariaInvalid = e ? "" : null;
      },
      /**
       * @returns {boolean}
       */
      getInvalid: () => this.ui.input.ariaInvalid !== null,
      /**
      ...
      getMin: () => {
        switch (this.ui.input.type) {
          case "number":
            return this.ui.input.min ? new Number(this.ui.input.min) : NaN;
          default:
      ...
      getMax: () => {
        switch (this.ui.input.type) {
          case "number":
            return this.ui.input.max ? new Number(this.ui.input.max) : NaN;
          default:
