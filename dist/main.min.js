...
var u = (o, t, e) => (Tt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), wt = (o, t, e) => t.has(o) ? yt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const kt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class c {
  ...
  off(t, e) {
    ...
    for (const a of u(this, d)[t])
      a === e && (u(this, d)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
const g = class g extends HTMLElement {
    ...
    super(), this.attachShadow({ mode: "open" }), this.removeRippleCallback = null, this.ui = {
      ...
      set noripple(t) {
        if (!t) {
          ...
          this.root.removeRippleCallback = h(this.root);
        }
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <slot></slot>
    `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = h(this)), this.addEventListener("click", () => {
...
const b = class b extends HTMLElement {
  ...
  shadowRender() {
    ...
    `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = h(this, { centered: !0 })), this.addEventListener("click", () => {
      this.ui.events.dispatch("click", this);
    });
  }
  connectedCallback() {
...
`, m = class m extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Et(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new c(),
      get title() {
...
const x = class x extends HTMLElement {
  ...
  enableRipple() {
    if (this.removeRipple || (this.removeRipple = h(this), this.style.cursor = "pointer", this.running)) return;
