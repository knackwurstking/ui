...
var Ze = (o, e, t) => e in o ? Je(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var s = (o, e, t) => Ze(o, typeof e != "symbol" ? e + "" : e, t), de = (o, e, t) => e.has(o) || he("Cannot " + t);
var y = (o, e, t) => (de(o, e, "read from private field"), t ? t.call(o) : e.get(o)), c = (o, e, t) => e.has(o) ? he("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t);
var u = (o, e, t) => (de(o, e, "access private method"), t);
class Ue {
  constructor() {
    this.callbacks = [];
  }
...
function Ge(o, e, { onDragStart: t = null, onDragging: i = null, onDragEnd: r = null } = {}) {
  const a = () => {
    const p = [...o.children].indexOf(e);
    e.draggable = !0, e.ondragstart = (g) => {
      g.dataTransfer.effectAllowed = "move", g.dataTransfer.dropEffect = "move", t && t(p);
    }, e.ondragover = (g) => (g.preventDefault(), !1), e.ondragenter = (g) => {
      g.preventDefault(), [...o.children].forEach(
        (v, D) => {
          if (D === p) {
            v.style.background = "var(--ui-primary)", v.style.color = "var(--ui-primary-fg)";
            return;
          }
          v.style.background = "inherit", v.style.color = "inherit";
        }
      ), i && i(p);
    }, e.ondrop = (g) => {
      g.preventDefault(), g.dataTransfer.dropEffect = "move", r && r(p), [...o.children].forEach((v) => {
        v.style.background = "inherit", v.style.color = "inherit";
      });
    };
  }, d = () => {
...
function Ne(o, { onDragEnd: e = null, onDragStart: t = null } = {}) {
  let i = null, r = null, a = null, d = null, h = null, p = !1, g = null, v = null;
  const D = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (a = n.clientX, d = n.clientY, r = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, h || clearTimeout(h), h = setTimeout(() => {
      g = i.style.color, v = i.style.backgroundColor, i.style.color = "var(--ui-primary-fg)", i.style.backgroundColor = "var(--ui-primary)", o.classList.add("dragging"), p = !0, t && t();
    }, 200));
  }, le = (n) => {
    if (!r || !i) return;
    if (!p && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const ce = Math.abs(a - n.clientX), ue = Math.abs(d - n.clientY);
      if ((ce > ue ? ce : ue) < 24)
        return;
      Rt();
      return;
    }
    n.preventDefault(), p || (p = !0, t && t());
    const k = !!n.targetTouches && n.targetTouches[0] || n;
    let f = document.elementFromPoint(k.clientX, k.clientY);
    for (; !f.classList.contains("draggable") && f.parentElement; )
      f = f.parentElement;
    f.classList.contains("draggable") && Xe(i, f);
  }, Rt = () => {
    h !== null && (clearTimeout(h), h = null), i && (i.style.color = g, i.style.backgroundColor = v, i = null), r = null, o.classList.remove("dragging"), p && (e && e(), p = !1);
  };
  function Xe(n, k) {
    De(n, k) ? o.insertBefore(n, k) : o.insertBefore(n, k.nextElementSibling);
  }
  function De(n, k) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (n) => {
        n.classList.add("draggable"), n.onmousedown = D, n.ontouchstart = D, n.onmousemove = le, n.ontouchmove = le, n.onmouseup = Rt, n.ontouchend = Rt;
      }
    );
  })(), {
    /** @param {DraggableMobile_Options} options */
    update: (n) => {
      Object.hasOwn(n, "onDragStart") && (t = n.onDragStart), Object.hasOwn(n, "onDragEnd") && (e = n.onDragEnd);
    },
    destroy: () => {
      Array.from(o.children).forEach(
        (n) => {
...
class b {
  ...
  on(e, t) {
    ...
    return y(this, m)[e] || (y(this, m)[e] = []), y(this, m)[e].push(t), () => {
      this.off(e, t);
    };
  }
  /**
  ...
  off(e, t) {
    ...
    let i = !1, r = 0;
    for (const a of y(this, m)[e])
      a === t && (y(this, m)[e].splice(r, 1), i = !0), r++;
    if (!i)
...
function w(o, e = {}) {
  ...
  const i = (p) => {
    ...
    o.classList.add("ripple-container"), o.style.overflow = "hidden", e.useClick === !0 ? o.addEventListener("click", a) : (o.addEventListener("pointerdown", i), o.addEventListener("pointerup", r), o.addEventListener("pointerleave", r));
  }, h = () => {
    o.classList.remove("ripple-container"), e.useClick === !0 ? o.removeEventListener("click", a) : (o.removeEventListener("pointerdown", i), o.removeEventListener("pointerup", r), o.removeEventListener("pointerleave", r));
  };
  return d(), {
    update: (p) => {
      e = {
...
function qt(o, e) {
  ...
  if (e.centered)
    ...
    const a = !!o.targetTouches && o.targetTouches[0] || o;
    t.style.top = `${a.clientY - i.top}px`, t.style.left = `${a.clientX - i.left}px`;
  }
...
const l = String.raw, B = String.raw;
function ri(o) {
...
J = new WeakSet(), ge = function() {
  ...
  customElements.get("ui-alerts") || customElements.define("ui-alerts", Z);
});
let jt = Z;
var G, be;
...
K = new WeakSet(), me = function() {
  ...
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", A);
}), s(A, "observedAttributes", ["gap"]);
let Ot = A;
var Q, ve;
const W = class W extends P {
  ...
  constructor(t = null) {
    super();
    c(this, Q);
    this.messageContainer = null, this.styleVariants = {
      info: B`
                :host {
       ...
       */
      set({ message: i }) {
        this.root.messageContainer.innerHTML = i;
      },
      get message() {
    ...
    }, u(this, Q, ve).call(this), t && this.ui.set(t);
  }
...
Q = new WeakSet(), ve = function() {
  ...
  customElements.get("ui-alert") || customElements.define("ui-alert", W);
});
let Ft = W;
var _, ye;
...
_ = new WeakSet(), ye = function() {
  ...
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", I);
});
let Vt = I;
var U, ke;
...
const L = class L extends HTMLElement {
  constructor() {
    ...
    this.ripple = null, this.ui = {
      ...
      set noripple(t) {
        if (!t) {
          this.root.ripple && this.root.ripple.destroy(), this.root.ripple = w(this.root);
          return;
        }
...
et = new WeakSet(), we = function() {
  this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = l`
            ...
            <slot></slot>
        `, typeof this.ripple != "function" && (this.ripple = w(this)), this.addEventListener("click", () => {
    this.ui.events.dispatch("click", this);
  });
}, s(L, "register", () => {
  customElements.get("ui-button") || customElements.define("ui-button", L);
}), s(L, "observedAttributes", ["noripple"]);
let Bt = L;
var it, xe;
...
it = new WeakSet(), xe = function() {
  this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = l`
        ...
        `, typeof this.ripple != "function" && (this.ripple = w(this, { centered: !0 })), this.addEventListener("click", () => {
    this.ui.events.dispatch("click", this);
  });
}, s(S, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", S);
}), s(S, "observedAttributes", ["noripple"]);
let Pt = S;
var rt, Ce;
const ot = class ot extends HTMLElement {
  constructor() {
    super();
    c(this, rt);
    this.ui = {}, u(this, rt, Ce).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
rt = new WeakSet(), Ce = function() {
  ...
  customElements.get("ui-container") || customElements.define("ui-container", ot);
});
let Xt = ot;
const Ke = l`
...
const T = class T extends HTMLElement {
  ...
  constructor(t) {
    ...
    this._title = t || "", this.ui = {
       ...
       */
      open(i = !1, r = !0) {
        const a = this.root.shadowRoot.querySelector("dialog"), d = a.inert;
        a.inert = r, i ? a.showModal() : a.show(), this.events.dispatch("open", null), a.inert = d;
      },
      close() {
        this.events.dispatch("close", null), this.root.shadowRoot.querySelector("dialog").close();
      }
    }, u(this, st, Ee).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
  ...
  static createAction({
    ...
    const d = new P();
    d.ui.flex = r, d.slot = "actions", d.innerHTML = l`
            <ui-button variant="${t}" color="${i}"></ui-button>
        `;
    let h;
    return a && (h = d.querySelector("ui-button"), h.ui.events.on("click", a)), {
      container: d,
      action: h
    };
  }
};
st = new WeakSet(), Ee = function() {
  this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = l`
            <style>
                * {
                    box-sizing: border-box;
  ...
  const r = this.shadowRoot.querySelector("dialog"), a = (d) => d.preventDefault();
  r.addEventListener("cancel", a);
}, s(T, "register", () => {
  customElements.get("ui-dialog") || customElements.define("ui-dialog", T);
}), s(T, "observedAttributes", ["title"]);
let Dt = T;
var nt, Ae;
...
nt = new WeakSet(), Ae = function() {
  ...
  customElements.get("ui-drawer") || customElements.define("ui-drawer", at);
});
let Jt = at;
const Le = l`
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
lt = new WeakSet(), Se = function() {
  ...
  customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", M);
}), s(M, "observedAttributes", ["title"]);
let Zt = M;
var ct, Te;
const ut = class ut extends HTMLElement {
  constructor() {
    super();
    c(this, ct);
    this.ui = {}, u(this, ct, Te).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
ct = new WeakSet(), Te = function() {
  ...
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", ut);
});
let Gt = ut;
var ht, Me;
...
ht = new WeakSet(), Me = function() {
  ...
  customElements.get("ui-check") || customElements.define("ui-check", H);
}), s(H, "observedAttributes", ["checked"]);
let Nt = H;
var dt, He;
const R = class R extends HTMLElement {
  ...
  enableRipple() {
    if (this.ripple || (this.ripple = w(this), this.style.cursor = "pointer", this.running)) return;
...
dt = new WeakSet(), He = function() {
  ...
  customElements.get("ui-label") || customElements.define("ui-label", R);
}), s(R, "observedAttributes", ["ripple", "secondary", "primary"]);
let Kt = R;
var pt, Re;
const gt = class gt extends HTMLElement {
  constructor() {
    super();
    c(this, pt);
    this.ui = {}, u(this, pt, Re).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const ft = class ft extends HTMLElement {
  constructor() {
    super();
    c(this, bt);
    this.ui = {}, u(this, bt, qe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
  ...
  constructor() {
    ...
    this.ui = {
      ...
      set title(t) {
        ...
        !t && i && this.root.removeChild(i), t && (i || (i = new x(), i.slot = "title", this.root.appendChild(i)), i.innerHTML = t);
      },
      get type() {
...
mt = new WeakSet(), ze = function() {
  ...
  customElements.get("ui-input") || customElements.define("ui-input", q);
...
vt = new WeakSet(), je = function() {
  ...
  customElements.get("ui-search") || customElements.define("ui-search", z);
...
yt = new WeakSet(), $e = function() {
  ...
  customElements.get("ui-select-option") || customElements.define("ui-select-option", kt);
});
let X = kt;
var wt, Oe;
const j = class j extends HTMLElement {
  ...
  attributeChangedCallback(t, i, r) {
    switch (t) {
      case "open":
        const a = r !== null;
        a !== this.ui.open && (this.ui.open = a);
        break;
    }
  }
};
wt = new WeakSet(), Oe = function() {
  this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = l`
            <style>
                * {
                    box-sizing: border-box;
            ...
            <div class="options">
                <div class="icon"><ui-svg>${Le}</ui-svg></div>
  ...
  const t = (r) => {
    const a = async (d) => {
      (d.composedPath() || []).forEach((h) => {
        h instanceof X && ([...this.querySelectorAll("ui-select-option")].forEach(
          (p) => p.removeAttribute("selected")
        ), h.setAttribute("selected", ""), this.ui.events.dispatch("change", h));
      });
    };
    this.ui.open = !this.ui.open, this.ui.open ? (r.stopPropagation(), this.addEventListener("click", a)) : setTimeout(
      () => this.removeEventListener("click", a)
    );
  };
  this.shadowRoot.querySelector(".options").addEventListener("click", t);
}, s(j, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", j);
}), s(j, "observedAttributes", ["open"]);
let It = j;
var xt, Fe;
...
s(O, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", O);
}), s(O, "observedAttributes", ["current"]);
let te = O;
...
s(Ct, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", Ct);
});
let ee = Ct;
var Et, Ve;
...
Et = new WeakSet(), Ve = function() {
  ...
  customElements.get("ui-spinner") || customElements.define("ui-spinner", F);
}), s(F, "observedAttributes", ["nobg"]);
let ie = F;
var At, Ye;
...
At = new WeakSet(), Ye = function() {
  ...
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", V);
}), s(V, "observedAttributes", ["name"]);
let re = V;
var Lt, Be;
const St = class St extends HTMLElement {
  constructor() {
    ...
    this.pages = {}, this.stack = [], this.onpopstate = () => this.goBack(), this.ui = {
      ...
      set(t, i = null, r = !1) {
        if (this.lock) return;
        const a = this.root.pages[t]();
        this.root.stack.push(this.root.appendChild(a)), typeof i == "function" && i(a);
        let d = null;
...
Lt = new WeakSet(), Be = function() {
  ...
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", St);
});
let oe = St;
const Tt = class Tt extends HTMLElement {
  constructor() {
...
s(Tt, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", Tt);
});
let se = Tt;
...
const Ht = class Ht extends HTMLElement {
  constructor() {
    super();
    c(this, Mt);
    this.ui = {}, u(this, Mt, Pe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Mt = new WeakSet(), Pe = function() {
  ...
  customElements.get("ui-svg") || customElements.define("ui-svg", Ht);
});
let ae = Ht;
function oi() {
  jt.register(), Ft.register(), Yt.register(), Vt.register(), Bt.register(), Pt.register(), Xt.register(), Dt.register(), Gt.register(), Zt.register(), Jt.register(), P.register(), $t.register(), Ot.register(), Nt.register(), Wt.register(), _t.register(), X.register(), It.register(), Ut.register(), ee.register(), te.register(), ie.register(), oe.register(), re.register(), se.register(), ae.register(), Kt.register(), Qt.register(), x.register(), ne.register();
}
export {
  Ue as CleanUp,
  b as Events,
  ...
  ie as UISpinner,
  oe as UIStackLayout,
  re as UIStackLayoutPage,
  se as UIStore,
  Ut as UITextarea,
  ne as UIThemeHandler,
  B as css,
  ti as draggable,
  l as html,
  ii as isAndroid,
