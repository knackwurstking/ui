...
var xt = (r, t, e) => t in r ? kt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var o = (r, t, e) => xt(r, typeof t != "symbol" ? t + "" : t, e), Ct = (r, t, e) => t.has(r) || bt("Cannot " + e);
var c = (r, t, e) => (Ct(r, t, "read from private field"), e ? e.call(r) : t.get(r)), mt = (r, t, e) => t.has(r) ? bt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(r) : t.set(r, e);
const ft = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function Rt(r, t = {}) {
  ...
  const e = () => {
    ...
    r.draggable = !0, r.ondragstart = (n) => {
      n.dataTransfer.effectAllowed = "move", n.dataTransfer.dropEffect = "move", n.dataTransfer.setData(
        "text/plain",
        a.toString()
      ), t.onDragStart && t.onDragStart(a);
    }, r.ondragover = (n) => (n.preventDefault(), !1), r.ondragenter = (n) => {
      n.preventDefault(), t.onDragging && t.onDragging(a);
    }, r.ondrop = (n) => {
...
class d {
  ...
  on(t, e) {
    ...
    return c(this, h)[t] || (c(this, h)[t] = []), c(this, h)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const a of c(this, h)[t])
      a === e && (c(this, h)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
}), o(b, "observedAttributes", ["noripple"]);
let Q = b;
...
const v = class v extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.renderCleanUp = new u(), this.ui = {
      root: this,
      /**
...
const V = class V extends HTMLElement {
  constructor() {
    ...
    `);
    o(this, "shadowTemplate", () => l`<slot></slot>`);
...
o(C, "register", () => {
  H.register(), g.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
}), o(C, "observedAttributes", ["ripple", "secondary", "primary"]);
let ot = C;
...
const O = class O extends HTMLElement {
  ...
  shadowRender() {
    ...
    const t = (i) => {
      const s = async (a) => {
        (a.composedPath() || []).forEach((n) => {
          n instanceof M && ([...this.querySelectorAll("ui-select-option")].forEach(
  ...
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      setPage(e, i = null, s = !1) {
        if (this.lock) return;
        const a = this.pages[e]();
        this.stack.push(this.root.appendChild(a)), typeof i == "function" && setTimeout(() => i(a));
        let n = null;
...
}), o(S, "observedAttributes", ["use-history"]);
let ut = S;
...
}), o(L, "observedAttributes", ["use-storage", "storage-prefix"]);
let ct = L;
...
}), o(T, "observedAttributes", ["auto", "mode"]);
let pt = T;
const K = class K extends HTMLElement {
  constructor() {
    super();
