...
let Bt = (_e = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Oe(s(this, O), { centered: !0 }));
  }
  disableRipple() {
...
r(S, "register", () => customElements.define("ui-button", S)), r(S, "observedAttributes", ["no-ripple"]);
let te = S;
...
let Xt = (et = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Oe(s(this, P), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
r(Le, "register", () => customElements.define("ui-select-option", Le));
let q = Le;
...
const ke = class ke extends HTMLElement {
  constructor() {
    ...
    /** @param {Event} ev */
    n(this, Y, (t) => {
      this.classList.toggle("open") ? (t.stopPropagation(), this.addEventListener("click", s(this, L))) : setTimeout(
        () => this.removeEventListener("click", s(this, L))
      );
    });
  ...
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", s(this, L)), (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", s(this, Y));
  }
};
Y = new WeakMap(), L = new WeakMap(), r(ke, "register", () => customElements.define("ui-select", ke));
let ae = ke;
var K, k, Q, it;
let Qt = (it = class {
  /** @param {Lang} root */
  constructor(e) {
     ...
     */
    n(this, Q, void 0);
    a(this, K, e), a(this, k, new _()), this.langType = null;
  }
   ...
   */
  new(e, t) {
    this.langType = e, a(this, Q, t), s(this, k).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  on(e, t, i = !1) {
    ...
    return i && t(this.langType), s(this, k).addListener(e, t);
  }
}, K = new WeakMap(), k = new WeakMap(), Q = new WeakMap(), it);
var Ce, yt;
...
const Ee = class Ee extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Lt.content.cloneNode(!0)), this.ui = new _t(this);
  }
};
...
r(Se, "register", () => customElements.define("ui-svg-chevron-down", Se));
let Je = Se;
...
let ts = (nt = class {
  ...
  enableRipple() {
    s(this, M) || (this.removeRipple = Oe(s(this, f)), s(this, f).style.cursor = "pointer", d(this, Ne, At).call(this));
  }
  disableRipple() {
