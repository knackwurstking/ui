...
o(V, "register", () => {
  R.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", V);
});
let wt = V;
const re = n`
    <style>
...
o(O, "register", () => {
  customElements.get("svg-document-new") || customElements.define("svg-document-new", O);
});
let St = O;
const fe = n`
    <style>
...
o(J, "register", () => {
  lt.register(), H.register(), R.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", J);
});
let Zt = J;
const $t = 150, Ce = n`
    <style>
...
o(C, "register", () => {
  ut.register(), T.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", C);
}), o(C, "observedAttributes", ["title"]);
let Bt = C;
const Ae = n`
    <style>
        * {
...
o(U, "register", () => {
  at.register(), g.register(), customElements.get("ui-select") || customElements.define("ui-select", U);
});
let zt = U;
const Te = n`
    <style>
...
o(x, "register", () => {
  p.register(), H.register(), ct.register(), customElements.get("ui-search") || customElements.define("ui-search", x);
