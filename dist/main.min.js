...
}, l = (i, t, e, o) => (Ot(i, t, "write to private field"), o ? o.call(i, e) : t.set(i, e), e);
const Pt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
let Oe = (Xt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Rt(s(this, P), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
let Pe = (Yt = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, x, void 0);
    l(this, b, t), l(this, y, e), this.events = new H(), l(this, x, document.createElement("h4")), s(this, x).slot = "title", s(this, b).appendChild(s(this, x));
  }
  get dialog() {
    return s(this, y);
  }
...
}, b = new WeakMap(), y = new WeakMap(), x = new WeakMap(), Yt);
var D, V;
...
D = new WeakMap(), V = new WeakMap(), r(pt, "register", () => customElements.define("ui-dialog", pt));
let G = pt;
const Dt = "1", ae = document.createElement("template");
ae.innerHTML = `
<style></style>
<slot></slot>
`;
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ae.content.cloneNode(!0)), this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
const gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(de.content.cloneNode(!0)), this.ui = new De(this);
  }
};
...
const mt = class mt extends HTMLElement {
  ...
  async onClick(t) {
    (t.composedPath() || []).forEach((e) => {
      ...
      ), e.setAttribute("selected", ""), this.ui.events.dispatch("change", e));
    });
  }
  // }}}
};
...
let Ze = (Qt = class {
  ...
  constructor(t) {
     ...
     */
    n(this, J, void 0);
    l(this, Z, t), l(this, C, new H()), this.langType = null;
  }
   ...
   */
  new(t, e) {
    this.langType = t, l(this, J, e), s(this, C).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
...
}, Z = new WeakMap(), C = new WeakMap(), J = new WeakMap(), Qt);
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(pe.content.cloneNode(!0)), this.ui = new Be(this);
  }
};
...
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0)), this.ui = new Xe(this);
  }
};
...
let Ke = (te = class {
  ...
  _startInputHandling() {
    s(this, S) || (s(this, c).addEventListener("click", s(this, B)), this.getInputSlot().forEach((t) => {
...
}, c = new WeakMap(), S = new WeakMap(), B = new WeakMap(), X = new WeakMap(), T = new WeakMap(), te);
const U = class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0)), this.ui = new Ke(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
async function Ge() {
  Y.register(), Q.register(), K.register(), W.register(), F.register(), _.register(), tt.register(), q.register(), et.register(), it.register(), st.register(), ot.register(), rt.register(), nt.register(), ct.register(), at.register(), lt.register(), ht.register(), G.register();
}
async function Fe() {
