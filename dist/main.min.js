...
var r = (s, e, t) => xt(s, typeof e != "symbol" ? e + "" : e, t), St = (s, e, t) => e.has(s) || bt("Cannot " + t);
var p = (s, e, t) => (St(s, e, "read from private field"), t ? t.call(s) : e.get(s)), ft = (s, e, t) => e.has(s) ? bt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(s) : e.set(s, t);
const vt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class c {
  ...
  on(e, t) {
    ...
    return p(this, d)[e] || (p(this, d)[e] = []), p(this, d)[e].push(t), () => {
      this.off(e, t);
    };
  }
  // }}}
  ...
  off(e, t) {
    ...
    let i = !1, o = 0;
    for (const n of p(this, d)[e])
      n === t && (p(this, d)[e].splice(o, 1), i = !0), o++;
    if (!i)
...
function wt(s, e) {
  ...
  e.centered ? (t.style.top = `${i.height / 2}px`, t.style.left = `${i.width / 2}px`) : (t.style.top = `${s.clientY - i.top}px`, t.style.left = `${s.clientX - i.left}px`);
...
}), r(b, "observedAttributes", ["no-ripple"]);
let Q = b;
...
}), r(f, "observedAttributes", ["no-ripple"]);
let W = f;
...
`, v = class v extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new h(), this.ui = {
      ...
      open(e = !1, t = !0) {
        ...
        i.inert = t, e ? i.showModal() : i.show(), this.events.dispatch("open", null), i.inert = o;
      },
      close() {
  ...
  shadowRender() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), o = (n) => n.preventDefault();
    i.addEventListener("cancel", o), this.shadowRenderCleanUp.add(() => {
      e.removeEventListener("click", t), i.removeEventListener("cancel", o);
    });
  }
  render() {
  }
...
const w = class w extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = `
        ...
        `, this.shadowRoot.querySelector("aside").addEventListener("click", (e) => e.stopPropagation());
  }
  render() {
    ...
    this.addEventListener("click", e), this.renderCleanUp.add(
      () => {
        this.removeEventListener("click", e);
      }
    );
...
const y = class y extends HTMLElement {
  ...
  setGroupTitle(e) {
    ...
    t.classList.add("visible"), t.innerHTML = `
            <span
                style="
                    font-size: 1.5rem;
                    font-weight: 600;
...
r(C, "register", () => {
  customElements.get("ui-flex-grid-row") || customElements.define("ui-flex-grid-row", C);
...
const g = class g extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setGap(t) {
        this.shadowAttr.gap = t || g.defaultGap, this.root.shadowRender({ ...this.shadowAttr });
      }
...
r(g, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", g);
}), r(g, "observedAttributes", ["gap"]), r(g, "defaultGap", "0");
let ot = g;
...
r(x, "register", () => {
  M.register(), m.register(), customElements.get("ui-label") || customElements.define("ui-label", x);
    ...
    switch (t) {
      case "title":
        ...
        if (o === null && n && (this.removeChild(n), n = null), o === null)
          return;
        n || (n = new m(), n.slot = "title", this.appendChild(n)), n.innerHTML = o;
        break;
      case "type":
...
const D = class D extends HTMLElement {
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), i = async (n) => {
...
`, A = class A extends HTMLElement {
  ...
  attributeChangedCallback(t, i, o) {
    switch (t) {
      case "title":
        let n = this.querySelector('[slot="title"]');
        o === null && n && (this.removeChild(n), n = null), n || (n = new m(), n.slot = "title", this.appendChild(n)), n.innerHTML = o || "";
        break;
      case "value":
        this.ui.setValue(o);
        break;
...
const E = class E extends HTMLElement {
  constructor() {
    super(), this.ui = {
      ...
      get(e, t) {
        var i, o;
        return ((o = (i = this.data) == null ? void 0 : i[e]) == null ? void 0 : o[t]) || null;
      },
      /**
       * @param {"change"} key
      ...
      on(e, t, i = !1) {
        ...
        return i && t(this.langType), this.events.on(e, t);
      }
    };
  }
  /**
  ...
  async loadLanguage(e) {
    ...
    const i = await fetch(t.ui.getHref());
    this.ui.new(t, await i.json());
  }
};
r(E, "register", () => {
...
}), r(T, "observedAttributes", ["use-storage", "storage-prefix"]);
let pt = T;
...
r(G, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", G);
});
let mt = G;
function $t() {
  B.register(), X.register(), Q.register(), W.register(), _.register(), U.register(), et.register(), tt.register(), I.register(), it.register(), rt.register(), ot.register(), nt.register(), lt.register(), H.register(), at.register(), ht.register(), ut.register(), dt.register(), ct.register(), $.register(), pt.register(), mt.register(), st.register(), M.register(), m.register(), gt.register();
}
export {
  X as UIAppBar,
  B as UIAppBarItem,
