...
var ye = (o, t, e) => t in o ? we(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => (ye(o, typeof t != "symbol" ? t + "" : t, e), e), Rt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var i = (o, t, e) => (Rt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), l = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, c = (o, t, e, s) => (Rt(o, t, "write to private field"), s ? s.call(o, e) : t.set(o, e), e);
const $t = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const n = String.raw, xe = String.raw;
class h {
  constructor() {
    this.callbacks = [];
  }
...
const fi = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  createRipple: kt,
  css: xe,
  defaultRippleOptions: fe,
  html: n,
  isAndroid: Ce
}, Symbol.toStringTag, { value: "Module" })), Ct = "1", Le = n`
<style></style>
<slot></slot>
`;
let Ee = class {
...
const q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Le, this.cleanup = new h(), this.ui = new Ee(this), this.updateStyle();
  }
  connectedCallback() {
  }
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this.cleanup = new h(), this.ui = new He(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const D = class D extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Te, this.cleanup = new h(), this.ui = new Ae(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let je = (ne = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = kt(i(this, p), { centered: !0 }), i(this, p).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new je(this);
  }
  connectedCallback() {
...
const V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ze, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new qe(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
}, x = new WeakMap(), b = new WeakMap(), L = new WeakMap(), le);
const ut = class ut extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = We, this.cleanup = new h(), this.ui = new Ge(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
r(ut, "register", () => {
  Et.register(), Ht.register(), W.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", ut);
});
let Wt = ut;
const Ie = n`
<style>
...
`, dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ie, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(dt, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", dt);
});
let Tt = dt;
const Ue = n`
<style>
...
`, pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ue, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(pt, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", pt);
});
let J = pt;
const _e = n`
<style>
...
let ti = (ce = class {
  ...
  enableRipple() {
    i(this, $) || (this.removeRipple = kt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
...
}, u = new WeakMap(), R = new WeakMap(), Y = new WeakMap(), X = new WeakMap(), $ = new WeakMap(), ce);
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = _e, this.cleanup = new h(), this.ui = new ti(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(P, "register", () => {
  Tt.register(), J.register(), customElements.get("ui-label") || customElements.define("ui-label", P);
}), r(P, "observedAttributes", ["ripple", "secondary", "primary"]);
let Gt = P;
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(be.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new ei(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(O, "register", () => {
  J.register(), customElements.get("ui-input") || customElements.define("ui-input", O);
...
const mt = class mt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = oi, this.cleanup = new h(), this.ui = new ri();
  }
  // }}}
  connectedCallback() {
...
K = new WeakMap(), // }}}
r(mt, "register", () => {
  Mt.register(), G.register(), customElements.get("ui-select") || customElements.define("ui-select", mt);
});
let Ut = mt;
var E, S, Q, ue;
let ni = (ue = class {
   ...
   */
  new(t, e) {
    this.langType = t, c(this, Q, e), i(this, S).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
...
}, E = new WeakMap(), S = new WeakMap(), Q = new WeakMap(), ue);
const B = class B extends HTMLElement {
  constructor() {
    super(), this.ui = new ni(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
r(ft, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", ft);
});
let te = ft;
const li = n`
<style>
...
r(bt, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", bt);
});
let ee = bt;
const ci = n`
    <style>
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ci, this.cleanup = new h(), this.ui = new hi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(vt, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", vt);
});
let At = vt;
const ui = n`
    <style>
...
let di = (ge = class {
  ...
  constructor(t) {
     ...
     */
    l(this, z, {});
    c(this, H, t), this.events = new A(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    if (!this.stack.length || i(this, T))
      return;
    const t = this.stack.pop(), e = i(this, H).removeChild(t);
    this.stack.length && i(this, H).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent(e);
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (!i(this, T)) {
      if (this.stack.push(
        // @ts-expect-error
        i(this, H).appendChild(i(this, z)[t]().children[0])
      ), this.stack.length > 1) {
...
}, H = new WeakMap(), T = new WeakMap(), z = new WeakMap(), ge);
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ui, this.cleanup = new h(), this.ui = new di(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(wt, "register", () => {
  At.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", wt);
});
let ie = wt;
var k, C, me;
let pi = (me = class {
...
}, k = new WeakMap(), C = new WeakMap(), me);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.ui = new pi(this);
  }
};
r(yt, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", yt);
});
let se = yt;
var w;
class gi {
...
export {
  ...
  ee as UISpinner,
  ie as UIStackLayout,
  At as UIStackLayoutPage,
  se as UIStore,
  oe as UIThemeHandler,
  fi as js
};
