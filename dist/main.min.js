...
const Ge = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: It
}, Symbol.toStringTag, { value: "Module" })), ot = "1", te = n`
    <style></style>
    <slot></slot>
...
o(T, "register", () => {
  R.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", T);
});
let wt = T;
const re = n`
    <style>
...
`, v = class v extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = se, this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = it(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
      },
      disableRipple() {
...
}), o(w, "observedAttributes", ["no-ripple", "color"]);
let H = w;
const ae = n`
    <style>
        * {
...
o($, "register", () => {
  customElements.get("svg-plus") || customElements.define("svg-plus", $);
});
let Lt = $;
const ce = n`
    <style>
...
o(j, "register", () => {
  customElements.get("svg-chevron-left") || customElements.define("svg-chevron-left", j);
});
let xt = j;
const ue = n`
    <style>
...
o(G, "register", () => {
  customElements.get("svg-chevron-down") || customElements.define("svg-chevron-down", G);
});
let nt = G;
const he = n`
    <style>
...
o(B, "register", () => {
  customElements.get("svg-close") || customElements.define("svg-close", B);
});
let at = B;
const de = n`
    <style>
...
o(_, "register", () => {
  customElements.get("svg-search") || customElements.define("svg-search", _);
});
let lt = _;
const be = n`
    <style>
...
o(P, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", P);
});
let Rt = P;
const ve = n`
    <style>
...
o(N, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", N);
});
let Ht = N;
const we = n`
    <style>
...
o(D, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", D);
});
let Tt = D;
const ke = n`
    <style>
...
o(K, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", K);
});
let Vt = K;
const ye = n`
    <style>
...
o(Y, "register", () => {
  at.register(), H.register(), R.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", Y);
});
let Zt = Y;
const $t = 150, Ce = n`
    <style>
...
o(y, "register", () => {
  ct.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", y);
...
`, C = class C extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = it(this.root), this.root.style.cursor = "pointer", this.startInputHandling());
      },
      disableRipple() {
...
o(C, "register", () => {
  ut.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
...
o(I, "register", () => {
  nt.register(), g.register(), customElements.get("ui-select") || customElements.define("ui-select", I);
});
let zt = I;
const Te = n`
    <style>
...
o(x, "register", () => {
  p.register(), H.register(), lt.register(), customElements.get("ui-search") || customElements.define("ui-search", x);
}), o(x, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
o(M, "register", () => {
  ht.register(), customElements.get("ui-lang") || customElements.define("ui-lang", M);
}), o(M, "observedAttributes", ["current"]);
let Ot = M;
const Ve = n`
    <style>
        :host {
...
o(E, "register", () => {
  dt.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", E);
}), o(E, "observedAttributes", ["use-history"]);
let Pt = E;
...
}), o(S, "observedAttributes", ["use-storage", "storage-prefix"]);
let Nt = S;
...
}), o(A, "observedAttributes", ["auto", "mode"]);
let Dt = A;
export {
  nt as SvgChevronDown,
