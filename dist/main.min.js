...
var $t = (o, e, t) => e in o ? At(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var d = (o, e, t) => ($t(o, typeof e != "symbol" ? e + "" : e, t), t), _ = (o, e, t) => {
  if (!e.has(o))
    throw TypeError("Cannot " + t);
};
var i = (o, e, t) => (_(o, e, "read from private field"), t ? t.call(o) : e.get(o)), r = (o, e, t) => {
  if (e.has(o))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(o) : e.set(o, t);
}, l = (o, e, t, s) => (_(o, e, "write to private field"), s ? s.call(o, t) : e.set(o, t), t);
var p = (o, e, t) => (_(o, e, "access private method"), t);
class B {
  constructor(e = !1) {
  ...
  removeListener(e, t) {
    ...
    let s = !1, n = 0;
    for (const m of this.listeners[e])
      m === t && (this.listeners[e].splice(n, 1), s = !0), n++;
    if (!s)
...
const Dt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ripple: Nt,
  utils: Dt
}, Symbol.toStringTag, { value: "Module" })), V = document.createElement("template");
V.innerHTML = `
<style>
    :host {
        display: flex;
...
class X extends HTMLElement {
  ...
  connectedCallback() {
    this.hasAttribute("no-ripple") || O(this);
  }
}
...
class K extends HTMLElement {
  ...
  connectedCallback() {
    this.hasAttribute("no-ripple") || O(this, { centered: !0 });
  }
}
...
class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Q.content.cloneNode(!0));
  }
}
...
class st extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ot.content.cloneNode(!0));
  }
  /**
   * Runs each time the element is appended to or moved in the DOM
   */
...
class nt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(it.content.cloneNode(!0));
  }
  /**
   * Runs each time the element is appended to or moved in the DOM
   */
...
class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(rt.content.cloneNode(!0)), this.type = "ui-select-option";
  }
  get value() {
...
class at extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(lt.content.cloneNode(!0));
  }
  /**
   * Runs each time the element is appended to or moved in the DOM
   */
  connectedCallback() {
    var t;
    i(this, g) || ((t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", i(this, k)), l(this, g, !0)), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", i(this, f)), (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", i(this, k)), l(this, g, !1);
  }
}
g = new WeakMap(), k = new WeakMap(), f = new WeakMap();
var v, C, I;
let Bt = (I = class {
  constructor() {
    r(this, v, void 0);
     ...
     */
    r(this, C, void 0);
    l(this, v, new B()), this.langType = null;
  }
  /**
   ...
   */
  new(e, t) {
    this.langType = e, l(this, C, t), i(this, v).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(e, t) {
    var s;
    return (s = i(this, C)) == null ? void 0 : s[e][t];
  }
  /**
   * @param {"change"} key
...
class ct extends HTMLElement {
  ...
  set current(t) {
    this.setAttribute("current", t), p(this, R, ht).call(this, t);
  }
  get current() {
...
R = new WeakSet(), ht = async function(t) {
...
class gt extends HTMLElement {
  constructor() {
     ...
     */
    r(this, w, {});
    this.events = new B(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(mt.content.cloneNode(!0)), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    }, this.stack.length && this.appendChild(this.stack[this.stack.length - 1].element), p(this, E, Z).call(this);
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (this.stack.push({
      name: t,
      // @ts-expect-error
      element: this.appendChild(i(this, w)[t]().children[0])
    }), this.stack.length > 1) {
...
w = new WeakMap(), E = new WeakSet(), Z = async function() {
  var t, s;
...
class Ot {
  ...
  constructor(e) {
    r(this, y, void 0);
    r(this, c, void 0);
    l(this, c, e), l(this, y, new B()), this.localStoragePrefix = "", this.enableLocalStorage = !1;
  }
  /**
   * @param {string} key
   */
  ...
  set(e, t, s = !1) {
    if (s && this.enableLocalStorage) {
      ...
      i(this, c).stores[e] = t;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + e, JSON.stringify(i(this, c).stores[e])), i(this, y).dispatchWithData(e, i(this, c).stores[e]);
  }
  /**
   * @param {string} key
...
y = new WeakMap(), c = new WeakMap();
class ft extends HTMLElement {
  constructor() {
    super(), this.data = new Ot(this), this.stores = {};
  }
  /**
   * Runs each time the element is appended to or moved in the DOM
   */
...
class It extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(bt.content.cloneNode(!0));
  }
}
...
const x = class x extends HTMLElement {
  constructor() {
    ...
    r(this, h, null);
    r(this, b, !1);
    r(this, M, async () => !!i(this, h) && i(this, h).click());
    r(this, T, async (t) => t.stopPropagation());
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ct.content.cloneNode(!0));
  }
  attributeChangedCallback(t, s, n) {
    switch (t) {
      case "ripple":
        n !== null ? this.enableRipple() : this.disableRipple();
        break;
    }
  }
  enableRipple() {
    O(this), this.style.cursor = "pointer", p(this, j, Et).call(this);
  }
  disableRipple() {
    p(this, N, Mt).call(this);
  }
};
h = new WeakMap(), b = new WeakMap(), M = new WeakMap(), T = new WeakMap(), j = new WeakSet(), Et = function() {
  i(this, b) || (l(this, h, this.querySelector("input")), i(this, h) && (this.addEventListener("click", i(this, M)), i(this, h).addEventListener("click", i(this, T))), l(this, b, !0));
}, N = new WeakSet(), Mt = function() {
  i(this, h) && (this.removeEventListener("click", i(this, M)), i(this, h).removeEventListener("click", i(this, T))), l(this, b, !1);
}, d(x, "register", () => customElements.define("ui-label", x)), d(x, "observedAttributes", ["ripple"]);
let S = x;
const Tt = document.createElement("template");
Tt.innerHTML = `
<style>
...
d(P, "register", () => customElements.define("ui-primary", P));
let H = P;
...
d(D, "register", () => customElements.define("ui-secondary", D));
let A = D;
var a, z, Ht;
const L = class L extends HTMLElement {
  ...
  attributeChangedCallback(t, s, n) {
    switch (t) {
      case "auto":
        n !== null ? this.enableAutoMode() : this.disableAutoMode();
        break;
      case "mode":
        n !== null ? this.setMode(n) : this.removeMode();
        break;
    }
  }
  enableAutoMode() {
    if (this.removeMode(), i(this, a)) {
      this.mediaChangeHandler(i(this, a));
      return;
    }
    l(this, a, window.matchMedia("(prefers-color-scheme: dark)")), i(this, a).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, a));
  }
  disableAutoMode() {
  ...
  loadTheme(t) {
    ...
    if (((n = this.currentTheme) == null ? void 0 : n.name) == t)
      return;
    {
      const m = document.getElementById("theme");
      m && (document.head.removeChild(m), this.currentTheme = null);
    }
...
a = new WeakMap(), z = new WeakSet(), Ht = function() {
  i(this, a) && (i(this, a).removeEventListener("change", this.mediaChangeHandler), l(this, a, null));
}, d(L, "register", () => customElements.define("ui-theme-handler", L)), d(L, "observedAttributes", ["auto", "mode"]);
let $ = L;
...
async function Jt() {
  customElements.define("ui-app-bar", G), customElements.define("ui-icon-button", K), customElements.define("ui-button", X), customElements.define("ui-container", U), customElements.define("ui-flex-grid", nt), customElements.define("ui-flex-grid-row", st), customElements.define("ui-flex-grid-item", et), customElements.define("ui-select-option", q), customElements.define("ui-select", at), customElements.define("ui-lang-type", dt), customElements.define("ui-lang", ct), customElements.define("ui-stack-layout-page", pt), customElements.define("ui-stack-layout", gt), customElements.define("ui-store", ft), customElements.define(
    "ui-icon-back-arrow-navigation",
    u.BackArrowNavigation
  ), customElements.define("ui-icon-chevron-down", u.ChevronDown), customElements.define(
    "ui-icon-delete-recycle-bin",
    u.DeleteRecycleBin
  ), customElements.define("ui-icon-edit2", u.Edit2), customElements.define("ui-icon-pdf-document", u.PDFDocument), customElements.define("ui-icon-settings", u.Settings), customElements.define("ui-icon-today-outline", u.TodayOutline), A.register(), H.register(), S.register(), $.register();
}
const Kt = {
  ...zt,
  wc: Gt,
