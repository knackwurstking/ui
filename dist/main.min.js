...
var r = (o, t, e) => (ge(o, typeof t != "symbol" ? t + "" : t, e), e), Mt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var i = (o, t, e) => (Mt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), a = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, c = (o, t, e, s) => (Mt(o, t, "write to private field"), s ? s.call(o, e) : t.set(o, e), e);
const Tt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class A {
  ...
  off(t, e) {
    ...
    for (const g of i(this, f)[t])
      g === e && (i(this, f)[t].splice(n, 1), s = !0), n++;
    if (!s)
...
const ai = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  isAndroid: fe,
  rippleCreate: bt
}, Symbol.toStringTag, { value: "Module" })), vt = "1", ve = l`
<style></style>
<slot></slot>
`;
let we = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : vt;
  }
  set flex(t) {
...
let xe = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || wt;
  }
  set gap(t) {
...
let Ce = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || yt;
  }
  set gap(t) {
    t === null ? this.root.removeAttribute("gap") : this.root.setAttribute("gap", t);
  }
...
r(G, "register", () => {
  customElements.get("ui-flex-grid-row") || Q.register(), customElements.get("ui-app-bar") || (console.debug("register web component: ui-app-bar"), customElements.define("ui-app-bar", G));
});
let $t = G;
const Me = l`
<style>
...
`, I = class I extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Re, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(I, "register", () => {
  customElements.get("ui-container") || (console.debug("register web component: ui-container"), customElements.define("ui-container", I));
});
let jt = I;
const Se = l`
<style>
...
r(U, "register", () => {
  customElements.get("svg-back-arrow") || (console.debug("register svg component: svg-back-arrow"), customElements.define("svg-back-arrow", U));
});
let qt = U;
const $e = l`
<style>
...
r(_, "register", () => {
  customElements.get("svg-chevron-down") || (console.debug("register svg component: svg-chevron-down"), customElements.define("svg-chevron-down", _));
});
let kt = _;
const ze = l`
<style>
...
r(tt, "register", () => {
  customElements.get("svg-close") || (console.debug("register svg component: svg-close"), customElements.define("svg-close", tt));
});
let Ct = tt;
const je = l`
<style>
...
r(et, "register", () => {
  customElements.get("svg-edit2") || (console.debug("register svg component: svg-edit2"), customElements.define("svg-edit2", et));
});
let Nt = et;
const qe = l`
<style>
...
r(it, "register", () => {
  customElements.get("svg-pdf") || (console.debug("register svg component: svg-pdf"), customElements.define("svg-pdf", it));
});
let Dt = it;
const Ne = l`
<style>
...
r(st, "register", () => {
  customElements.get("svg-recycle") || (console.debug("register svg component: svg-recycle"), customElements.define("svg-recycle", st));
});
let Pt = st;
const De = l`
<style>
...
r(ot, "register", () => {
  customElements.get("svg-settings") || (console.debug("register svg component: svg-settings"), customElements.define("svg-settings", ot));
});
let Vt = ot;
const Pe = l`
<style>
...
r(rt, "register", () => {
  customElements.get("svg-menu") || (console.debug("register svg component: svg-menu"), customElements.define("svg-menu", rt));
});
let Ot = rt;
const Ve = l`
<style>
...
r(nt, "register", () => {
  customElements.get("svg-today") || (console.debug("register svg component: svg-today"), customElements.define("svg-today", nt));
});
let Zt = nt;
const Oe = l`
<style>
...
const at = class at extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Oe, this.cleanup = new h(), this.ui = new Ze(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
r(at, "register", () => {
  customElements.get("ui-icon-button") || xt.register(), customElements.get("svg-close") || Ct.register(), customElements.get("ui-flex-grid-row") || Q.register(), customElements.get("ui-dialog") || (console.debug("register web component: ui-dialog"), customElements.define("ui-dialog", at));
});
let Bt = at;
const Be = l`
<style>
...
r(lt, "register", () => {
  customElements.get("ui-primary") || (console.debug("register web component: ui-primary"), customElements.define("ui-primary", lt));
});
let Lt = lt;
const Fe = l`
<style>
...
r(ct, "register", () => {
  customElements.get("ui-secondary") || (console.debug("register web component: ui-secondary"), customElements.define("ui-secondary", ct));
});
let W = ct;
const Je = l`
<style>
...
let Ye = (se = class {
  ...
  enableRipple() {
    i(this, S) || (this.removeRipple = bt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
    i(this, S) && i(this, S).call(this), this.stopInputHandling();
  }
  /**
   * @private
   */
  startInputHandling() {
    i(this, R) || (i(this, u).addEventListener("click", i(this, J)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", i(this, Y));
    }), c(this, R, !0));
  }
  /**
   * @private
   */
  stopInputHandling() {
    i(this, u).removeEventListener("click", i(this, J)), [...i(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, Y));
    }), c(this, R, !1);
  }
}, u = new WeakMap(), R = new WeakMap(), J = new WeakMap(), Y = new WeakMap(), S = new WeakMap(), se);
...
r(O, "register", () => {
  customElements.get("ui-primary") || Lt.register(), customElements.get("ui-secondary") || W.register(), customElements.get("ui-label") || (console.debug("register web component: ui-label"), customElements.define("ui-label", O));
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ue.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new Xe(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(Z, "register", () => {
  customElements.get("ui-input") || (console.debug("register web component: ui-input"), customElements.define("ui-input", Z));
}), r(Z, "observedAttributes", [
  "title",
  "type",
  "value",
  "placeholder",
...
const ht = class ht extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ke, this.setAttribute("role", "button"), this.ui = new Qe(this);
  }
};
r(ht, "register", () => {
  customElements.get("ui-select-option") || (console.debug("register web component: ui-select-option"), customElements.define("ui-select-option", ht));
});
let Et = ht;
const We = l`
<style>
  ...
  constructor() {
    ...
    a(this, X, async (e) => {
      (e.composedPath() || []).forEach((s) => {
        s instanceof Et && ([...this.querySelectorAll("ui-select-option")].forEach(
          (n) => n.removeAttribute("selected")
        ), s.setAttribute("selected", ""), this.ui.events.dispatch("change", s));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = We, this.cleanup = new h(), this.ui = new Ge();
  }
  // }}}
  connectedCallback() {
...
X = new WeakMap(), // }}}
r(ut, "register", () => {
  customElements.get("svg-chevron-down") || kt.register(), customElements.get("ui-select") || (console.debug("register web component: ui-select"), customElements.define("ui-select", ut));
});
let Yt = ut;
var E, $, K, re;
let Ie = (re = class {
   ...
   */
  new(t, e) {
    this.langType = t, c(this, K, e), i(this, $).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var s, n;
    return ((n = (s = i(this, K)) == null ? void 0 : s[t]) == null ? void 0 : n[e]) || null;
  }
  /**
   * @param {"change"} key
...
}, E = new WeakMap(), $ = new WeakMap(), K = new WeakMap(), re);
...
r(dt, "register", () => {
  customElements.get("ui-lang-type") || (console.debug("register web component: ui-lang-type"), customElements.define("ui-lang-type", dt));
});
let Kt = dt;
const _e = l`
<style>
...
r(pt, "register", () => {
  customElements.get("ui-spinner") || (console.debug("register web component: ui-spinner"), customElements.define("ui-spinner", pt));
});
let Qt = pt;
const ti = l`
    <style>
...
r(gt, "register", () => {
  customElements.get("ui-stack-layout-page") || (console.debug("register web component: ui-stack-layout-page"), customElements.define("ui-stack-layout-page", gt));
});
let Wt = gt;
const ii = l`
    <style>
...
r(mt, "register", () => {
  customElements.get("ui-stack-layout") || (console.debug("register web component: ui-stack-layout"), customElements.define("ui-stack-layout", mt));
});
let Gt = mt;
var x, k, ce;
let oi = (ce = class {
...
r(ft, "register", () => {
  customElements.get("ui-store") || (console.debug("register web component: ui-store"), customElements.define("ui-store", ft));
});
let It = ft;
var w;
class ri {
...
export {
  ...
  W as UISecondary,
  Yt as UISelect,
  Et as UISelectOption,
  Qt as UISpinner,
  Gt as UIStackLayout,
  Wt as UIStackLayoutPage,
  It as UIStore,
