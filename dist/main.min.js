...
var Rt = (o, t, e) => t in o ? At(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Rt(o, typeof t != "symbol" ? t + "" : t, e), Et = (o, t, e) => t.has(o) || mt("Cannot " + e);
var h = (o, t, e) => (Et(o, t, "read from private field"), e ? e.call(o) : t.get(o)), ft = (o, t, e) => t.has(o) ? mt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const vt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new xt(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
...
const C = class C extends HTMLElement {
  ...
  setTitle(t) {
    ...
    !t && e && this.removeChild(e), t && (e || (e = new T(), e.slot = "title", this.appendChild(e)), e.innerHTML = t);
  }
  /**
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Mt}</ui-icon-button>
      </div>
    `;
...
const D = class D extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="options">
        <div class="icon"><ui-svg>${Ct}</ui-svg></div>
...
}), r(S, "observedAttributes", ["storageprefix"]);
let pt = S;
...
let bt = Y;
function zt() {
  K.register(), J.register(), Z.register(), X.register(), Q.register(), W.register(), I.register(), _.register(), G.register(), U.register(), tt.register(), et.register(), it.register(), st.register(), nt.register(), M.register(), at.register(), ct.register(), lt.register(), dt.register(), ut.register(), ht.register(), pt.register(), bt.register(), ot.register(), rt.register(), T.register(), gt.register();
}
export {
  J as UIAppBar,
  K as UIAppBarItem,
