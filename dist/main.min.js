...
var ci = (o, i, t) => i in o ? li(o, i, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[i] = t;
var s = (o, i, t) => ci(o, typeof i != "symbol" ? i + "" : i, t), Xt = (o, i, t) => i.has(o) || Ae("Cannot " + t);
var d = (o, i, t) => (Xt(o, i, "read from private field"), t ? t.call(o) : i.get(o)), a = (o, i, t) => i.has(o) ? Ae("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(o) : i.set(o, t), x = (o, i, t, e) => (Xt(o, i, "write to private field"), e ? e.call(o, t) : i.set(o, t), t), u = (o, i, t) => (Xt(o, i, "access private method"), t);
class Zi {
  constructor() {
    this.callbacks = [];
  }
  ...
  run() {
    for (let i = 0; i < this.callbacks.length; i++)
      if (this.callbacks[i] !== null)
        try {
          this.callbacks[i](), this.callbacks[i] = null;
        } catch (t) {
          console.error("cleanup error:", t);
        }
    this.callbacks = this.callbacks.filter((i) => i !== null);
  }
}
function ui(o, i, { onDragStart: t = null, onDragging: e = null, onDragEnd: r = null } = {}) {
  const c = () => {
    const m = [...o.children].indexOf(i);
    i.draggable = !0, i.ondragstart = (f) => {
      f.dataTransfer.effectAllowed = "move", f.dataTransfer.dropEffect = "move", t && t(m);
    }, i.ondragover = (f) => (f.preventDefault(), !1), i.ondragenter = (f) => {
  ...
  return c(), {
     ...
     */
    update(p) {
      Object.hasOwn(p, "onDragStart") && (t = p.onDragStart), Object.hasOwn(p, "onDragging") && (e = p.onDragStart), Object.hasOwn(p, "onDragEnd") && (r = p.onDragEnd);
    },
    destroy: h
  };
}
function di(o, { onDragEnd: i = null, onDragStart: t = null } = {}) {
  let e = null, r = null, c = null, h = null, p = null, m = !1, f = null, w = null;
  const nt = (l) => {
    !e && Array.from(l.currentTarget.classList).includes("draggable") && (c = l.clientX, h = l.clientY, r = (/* @__PURE__ */ new Date()).getTime(), e = l.currentTarget, p || clearTimeout(p), p = setTimeout(() => {
      f = e.style.color, w = e.style.backgroundColor, e.style.color = "var(--ui-primary-fg)", e.style.backgroundColor = "var(--ui-primary)", o.classList.add("dragging"), m = !0, t && t();
    }, 200));
  }, Se = (l) => {
    if (!r || !e) return;
    if (!m && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const Re = Math.abs(c - l.clientX), Ee = Math.abs(h - l.clientY);
      if ((Re > Ee ? Re : Ee) < 24)
        return;
      Yt();
      return;
    ...
    for (; !v.classList.contains("draggable") && v.parentElement; )
      v = v.parentElement;
    v.classList.contains("draggable") && ni(e, v);
  }, Yt = () => {
    p !== null && (clearTimeout(p), p = null), e && (e.style.color = f, e.style.backgroundColor = w, e = null), r = null, o.classList.remove("dragging"), m && (i && i(), m = !1);
  };
  function ni(l, C) {
    ai(l, C) ? o.insertBefore(l, C) : o.insertBefore(l, C.nextElementSibling);
  }
  function ai(l, C) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (l) => {
        l.classList.add("draggable"), l.onmousedown = nt, l.ontouchstart = nt, l.onmousemove = Se, l.ontouchmove = Se, l.onmouseup = Yt, l.ontouchend = Yt;
      }
    );
  })(), {
    /** @param {DraggableMobile_Options} options */
    update: (l) => {
      Object.hasOwn(l, "onDragStart") && (t = l.onDragStart), Object.hasOwn(l, "onDragEnd") && (i = l.onDragEnd);
    },
    destroy: () => {
      Array.from(o.children).forEach(
        (l) => {
...
class b {
  ...
  on(i, t) {
    if (typeof t != "function")
      throw `invalid event listener passed for "${i.toString()}" event!`;
    return d(this, k)[i] || (d(this, k)[i] = []), d(this, k)[i].push(t), () => {
      this.off(i, t);
    };
  }
  /**
  ...
  off(i, t) {
    if (!d(this, k)[i])
      throw `no listeners found for ${i.toString()}, there is nothing to delete`;
    let e = !1, r = 0;
    for (const c of d(this, k)[i])
      c === t && (d(this, k)[i].splice(r, 1), e = !0), r++;
    if (!e)
      throw `listener not found for ${i.toString()}, there is nothing to delete`;
    return this;
  }
  /**
   * @template {keyof T} K
...
let Jt = null;
function hi() {
  return Jt === null && (Jt = Array.from(document.styleSheets).map((o) => {
    const i = new CSSStyleSheet(), t = Array.from(o.cssRules).map((e) => e.cssText).join(" ");
    return i.replaceSync(t), i;
  })), Jt;
}
function g(o) {
  o.adoptedStyleSheets.push(...hi());
}
const He = {
...
function S(o, i = {}) {
  ...
  let t = null;
  const e = (f) => {
    t = Qt(f, i), o.addEventListener("pointermove", c);
  }, r = () => {
    o.removeEventListener("pointermove", c), Wt(t), t = null;
  }, c = () => r(), h = (f) => {
    t = Qt(f, i), Wt(t), t = null;
  }, p = () => {
    o.classList.add("ripple-container"), o.style.overflow = "hidden", i.useClick === !0 ? o.addEventListener("click", h) : (o.addEventListener("pointerdown", e), o.addEventListener("pointerup", r), o.addEventListener("pointerleave", r));
  }, m = () => {
    o.classList.remove("ripple-container"), i.useClick === !0 ? o.removeEventListener("click", h) : (o.removeEventListener("pointerdown", e), o.removeEventListener("pointerup", r), o.removeEventListener("pointerleave", r), o.removeEventListener("pointermove", c));
  };
  return p(), {
    update: (f) => {
      i = {
...
function Qt(o, i) {
  ...
  t.classList.add("ripple"), t.style.position = "absolute", t.style.color = "inherit", t.style.borderRadius = "50%", t.style.pointerEvents = "none", t.style.width = "100px", t.style.height = "100px", t.style.marginTop = "-50px", t.style.marginLeft = "-50px", t.style.opacity = `${i.opacity}`, t.style.backgroundColor = i.color, t.style.transform = "scale(0) translate(0, 0)", t.style.transition = `transform ${i.spreadDuration} ${i.spreadTiming} 0s,opacity ${i.clearDuration} ${i.clearTiming} 0s`, o.currentTarget.appendChild(t);
  const e = o.currentTarget.getBoundingClientRect();
  if (i.centered)
    t.style.top = `${e.height / 2}px`, t.style.left = `${e.width / 2}px`;
  else {
    const c = !!o.targetTouches && o.targetTouches[0] || o;
    t.style.top = `${c.clientY - e.top}px`, t.style.left = `${c.clientX - e.left}px`;
  }
  const r = Math.max(e.width, e.height) * 0.02;
  return t.style.transform = `scale(${r}) translate(0, 0)`, t;
}
function Wt(o) {
  o && (o.addEventListener("transitionend", (i) => {
    i.propertyName === "opacity" && o.remove();
  }), o.style.opacity = "0");
}
...
const n = String.raw, R = String.raw;
function qi(o) {
  return Object.entries(o).map(
    ([i, t]) => `${i.replace(/[A-Z]/g, (e) => `-${e.toLowerCase()}`)}:${t}`
  ).join(";") + ";";
}
const pi = n`
...
at = new WeakSet(), Ve = function() {
  ...
  customElements.get("ui-alerts") || (console.debug('[ui] Register "ui-alerts" component'), customElements.define("ui-alerts", lt));
});
let It = lt;
It.register();
var ct, _e;
...
ct = new WeakSet(), _e = function() {
  ...
  customElements.get("ui-flex-grid-item") || (console.debug('[ui] Register "ui-flex-grid-item" component'), customElements.define("ui-flex-grid-item", A));
}), s(A, "observedAttributes", ["flex"]);
let X = A;
X.register();
var ut, Ze;
...
ut = new WeakSet(), Ze = function() {
  ...
  customElements.get("ui-flex-grid-row") || (console.debug('[ui] Register "ui-flex-grid-row" component'), customElements.define("ui-flex-grid-row", H));
}), s(H, "observedAttributes", ["gap", "justify", "align"]);
let Ut = H;
Ut.register();
var dt, Ge;
...
dt = new WeakSet(), Ge = function() {
  ...
  customElements.get("ui-flex-grid") || (console.debug('[ui] Register "ui-flex-grid" component'), customElements.define("ui-flex-grid", j));
}), s(j, "observedAttributes", ["gap", "justify", "align"]);
let te = j;
te.register();
var ht, ze;
const pt = class pt extends X {
  ...
  constructor(t = null) {
    ...
    this.styleVariants = {
       ...
       */
      set(e) {
        e && (this.message = e.message, this.variant = e.variant);
      },
      get message() {
    ...
    }, u(this, ht, ze).call(this), t && this.ui.set(t);
  }
   ...
   */
  attributeChangedCallback(t, e, r) {
    switch (super.attributeChangedCallback(t, e, r), t) {
      case "message":
        this.ui.message = r;
        break;
      case "variant":
...
ht = new WeakSet(), ze = function() {
  ...
  customElements.get("ui-alert") || (console.debug('[ui] Register "ui-alert" component'), customElements.define("ui-alert", pt));
});
let ee = pt;
ee.register();
var gt, Be;
...
gt = new WeakSet(), Be = function() {
  ...
  customElements.get("ui-app-bar") || (console.debug('[ui] Register "ui-app-bar" component'), customElements.define("ui-app-bar", ft));
});
let ie = ft;
ie.register();
var mt, qe;
...
mt = new WeakSet(), qe = function() {
  ...
  customElements.get("ui-app-bar-item") || (console.debug('[ui] Register "ui-app-bar-item" component'), customElements.define("ui-app-bar-item", bt));
});
let re = bt;
re.register();
var vt, Oe;
const T = class T extends HTMLElement {
  constructor() {
    ...
    this.ripple = null, this.ui = {
      ...
      set noripple(t) {
        if (!t) {
          this.root.ripple && this.root.ripple.destroy(), this.root.ripple = S(this.root);
          return;
        }
...
vt = new WeakSet(), Oe = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            ...
            <slot></slot>
        `, typeof this.ripple != "function" && (this.ripple = S(this)), this.addEventListener("click", (t) => {
    this.ui.events.dispatch("click", t);
  });
}, s(T, "register", () => {
  customElements.get("ui-button") || (console.debug('[ui] Register "ui-button" component'), customElements.define("ui-button", T));
...
kt = new WeakSet(), $e = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
        ...
        `, typeof this.ripple != "function" && (this.ripple = S(this, { centered: !0 })), this.addEventListener("click", (t) => {
    this.ui.events.dispatch("click", t);
  });
}, s(V, "register", () => {
  customElements.get("ui-icon-button") || (console.debug('[ui] Register "ui-icon-button" component'), customElements.define("ui-icon-button", V));
}), s(V, "observedAttributes", ["noripple"]);
let se = V;
se.register();
var yt, Fe;
const wt = class wt extends HTMLElement {
  constructor() {
    super();
    a(this, yt);
    this.ui = {}, u(this, yt, Fe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
yt = new WeakSet(), Fe = function() {
  ...
  customElements.get("ui-container") || (console.debug('[ui] Register "ui-container" component'), customElements.define("ui-container", wt));
});
let ne = wt;
ne.register();
var Ct, Pe;
const _ = class _ extends HTMLElement {
  ...
  constructor(t) {
    ...
    this._title = t || "", this.ui = {
      ...
      set title(e) {
        ...
        this.root._title = r.innerHTML = e || "";
      },
      get fullscreen() {
       ...
       */
      open(e = !1, r = !0) {
        const c = this.root.shadowRoot.querySelector("dialog"), h = c.inert;
        c.inert = r, e ? c.showModal() : c.show(), this.events.dispatch("open", null), c.inert = h;
      },
      close() {
        this.events.dispatch("close", null), this.root.shadowRoot.querySelector("dialog").close();
      }
    }, u(this, Ct, Pe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
  ...
  static createAction({
    ...
    h.ui.flex = r, h.slot = "actions", h.innerHTML = n`
        ...
        `;
    let p;
    return c && (p = h.querySelector("ui-button"), p.ui.events.on("click", c)), {
      container: h,
      action: p
    };
  }
...
Ct = new WeakSet(), Pe = function() {
  ...
  const r = this.shadowRoot.querySelector("dialog"), c = (h) => h.preventDefault();
  r.addEventListener("cancel", c);
}, s(_, "register", () => {
  customElements.get("ui-dialog") || (console.debug('[ui] Register "ui-dialog" component'), customElements.define("ui-dialog", _));
...
xt = new WeakSet(), De = function() {
  ...
  customElements.get("ui-drawer") || (console.debug('[ui] Register "ui-drawer" component'), customElements.define("ui-drawer", Lt));
});
let le = Lt;
le.register();
var Mt, Ne;
  ...
  constructor() {
    ...
    this.ui = {
      ...
      set title(t) {
        ...
        e.classList.add("visible"), e.innerHTML = n` <h3>${t}</h3> `;
      },
      get fold() {
...
Mt = new WeakSet(), Ne = function() {
  ...
  customElements.get("ui-drawer-group") || (console.debug('[ui] Register "ui-drawer-group" component'), customElements.define("ui-drawer-group", Z));
...
const Rt = class Rt extends HTMLElement {
  constructor() {
    super();
    a(this, St);
    this.ui = {}, u(this, St, Ye).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
St = new WeakSet(), Ye = function() {
  ...
  customElements.get("ui-drawer-group-item") || (console.debug('[ui] Register "ui-drawer-group-item" component'), customElements.define("ui-drawer-group-item", Rt));
});
let ue = Rt;
ue.register();
var Et, Xe;
...
Et = new WeakSet(), Xe = function() {
  ...
  customElements.get("ui-check") || (console.debug('[ui] Register "ui-check" component'), customElements.define("ui-check", G));
}), s(G, "observedAttributes", ["checked"]);
let de = G;
de.register();
var Q, W, I, U, tt, et, it, rt, ot, st, y, Je, L;
const z = class z extends HTMLElement {
  constructor() {
    super();
    a(this, y);
    ...
    a(this, tt, 0);
    a(this, et, d(this, tt));
    a(this, it, "var(--ui-fontSize)");
    a(this, rt, d(this, it));
    a(this, ot, "var(--ui-fontFamily)");
    a(this, st, d(this, ot));
    this.ui = {
      root: this,
      get casl() {
        return d(this.root, W);
      },
      set casl(t) {
        var e;
        t === null && (t = d(this.root, Q)), x(this.root, W, t), u(e = this.root, y, L).call(e);
      },
      get mono() {
        return d(this.root, U);
      },
      set mono(t) {
        var e;
        t === null && (t = d(this.root, I)), x(this.root, U, t), u(e = this.root, y, L).call(e);
      },
      get slnt() {
        return d(this.root, et);
      },
      set slnt(t) {
        var e;
        t === null && (t = d(this.root, tt)), x(this.root, et, t), u(e = this.root, y, L).call(e);
      },
      get size() {
        return d(this.root, rt);
      },
      set size(t) {
        var e;
        t === null && (t = d(this.root, it)), x(this.root, rt, t), u(e = this.root, y, L).call(e);
      },
      get family() {
        return d(this.root, st);
      },
      set family(t) {
        var e;
        t === null && (t = d(this.root, ot)), x(this.root, st, t), u(e = this.root, y, L).call(e);
      }
    }, u(this, y, Je).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Q = new WeakMap(), W = new WeakMap(), I = new WeakMap(), U = new WeakMap(), tt = new WeakMap(), et = new WeakMap(), it = new WeakMap(), rt = new WeakMap(), ot = new WeakMap(), st = new WeakMap(), y = new WeakSet(), Je = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            <style>
                :host {
                    display: inline-block;
  ...
  customElements.get("ui-text") || (console.debug('[ui] Register "ui-text" component'), customElements.define("ui-text", z));
}), s(z, "observedAttributes", ["casl", "mono", "slnt", "size", "family"]);
let J = z;
J.register();
var At, Ke;
const B = class B extends HTMLElement {
  ...
  enableRipple() {
    if (this.ripple || (this.ripple = S(
      this.shadowRoot.querySelector(".container")
    ), this.style.cursor = "pointer", this.running)) return;
    this.addEventListener("click", this.onClick), [...this.querySelectorAll('[slot="inputs"]')].forEach((e) => {
...
At = new WeakSet(), Ke = function() {
  ...
  customElements.get("ui-label") || (console.debug('[ui] Register "ui-label" component'), customElements.define("ui-label", B));
}), s(B, "observedAttributes", ["ripple", "secondary", "primary"]);
let he = B;
he.register();
var Ht, Qe;
const jt = class jt extends J {
  constructor() {
    super();
    a(this, Ht);
    u(this, Ht, Qe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Ht = new WeakSet(), Qe = function() {
  this.ui.size = "1.1rem", this.ui.casl = 1, this.ui.mono = 0, this.ui.slnt = 0;
}, s(jt, "register", () => {
  customElements.get("ui-primary") || (console.debug('[ui] Register "ui-primary" component'), customElements.define("ui-primary", jt));
});
let pe = jt;
pe.register();
var Tt, We;
...
Tt = new WeakSet(), We = function() {
  this.ui.size = "0.9rem", this.ui.casl = 1, this.ui.mono = 0, this.ui.slnt = -15;
}, s(Vt, "register", () => {
  customElements.get("ui-secondary") || (console.debug('[ui] Register "ui-secondary" component'), customElements.define("ui-secondary", Vt));
});
let E = Vt;
E.register();
var _t, Ie;
  ...
  constructor() {
    ...
    this.ui = {
      ...
      set title(t) {
        ...
        !t && e && this.root.removeChild(e), t && (e || (e = new E(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t);
      },
      get type() {
...
_t = new WeakSet(), Ie = function() {
  ...
  customElements.get("ui-input") || (console.debug('[ui] Register "ui-input" component'), customElements.define("ui-input", q));
...
Zt = new WeakSet(), Ue = function() {
  ...
  customElements.get("ui-search") || (console.debug('[ui] Register "ui-search" component'), customElements.define("ui-search", O));
...
Gt = new WeakSet(), ti = function() {
  ...
  customElements.get("ui-select-option") || (console.debug('[ui] Register "ui-select-option" component'), customElements.define("ui-select-option", zt));
});
let K = zt;
K.register();
var M, Bt, ei;
const $ = class $ extends HTMLElement {
  constructor() {
    ...
    this.open = !1, this.ui = {
      ...
      events: new b(),
      get open() {
        return this.root.open || d(this.root, M);
      },
      set open(t) {
        this.keepOpen && (t = d(this.root, M)), this.root.open = t, t ? this.root.setAttribute("open", "") : this.root.removeAttribute("open"), this.root.style.setProperty(
          "--items-length",
          `${this.root.children.length || 1}`
        );
      },
      get keepOpen() {
        return d(this.root, M);
      },
      set keepOpen(t) {
        x(this.root, M, !!t), this.open = this.open;
      },
      /**
...
M = new WeakMap(), Bt = new WeakSet(), ei = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            <style>
                * {
                    box-sizing: border-box;
            ...
            <div class="options">
                <div class="icon"><ui-svg>${Me}</ui-svg></div>

                <slot></slot>
            </div>
        `;
  const t = async (c) => {
    (c.composedPath() || []).forEach((h) => {
      h instanceof K && ([...this.querySelectorAll("ui-select-option")].forEach(
        (p) => p.removeAttribute("selected")
    ...
    this.ui.open = !this.ui.open, this.ui.open ? (c.stopPropagation(), this.addEventListener("click", t)) : setTimeout(
      () => this.removeEventListener("click", t)
    );
  };
  this.shadowRoot.querySelector(".options").addEventListener("click", e);
}, s($, "register", () => {
  customElements.get("ui-select") || (console.debug('[ui] Register "ui-select" component'), customElements.define("ui-select", $));
}), s($, "observedAttributes", ["open", "keep-open"]);
let me = $;
me.register();
var qt, ii;
...
qt = new WeakSet(), ii = function() {
  ...
  customElements.get("ui-textarea") || (console.debug('[ui] Register "ui-textarea" component'), customElements.define("ui-textarea", F));
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.ui = {
      ...
      get(i, t) {
        var e, r;
        return ((r = (e = this.data) == null ? void 0 : e[i]) == null ? void 0 : r[t]) || null;
      }
    };
  }
  connectedCallback() {
   ...
   */
  async setCurrent(i) {
    const t = this.querySelector(`ui-lang-type[name="${i}"]`) || this.ui.fallback();
    if (t) {
...
s(P, "register", () => {
  customElements.get("ui-lang") || (console.debug('[ui] Register "ui-lang" component'), customElements.define("ui-lang", P));
}), s(P, "observedAttributes", ["current"]);
let ve = P;
ve.register();
...
s(Ot, "register", () => {
  customElements.get("ui-lang-type") || (console.debug('[ui] Register "ui-lang-type" component'), customElements.define("ui-lang-type", Ot));
});
let ke = Ot;
ke.register();
var $t, ri;
...
$t = new WeakSet(), ri = function() {
  ...
  customElements.get("ui-spinner") || (console.debug('[ui] Register "ui-spinner" component'), customElements.define("ui-spinner", D));
}), s(D, "observedAttributes", ["nobg"]);
let ye = D;
ye.register();
var Ft, oi;
const Pt = class Pt extends HTMLElement {
  constructor() {
    ...
    this.pages = {}, this.stack = [], this.onpopstate = () => this.goBack(), this.ui = {
       ...
       */
      async set(t, e = null, r = !1) {
        if (this.lock) return;
        const c = await this.root.pages[t]();
        this.root.stack.push(this.root.appendChild(c)), typeof e == "function" && e(c);
        let h = null;
...
Ft = new WeakSet(), oi = function() {
  ...
  customElements.get("ui-stack-layout") || (console.debug('[ui] Register "ui-stack-layout" component'), customElements.define("ui-stack-layout", Pt));
});
let we = Pt;
we.register();
var Dt, si;
...
Dt = new WeakSet(), si = function() {
  ...
  customElements.get("ui-stack-layout-page") || (console.debug('[ui] Register "ui-stack-layout-page" component'), customElements.define("ui-stack-layout-page", N));
}), s(N, "observedAttributes", ["name"]);
let Ce = N;
Ce.register();
  ...
  constructor() {
    super(), this.stores = {}, this.ui = {
      ...
      set storageprefix(i) {
        ...
        this.root.setAttribute("storageprefix", i);
      },
      /**
       * @template {keyof T} K
       * @param {K} key
      ...
      get(i) {
        if (this.storage) {
          const t = localStorage.getItem(
            (this.storageprefix || "") + i.toString()
          );
          if (t !== null)
            return JSON.parse(t);
        }
        return this.root.stores[i];
      },
      /**
       * @template {keyof T} K
       * @param {K} key
      ...
      set(i, t, e = !1) {
        if (e && this.storage) {
          ...
          this.root.stores[i] = r ?? t;
        } else
          this.root.stores[i] = t;
        this.storage && localStorage.setItem(
          (this.storageprefix || "") + i.toString(),
          JSON.stringify(this.root.stores[i])
        ), this.events.dispatch(i, this.root.stores[i]);
      },
      /**
       * @template {keyof T} K
       * @param {K} key
      ...
      update(i, t) {
        ...
        if (this.storage) {
          ...
          r !== null && (e = JSON.parse(r));
        }
        e === null && (e = this.root.stores[i]), this.set(i, t(e));
      },
      /**
       * @template {keyof T} K
       * @param {K} key
      ...
      on(i, t, e = !1) {
        if (typeof t != "function")
          throw "callback is not a function";
        return e && t(this.get(i)), this.events.on(i, t);
      }
    };
  }
  connectedCallback() {
...
s(Nt, "register", () => {
  customElements.get("ui-store") || (console.debug('[ui] Register "ui-store" component'), customElements.define("ui-store", Nt));
});
let xe = Nt;
xe.register();
const Kt = "gruvbox", Y = class Y extends HTMLElement {
  constructor() {
    super(), this.mediaHandler = null, this.currentTheme = null, this.mode = null, this.theme = Kt, this.ui = {
      root: this,
      get auto() {
       ...
       */
      set theme(i) {
        this.root.theme = i, this.root.setTheme(i || Kt);
      }
    };
  }
  /**
  ...
  setAuto(i, t = document.body) {
    ...
    this.mediaHandler = (e) => {
      e.matches ? t.setAttribute("data-theme", "dark") : t.setAttribute("data-theme", "light");
   ...
   * @param {HTMLElement} target
   */
  setMode(i, t = document.body) {
    this.mode = i, this.mode ? t.setAttribute("data-theme", i) : t.removeAttribute("data-theme");
  }
  /**
  ...
  setTheme(i, t = null) {
    t = {
      ...
      prefixPath: "/themes",
      ...t || {}
    }, t.target.querySelectorAll("link.theme").forEach((r) => t.target.removeChild(r));
    const e = document.createElement("link");
    e.classList.add("theme"), e.rel = "stylesheet", e.href = `${t.prefixPath}/${i || Kt}.css`, t.target.appendChild(e);
  }
};
s(Y, "register", () => {
  customElements.get("ui-theme-handler") || (console.debug('[ui] Register "ui-theme-handler" component'), customElements.define("ui-theme-handler", Y));
}), s(Y, "observedAttributes", ["auto", "mode", "theme"]);
let Le = Y;
Le.register();
export {
  Zi as CleanUp,
