...
function Lt(o, t = {}) {
  ...
  const e = () => {
    ...
    o.draggable = !0, o.ondragstart = (l) => {
      ...
      const Z = parseInt(l.dataTransfer.getData("text/plain"), 10);
