...
var r = (i, t, e) => (Re(i, typeof t != "symbol" ? t + "" : t, e), e), Dt = (i, t, e) => {
  if (!t.has(i))
    throw TypeError("Cannot " + e);
};
var s = (i, t, e) => (Dt(i, t, "read from private field"), e ? e.call(i) : t.get(i)), n = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, l = (i, t, e, o) => (Dt(i, t, "write to private field"), o ? o.call(i, e) : t.set(i, e), e);
const Vt = {
  ondragstart: null,
  ondragging: null,
  ondragend: null
...
const mt = class mt extends HTMLElement {
  constructor() {
    super();
    n(this, D, () => this.ui.events.dispatchWithData("close", null));
...
D = new WeakMap(), V = new WeakMap(), r(mt, "register", () => customElements.define("ui-dialog", mt));
let _ = mt;
...
const vt = class vt extends HTMLElement {
  constructor() {
    ...
    /** @param {Event} ev */
    n(this, Z, (e) => {
      this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", s(this, C))) : setTimeout(
        () => this.removeEventListener("click", s(this, C))
      );
    });
  ...
  disconnectedCallback() {
    var e;
    this.removeEventListener("click", s(this, C)), (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", s(this, Z));
  }
};
Z = new WeakMap(), C = new WeakMap(), r(vt, "register", () => customElements.define("ui-select", vt));
let it = vt;
var W, E, J, Gt;
let We = (Gt = class {
  /** @param {Lang} root */
  constructor(t) {
     ...
     */
    n(this, J, void 0);
    l(this, W, t), l(this, E, new Y()), this.langType = null;
  }
   ...
   */
  new(t, e) {
    this.langType = t, l(this, J, e), s(this, E).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  on(t, e, o = !1) {
    ...
    return o && e(this.langType), s(this, E).addListener(t, e);
  }
}, W = new WeakMap(), E = new WeakMap(), J = new WeakMap(), Gt);
...
let Xe = (te = class {
  ...
  constructor(t) {
     ...
     */
    n(this, S, {});
    l(this, k, t), this.events = new Y(), this.stack = [];
  }
  /**
   * @param {string} name
...
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ee.content.cloneNode(!0)), this.ui = new Ke(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
