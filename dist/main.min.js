...
const pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(re.content.cloneNode(!0)), this.ui = new De(this);
  }
};
...
const A = class A extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0)), this.ui = new Oe(this);
  }
  connectedCallback() {
...
let Pe = (Yt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = $t(s(this, P), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
let Ve = (Kt = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, x, void 0);
    l(this, b, t), l(this, y, e), this.events = new R(), l(this, x, document.createElement("h4")), s(this, x).slot = "title", s(this, b).appendChild(s(this, x));
  }
  get dialog() {
    return s(this, y);
  }
...
const mt = class mt extends HTMLElement {
  constructor() {
    super();
    n(this, V, () => this.ui.events.dispatchWithData("close", null));
  ...
  connectedCallback() {
    ...
    e.addEventListener("click", s(this, Z)), e.addEventListener("click", s(this, V));
  }
  disconnectedCallback() {
    const e = this.shadowRoot.querySelector("header ui-icon-button");
    e.removeEventListener("click", s(this, Z)), e.removeEventListener("click", s(this, V));
  }
};
...
r(N, "register", () => customElements.define("ui-flex-grid", N)), r(N, "observedAttributes", ["gap"]);
let st = N;
...
const vt = class vt extends HTMLElement {
  constructor() {
    ...
    /** @param {Event} ev */
    n(this, W, (e) => {
      this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", s(this, E))) : setTimeout(
        () => this.removeEventListener("click", s(this, E))
      );
    });
    ...
    n(this, E, (e) => {
      (e.composedPath() || []).forEach((o) => {
        ...
        ), o.setAttribute("selected", ""), this.ui.events.dispatchWithData("change", o));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0)), this.ui = new We();
  }
  connectedCallback() {
    var e;
    (e = this.shadowRoot.querySelector(".options")) == null || e.addEventListener("click", s(this, W)), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var e;
    this.removeEventListener("click", s(this, E)), (e = this.shadowRoot.querySelector(".options")) == null || e.removeEventListener("click", s(this, W));
  }
};
W = new WeakMap(), E = new WeakMap(), r(vt, "register", () => customElements.define("ui-select", vt));
let it = vt;
var J, C, B, Gt;
let Je = (Gt = class {
  /** @param {Lang} root */
  constructor(t) {
     ...
     */
    n(this, B, void 0);
    l(this, J, t), l(this, C, new R()), this.langType = null;
  }
   ...
   */
  new(t, e) {
    this.langType = t, l(this, B, e), s(this, C).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
...
const bt = class bt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(me.content.cloneNode(!0)), this.ui = new Xe(this);
  }
};
...
let Ye = (te = class {
  ...
  constructor(t) {
     ...
     */
    n(this, S, {});
    l(this, k, t), this.events = new R(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      s(this, k).appendChild(s(this, S)[t]().children[0])
    ), this.stack.length > 1) {
...
}, k = new WeakMap(), S = new WeakMap(), te);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(fe.content.cloneNode(!0)), this.ui = new Ye(this);
  }
};
...
let Qe = (se = class {
  ...
  _startInputHandling() {
    s(this, T) || (s(this, c).addEventListener("click", s(this, X)), this.getInputSlot().forEach((t) => {
...
async function _e() {
  K.register(), G.register(), Q.register(), F.register(), tt.register(), et.register(), st.register(), D.register(), it.register(), rt.register(), ot.register(), nt.register(), at.register(), lt.register(), dt.register(), ht.register(), ct.register(), ut.register(), _.register();
}
async function ts() {
