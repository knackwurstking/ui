...
var s = (o, e, t) => ai(o, typeof e != "symbol" ? e + "" : e, t), Gt = (o, e, t) => e.has(o) || Se("Cannot " + t);
var p = (o, e, t) => (Gt(o, e, "read from private field"), t ? t.call(o) : e.get(o)), n = (o, e, t) => e.has(o) ? Se("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t), E = (o, e, t, i) => (Gt(o, e, "write to private field"), i ? i.call(o, t) : e.set(o, t), t), l = (o, e, t) => (Gt(o, e, "access private method"), t);
class bi {
  constructor() {
    this.callbacks = [];
  }
...
function li(o, e, { onDragStart: t = null, onDragging: i = null, onDragEnd: r = null } = {}) {
  const c = () => {
    const b = [...o.children].indexOf(e);
    e.draggable = !0, e.ondragstart = (g) => {
      g.dataTransfer.effectAllowed = "move", g.dataTransfer.dropEffect = "move", t && t(b);
      ...
      g.preventDefault(), g.dataTransfer.dropEffect = "move", r && r(b), [...o.children].forEach((k) => {
        k.style.background = "inherit", k.style.color = "inherit";
      });
    };
  }, d = () => {
...
function ci(o, { onDragEnd: e = null, onDragStart: t = null } = {}) {
  let i = null, r = null, c = null, d = null, h = null, b = !1, g = null, k = null;
  const rt = (a) => {
    !i && Array.from(a.currentTarget.classList).includes("draggable") && (c = a.clientX, d = a.clientY, r = (/* @__PURE__ */ new Date()).getTime(), i = a.currentTarget, h || clearTimeout(h), h = setTimeout(() => {
      g = i.style.color, k = i.style.backgroundColor, i.style.color = "var(--ui-primary-fg)", i.style.backgroundColor = "var(--ui-primary)", o.classList.add("dragging"), b = !0, t && t();
    }, 200));
  }, Ee = (a) => {
    if (!r || !i) return;
    if (!b && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const Ae = Math.abs(c - a.clientX), Le = Math.abs(d - a.clientY);
      if ((Ae > Le ? Ae : Le) < 24)
        return;
      Zt();
      return;
    }
    a.preventDefault(), b || (b = !0, t && t());
    const w = !!a.targetTouches && a.targetTouches[0] || a;
    let f = document.elementFromPoint(w.clientX, w.clientY);
    for (; !f.classList.contains("draggable") && f.parentElement; )
      f = f.parentElement;
    f.classList.contains("draggable") && oi(i, f);
  }, Zt = () => {
    h !== null && (clearTimeout(h), h = null), i && (i.style.color = g, i.style.backgroundColor = k, i = null), r = null, o.classList.remove("dragging"), b && (e && e(), b = !1);
  };
  function oi(a, w) {
...
function C(o, e = {}) {
  ...
  let t = null;
  const i = (g) => {
    t = Kt(g, e), o.addEventListener("pointermove", c);
  }, r = () => {
    o.removeEventListener("pointermove", c), Qt(t), t = null;
  }, c = () => r(), d = (g) => {
    t = Kt(g, e), Qt(t), t = null;
  }, h = () => {
    o.classList.add("ripple-container"), o.style.overflow = "hidden", e.useClick === !0 ? o.addEventListener("click", d) : (o.addEventListener("pointerdown", i), o.addEventListener("pointerup", r), o.addEventListener("pointerleave", r));
  }, b = () => {
    o.classList.remove("ripple-container"), e.useClick === !0 ? o.removeEventListener("click", d) : (o.removeEventListener("pointerdown", i), o.removeEventListener("pointerup", r), o.removeEventListener("pointerleave", r), o.removeEventListener("pointermove", c));
  };
  return h(), {
    update: (g) => {
      e = {
  ...
  constructor() {
    ...
    this.ui = {
      ...
      set title(t) {
        ...
        !t && i && this.root.removeChild(i), t && (i || (i = new L(), i.slot = "title", this.root.appendChild(i)), i.innerHTML = t);
      },
      get type() {
...
let Ce = Nt;
function ki() {
  Wt.register(), Ut.register(), ee.register(), te.register(), ie.register(), re.register(), oe.register(), se.register(), le.register(), ae.register(), ne.register(), N.register(), _t.register(), It.register(), ce.register(), de.register(), pe.register(), Z.register(), ge.register(), be.register(), fe.register(), me.register(), ve.register(), ke.register(), ye.register(), we.register(), Ce.register(), ue.register(), he.register(), L.register(), xe.register();
}
export {
  bi as CleanUp,
  m as Events,
