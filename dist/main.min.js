...
const q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = new h(), this.ui = new ze(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = qe, this.cleanup = new h(), this.ui = new je(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Oe(this);
  }
  connectedCallback() {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Be, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new De(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
`, _ = class _ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(O, "register", () => {
  G.register(), J.register(), customElements.get("ui-label") || customElements.define("ui-label", O);
...
r(B, "register", () => {
  Rt.register(), G.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", B);
}), r(B, "observedAttributes", ["title"]);
let ee = B;
...
r(D, "register", () => {
  J.register(), customElements.get("ui-input") || customElements.define("ui-input", D);
}), r(D, "observedAttributes", [
  "title",
  "type",
  "value",
  "placeholder",
...
let ki = (be = class {
  ...
  constructor(t) {
     ...
     */
    l(this, S, {});
    c(this, E, t), this.events = new v(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  clearStack() {
    for (; this.stackSize() > 0; )
      i(this, E).removeChild(this.stack.pop());
  }
  stackSize() {
  ...
  goBack() {
    if (!this.stack.length || i(this, T))
      return;
    const t = this.stack.pop(), e = i(this, E).removeChild(t);
    this.stack.length && i(this, E).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent(e);
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (!i(this, T)) {
      if (this.stack.push(
        // @ts-expect-error
        i(this, E).appendChild(i(this, S)[t]().children[0])
      ), this.stack.length > 1) {
...
}, E = new WeakMap(), T = new WeakMap(), S = new WeakMap(), be);
