...
var o = (r, t, e) => (pe(r, typeof t != "symbol" ? t + "" : t, e), e), Qt = (r, t, e) => {
  if (!t.has(r))
    throw TypeError("Cannot " + e);
};
var i = (r, t, e) => (Qt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), a = (r, t, e) => {
  if (t.has(r))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(r) : t.set(r, e);
}, c = (r, t, e, s) => (Qt(r, t, "write to private field"), s ? s.call(r, e) : t.set(r, e), e);
const Wt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const l = String.raw, we = String.raw, ye = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  css: we,
  html: l,
  isAndroid: ve
...
const xe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ripple: be,
  utils: ye
}, Symbol.toStringTag, { value: "Module" })), ke = l`
<style>
    :host {
...
const ft = class ft extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ke, this.cleanup = new h(), this.ui = new Ce(this);
  }
  connectedCallback() {
  }
...
o(ft, "register", () => customElements.define("ui-app-bar", ft));
let W = ft;
const Le = l`
<style>
    :host {
...
let Me = (_t = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = zt(i(this, p), { centered: !0 }), i(this, p).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Le, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Me(this);
  }
  connectedCallback() {
...
let Ee = (te = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = zt(i(this, d), { centered: !0 }), i(this, d).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
let Se = (ee = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    a(this, M, void 0);
    c(this, L, t), c(this, b, e), this.events = new S(), c(this, M, document.createElement("h4")), i(this, M).slot = "title", i(this, L).appendChild(i(this, M));
  }
  get fullscreen() {
...
}, L = new WeakMap(), b = new WeakMap(), M = new WeakMap(), ee);
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ae, this.cleanup = new h(), this.ui = new Se(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
o(vt, "register", () => customElements.define("ui-dialog", vt));
let et = vt;
const Ot = "1", Re = l`
<style></style>
<slot></slot>
...
let $e = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : Ot;
  }
  set flex(t) {
...
let je = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || Pt;
  }
  set gap(t) {
...
let ze = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || Dt;
  }
  set gap(t) {
    t === null ? this.root.removeAttribute("gap") : this.root.setAttribute("gap", t);
  }
...
const D = class D extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(he.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new qe(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ne, this.setAttribute("role", "button"), this.ui = new Oe(this);
  }
};
o(wt, "register", () => customElements.define("ui-select-option", wt));
let J = wt;
const Pe = l`
<style>
    * {
...
const yt = class yt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.cleanup = new h(), this.ui = new De();
  }
  // }}}
  connectedCallback() {
...
X = new WeakMap(), // }}}
o(yt, "register", () => customElements.define("ui-select", yt));
let nt = yt;
var T, R, F, se;
let Ve = (se = class {
  /** @param {Lang} root */
   ...
   */
  new(t, e) {
    this.langType = t, c(this, F, e), i(this, R).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
...
}, T = new WeakMap(), R = new WeakMap(), F = new WeakMap(), se);
...
o(xt, "register", () => customElements.define("ui-lang-type", xt));
let lt = xt;
const Be = l`
<style>
    .background {
...
}, H = new WeakMap(), A = new WeakMap(), I = new WeakMap(), ne);
...
o(Lt, "register", () => customElements.define("ui-stack-layout", Lt));
let ut = Lt;
var k, C, ae;
let Ke = (ae = class {
  /**
...
}, k = new WeakMap(), C = new WeakMap(), ae);
const Mt = class Mt extends HTMLElement {
  constructor() {
    super(), this.ui = new Ke(this);
  }
};
o(Mt, "register", () => customElements.define("ui-store", Mt));
let dt = Mt;
const Qe = l`
<style>
    :host {
...
o(Tt, "register", () => customElements.define("ui-svg-back-arrow-navigation", Tt));
let Vt = Tt;
const We = l`
<style>
    :host {
...
o(Et, "register", () => customElements.define("ui-svg-chevron-down", Et));
let Zt = Et;
const Ge = l`
<style>
    :host {
...
o(Ht, "register", () => customElements.define("ui-svg-close", Ht));
let Bt = Ht;
const _e = l`
<style>
    :host {
...
o(Rt, "register", () => customElements.define("ui-svg-pdf-document", Rt));
let Xt = Rt;
const ii = l`
<style>
    :host {
...
o($t, "register", () => customElements.define("ui-svg-settings", $t));
let Ft = $t;
const si = l`
<style>
    :host {
...
let oi = (le = class {
  ...
  enableRipple() {
    i(this, U) || (this.removeRipple = zt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
   ...
   */
  startInputHandling() {
    i(this, j) || (i(this, u).addEventListener("click", i(this, K)), this.getInputSlot().forEach((t) => {
...
}, u = new WeakMap(), j = new WeakMap(), K = new WeakMap(), Q = new WeakMap(), U = new WeakMap(), le);
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ri, this.cleanup = new h(), this.ui = new oi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
async function hi() {
  W.register(), _.register(), G.register(), tt.register(), it.register(), st.register(), rt.register(), ot.register(), J.register(), nt.register(), lt.register(), at.register(), ct.register(), ht.register(), ut.register(), dt.register(), Y.register(), gt.register(), pt.register(), mt.register(), et.register();
}
async function ui() {
