...
var Kt = (r, t, e) => t in r ? Xt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var o = (r, t, e) => (Kt(r, typeof t != "symbol" ? t + "" : t, e), e), Qt = (r, t, e) => {
  if (!t.has(r))
    throw TypeError("Cannot " + e);
};
var h = (r, t, e) => (Qt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), ht = (r, t, e) => {
  if (t.has(r))
...
class d {
  ...
  on(t, e) {
    ...
    return h(this, u)[t] || (h(this, u)[t] = []), h(this, u)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const a of h(this, u)[t])
      a === e && (h(this, u)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
function ot(r, t = {}) {
  ...
  return r.classList.add("ripple-container"), r.style.overflow = "hidden", t.useClick === !0 ? r.addEventListener("click", (a) => {
    e = gt(a, t), ft(e);
...
`, g = class g extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = te, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      getFlex() {
...
`, f = class f extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ee, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      getGap() {
...
`, m = class m extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ie, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      getGap() {
...
`, H = class H extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = oe, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      getLeftSlot() {
...
o(H, "register", () => {
  E.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", H);
});
let vt = H;
const re = n`
    <style>
...
`, T = class T extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = re, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      enable() {
...
o(T, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", T);
});
let wt = T;
const se = n`
    <style>
...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = se, this.setAttribute("role", "button"), this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      /**
...
`, v = class v extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ne, this.setAttribute("role", "button"), this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      /**
...
`, V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = le, this.cleanup = new l(), this.ui = {};
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(Z, "register", () => {
  customElements.get("svg-plus") || customElements.define("svg-plus", Z);
});
let Lt = Z;
const ce = n`
    <style>
...
o($, "register", () => {
  customElements.get("svg-chevron-left") || customElements.define("svg-chevron-left", $);
});
let Ct = $;
const ue = n`
    <style>
...
o(j, "register", () => {
  customElements.get("svg-chevron-down") || customElements.define("svg-chevron-down", j);
});
let lt = j;
const de = n`
    <style>
...
o(G, "register", () => {
  customElements.get("svg-close") || customElements.define("svg-close", G);
});
let at = G;
const he = n`
    <style>
...
o(B, "register", () => {
  customElements.get("svg-download") || customElements.define("svg-download", B);
});
let xt = B;
const pe = n`
    <style>
...
o(z, "register", () => {
  customElements.get("svg-pen") || customElements.define("svg-pen", z);
});
let Mt = z;
const ge = n`
    <style>
...
o(q, "register", () => {
  customElements.get("svg-document-new") || customElements.define("svg-document-new", q);
});
let Et = q;
const fe = n`
    <style>
...
o(F, "register", () => {
  customElements.get("svg-trash") || customElements.define("svg-trash", F);
});
let At = F;
const me = n`
    <style>
...
o(O, "register", () => {
  customElements.get("svg-search") || customElements.define("svg-search", O);
});
let ct = O;
const be = n`
    <style>
...
o(_, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", _);
});
let St = _;
const ve = n`
    <style>
...
o(P, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", P);
});
let Rt = P;
const we = n`
    <style>
...
o(N, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", N);
});
let Ht = N;
const ye = n`
    <style>
...
o(D, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", D);
});
let Tt = D;
const ke = n`
    <style>
...
`, Y = class Y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ke, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      /** @type {Events<T>} */
      events: new d(),
  ...
  connectedCallback() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), s = (a) => {
      a.preventDefault();
    };
...
o(Y, "register", () => {
  at.register(), A.register(), E.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", Y);
});
let Vt = Y;
const Zt = 150, Le = n`
    <style>
...
`, J = class J extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ce, this.cleanup = new l(), this.ui = {};
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
`, X = class X extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = xe, this.cleanup = new l(), this.ui = {};
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
`, y = class y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      /** @private */
      running: !1,
...
o(y, "register", () => {
  S.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", y);
...
o(K, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", K);
});
let ut = K;
const Ae = n`
    <style>
...
`, k = class k extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ae, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      getTitle() {
...
o(k, "register", () => {
  ut.register(), S.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", k);
...
`, L = class L extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      input: (() => {
...
o(L, "register", () => {
  p.register(), customElements.get("ui-input") || customElements.define("ui-input", L);
...
o(Q, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", Q);
});
let R = Q;
const He = n`
    <style>
...
`, W = class W extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = He, this.cleanup = new l(), this.ui = {
      /**
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), e = async (s) => {
      (s.composedPath() || []).forEach((a) => {
        a instanceof R && ([...this.querySelectorAll("ui-select-option")].forEach(
          (c) => c.removeAttribute("selected")
        ), a.setAttribute("selected", ""), this.ui.events.dispatch("change", a));
      });
    }, i = (s) => {
      this.classList.toggle("open") ? (s.stopPropagation(), this.addEventListener("click", e)) : setTimeout(() => this.removeEventListener("click", e));
    };
...
o(W, "register", () => {
  lt.register(), R.register(), customElements.get("ui-select") || customElements.define("ui-select", W);
});
let zt = W;
const Te = n`
    <style>
...
o(C, "register", () => {
  p.register(), A.register(), ct.register(), customElements.get("ui-search") || customElements.define("ui-search", C);
}), o(C, "observedAttributes", ["title", "value", "placeholder", "invalid"]);
let qt = C;
...
o(x, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", x);
...
o(I, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", I);
});
let Ot = I;
const Ve = n`
    <style>
...
`, U = class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.cleanup = new l(), this.ui = {};
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(U, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", U);
});
let _t = U;
const Ze = n`
    <style>
...
`, tt = class tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ze, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      getName() {
        return this.root.getAttribute("name");
...
`, et = class et extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = $e, this.cleanup = new l(), this.ui = {
      /** @private */
      root: this,
      /**
       * @private
      ...
      setPage(t, e = null, i = !1) {
        ...
        let a = null;
        this.stack.length > 1 && !i && (a = this.stack[this.stack.length - 2], a.parentElement.removeChild(a)), this.dispatchChangeEvent(a);
      },
      /**
...
o(et, "register", () => {
  dt.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", et);
});
let Pt = et;
...
o(M, "register", () => {
  customElements.get("ui-theme-handler") || customElements.define("ui-theme-handler", M);
}), o(M, "observedAttributes", ["auto", "mode"]);
let Dt = M;
export {
  lt as SvgChevronDown,
  Ct as SvgChevronLeft,
  at as SvgClose,
  Et as SvgDocumentNew,
  xt as SvgDownload,
  Rt as SvgMenu,
  Mt as SvgPen,
  Lt as SvgPlus,
