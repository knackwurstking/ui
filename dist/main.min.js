...
var Jt = (o, t, e) => t in o ? Bt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var s = (o, t, e) => Jt(o, typeof t != "symbol" ? t + "" : t, e), Zt = (o, t, e) => t.has(o) || Ot("Cannot " + e);
var m = (o, t, e) => (Zt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), Ft = (o, t, e) => t.has(o) ? Ot("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
class Dt {
  constructor() {
    this.callbacks = [];
  }
...
function Nt(o, t, { onDragStart: e = null, onDragging: i = null, onDragEnd: r = null } = {}) {
  const l = () => {
    const u = [...o.children].indexOf(t);
    t.draggable = !0, t.ondragstart = (h) => {
      h.dataTransfer.effectAllowed = "move", h.dataTransfer.dropEffect = "move", e && e(u);
    }, t.ondragover = (h) => (h.preventDefault(), !1), t.ondragenter = (h) => {
      h.preventDefault(), [...o.children].forEach(
        (f, P) => {
          if (P === u) {
            f.style.background = "var(--ui-primary)", f.style.color = "var(--ui-primary-fg)";
            return;
          }
          f.style.background = "inherit", f.style.color = "inherit";
        }
      ), i && i(u);
    }, t.ondrop = (h) => {
      h.preventDefault(), h.dataTransfer.dropEffect = "move", r && r(u), [...o.children].forEach((f) => {
        f.style.background = "inherit", f.style.color = "inherit";
      });
    };
  }, d = () => {
...
function Kt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  let i = null, r = null, l = null, d = null, c = null, u = !1, h = null, f = null;
  const P = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, d = n.clientY, r = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
      h = i.style.color, f = i.style.backgroundColor, i.style.color = "var(--ui-primary-fg)", i.style.backgroundColor = "var(--ui-primary)", o.classList.add("dragging"), u = !0, e && e();
    }, 200));
  }, zt = (n) => {
    if (!r || !i) return;
    if (!u && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const jt = Math.abs(l - n.clientX), $t = Math.abs(d - n.clientY);
      if ((jt > $t ? jt : $t) < 24)
        return;
      it();
      return;
    ...
    let g = document.elementFromPoint(v.clientX, v.clientY);
    for (; !g.classList.contains("draggable") && g.parentElement; )
      g = g.parentElement;
    g.classList.contains("draggable") && Xt(i, g);
  }, it = () => {
    c !== null && (clearTimeout(c), c = null), i && (i.style.color = h, i.style.backgroundColor = f, i = null), r = null, o.classList.remove("dragging"), u && (t && t(), u = !1);
  };
  function Xt(n, v) {
    Pt(n, v) ? o.insertBefore(n, v) : o.insertBefore(n, v.nextElementSibling);
  }
  function Pt(n, v) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (n) => {
        n.classList.add("draggable"), n.onmousedown = P, n.ontouchstart = P, n.onmousemove = zt, n.ontouchmove = zt, n.onmouseup = it, n.ontouchend = it;
      }
    );
  })(), {
...
class p {
  ...
  on(t, e) {
    ...
    return m(this, b)[t] || (m(this, b)[t] = []), m(this, b)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
  ...
  off(t, e) {
    ...
    let i = !1, r = 0;
    for (const l of m(this, b)[t])
      l === e && (m(this, b)[t].splice(r, 1), i = !0), r++;
    if (!i)
...
function y(o, t = {}) {
  ...
  const i = (u) => {
    ...
    o.classList.add("ripple-container"), o.style.overflow = "hidden", t.useClick === !0 ? o.addEventListener("click", l) : (o.addEventListener("pointerdown", i), o.addEventListener("pointerup", r), o.addEventListener("pointerleave", r));
  }, c = () => {
    o.classList.remove("ripple-container"), t.useClick === !0 ? o.removeEventListener("click", l) : (o.removeEventListener("pointerdown", i), o.removeEventListener("pointerup", r), o.removeEventListener("pointerleave", r));
  };
  return d(), {
    update: (u) => {
      t = {
...
const a = String.raw, V = String.raw;
function ie(o) {
...
const B = class B extends HTMLElement {
  ...
  shadowRender() {
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = a`
            <style>
                :host {
                    display: block;
...
s(B, "register", () => {
  customElements.get("ui-alerts") || customElements.define("ui-alerts", B);
});
let st = B;
...
s(k, "register", () => {
  customElements.get("ui-flex-grid-item") || customElements.define("ui-flex-grid-item", k);
}), s(k, "observedAttributes", ["flex"]);
let Y = k;
...
s(x, "register", () => {
  customElements.get("ui-flex-grid-row") || customElements.define("ui-flex-grid-row", x);
}), s(x, "observedAttributes", ["gap", "justify", "align"]);
let nt = x;
...
const J = class J extends Y {
   ...
   */
  constructor(t = null) {
    super(), this.messageContainer = null, this.styleVariants = {
      info: V`
                :host {
       ...
       */
      set({ message: e }) {
        this.root.messageContainer.innerHTML = e;
      },
      get message() {
       ...
       */
      set message(e) {
        const i = this.root.shadowRoot.querySelector("ui-primary");
        i.innerHTML = e || "";
      },
      get variant() {
  ...
  shadowRender() {
    super.shadowRender(), this.shadowRoot.removeChild(this.shadowRoot.querySelector("slot")), this.shadowRoot.innerHTML += a`
            <style>
                :host {
                    position: relative !important;
                    padding: var(--ui-spacing);
  ...
  attributeChangedCallback(t, e, i) {
    switch (super.attributeChangedCallback(t, e, i), t) {
      ...
      case "variant":
        ...
        this.styleVariants[i] || "";
    }
  }
};
s(J, "register", () => {
  customElements.get("ui-alert") || customElements.define("ui-alert", J);
});
let lt = J;
...
const E = class E extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ripple = null, this.ui = {
      ...
      set noripple(t) {
        if (!t) {
          this.root.ripple && this.root.ripple.destroy(), this.root.ripple = y(this.root);
          return;
        }
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
            ...
            <slot></slot>
        `, typeof this.ripple != "function" && (this.ripple = y(this)), this.addEventListener("click", () => {
...
s(E, "register", () => {
  customElements.get("ui-button") || customElements.define("ui-button", E);
}), s(E, "observedAttributes", ["noripple"]);
let dt = E;
const R = class R extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
        ...
        `, typeof this.ripple != "function" && (this.ripple = y(this, { centered: !0 })), this.addEventListener("click", () => {
      this.ui.events.dispatch("click", this);
    });
  }
  connectedCallback() {
...
s(R, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", R);
...
s(N, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", N);
});
let pt = N;
const Qt = a`
...
`, A = class A extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Dt(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new p(),
      get title() {
  ...
  static createAction({
    ...
    l.ui.flex = i, l.slot = "actions", l.innerHTML = a`
        ...
        `;
    let d;
    return r && (d = l.querySelector("ui-button"), d.ui.events.on("click", r)), {
      container: l,
      action: d
    };
  }
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set title(t) {
        ...
        e.classList.add("visible"), e.innerHTML = a` <h3>${t}</h3> `;
      },
      get fold() {
...
s(Q, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", Q);
});
let mt = Q;
...
}), s(S, "observedAttributes", ["checked"]);
let vt = S;
...
s(W, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", W);
});
let wt = W;
...
s(G, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", G);
});
let w = G;
...
s(_, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", _);
});
let X = _;
const q = class q extends HTMLElement {
  constructor() {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
            ...
            <div class="options">
                <div class="icon"><ui-svg>${Yt}</ui-svg></div>
    ...
    const t = (i) => {
      const r = async (l) => {
        (l.composedPath() || []).forEach((d) => {
          d instanceof X && ([...this.querySelectorAll("ui-select-option")].forEach(
...
s(I, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", I);
});
let Tt = I;
  ...
  constructor() {
    super(), this.stores = {}, this.ui = {
      ...
      update(t, e) {
        ...
        i === null && (i = this.root.stores[t]), this.set(t, e(i));
      },
      /**
       * @template {keyof T} K
       * @param {K} key
...
s(et, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", et);
});
let qt = et;
function oe() {
  st.register(), lt.register(), ut.register(), ct.register(), dt.register(), ht.register(), pt.register(), gt.register(), mt.register(), ft.register(), bt.register(), Y.register(), nt.register(), at.register(), vt.register(), kt.register(), xt.register(), X.register(), Ct.register(), Et.register(), At.register(), Rt.register(), Lt.register(), Tt.register(), St.register(), Mt.register(), qt.register(), yt.register(), wt.register(), w.register(), Ht.register();
}
export {
  Dt as CleanUp,
  p as Events,
  ...
  Lt as UISpinner,
  Tt as UIStackLayout,
  St as UIStackLayoutPage,
  Mt as UIStore,
  Et as UITextarea,
  Ht as UIThemeHandler,
  V as css,
  It as draggable,
  a as html,
  ee as isAndroid,
