...
function Jt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  ...
  const Y = (n) => {
    ...
    for (; !g.classList.contains("draggable") && g.parentElement; )
      g = g.parentElement;
    g.classList.contains("draggable") && Ot(i, g);
  }, I = () => {
...
class p {
  ...
  on(t, e) {
    ...
    return m(this, f)[t] || (m(this, f)[t] = []), m(this, f)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
  ...
  off(t, e) {
    ...
    let i = !1, r = 0;
    for (const l of m(this, f)[t])
      l === e && (m(this, f)[t].splice(r, 1), i = !0), r++;
    if (!i)
...
let Lt = U;
function It() {
  ot.register(), it.register(), rt.register(), st.register(), nt.register(), ct.register(), ht.register(), dt.register(), ut.register(), X.register(), at.register(), lt.register(), pt.register(), bt.register(), mt.register(), V.register(), vt.register(), yt.register(), kt.register(), wt.register(), xt.register(), Et.register(), Ct.register(), Rt.register(), Lt.register(), gt.register(), ft.register(), w.register(), At.register();
}
export {
  Pt as CleanUp,
  p as Events,
