...
var xt = (o, t, e) => t in o ? kt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => xt(o, typeof t != "symbol" ? t + "" : t, e), Ct = (o, t, e) => t.has(o) || mt("Cannot " + e);
var u = (o, t, e) => (Ct(o, t, "read from private field"), e ? e.call(o) : t.get(o)), bt = (o, t, e) => t.has(o) ? mt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const ft = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class c {
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const l of u(this, d)[t])
      l === e && (u(this, d)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
r(V, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", V);
});
let tt = V;
...
r(x, "register", () => {
  H.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", x);
...
const D = class D extends HTMLElement {
  constructor() {
    ...
    r(this, "shadowTemplate", () => n`
        <div class="options">
            <div class="icon"><ui-svg>${Et}</ui-svg></div>
  ...
  connectedCallback() {
    ...
    e.addEventListener("click", s), this.cleanup.add(() => {
      this.removeEventListener("click", s), e.removeEventListener("click", s);
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = `
            ...
            <div class="container">
                <slot name="title"></slot>
                <input type="search" />
                <ui-icon-button name="submit" ghost>${Tt}</ui-icon-button>
            </div>
        `;
...
}), r(S, "observedAttributes", ["current"]);
let ht = S;
...
const R = class R extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setPage(e, i = null, s = !1) {
        if (this.lock) return;
        const l = this.pages[e]();
        this.stack.push(this.root.appendChild(l)), typeof i == "function" && setTimeout(() => i(l));
        let a = null;
        this.stack.length > 1 && !s && (a = this.stack[this.stack.length - 2], a.parentElement.removeChild(a)), this.dispatchChangeEvent(a), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
...
}), r(E, "observedAttributes", ["use-storage", "storage-prefix"]);
let ut = E;
...
let gt = J;
function Mt() {
  K.register(), B.register(), Q.register(), W.register(), G.register(), _.register(), tt.register(), I.register(), U.register(), et.register(), it.register(), rt.register(), st.register(), at.register(), L.register(), nt.register(), lt.register(), ht.register(), dt.register(), ct.register(), M.register(), ut.register(), gt.register(), ot.register(), H.register(), p.register(), pt.register();
}
export {
  B as UIAppBar,
  K as UIAppBarItem,
