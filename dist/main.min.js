...
var Tt = (o, t, e) => t in o ? Mt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Tt(o, typeof t != "symbol" ? t + "" : t, e), Ht = (o, t, e) => t.has(o) || wt("Cannot " + e);
var h = (o, t, e) => (Ht(o, t, "read from private field"), e ? e.call(o) : t.get(o)), kt = (o, t, e) => t.has(o) ? wt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
class Et {
  constructor() {
    this.callbacks = [];
  }
...
function qt(o, t, e = {}) {
  ...
  const i = () => {
    ...
    t.draggable = !0, t.ondragstart = (c) => {
      ...
      c.preventDefault(), [...o.children].forEach((p, St) => {
        if (St === u) {
      ...
      c.preventDefault(), c.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(u), [...o.children].forEach((p) => {
        p.style.background = "inherit", p.style.color = "inherit";
      });
    };
  }, s = () => {
  ...
  return {
    destroy: () => {
      Array.from(o.children).forEach(
        (i) => {
          i.classList.remove("draggable"), i.onmousedown = null, i.ontouchstart = null, i.onmousemove = null, i.ontouchmove = null, i.onmouseup = null, i.ontouchend = null;
        }
      );
    }
  };
...
const n = String.raw, K = String.raw, Vt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: Et,
  Events: l,
  createDraggable: qt,
  createMobileDraggable: zt,
  createRipple: g,
  css: K,
...
}), r(f, "observedAttributes", ["noripple"]);
let G = f;
...
}), r(k, "observedAttributes", ["gap", "justify", "align"]);
let ot = k;
...
}), r(C, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let st = C;
...
}), r(R, "observedAttributes", ["ripple", "secondary", "primary"]);
let nt = R;
...
const Y = class Y extends HTMLElement {
  ...
  shadowRender() {
    ...
    const t = (i) => {
      const s = async (a) => {
        (a.composedPath() || []).forEach((u) => {
          u instanceof q && ([...this.querySelectorAll("ui-select-option")].forEach(
...
}), r(H, "observedAttributes", ["auto", "mode"]);
let vt = H;
