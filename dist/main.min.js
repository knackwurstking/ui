...
function Et(r, e = {}) {
  ...
  const t = () => {
    ...
    r.draggable = !0, r.ondragstart = (u) => {
      ...
      u.preventDefault(), e.onDragging && e.onDragging(a);
    }, r.ondrop = (u) => {
...
class d {
  ...
  off(e, t) {
    ...
    let o = !1, s = 0;
    for (const a of p(this, c)[e])
      a === t && (p(this, c)[e].splice(s, 1), o = !0), s++;
    if (!o)
...
`, P = class P extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const s = this.shadowRoot.querySelector("dialog"), a = (u) => {
      u.preventDefault();
    };
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), o = async (a) => {
      (a.composedPath() || []).forEach((u) => {
        u instanceof L && ([...this.querySelectorAll("ui-select-option")].forEach(
