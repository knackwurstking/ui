...
var r = (o, t, e) => At(o, typeof t != "symbol" ? t + "" : t, e), St = (o, t, e) => t.has(o) || ft("Cannot " + e);
var h = (o, t, e) => (St(o, t, "read from private field"), e ? e.call(o) : t.get(o)), vt = (o, t, e) => t.has(o) ? ft("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const yt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
r(P, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", P);
});
let ut = P;
...
}), r(S, "observedAttributes", ["auto", "mode"]);
let bt = S;
const J = class J extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {}, this.shadowRender();
