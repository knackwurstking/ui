...
var r = (s, t, e) => xt(s, typeof t != "symbol" ? t + "" : t, e), St = (s, t, e) => t.has(s) || bt("Cannot " + e);
...
class d {
  ...
  on(t, e) {
    ...
    return p(this, u)[t] || (p(this, u)[t] = []), p(this, u)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let i = !1, o = 0;
    for (const n of p(this, u)[t])
      n === e && (p(this, u)[t].splice(o, 1), i = !0), o++;
    if (!i)
...
const a = String.raw, c = String.raw;
class h {
  constructor() {
    this.callbacks = [];
  }
...
const Mt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: a,
  isAndroid: Et
}, Symbol.toStringTag, { value: "Module" })), $ = class $ extends HTMLElement {
  constructor() {
...
r($, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", $);
});
let B = $;
...
}), r(m, "observedAttributes", ["no-ripple"]);
let W = m;
...
r(P, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", P);
});
let _ = P;
const At = a`
...
const S = class S extends HTMLElement {
  ...
  setTitle(t) {
    ...
    !t && e && this.removeChild(e), t && (e || (e = new g(), e.slot = "title", this.appendChild(e)), e.innerHTML = t);
  }
  /**
...
r(D, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", D);
});
let H = D;
  ...
  attributeChangedCallback(e, i, o) {
    switch (e) {
      case "title":
        ...
        o === null && n && (this.removeChild(n), n = null), n || (n = new g(), n.slot = "title", this.appendChild(n)), n.innerHTML = o || "";
        break;
      case "value":
        this.ui.setValue(o);
        break;
...
r(A, "register", () => {
  q.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", A);
}), r(A, "observedAttributes", ["use-history"]);
let ct = A;
