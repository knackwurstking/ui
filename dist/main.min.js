...
var Te = (i, t, e) => t in i ? Se(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var r = (i, t, e) => (Te(i, typeof t != "symbol" ? t + "" : t, e), e), Ot = (i, t, e) => {
  if (!t.has(i))
    throw TypeError("Cannot " + e);
};
var s = (i, t, e) => (Ot(i, t, "read from private field"), e ? e.call(i) : t.get(i)), n = (i, t, e) => {
  if (t.has(i))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(i) : t.set(i, e);
}, a = (i, t, e, o) => (Ot(i, t, "write to private field"), o ? o.call(i, e) : t.set(i, e), e);
const Dt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class H {
  ...
  removeListener(t, e) {
    ...
    for (const w of s(this, d)[t])
      w === e && (s(this, d)[t].splice(l, 1), o = !0), l++;
    if (!o)
...
const Ne = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ripple: je,
  utils: Ne
}, Symbol.toStringTag, { value: "Module" })), ie = document.createElement("template");
ie.innerHTML = `
<style>
    :host {
        display: flex;
...
const dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ie.content.cloneNode(!0)), this.ui = new ze(this);
  }
};
r(dt, "register", () => customElements.define("ui-app-bar", dt));
let X = dt;
...
let qe = (Jt = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Rt(s(this, O), { centered: !0 }));
  }
  disableRipple() {
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(oe.content.cloneNode(!0)), this.ui = new qe(this);
  }
  connectedCallback() {
...
let Oe = (Bt = class {
  ...
  constructor(t) {
    /** @type {IconButton} */
    n(this, D, void 0);
    a(this, D, t), this.removeRipple = null;
  }
  enableRipple() {
    this.removeRipple || (this.removeRipple = Rt(s(this, D), { centered: !0 }));
  }
  disableRipple() {
    this.removeRipple && this.removeRipple(), this.removeRipple = null;
  }
...
r(ut, "register", () => customElements.define("ui-container", ut));
let Q = ut;
...
let De = (Xt = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, x, void 0);
    a(this, b, t), a(this, y, e), this.events = new H(), a(this, x, document.createElement("h4")), s(this, x).slot = "title", s(this, b).appendChild(s(this, x));
  }
  get dialog() {
    return s(this, y);
  }
...
}, b = new WeakMap(), y = new WeakMap(), x = new WeakMap(), Xt);
var P, V;
const pt = class pt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ae.content.cloneNode(!0)), this.ui = new De(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
P = new WeakMap(), V = new WeakMap(), r(pt, "register", () => customElements.define("ui-dialog", pt));
let G = pt;
const Pt = "1", le = document.createElement("template");
le.innerHTML = `
<style></style>
<slot></slot>
`;
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(le.content.cloneNode(!0)), this._updateStyle();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
let F = $;
const Vt = "0", ce = document.createElement("template");
ce.innerHTML = `
<style></style>
<slot></slot>
`;
...
let _ = j;
const Zt = "0", he = document.createElement("template");
he.innerHTML = `
<style></style>
<slot></slot>
`;
...
const gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(de.content.cloneNode(!0)), this.ui = new Pe(this);
  }
};
r(gt, "register", () => customElements.define("ui-select-option", gt));
let q = gt;
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ue.content.cloneNode(!0)), this.ui = new Ve();
  }
  // }}}
  connectedCallback() {
    var t;
    (t = this.shadowRoot.querySelector(".options")) == null || t.addEventListener("click", this.onClickOptions), this.style.setProperty(
      "--items-length",
  ...
  disconnectedCallback() {
    var t;
    this.removeEventListener("click", this.onClick), (t = this.shadowRoot.querySelector(".options")) == null || t.removeEventListener("click", this.onClickOptions);
  }
  // }}}
  /**
   * @private
   * @param {Event} ev
   */
  async onClickOptions(t) {
    this.classList.toggle("open") ? (t.stopPropagation(), this.addEventListener("click", this.onClick)) : setTimeout(
...
let Ze = (Kt = class {
  ...
  constructor(t) {
     ...
     */
    n(this, W, void 0);
    a(this, Z, t), a(this, C, new H()), this.langType = null;
  }
  /** @returns {import("./lang-type").LangType} */
  getFallbackElement() {
    return s(this, Z).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, a(this, W, e), s(this, C).dispatchWithData("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var o;
    return (o = s(this, W)) == null ? void 0 : o[t][e];
  }
  /**
   * @param {"change"} key
...
}, Z = new WeakMap(), C = new WeakMap(), W = new WeakMap(), Kt);
...
r(ft, "register", () => customElements.define("ui-lang-type", ft));
let it = ft;
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(pe.content.cloneNode(!0)), this.ui = new Je(this);
  }
};
r(vt, "register", () => customElements.define("ui-stack-layout-page", vt));
let ot = vt;
...
let Be = (Ft = class {
  ...
  constructor(t) {
     ...
     */
    n(this, M, {});
    a(this, k, t), this.events = new H(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    ...
    t.ontransitionend = () => {
      t.ontransitionend = null, s(this, k).removeChild(t);
    }, this.stack.length && s(this, k).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (this.stack.push(
      // @ts-expect-error
      s(this, k).appendChild(s(this, M)[t]().children[0])
    ), this.stack.length > 1) {
...
}, k = new WeakMap(), M = new WeakMap(), Ft);
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ge.content.cloneNode(!0)), this.ui = new Be(this);
  }
};
...
}, f = new WeakMap(), v = new WeakMap(), _t);
const bt = class bt extends HTMLElement {
  constructor() {
    super(), this.ui = new Xe(this);
  }
};
r(bt, "register", () => customElements.define("ui-store", bt));
let nt = bt;
...
r(yt, "register", () => customElements.define("ui-svg-back-arrow-navigation", yt));
let At = yt;
...
r(xt, "register", () => customElements.define("ui-svg-chevron-down", xt));
let $t = xt;
...
r(Lt, "register", () => customElements.define("ui-svg-close", Lt));
let jt = Lt;
...
r(kt, "register", () => customElements.define("ui-svg-delete-recycle-bin", kt));
let It = kt;
...
r(Ct, "register", () => customElements.define("ui-svg-edit2", Ct));
let Nt = Ct;
...
r(Mt, "register", () => customElements.define("ui-svg-settings", Mt));
let zt = Mt;
...
let Ye = (te = class {
  ...
  enableRipple() {
    s(this, T) || (this.removeRipple = Rt(s(this, c)), s(this, c).style.cursor = "pointer", this._startInputHandling());
  }
  disableRipple() {
    s(this, T) && s(this, T).call(this), this._stopInputHandling();
  }
  _startInputHandling() {
    s(this, S) || (s(this, c).addEventListener("click", s(this, J)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", s(this, B));
    }), a(this, S, !0));
  }
  _stopInputHandling() {
    s(this, c).removeEventListener("click", s(this, J)), [...s(this, c).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", s(this, B));
    }), a(this, S, !1);
  }
}, c = new WeakMap(), S = new WeakMap(), J = new WeakMap(), B = new WeakMap(), T = new WeakMap(), te);
const U = class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0)), this.ui = new Ye(this);
  }
  /**
  * @param {string} name
  * @param {string | null} _oldValue
...
r(Tt, "register", () => customElements.define("ui-primary", Tt));
let lt = Tt;
...
r(Ht, "register", () => customElements.define("ui-secondary", Ht));
let ct = Ht;
var p;
class Ke {
  constructor() {
...
r(z, "register", () => customElements.define("ui-theme-handler", z)), r(z, "observedAttributes", ["auto", "mode"]);
let ht = z;
...
async function Ge() {
  X.register(), K.register(), Y.register(), Q.register(), F.register(), _.register(), tt.register(), q.register(), et.register(), it.register(), st.register(), ot.register(), rt.register(), nt.register(), ct.register(), lt.register(), at.register(), ht.register(), G.register();
}
async function Fe() {
