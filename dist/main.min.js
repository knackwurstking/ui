...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ze, this.cleanup = new h(), this.ui = new Oe(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const tt = class tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.cleanup = new h(), this.ui = new Be(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const D = class D extends HTMLElement {
   ...
   */
  attributeChangedCallback(t, e, s) {
    switch (console.debug("Handle attribute:", s), t) {
      case "title":
  ...
  setTitle(t) {
    ...
    e || (e = document.createElement("span"), e.slot = "title"), e.innerHTML = t, this.appendChild(e);
  }
  /**
   * @private
   */
