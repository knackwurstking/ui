...
const a = String.raw, ge = String.raw, fe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  css: ge,
  html: a,
  isAndroid: pe
...
class Ge {
  ...
  enableAutoMode() {
    ...
    c(this, g, window.matchMedia("(prefers-color-scheme: dark)")), i(this, g).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, g));
  }
  disableAutoMode() {
    this.removeMedia();
  }
   ...
   */
  removeMedia() {
    i(this, g) && (i(this, g).removeEventListener("change", this.mediaChangeHandler), c(this, g, null));
  }
}
g = new WeakMap();
