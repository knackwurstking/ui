...
function Rt(o, t = {}) {
  ...
  const e = () => {
    ...
    o.draggable = !0, o.ondragstart = (n) => {
      n.dataTransfer.effectAllowed = "move", n.dataTransfer.dropEffect = "move", n.dataTransfer.setData(
        "text/plain",
        l.toString()
      ), t.onDragStart && t.onDragStart(l);
    }, o.ondragover = (n) => (n.preventDefault(), !1), o.ondragenter = (n) => {
      n.preventDefault(), t.onDragging && t.onDragging(l);
    }, o.ondrop = (n) => {
...
const O = class O extends HTMLElement {
  ...
  connectedCallback() {
    const e = this.shadowRoot.querySelector(".options"), i = async (l) => {
      (l.composedPath() || []).forEach((n) => {
        n instanceof H && ([...this.querySelectorAll("ui-select-option")].forEach(
  ...
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      setPage(e, i = null, s = !1) {
        ...
        let n = null;
        this.stack.length > 1 && !s && (n = this.stack[this.stack.length - 2], n.parentElement.removeChild(n)), this.dispatchChangeEvent(n), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
