...
var s = (o, e, t) => ai(o, typeof e != "symbol" ? e + "" : e, t), Xt = (o, e, t) => e.has(o) || Re("Cannot " + t);
var p = (o, e, t) => (Xt(o, e, "read from private field"), t ? t.call(o) : e.get(o)), a = (o, e, t) => e.has(o) ? Re("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t), M = (o, e, t, i) => (Xt(o, e, "write to private field"), i ? i.call(o, t) : e.set(o, t), t), c = (o, e, t) => (Xt(o, e, "access private method"), t);
class Vi {
  constructor() {
    this.callbacks = [];
  }
...
function ci(o, { onDragEnd: e = null, onDragStart: t = null } = {}) {
  ...
  const st = (l) => {
    ...
    if (!m && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const Me = Math.abs(u - l.clientX), Se = Math.abs(h - l.clientY);
      if ((Me > Se ? Me : Se) < 24)
        return;
      Yt();
      return;
    ...
    for (; !v.classList.contains("draggable") && v.parentElement; )
      v = v.parentElement;
    v.classList.contains("draggable") && oi(i, v);
  }, Yt = () => {
  ...
  function oi(l, C) {
    si(l, C) ? o.insertBefore(l, C) : o.insertBefore(l, C.nextElementSibling);
  }
  function si(l, C) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (l) => {
        l.classList.add("draggable"), l.onmousedown = st, l.ontouchstart = st, l.onmousemove = Le, l.ontouchmove = Le, l.onmouseup = Yt, l.ontouchend = Yt;
      }
    );
  })(), {
...
function L(o, e = {}) {
  ...
  let t = null;
  const i = (f) => {
    t = Jt(f, e), o.addEventListener("pointermove", u);
  }, r = () => {
    o.removeEventListener("pointermove", u), Kt(t), t = null;
  }, u = () => r(), h = (f) => {
    t = Jt(f, e), Kt(t), t = null;
  }, d = () => {
...
nt = new WeakSet(), je = function() {
  ...
  customElements.get("ui-alerts") || (console.debug('[ui] Register "ui-alerts" component'), customElements.define("ui-alerts", at));
});
let Qt = at;
Qt.register();
var lt, Te;
...
const ht = class ht extends X {
  ...
  constructor(t = null) {
    ...
    }, c(this, dt, Ze).call(this), t && this.ui.set(t);
  }
...
dt = new WeakSet(), Ze = function() {
  ...
  customElements.get("ui-alert") || (console.debug('[ui] Register "ui-alert" component'), customElements.define("ui-alert", ht));
});
let Ut = ht;
Ut.register();
var pt, Ge;
...
pt = new WeakSet(), Ge = function() {
  ...
  customElements.get("ui-app-bar") || (console.debug('[ui] Register "ui-app-bar" component'), customElements.define("ui-app-bar", gt));
});
let te = gt;
te.register();
var ft, ze;
...
ft = new WeakSet(), ze = function() {
  ...
  customElements.get("ui-app-bar-item") || (console.debug('[ui] Register "ui-app-bar-item" component'), customElements.define("ui-app-bar-item", mt));
});
let ee = mt;
ee.register();
var bt, Be;
...
const yt = class yt extends HTMLElement {
  constructor() {
    super();
    a(this, kt);
    this.ui = {}, c(this, kt, Oe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
kt = new WeakSet(), Oe = function() {
  ...
  customElements.get("ui-container") || (console.debug('[ui] Register "ui-container" component'), customElements.define("ui-container", yt));
});
let oe = yt;
oe.register();
var wt, $e;
...
Ct = new WeakSet(), Fe = function() {
  ...
  customElements.get("ui-drawer") || (console.debug('[ui] Register "ui-drawer" component'), customElements.define("ui-drawer", xt));
});
let ne = xt;
ne.register();
var Lt, Pe;
...
const St = class St extends HTMLElement {
  constructor() {
    super();
    a(this, Mt);
    this.ui = {}, c(this, Mt, De).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Mt = new WeakSet(), De = function() {
  ...
  customElements.get("ui-drawer-group-item") || (console.debug('[ui] Register "ui-drawer-group-item" component'), customElements.define("ui-drawer-group-item", St));
});
let le = St;
le.register();
var Rt, Ye;
...
let ce = Z;
ce.register();
var K, Q, W, I, U, tt, et, it, rt, ot, y, Xe, x;
const G = class G extends HTMLElement {
  constructor() {
    ...
    this.ui = {
      ...
      set casl(t) {
        var i;
        t === null && (t = p(this.root, K)), M(this.root, Q, t), c(i = this.root, y, x).call(i);
      },
      get mono() {
      ...
      set mono(t) {
        var i;
        t === null && (t = p(this.root, W)), M(this.root, I, t), c(i = this.root, y, x).call(i);
      },
      get slnt() {
      ...
      set slnt(t) {
        var i;
        t === null && (t = p(this.root, U)), M(this.root, tt, t), c(i = this.root, y, x).call(i);
      },
      get size() {
      ...
      set size(t) {
        var i;
        t === null && (t = p(this.root, et)), M(this.root, it, t), c(i = this.root, y, x).call(i);
      },
      get family() {
      ...
      set family(t) {
        var i;
        t === null && (t = p(this.root, rt)), M(this.root, ot, t), c(i = this.root, y, x).call(i);
      }
    }, c(this, y, Xe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
K = new WeakMap(), Q = new WeakMap(), W = new WeakMap(), I = new WeakMap(), U = new WeakMap(), tt = new WeakMap(), et = new WeakMap(), it = new WeakMap(), rt = new WeakMap(), ot = new WeakMap(), y = new WeakSet(), Xe = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            <style>
                :host {
                    display: inline-block;
...
At = new WeakSet(), Je = function() {
  this.ui.size = "1.1rem", this.ui.casl = 1, this.ui.mono = 0, this.ui.slnt = 0;
}, s(Ht, "register", () => {
  customElements.get("ui-primary") || (console.debug('[ui] Register "ui-primary" component'), customElements.define("ui-primary", Ht));
});
let de = Ht;
de.register();
var jt, Ke;
...
jt = new WeakSet(), Ke = function() {
  this.ui.size = "0.9rem", this.ui.casl = 1, this.ui.mono = 0, this.ui.slnt = -15;
}, s(Tt, "register", () => {
  customElements.get("ui-secondary") || (console.debug('[ui] Register "ui-secondary" component'), customElements.define("ui-secondary", Tt));
});
let R = Tt;
R.register();
var Vt, Qe;
...
Zt = new WeakSet(), Ie = function() {
  ...
  customElements.get("ui-select-option") || (console.debug('[ui] Register "ui-select-option" component'), customElements.define("ui-select-option", Gt));
});
let J = Gt;
J.register();
var zt, Ue;
...
zt = new WeakSet(), Ue = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            ...
            <div class="options">
                <div class="icon"><ui-svg>${xe}</ui-svg></div>
  ...
  const t = (r) => {
    const u = async (h) => {
      (h.composedPath() || []).forEach((d) => {
        d instanceof J && ([...this.querySelectorAll("ui-select-option")].forEach(
...
s(F, "register", () => {
  customElements.get("ui-lang") || (console.debug('[ui] Register "ui-lang" component'), customElements.define("ui-lang", F));
...
s(qt, "register", () => {
  customElements.get("ui-lang-type") || (console.debug('[ui] Register "ui-lang-type" component'), customElements.define("ui-lang-type", qt));
});
let be = qt;
be.register();
var Ot, ei;
...
Ot = new WeakSet(), ei = function() {
  ...
  customElements.get("ui-spinner") || (console.debug('[ui] Register "ui-spinner" component'), customElements.define("ui-spinner", P));
...
$t = new WeakSet(), ii = function() {
  ...
  customElements.get("ui-stack-layout") || (console.debug('[ui] Register "ui-stack-layout" component'), customElements.define("ui-stack-layout", Ft));
});
let ke = Ft;
ke.register();
var Pt, ri;
...
s(Dt, "register", () => {
  customElements.get("ui-store") || (console.debug('[ui] Register "ui-store" component'), customElements.define("ui-store", Dt));
});
let we = Dt;
we.register();
