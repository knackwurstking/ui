...
var Vt = (o, t, e) => t in o ? Yt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Vt(o, typeof t != "symbol" ? t + "" : t, e), Xt = (o, t, e) => t.has(o) || qt("Cannot " + e);
...
function Bt(o, t, { onDragStart: e = null, onDragging: i = null, onDragEnd: s = null } = {}) {
  const l = () => {
    ...
    t.draggable = !0, t.ondragstart = (u) => {
      u.dataTransfer.effectAllowed = "move", u.dataTransfer.dropEffect = "move", e && e(h);
      ...
      u.preventDefault(), u.dataTransfer.dropEffect = "move", s && s(h), [...o.children].forEach((m) => {
        m.style.background = "inherit", m.style.color = "inherit";
      });
    };
  }, d = () => {
...
function Jt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
  let i = null, s = null, l = null, d = null, c = null, h = !1, u = null, m = null;
  const Y = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, d = n.clientY, s = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
      u = i.style.color, m = i.style.backgroundColor, i.style.color = "var(--ui-primary-color)", i.style.backgroundColor = "var(--ui-primary-bgColor)", o.classList.add("dragging"), h = !0, e && e();
    }, 200));
  }, Tt = (n) => {
    if (!s || !i) return;
    if (!h && (/* @__PURE__ */ new Date()).getTime() - s < 200) {
      const Mt = Math.abs(l - n.clientX), Ht = Math.abs(d - n.clientY);
      if ((Mt > Ht ? Mt : Ht) < 24)
        return;
      U();
      return;
    ...
    c !== null && (clearTimeout(c), c = null), i && (i.style.color = u, i.style.backgroundColor = m, i = null), s = null, o.classList.remove("dragging"), h && (t && t(), h = !1);
  };
  function Ot(n, v) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (n) => {
        n.classList.add("draggable"), n.onmousedown = Y, n.ontouchstart = Y, n.onmousemove = Tt, n.ontouchmove = Tt, n.onmouseup = U, n.ontouchend = U;
      }
    );
  })(), {
...
class b {
  ...
  off(t, e) {
    ...
    for (const l of f(this, g)[t])
      l === e && (f(this, g)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
r(X, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", X);
});
let it = X;
    ...
    const t = (i) => {
      const s = async (l) => {
        (l.composedPath() || []).forEach((d) => {
          d instanceof F && ([...this.querySelectorAll("ui-select-option")].forEach(
...
let Lt = _;
function It() {
  it.register(), et.register(), ot.register(), rt.register(), st.register(), nt.register(), ct.register(), lt.register(), at.register(), ut.register(), dt.register(), ht.register(), pt.register(), mt.register(), ft.register(), F.register(), vt.register(), yt.register(), kt.register(), wt.register(), xt.register(), Et.register(), Ct.register(), Rt.register(), Lt.register(), gt.register(), bt.register(), w.register(), At.register();
}
export {
  Pt as CleanUp,
  b as Events,
  ...
  at as UIDrawer,
  lt as UIDrawerGroup,
  ct as UIDrawerGroupItem,
  ht as UIFlexGrid,
  ut as UIFlexGridItem,
  dt as UIFlexGridRow,
  rt as UIIconButton,
  mt as UIInput,
  gt as UILabel,
