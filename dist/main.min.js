...
var Me = (o, t, e) => t in o ? Ee(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => (Me(o, typeof t != "symbol" ? t + "" : t, e), e), St = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var s = (o, t, e) => (St(o, t, "read from private field"), e ? e.call(o) : t.get(o)), c = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, h = (o, t, e, i) => (St(o, t, "write to private field"), i ? i.call(o, e) : t.set(o, e), e);
const zt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const l = String.raw, Ae = String.raw;
class a {
  constructor() {
    this.callbacks = [];
  }
...
const Ei = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  createRipple: xt,
  css: Ae,
  defaultRippleOptions: we,
  html: l,
  isAndroid: He
}, Symbol.toStringTag, { value: "Module" })), Lt = "1", Re = l`
<style></style>
<slot></slot>
`;
let $e = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : Lt;
  }
  set flex(t) {
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Re, this.cleanup = new a(), this.ui = new $e(this), this.updateStyle();
  }
  connectedCallback() {
  }
...
r(R, "register", () => {
  customElements.get("ui-flex-grid-item") || customElements.define("ui-flex-grid-item", R);
}), r(R, "observedAttributes", ["flex"]);
let Nt = R;
const Et = "0", Se = l`
<style></style>
<slot></slot>
...
let ze = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || Et;
  }
  set gap(t) {
...
const $ = class $ extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = new a(), this.ui = new ze(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const S = class S extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = qe, this.cleanup = new a(), this.ui = new je(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(S, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", S);
}), r(S, "observedAttributes", ["gap"]);
let Zt = S;
const Ne = l`
    <style>
...
`, G = class G extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ne, this.cleanup = new a(), this.ui = {
...
r(G, "register", () => {
  X.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", G);
});
let Pt = G;
const Ze = l`
    <style>
...
r(I, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", I);
});
let Ot = I;
const Pe = l`
    <style>
...
`, z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      /**
      ...
      enableRipple: () => {
        this.ui.removeRipple || (this.ui.removeRipple = xt(this, { centered: !0 }), this.removeAttribute("no-ripple"));
      },
      disableRipple: () => {
...
`, q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Oe, this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      /**
...
}), r(q, "observedAttributes", ["no-ripple", "color"]);
let K = q;
const Fe = l`
<style>
    * { box-sizing: border-box; }
...
`, U = class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Fe, this.cleanup = new a(), this.ui = {};
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(U, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", U);
});
let Dt = U;
const De = l`
<style>
...
r(_, "register", () => {
  customElements.get("svg-add") || customElements.define("svg-add", _);
});
let Bt = _;
const Be = l`
<style>
...
r(tt, "register", () => {
  customElements.get("svg-back-arrow") || customElements.define("svg-back-arrow", tt);
});
let Vt = tt;
const Ve = l`
<style>
...
r(et, "register", () => {
  customElements.get("svg-chevron-down") || customElements.define("svg-chevron-down", et);
});
let Tt = et;
const Ye = l`
<style>
...
r(it, "register", () => {
  customElements.get("svg-close") || customElements.define("svg-close", it);
});
let Ht = it;
const Je = l`
<style>
...
r(st, "register", () => {
  customElements.get("svg-download") || customElements.define("svg-download", st);
});
let Yt = st;
const Xe = l`
<style>
...
r(ot, "register", () => {
  customElements.get("svg-edit") || customElements.define("svg-edit", ot);
});
let Jt = ot;
const Ke = l`
<style>
...
r(rt, "register", () => {
  customElements.get("svg-pdf") || customElements.define("svg-pdf", rt);
});
let Xt = rt;
const Qe = l`
<style>
...
r(nt, "register", () => {
  customElements.get("svg-recycle") || customElements.define("svg-recycle", nt);
});
let Kt = nt;
const We = l`
<style>
...
r(at, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", at);
});
let Qt = at;
const Ie = l`
<style>
...
r(ct, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", ct);
});
let Wt = ct;
const Ue = l`
<style>
...
r(ht, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", ht);
});
let Gt = ht;
const _e = l`
<style>
...
r(ut, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", ut);
});
let It = ut;
const ti = l`
    <style>
...
`, dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ti, this.cleanup = new a(), this.ui = {
      /** @type {Events<T>} */
      events: new f(),
      /**
       * @private
       ...
       */
      setFullscreen: (t) => {
        t ? this.setAttribute("fullscreen", "") : this.removeAttribute("fullscreen");
      },
       ...
       */
      setTitle: (t) => {
        this.ui.h4.innerText = t;
      },
      getDialogElement: () => this.ui.dialog,
      open: (t = !1, e = !0) => {
        const i = this.ui.dialog.inert;
        this.ui.dialog.inert = e, t ? this.ui.dialog.showModal() : this.ui.dialog.show(), this.ui.events.dispatch("open", null), this.ui.dialog.inert = i;
      },
      close: () => {
...
r(dt, "register", () => {
  K.register(), Ht.register(), X.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", dt);
});
let Ut = dt;
const _t = 150, ye = document.createElement("template");
ye.innerHTML = `
    <style>
        * { box-sizing: border-box; }
...
let ei = class {
   ...
   */
  constructor(t) {
    this.root = t, this.aside = this.root.shadowRoot.querySelector("aside"), this.events = new f();
  }
  get open() {
...
const j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ye.content.cloneNode(!0)), this.cleanup = new a(), this.ui = new ei(this);
  }
  connectedCallback() {
    const t = (i) => {
...
`, pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ii, this.cleanup = new a();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(pt, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", pt);
});
let Q = pt;
const si = l`
<style>
...
`, gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = si, this.cleanup = new a();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(gt, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", gt);
});
let L = gt;
const oi = l`
<style>
...
let ri = (de = class {
  ...
  enableRipple() {
    s(this, M) || (this.removeRipple = xt(s(this, u)), s(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
    s(this, M) && s(this, M).call(this), this.stopInputHandling();
  }
  /**
   * @private
   */
  startInputHandling() {
    s(this, E) || (s(this, u).addEventListener("click", s(this, B)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", s(this, V));
    }), h(this, E, !0));
  }
  /**
   * @private
   */
  stopInputHandling() {
    s(this, u).removeEventListener("click", s(this, B)), [...s(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", s(this, V));
    }), h(this, E, !1);
  }
}, u = new WeakMap(), E = new WeakMap(), B = new WeakMap(), V = new WeakMap(), M = new WeakMap(), de);
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = oi, this.cleanup = new a(), this.ui = new ri(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(N, "register", () => {
  Q.register(), L.register(), customElements.get("ui-label") || customElements.define("ui-label", N);
}), r(N, "observedAttributes", ["ripple", "secondary", "primary"]);
let ee = N;
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0)), this.cleanup = new a(), this.ui = new ni(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ce.content.cloneNode(!0)), this.cleanup = new a(), this.ui = new li(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(Z, "register", () => {
  Rt.register(), Q.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", Z);
}), r(Z, "observedAttributes", ["title"]);
let ie = Z;
...
let ai = class {
   ...
   */
  constructor(t) {
    this.root = t, this.events = new f(), this.input = this.root.shadowRoot.querySelector("input"), this.input.type = this.root.getAttribute("type") || "text", this.input.oninput = () => this.events.dispatch("input", this.value), this.input.onchange = () => this.events.dispatch("change", this.value);
  }
  /**
   * @param {string | null} v
   */
  set title(t) {
    ...
    t === null && e && (this.root.removeChild(e), e = null), e || (e = new L(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t || "";
  }
  get title() {
    var t;
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(xe.content.cloneNode(!0)), this.cleanup = new a(), this.ui = new ai(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(P, "register", () => {
  L.register(), customElements.get("ui-input") || customElements.define("ui-input", P);
}), r(P, "observedAttributes", [
  "title",
  "type",
  "value",
  "placeholder",
...
let hi = (pe = class {
  ...
  get value() {
    return s(this, v).getAttribute("value");
  }
  set value(t) {
    s(this, v).setAttribute("value", t);
  }
  get selected() {
    return s(this, v).hasAttribute("selected");
  }
  set selected(t) {
    t ? s(this, v).setAttribute("selected", "") : s(this, v).removeAttribute("selected");
  }
}, v = new WeakMap(), pe);
const bt = class bt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ci, this.setAttribute("role", "button"), this.ui = new hi(this);
  }
};
r(bt, "register", () => {
...
const ft = class ft extends HTMLElement {
  constructor() {
    ...
    c(this, Y, async (e) => {
      (e.composedPath() || []).forEach((i) => {
        i instanceof W && ([...this.querySelectorAll("ui-select-option")].forEach(
          (n) => n.removeAttribute("selected")
        ), i.setAttribute("selected", ""), this.ui.events.dispatch("change", i));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ui, this.cleanup = new a(), this.ui = new di();
  }
  // }}}
  connectedCallback() {
  ...
  async onClickOptions(e) {
    this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", s(this, Y))) : setTimeout(
      () => this.removeEventListener("click", s(this, Y))
    );
  }
  // }}}
};
Y = new WeakMap(), // }}}
r(ft, "register", () => {
  Tt.register(), W.register(), customElements.get("ui-select") || customElements.define("ui-select", ft);
});
let oe = ft;
const pi = l`
    <style>
...
let gi = class {
   ...
   */
  constructor(t) {
    this.root = t, this.events = new f(), this.submit = this.root.shadowRoot.querySelector("ui-icon-button"), this.submit.ui.events.on("click", () => {
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = pi, this.cleanup = new a(), this.ui = new gi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "title":
        ...
        i === null && n && (this.removeChild(n), n = null), n || (n = new L(), n.slot = "title", this.appendChild(n)), n.innerHTML = i || "";
        break;
      case "value":
        this.ui.value = i || "";
        break;
...
r(O, "register", () => {
  L.register(), K.register(), At.register(), customElements.get("ui-search") || customElements.define("ui-search", O);
}), r(O, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid"
...
let mi = (ge = class {
  ...
  constructor(t) {
     ...
     */
    c(this, J, void 0);
    h(this, k, t), h(this, T, new f()), this.langType = null;
  }
  get current() {
    return s(this, k).getAttribute("current");
  }
  set current(t) {
    t === null ? s(this, k).removeAttribute("current") : s(this, k).setAttribute("current", t);
  }
  /** @returns {UILangType} */
  getFallbackElement() {
    return s(this, k).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, h(this, J, e), s(this, T).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var i, n;
    return ((n = (i = s(this, J)) == null ? void 0 : i[t]) == null ? void 0 : n[e]) || null;
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, i = !1) {
    ...
    return i && e(this.langType), s(this, T).on(t, e);
  }
}, k = new WeakMap(), T = new WeakMap(), J = new WeakMap(), ge);
...
}), r(F, "observedAttributes", ["current"]);
let ne = F;
var m, me;
let bi = (me = class {
  /**
  ...
  */
  ...
  get href() {
    return s(this, m).getAttribute("href");
  }
  set href(t) {
    s(this, m).setAttribute("href", t);
  }
  get fallback() {
    return s(this, m).hasAttribute("fallback");
  }
  set fallback(t) {
    t ? s(this, m).setAttribute("fallback", "") : s(this, m).removeAttribute("fallback");
  }
}, m = new WeakMap(), me);
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.ui = new bi(this);
  }
};
r(vt, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", vt);
});
let le = vt;
const fi = l`
<style>
...
`, wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = fi, this.cleanup = new a();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(wt, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", wt);
});
let ae = wt;
const vi = l`
    <style>
...
let wi = (be = class {
  ...
  */
  ...
  get name() {
    return s(this, H).getAttribute("name");
  }
  set name(t) {
    s(this, H).setAttribute("name", t);
  }
}, H = new WeakMap(), be);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = vi, this.cleanup = new a(), this.ui = new wi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(yt, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", yt);
});
let $t = yt;
const yi = l`
    <style>
...
let ki = (fe = class {
  ...
  constructor(t) {
     ...
     */
    c(this, A, {});
    h(this, C, t), this.events = new f(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  clearStack() {
    for (; this.stackSize() > 0; )
      s(this, C).removeChild(this.stack.pop());
  }
  stackSize() {
    return this.stack.length;
  }
  goBack() {
    if (!this.stack.length || s(this, x))
      return;
    const t = s(this, C).removeChild(this.stack.pop());
    this.stack.length > 0 && (this.stack[this.stack.length - 1].parentElement || s(this, C).appendChild(this.stack[this.stack.length - 1])), this.dispatchChangeEvent(t);
  }
  /**
   * @param {string} name
  ...
  setPage(t, e = !1) {
    if (s(this, x))
      return;
    this.stack.push(
      s(this, C).appendChild(s(this, A)[t]())
    );
    let i = null;
...
}, C = new WeakMap(), x = new WeakMap(), A = new WeakMap(), fe);
const kt = class kt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = yi, this.cleanup = new a(), this.ui = new ki(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(kt, "register", () => {
  $t.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", kt);
});
let ce = kt;
var w, y, ve;
let Ci = (ve = class {
  ...
  constructor(t) {
    ...
    /** @type {any} */
    c(this, y, {});
    h(this, w, t), this.events = new f();
  }
  get localStoragePrefix() {
    return s(this, w).getAttribute("local-storage-prefix");
  }
  set localStoragePrefix(t) {
    s(this, w).setAttribute("local-storage-prefix", t);
  }
  get enableLocalStorage() {
    return s(this, w).hasAttribute("enable-local-storage");
  }
  set enableLocalStorage(t) {
    t ? s(this, w).setAttribute("enable-local-storage", "") : s(this, w).removeAttribute("enable-local-storage");
  }
  /**
   * @template {keyof T} K
   * @param {K} key
  ...
  set(t, e, i = !1) {
    if (i && this.enableLocalStorage) {
      ...
      s(this, y)[t] = e;
    this.enableLocalStorage && localStorage.setItem(this.localStoragePrefix + t.toString(), JSON.stringify(s(this, y)[t])), this.events.dispatch(t, s(this, y)[t]);
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
}, w = new WeakMap(), y = new WeakMap(), ve);
...
r(Ct, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", Ct);
});
let he = Ct;
var b;
class xi {
...
}), r(D, "observedAttributes", ["auto", "mode"]);
let ue = D;
export {
  Bt as SvgAdd,
  Vt as SvgBackArrow,
  Tt as SvgChevronDown,
  Ht as SvgClose,
  Yt as SvgDownload,
  Jt as SvgEdit,
  Wt as SvgMenu,
  ...
  te as UIDrawer,
  ie as UIDrawerGroup,
  Rt as UIDrawerGroupItem,
  Zt as UIFlexGrid,
  Nt as UIFlexGridItem,
  X as UIFlexGridRow,
  K as UIIconButton,
  se as UIInput,
  ee as UILabel,
