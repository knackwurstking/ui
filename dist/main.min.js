...
const Mt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: l,
  isAndroid: At
}, Symbol.toStringTag, { value: "Module" })), T = class T extends HTMLElement {
  constructor() {
...
s(T, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", T);
});
let K = T;
...
s(M, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", M);
});
let Z = M;
...
s(H, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", H);
});
let B = H;
const Et = l`
...
s($, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", $);
});
let S = $;
const x = class x extends HTMLElement {
  ...
  setTitle(t) {
    ...
    !t && e && this.removeChild(e), t && (e || (e = new S(), e.slot = "title", this.appendChild(e)), e.innerHTML = t);
  }
  /**
...
s(V, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", V);
});
let rt = V;
const Lt = l`
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
s(R, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", R);
}), s(R, "observedAttributes", ["current"]);
let nt = R;
const P = class P extends HTMLElement {
  constructor() {
    super(), this.ui = {
...
s(D, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", D);
});
let lt = D;
const F = class F extends HTMLElement {
  constructor() {
...
}), s(A, "observedAttributes", ["storageprefix"]);
let ht = A;
...
}), s(E, "observedAttributes", ["auto", "mode"]);
let ut = E;
const Y = class Y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {}, this.shadowRender();
...
let pt = Y;
function Ht() {
  Z.register(), K.register(), N.register(), X.register(), B.register(), Q.register(), _.register(), G.register(), W.register(), U.register(), I.register(), tt.register(), ot.register(), st.register(), L.register(), rt.register(), at.register(), nt.register(), lt.register(), dt.register(), ct.register(), ht.register(), pt.register(), et.register(), it.register(), S.register(), ut.register();
}
export {
  K as UIAppBar,
  Z as UIAppBarItem,
