...
}), r(w, "observedAttributes", ["no-ripple"]);
let W = w;
const V = class V extends HTMLElement {
  constructor() {
...
r(y, "register", () => {
  customElements.get("ui-dialog") || customElements.define("ui-dialog", y);
...
const g = class g extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setFlex(t) {
        this.shadowAttr.flex = t || g.defaultFlex, this.root.shadowRender({ ...this.shadowAttr });
      }
...
}), r(g, "observedAttributes", ["flex"]), r(g, "defaultFlex", "1");
let it = g;
const m = class m extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setGap(t) {
        this.shadowAttr.gap = t || m.defaultGap, this.root.shadowRender({ ...this.shadowAttr });
      }
    }, this.shadowRender({ ...this.ui.shadowAttr });
  }
  connectedCallback() {
...
}), r(m, "observedAttributes", ["gap"]), r(m, "defaultGap", "0");
let rt = m;
...
}), r(b, "observedAttributes", ["gap"]), r(b, "defaultGap", "0");
let ot = b;
...
r(x, "register", () => {
  M.register(), f.register(), customElements.get("ui-label") || customElements.define("ui-label", x);
    ...
    switch (t) {
      case "title":
        ...
        if (o === null && n && (this.removeChild(n), n = null), o === null)
          return;
        n || (n = new f(), n.slot = "title", this.appendChild(n)), n.innerHTML = o;
        break;
      case "type":
...
`, A = class A extends HTMLElement {
  ...
  attributeChangedCallback(t, i, o) {
    switch (t) {
      case "title":
        let n = this.querySelector('[slot="title"]');
        o === null && n && (this.removeChild(n), n = null), n || (n = new f(), n.slot = "title", this.appendChild(n)), n.innerHTML = o || "";
        break;
      case "value":
        this.ui.setValue(o);
        break;
...
let mt = Y;
function $t() {
  B.register(), X.register(), Q.register(), W.register(), _.register(), I.register(), et.register(), tt.register(), U.register(), it.register(), rt.register(), ot.register(), nt.register(), lt.register(), H.register(), at.register(), ht.register(), ut.register(), dt.register(), ct.register(), $.register(), pt.register(), mt.register(), st.register(), M.register(), f.register(), gt.register();
}
export {
  X as UIAppBar,
  B as UIAppBarItem,
