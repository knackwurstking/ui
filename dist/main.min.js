...
o(R, "register", () => {
  A.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", R);
});
let vt = R;
const se = n`
    <style>
...
o(X, "register", () => {
  lt.register(), M.register(), A.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", X);
});
let $t = X;
const zt = 150, Ce = n`
    <style>
...
o(x, "register", () => {
  p.register(), M.register(), ct.register(), customElements.get("ui-search") || customElements.define("ui-search", x);
