...
var o = (r, t, e) => Tt(r, typeof t != "symbol" ? t + "" : t, e), Ht = (r, t, e) => t.has(r) || wt("Cannot " + e);
var h = (r, t, e) => (Ht(r, t, "read from private field"), e ? e.call(r) : t.get(r)), kt = (r, t, e) => t.has(r) ? wt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(r) : t.set(r, e);
const xt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function qt(r, t, e = {}) {
  ...
  const i = () => {
    ...
    t.draggable = !0, t.ondragstart = (c) => {
      ...
      c.preventDefault(), [...r.children].forEach((p, St) => {
        if (St === u) {
      ...
      c.preventDefault(), c.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(u), [...r.children].forEach((p) => {
        p.style.background = "inherit", p.style.color = "inherit";
      });
    };
  }, s = () => {
...
const n = String.raw, K = String.raw;
class At {
  constructor() {
    this.callbacks = [];
  }
...
}), o(m, "observedAttributes", ["noripple"]);
let N = m;
...
}), o(f, "observedAttributes", ["noripple"]);
let G = f;
...
`, v = class v extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new At(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new l(),
      get title() {
...
}), o(k, "observedAttributes", ["gap", "justify", "align"]);
let ot = k;
...
}), o(C, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let st = C;
...
}), o(R, "observedAttributes", ["ripple", "secondary", "primary"]);
let nt = R;
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${$t}</ui-icon-button>
      </div>
...
}), o(S, "observedAttributes", ["current"]);
let ut = S;
const J = class J extends HTMLElement {
  constructor() {
    super(), this.ui = {
...
}), o(H, "observedAttributes", ["auto", "mode"]);
let vt = H;
