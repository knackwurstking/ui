...
var pe = (o, t, e) => t in o ? ge(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => (pe(o, typeof t != "symbol" ? t + "" : t, e), e), Kt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var i = (o, t, e) => (Kt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), a = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, c = (o, t, e, s) => (Kt(o, t, "write to private field"), s ? s.call(o, e) : t.set(o, e), e);
const Qt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
const l = String.raw, be = String.raw;
class h {
  constructor() {
    this.callbacks = [];
  }
...
const ai = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  createDraggable: me,
  css: be,
  defaultRippleOptions: he,
  html: l,
  isAndroid: fe,
  rippleCreate: kt
}, Symbol.toStringTag, { value: "Module" })), Ct = "1", ve = l`
<style></style>
<slot></slot>
`;
let we = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : Ct;
  }
  set flex(t) {
...
const q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ve, this.cleanup = new h(), this.ui = new we(this), this.updateStyle();
  }
  connectedCallback() {
  }
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ye, this.cleanup = new h(), this.ui = new xe(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const D = class D extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ke, this.cleanup = new h(), this.ui = new Ce(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const et = class et extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Le, this.cleanup = new h(), this.ui = new Ee(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let Te = (te = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = kt(i(this, g), { centered: !0 }), i(this, g).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Te(this);
  }
  connectedCallback() {
...
let Ae = (ee = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = kt(i(this, d), { centered: !0 }), i(this, d).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = He, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Ae(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
`, it = class it extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(ht, "register", () => {
  customElements.get("svg-menu") || (console.debug("register svg component: svg-menu"), customElements.define("svg-menu", ht));
});
let Ut = ht;
const Ve = l`
<style>
...
}, C = new WeakMap(), b = new WeakMap(), L = new WeakMap(), ie);
const dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ze, this.cleanup = new h(), this.ui = new Oe(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
r(dt, "register", () => {
  customElements.get("ui-icon-button") || G.register(), customElements.get("svg-close") || U.register(), customElements.get("ui-flex-grid-row") || J.register(), customElements.get("ui-dialog") || (console.debug("register web component: ui-dialog"), customElements.define("ui-dialog", dt));
});
let Dt = dt;
const Be = l`
<style>
...
`, gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Be, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(gt, "register", () => {
  customElements.get("ui-primary") || (console.debug("register web component: ui-primary"), customElements.define("ui-primary", gt));
});
let _ = gt;
const Fe = l`
<style>
...
`, pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Fe, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(pt, "register", () => {
  customElements.get("ui-secondary") || (console.debug("register web component: ui-secondary"), customElements.define("ui-secondary", pt));
});
let Y = pt;
const Je = l`
<style>
...
let Ye = (se = class {
  ...
  enableRipple() {
    i(this, R) || (this.removeRipple = kt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
   ...
   */
  startInputHandling() {
    i(this, S) || (i(this, u).addEventListener("click", i(this, W)), this.getInputSlot().forEach((t) => {
   ...
   */
  stopInputHandling() {
    i(this, u).removeEventListener("click", i(this, W)), [...i(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, X));
    }), c(this, S, !1);
  }
}, u = new WeakMap(), S = new WeakMap(), W = new WeakMap(), X = new WeakMap(), R = new WeakMap(), se);
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Je, this.cleanup = new h(), this.ui = new Ye(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ue.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new We(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Xe, this.setAttribute("role", "button"), this.ui = new Ke(this);
  }
};
r(mt, "register", () => {
  customElements.get("ui-select-option") || (console.debug("register web component: ui-select-option"), customElements.define("ui-select-option", mt));
});
let tt = mt;
const Qe = l`
<style>
...
const ft = class ft extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Qe, this.cleanup = new h(), this.ui = new Ge();
  }
  // }}}
  connectedCallback() {
...
K = new WeakMap(), // }}}
r(ft, "register", () => {
  customElements.get("svg-chevron-down") || I.register(), customElements.get("ui-select") || (console.debug("register web component: ui-select"), customElements.define("ui-select", ft));
});
let Zt = ft;
var E, $, Q, re;
let Ie = (re = class {
...
}, E = new WeakMap(), $ = new WeakMap(), Q = new WeakMap(), re);
const B = class B extends HTMLElement {
  constructor() {
    super(), this.ui = new Ie(this);
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue
...
`, vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = _e, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(vt, "register", () => {
  customElements.get("ui-spinner") || (console.debug("register web component: ui-spinner"), customElements.define("ui-spinner", vt));
});
let Ft = vt;
const ti = l`
    <style>
...
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ti, this.cleanup = new h(), this.ui = new ei(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(wt, "register", () => {
  customElements.get("ui-stack-layout-page") || (console.debug("register web component: ui-stack-layout-page"), customElements.define("ui-stack-layout-page", wt));
});
let Jt = wt;
const ii = l`
    <style>
...
}, T = new WeakMap(), H = new WeakMap(), j = new WeakMap(), le);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ii, this.cleanup = new h(), this.ui = new si(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(yt, "register", () => {
  customElements.get("ui-stack-layout") || (console.debug("register web component: ui-stack-layout"), customElements.define("ui-stack-layout", yt));
});
let Yt = yt;
var x, k, ce;
let oi = (ce = class {
...
}, x = new WeakMap(), k = new WeakMap(), ce);
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.ui = new oi(this);
  }
};
r(xt, "register", () => {
  customElements.get("ui-store") || (console.debug("register web component: ui-store"), customElements.define("ui-store", xt));
});
let Wt = xt;
var w;
class ri {
...
r(F, "register", () => {
  customElements.get("ui-theme-handler") || (console.debug("register web component: ui-theme-handler"), customElements.define("ui-theme-handler", F));
}), r(F, "observedAttributes", ["auto", "mode"]);
let Xt = F;
function Li() {
  Ht.register(), G.register(), At.register(), St.register(), Lt.register(), J.register(), Tt.register(), Vt.register(), tt.register(), Zt.register(), Bt.register(), Ot.register(), Ft.register(), Jt.register(), Yt.register(), Wt.register(), Y.register(), _.register(), Pt.register(), Xt.register(), Dt.register();
}
function Ei() {
  Rt.register(), I.register(), U.register(), $t.register(), zt.register(), jt.register(), qt.register(), Nt.register();
}
export {
  Rt as SvgBackArrowNavigation,
  I as SvgChevronDown,
  U as SvgClose,
  $t as SvgDeleteRecycleBin,
  zt as SvgEdit2,
  Ut as SvgMenu,
  jt as SvgPDFDocument,
  qt as SvgSettings,
  Nt as SvgTodayOutline,
  Ht as UIAppBar,
  At as UIButton,
  St as UIContainer,
  Dt as UIDialog,
  Tt as UIFlexGrid,
  Lt as UIFlexGridItem,
  J as UIFlexGridRow,
  G as UIIconButton,
  Vt as UIInput,
  Pt as UILabel,
  ...
  ai as js,
  Ei as registerSVGComponents,
  Li as registerWebComponents
};
