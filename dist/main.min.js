...
var r = (o, t, e) => (Re(o, typeof t != "symbol" ? t + "" : t, e), e), zt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var s = (o, t, e) => (zt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), l = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, h = (o, t, e, i) => (zt(o, t, "write to private field"), i ? i.call(o, e) : t.set(o, e), e);
const jt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class v {
  ...
  off(t, e) {
    ...
    for (const d of s(this, g)[t])
      d === e && (s(this, g)[t].splice(a, 1), i = !0), a++;
    if (!i)
...
function Nt(o, t) {
  ...
  const a = Math.max(i.width, i.height) * 0.02;
...
function Et(o, t = {}) {
  ...
  return o.classList.add("ripple-container"), o.style.overflow = "hidden", t.useClick === !0 ? o.addEventListener("click", (d) => {
    e = Nt(d, t), Zt(e);
  }) : (o.addEventListener("pointerdown", i), o.addEventListener("pointerup", a), o.addEventListener("pointerleave", a)), () => {
    o.classList.remove("ripple-container"), o.removeEventListener("pointerdown", i), o.removeEventListener("pointerup", a), o.removeEventListener("pointerleave", a);
  };
}
function Se() {
...
const Si = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: Se
}, Symbol.toStringTag, { value: "Module" })), Mt = "1", ze = n`
<style></style>
<slot></slot>
`;
let je = class {
...
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ze, this.cleanup = new c(), this.ui = new je(this), this.updateStyle();
  }
  connectedCallback() {
  }
...
r(_, "register", () => {
  G.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", _);
});
let Bt = _;
const Fe = n`
<style>
...
let Ve = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Et(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
  }
  disableRipple() {
...
r(tt, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", tt);
});
let Ft = tt;
const Ke = n`
<style>
...
r(et, "register", () => {
  customElements.get("svg-add") || customElements.define("svg-add", et);
});
let Vt = et;
const Qe = n`
<style>
...
r(it, "register", () => {
  customElements.get("svg-back-arrow") || customElements.define("svg-back-arrow", it);
});
let Yt = it;
const We = n`
<style>
...
r(st, "register", () => {
  customElements.get("svg-chevron-down") || customElements.define("svg-chevron-down", st);
});
let Rt = st;
const Ge = n`
<style>
...
r(ot, "register", () => {
  customElements.get("svg-close") || customElements.define("svg-close", ot);
});
let $t = ot;
const Ie = n`
<style>
...
r(rt, "register", () => {
  customElements.get("svg-download") || customElements.define("svg-download", rt);
});
let Jt = rt;
const Ue = n`
<style>
...
r(nt, "register", () => {
  customElements.get("svg-edit") || customElements.define("svg-edit", nt);
});
let Xt = nt;
const _e = n`
<style>
...
r(lt, "register", () => {
  customElements.get("svg-recycle") || customElements.define("svg-recycle", lt);
});
let Qt = lt;
const ei = n`
<style>
...
r(ct, "register", () => {
  customElements.get("svg-search") || customElements.define("svg-search", ct);
});
let Wt = ct;
const ii = n`
<style>
...
const gt = class gt extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), a = (d) => {
      d.preventDefault();
    };
    i.addEventListener("cancel", a), this.cleanup.add(() => {
      t.removeEventListener("click", e), i.removeEventListener("cancel", a);
    });
  }
  disconnectedCallback() {
    this.cleanup.run();
...
r(gt, "register", () => {
  At.register(), $t.register(), G.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", gt);
});
let te = gt;
...
let di = (fe = class {
  ...
  enableRipple() {
    s(this, R) || (this.removeRipple = Et(s(this, u)), s(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
...
r(B, "register", () => {
  I.register(), H.register(), customElements.get("ui-label") || customElements.define("ui-label", B);
...
r(bt, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", bt);
});
let St = bt;
...
r(D, "register", () => {
  St.register(), I.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", D);
...
Q = new WeakMap(), // }}}
r(wt, "register", () => {
  Rt.register(), U.register(), customElements.get("ui-select") || customElements.define("ui-select", wt);
});
let ne = wt;
const yi = n`
    <style>
...
let ki = class {
   ...
   */
  constructor(t) {
    this.root = t, this.events = new v(), this.input = this.root.shadowRoot.querySelector("input"), this.input.type = this.root.getAttribute("type") || "text";
  }
  /**
   * @param {string | null} v
   */
...
r(V, "register", () => {
  H.register(), customElements.get("ui-search") || customElements.define("ui-search", V);
...
let Ci = (ve = class {
  ...
  get(t, e) {
    var i, a;
    return ((a = (i = s(this, W)) == null ? void 0 : i[t]) == null ? void 0 : a[e]) || null;
  }
  /**
   * @param {"change"} key
...
let Hi = (ke = class {
  ...
  setPage(t) {
    if (!s(this, T)) {
      if (this.stack.push(
        s(this, E).appendChild(s(this, q)[t]())
      ), this.stack.length > 1) {
...
}, E = new WeakMap(), T = new WeakMap(), q = new WeakMap(), ke);
