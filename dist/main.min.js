...
var Tt = (r, t, e) => t in r ? Mt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var s = (r, t, e) => Tt(r, typeof t != "symbol" ? t + "" : t, e), Ht = (r, t, e) => t.has(r) || wt("Cannot " + e);
var u = (r, t, e) => (Ht(r, t, "read from private field"), e ? e.call(r) : t.get(r)), kt = (r, t, e) => t.has(r) ? wt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(r) : t.set(r, e);
class Et {
  constructor() {
    this.callbacks = [];
  }
...
function qt(r, t, e = {}) {
  ...
  const i = () => {
    ...
    t.draggable = !0, t.ondragstart = (l) => {
      l.dataTransfer.effectAllowed = "move", l.dataTransfer.dropEffect = "move", e.onDragStart && e.onDragStart(h);
    }, t.ondragover = (l) => (l.preventDefault(), !1), t.ondragenter = (l) => {
      l.preventDefault(), [...r.children].forEach((p, St) => {
        if (St === h) {
          p.style.background = "var(--ui-primary-bgColor)", p.style.color = "var(--ui-primary-color)";
          return;
        }
        p.style.background = "inherit", p.style.color = "inherit";
      }), e.onDragging && e.onDragging(h);
    }, t.ondrop = (l) => {
      l.preventDefault(), l.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(h), [...r.children].forEach((p) => {
        p.style.background = "inherit", p.style.color = "inherit";
      });
    };
  }, o = () => {
...
function zt(r) {
  let t = null, e = null;
  const i = (o) => {
    if (!e && !t && Array.from(o.target.classList).includes("draggable")) {
      const a = !!o.targetTouches && o.targetTouches[0] || o;
      e = o.target.cloneNode(!0), t = o.target, r.appendChild(e), e.className = "dragging";
      const h = a.pageX - e.offsetWidth / 2 + "px", l = a.pageY - e.offsetHeight / 2 + "px";
      e.style.willChange = "transform", e.style.transform = `translate(${h}, ${l})`;
    }
  };
  Array.from(r.children).forEach((o) => {
    o.classList.add("draggable"), o.onmousedown = i, o.ontouchstart = i;
  });
}
var d;
class c {
  ...
  on(t, e) {
    ...
    return u(this, d)[t] || (u(this, d)[t] = []), u(this, d)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
  ...
  off(t, e) {
    ...
    let i = !1, o = 0;
    for (const a of u(this, d)[t])
      a === e && (u(this, d)[t].splice(o, 1), i = !0), o++;
    if (!i)
...
const n = String.raw, W = String.raw, Vt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: Et,
  Events: c,
  createDraggable: qt,
  createNoDragDraggable: zt,
  createRipple: g,
  css: W,
  defaultRippleOptions: At,
  html: n,
  isAndroid: jt
}, Symbol.toStringTag, { value: "Module" })), z = class z extends HTMLElement {
  constructor() {
...
s(z, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", z);
});
let B = z;
...
s(j, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", j);
});
let K = j;
const m = class m extends HTMLElement {
    ...
    super(), this.attachShadow({ mode: "open" }), this.removeRippleCallback = null, this.ui = {
      ...
      set noripple(t) {
        if (!t) {
          ...
          this.root.removeRippleCallback = g(this.root);
        }
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <slot></slot>
    `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = g(this)), this.addEventListener("click", () => {
...
s(m, "register", () => {
  customElements.get("ui-button") || customElements.define("ui-button", m);
}), s(m, "observedAttributes", ["noripple"]);
let Q = m;
const f = class f extends HTMLElement {
  ...
  shadowRender() {
    ...
    `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = g(this, { centered: !0 })), this.addEventListener("click", () => {
      this.ui.events.dispatch("click", this);
    });
  }
  connectedCallback() {
...
s(f, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", f);
}), s(f, "observedAttributes", ["noripple"]);
let G = f;
...
`, v = class v extends HTMLElement {
  ...
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Et(), this._title = t || "", this.ui = {
       ...
       */
      open(e = !1, i = !0) {
        const o = this.root.shadowRoot.querySelector("dialog"), a = o.inert;
        o.inert = i, e ? o.showModal() : o.show(), this.events.dispatch("open", null), o.inert = a;
      },
      close() {
  ...
  shadowRender() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), o = (a) => a.preventDefault();
...
s(D, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", D);
});
let I = D;
const Lt = n`
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
s(y, "register", () => {
  customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", y);
}), s(y, "observedAttributes", ["title"]);
let tt = y;
const F = class F extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {}, this.shadowRender();
...
s(F, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", F);
});
let et = F;
...
s(w, "register", () => {
  customElements.get("ui-flex-grid-item") || customElements.define("ui-flex-grid-item", w);
}), s(w, "observedAttributes", ["flex"]);
let it = w;
...
}), s(k, "observedAttributes", ["gap", "justify", "align"]);
let ot = k;
...
s(x, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", x);
}), s(x, "observedAttributes", ["gap"]);
let rt = x;
...
s(C, "register", () => {
  customElements.get("ui-check") || customElements.define("ui-check", C);
}), s(C, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let st = C;
const R = class R extends HTMLElement {
  ...
  enableRipple() {
    if (this.removeRipple || (this.removeRipple = g(this), this.style.cursor = "pointer", this.running)) return;
...
s(O, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", O);
});
let b = O;
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set title(t) {
        ...
        !t && e && this.root.removeChild(e), t && (e || (e = new b(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t);
      },
      get type() {
...
s(E, "register", () => {
  customElements.get("ui-input") || customElements.define("ui-input", E);
...
const Y = class Y extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = n`
      ...
      <div class="options">
        <div class="icon"><ui-svg>${Lt}</ui-svg></div>
    ...
    const t = (i) => {
      const o = async (a) => {
        (a.composedPath() || []).forEach((h) => {
          h instanceof q && ([...this.querySelectorAll("ui-select-option")].forEach(
...
s(Y, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", Y);
});
let dt = Y;
...
s(L, "register", () => {
  customElements.get("ui-textarea") || customElements.define("ui-textarea", L);
}), s(L, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
s(S, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", S);
}), s(S, "observedAttributes", ["current"]);
let ut = S;
const J = class J extends HTMLElement {
  constructor() {
    super(), this.ui = {
...
s(J, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", J);
});
let pt = J;
const M = class M extends HTMLElement {
  constructor() {
...
s(M, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", M);
}), s(M, "observedAttributes", ["nobg"]);
let gt = M;
...
s(T, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", T);
}), s(T, "observedAttributes", ["name"]);
let bt = T;
...
s(N, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", N);
});
let mt = N;
const X = class X extends HTMLElement {
  constructor() {
...
s(X, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", X);
});
let ft = X;
...
s(H, "register", () => {
  customElements.get("ui-theme-handler") || customElements.define("ui-theme-handler", H);
}), s(H, "observedAttributes", ["auto", "mode"]);
let vt = H;
...
let yt = Z;
function Ot() {
  K.register(), B.register(), Q.register(), G.register(), _.register(), U.register(), et.register(), tt.register(), I.register(), it.register(), ot.register(), rt.register(), st.register(), lt.register(), ct.register(), q.register(), dt.register(), ht.register(), pt.register(), ut.register(), gt.register(), mt.register(), bt.register(), ft.register(), yt.register(), nt.register(), at.register(), b.register(), vt.register();
}
export {
  B as UIAppBar,
  K as UIAppBarItem,
