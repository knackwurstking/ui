...
var At = (o, e, t) => e in o ? Et(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var i = (o, e, t) => (At(o, typeof e != "symbol" ? e + "" : e, t), t), St = (o, e, t) => {
  if (!e.has(o))
    throw TypeError("Cannot " + t);
};
var p = (o, e, t) => (St(o, e, "read from private field"), t ? t.call(o) : e.get(o)), yt = (o, e, t) => {
  if (e.has(o))
...
const zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  render({ flex: t = H } = {}) {
    this.shadowRoot.innerHTML = `
            <style>${this.css().trim({ flex: t })}</style>
            ${this.template().trim()}
        `;
  }
};
...
const K = class K extends HTMLElement {
  constructor() {
    ...
    i(this, "template", () => l`
        <div class="options">
            <div class="icon"><ui-svg>${Ht}</ui-svg></div>
  ...
  constructor() {
    ...
    i(this, "template", () => l`
        <div class="container">
            <slot name="title"></slot>
            <input type="search" />
            <ui-icon-button ghost>${Mt}</ui-icon-button>
        </div>
    `);
    this.attachShadow({ mode: "open" }), this.render(), this.ui = {
      /** @private */
