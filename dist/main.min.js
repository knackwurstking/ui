...
var c = (o, t, e) => (Ct(o, t, "read from private field"), e ? e.call(o) : t.get(o)), bt = (o, t, e) => t.has(o) ? mt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
const ft = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class u {
  ...
  on(t, e) {
    ...
    return c(this, d)[t] || (c(this, d)[t] = []), c(this, d)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const l of c(this, d)[t])
      l === e && (c(this, d)[t].splice(s, 1), i = !0), s++;
    if (!i)
