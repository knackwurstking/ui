...
var Vt = (o, t, e) =>
    t in o
        ? Yt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (o[t] = e);
var s = (o, t, e) => Vt(o, typeof t != "symbol" ? t + "" : t, e),
    Xt = (o, t, e) => t.has(o) || qt("Cannot " + e);
var m = (o, t, e) => (
        Xt(o, t, "read from private field"), e ? e.call(o) : t.get(o)
    ),
    zt = (o, t, e) =>
        t.has(o)
...
function Bt(
    o,
    t,
    { onDragStart: e = null, onDragging: i = null, onDragEnd: r = null } = {},
) {
    const l = () => {
            ...
            (t.draggable = !0),
                ...
                (t.ondragover = (h) => (h.preventDefault(), !1)),
                (t.ondragenter = (h) => {
                    h.preventDefault(),
                        [...o.children].forEach((f, V) => {
                            if (V === u) {
                                (f.style.background = "var(--ui-primary)"),
                                    (f.style.color = "var(--ui-primary-fg)");
                                return;
                            }
    ...
    return (
        l(),
        {
             ...
             */
            update(c) {
                Object.hasOwn(c, "onDragStart") && (e = c.onDragStart),
                    Object.hasOwn(c, "onDragging") && (i = c.onDragStart),
                    Object.hasOwn(c, "onDragEnd") && (r = c.onDragEnd);
            },
            destroy: d,
        }
    );
...
function Jt(o, { onDragEnd: t = null, onDragStart: e = null } = {}) {
    ...
    const V = (n) => {
            !i &&
                Array.from(n.currentTarget.classList).includes("draggable") &&
                ((l = n.clientX),
                (d = n.clientY),
                ...
                (c = setTimeout(() => {
                    (h = i.style.color),
                        ...
                        (i.style.color = "var(--ui-primary-fg)"),
                        (i.style.backgroundColor = "var(--ui-primary-bg)"),
        ...
        Tt = (n) => {
            ...
            if (!u && /* @__PURE__ */ new Date().getTime() - r < 200) {
                const Mt = Math.abs(l - n.clientX),
                    Ht = Math.abs(d - n.clientY);
                if ((Mt > Ht ? Mt : Ht) < 24) return;
                I();
                return;
            }
    ...
    function Ot(n, v) {
        Ft(n, v)
            ? o.insertBefore(n, v)
            : o.insertBefore(n, v.nextElementSibling);
    }
    function Ft(n, v) {
    ...
    return (
        ...
        })(),
        {
            ...
            update: (n) => {
                Object.hasOwn(n, "onDragStart") && (e = n.onDragStart),
                    Object.hasOwn(n, "onDragEnd") && (t = n.onDragEnd);
            },
            destroy: () => {
                Array.from(o.children).forEach((n) => {
...
class b {
    ...
    off(t, e) {
        ...
        let i = !1,
            r = 0;
        for (const l of m(this, g)[t])
            l === e && (m(this, g)[t].splice(r, 1), (i = !0)), r++;
        if (!i)
    ...
    dispatch(t, e) {
        ...
        if (m(this, g)[t]) for (const i of m(this, g)[t]) i(e);
        return this;
    }
}
g = new WeakMap();
...
function y(o, t = {}) {
    ...
    const i = (u) => {
        ...
        d = () => {
            o.classList.add("ripple-container"),
                (o.style.overflow = "hidden"),
                t.useClick === !0
                    ? o.addEventListener("click", l)
                    : (o.addEventListener("pointerdown", i),
                      o.addEventListener("pointerup", r),
                      o.addEventListener("pointerleave", r));
        },
        c = () => {
            o.classList.remove("ripple-container"),
                t.useClick === !0
                    ? o.removeEventListener("click", l)
                    : (o.removeEventListener("pointerdown", i),
                      o.removeEventListener("pointerup", r),
                      o.removeEventListener("pointerleave", r));
        };
    return (
        d(),
        {
...
function tt(o, t) {
    ...
    e.classList.add("ripple"),
        ...
        (e.style.transform = "scale(0) translate(0, 0)"),
        (e.style.transition = `transform ${t.spreadDuration} ${t.spreadTiming} 0s,opacity ${t.clearDuration} ${t.clearTiming} 0s`),
        o.currentTarget.appendChild(e);
    const i = o.currentTarget.getBoundingClientRect();
    if (t.centered)
        (e.style.top = `${i.height / 2}px`),
            (e.style.left = `${i.width / 2}px`);
    else {
        const l = (!!o.targetTouches && o.targetTouches[0]) || o;
        (e.style.top = `${l.clientY - i.top}px`),
            (e.style.left = `${l.clientX - i.left}px`);
    }
...
function Ut(o) {
    return (
        Object.entries(o)
            .map(
                ([t, e]) =>
                    `${t.replace(/[A-Z]/g, (i) => `-${i.toLowerCase()}`)}:${e}`,
            )
            .join(";") + ";"
    );
}
...
s(B, "register", () => {
    customElements.get("ui-app-bar-item") ||
        customElements.define("ui-app-bar-item", B);
});
let ot = B;
const k = class k extends HTMLElement {
    constructor() {
        super(),
            ...
            (this.ui = {
                ...
                set noripple(t) {
                    if (!t) {
                        this.root.ripple && this.root.ripple.destroy(),
                            (this.root.ripple = y(this.root));
                        return;
                    }
                    this.root.ripple &&
                        (this.root.ripple.destroy(), (this.root.ripple = null));
                },
                get color() {
    ...
    shadowRender() {
        (this.shadowRoot.innerHTML = a`
            ...
            <slot></slot>
        `),
            typeof this.ripple != "function" && (this.ripple = y(this)),
...
const x = class x extends HTMLElement {
    ...
    shadowRender() {
        ...
        `),
            typeof this.ripple != "function" &&
                (this.ripple = y(this, { centered: !0 })),
            this.addEventListener("click", () => {
                this.ui.events.dispatch("click", this);
            });
    }
...
s(x, "register", () => {
    customElements.get("ui-icon-button") ||
        customElements.define("ui-icon-button", x);
}),
...
s(J, "register", () => {
    customElements.get("ui-container") ||
        customElements.define("ui-container", J);
});
let nt = J;
const Zt = a`
...
s(C, "register", () => {
    customElements.get("ui-flex-grid-item") ||
        customElements.define("ui-flex-grid-item", C);
}),
...
s(E, "register", () => {
    customElements.get("ui-flex-grid-row") ||
        customElements.define("ui-flex-grid-row", E);
}),
...
s(R, "register", () => {
    customElements.get("ui-flex-grid") ||
        customElements.define("ui-flex-grid", R);
}),
...
const A = class A extends HTMLElement {
    ...
    constructor(t) {
        super(),
            this.attachShadow({ mode: "open" }),
            (this.shadowRenderCleanUp = new Pt()),
            (this._title = t || ""),
            (this.ui = {
                root: this,
                /** @type {Events<T>} */
                 ...
                 */
                open(e = !1, i = !0) {
                    const r = this.root.shadowRoot.querySelector("dialog"),
                        l = r.inert;
                    (r.inert = i),
                        e ? r.showModal() : r.show(),
                        this.events.dispatch("open", null),
                        (r.inert = l);
                },
                close() {
                    this.events.dispatch("close", null),
                        this.root.shadowRoot.querySelector("dialog").close();
                },
            }),
            this.shadowRender();
    }
        ...
        i.addEventListener("cancel", r),
            this.shadowRenderCleanUp.add(() => {
                t.removeEventListener("click", e),
                    i.removeEventListener("cancel", r);
            });
    }
    connectedCallback() {}
    disconnectedCallback() {}
    ...
    static createAction({
        ...
        return (
            r &&
                ((d = l.querySelector("ui-button")),
                d.ui.events.on("click", r)),
            {
                container: l,
                action: d,
            }
...
const Z = class Z extends HTMLElement {
    ...
    shadowRender() {
        ...
        `),
            ...
            this.addEventListener("click", () => (this.ui.open = !1));
    }
    connectedCallback() {
        this.setAttribute("role", "button");
    }
...
s(Z, "register", () => {
    customElements.get("ui-drawer") || customElements.define("ui-drawer", Z);
});
let ut = Z;
const $t = a`
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        constructor() {
            super(),
                ...
                (this.ui = {
                    root: this,
                    get title() {
                        return this.root.shadowRoot.querySelector(".title")
                            .innerHTML;
                    },
                    set title(t) {
...
s(L, "register", () => {
    customElements.get("ui-drawer-group") ||
        customElements.define("ui-drawer-group", L);
}),
...
s(D, "register", () => {
    customElements.get("ui-drawer-group-item") ||
        customElements.define("ui-drawer-group-item", D);
});
let ht = D;
...
const T = class T extends HTMLElement {
    constructor() {
        super(),
            ...
            (this.running = !1),
            (this.onClick = async () => {
                this.ui.inputSlot.forEach((t) => t.click());
            }),
    ...
    enableRipple() {
        ...
        this.addEventListener("click", this.onClick),
            [...this.querySelectorAll('[slot="input"]')].forEach((e) => {
...
s(N, "register", () => {
    customElements.get("ui-primary") || customElements.define("ui-primary", N);
});
let bt = N;
const K = class K extends HTMLElement {
    constructor() {
...
s(K, "register", () => {
    customElements.get("ui-secondary") ||
        customElements.define("ui-secondary", K);
});
let w = K;
...
`,
    H = class H extends HTMLElement {
        constructor() {
            super(),
                ...
                (this.ui = {
                    ...
                    get title() {
                        return this.root.querySelector('[slot="title"]')
                            .innerHTML;
                    },
                    set title(t) {
                        let e = this.root.querySelector('[slot="title"]');
                    ...
                    set storagekey(t) {
                        (this.root.storagekey = t),
                            this.storage &&
                                ((this.value =
                                    localStorage.getItem(
                                        this.storageprefix +
                                            this.root.storagekey,
                                    ) || ""),
        ...
        `),
                (this.ui.submit =
                    this.shadowRoot.querySelector('[name="submit"]')),
                (this.ui.input = this.shadowRoot.querySelector("input")),
...
s(Q, "register", () => {
    customElements.get("ui-select-option") ||
        customElements.define("ui-select-option", Q);
});
let Y = Q;
const q = class q extends HTMLElement {
    constructor() {
        super(),
            ...
            (this.ui = {
                ...
                selected() {
                    try {
                        return (
                            this.options().find((t) => t.ui.selected) || null
                        );
                    } catch {
                        return null;
                    }
            ...
            const r = async (l) => {
                (l.composedPath() || []).forEach((d) => {
                    d instanceof Y &&
                        ...
                        this.ui.events.dispatch("change", d));
                });
            };
            (this.ui.open = !this.ui.open),
                this.ui.open
                    ? (i.stopPropagation(), this.addEventListener("click", r))
                    : setTimeout(() => this.removeEventListener("click", r));
        };
...
s(z, "register", () => {
    customElements.get("ui-textarea") ||
        customElements.define("ui-textarea", z);
}),
...
const j = class j extends HTMLElement {
        ...
        super(),
            (this.ui = {
                ...
                get(t, e) {
                    var i, r;
                    return (
                        ((r = (i = this.data) == null ? void 0 : i[t]) == null
                            ? void 0
                            : r[e]) || null
                    );
                },
    ...
    async setCurrent(t) {
        const e =
            this.querySelector(`ui-lang-type[name="${t}"]`) ||
            this.ui.fallback();
        if (e) {
...
s(W, "register", () => {
    customElements.get("ui-lang-type") ||
        customElements.define("ui-lang-type", W);
});
let kt = W;
...
s(O, "register", () => {
    customElements.get("ui-stack-layout-page") ||
        customElements.define("ui-stack-layout-page", O);
}),
...
const G = class G extends HTMLElement {
        ...
        super(),
            ...
            (this.ui = {
                ...
                set(t, e = null, i = !1) {
                    ...
                    this.root.stack.push(this.root.appendChild(r)),
                        typeof e == "function" && e(r);
                    let l = null;
                    this.size() > 1 &&
                        !i &&
                        ((l = this.root.stack[this.root.stack.length - 2]),
                        l.parentElement.removeChild(l)),
                        this.root.dispatchChangeEvent(l),
                        this.root.onpopstate !== null &&
                            history.pushState(
                                null,
                                document.title,
                                location.href,
    ...
    goBack() {
        ...
        this.stack.length > 0 &&
            (this.stack[this.stack.length - 1].parentElement ||
...
s(G, "register", () => {
    customElements.get("ui-stack-layout") ||
        customElements.define("ui-stack-layout", G);
});
let Et = G;
...
s(F, "register", () => {
    customElements.get("ui-theme-handler") ||
        customElements.define("ui-theme-handler", F);
}),
