...
o(T, "register", () => {
  A.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", T);
});
let vt = T;
const re = n`
    <style>
...
o(F, "register", () => {
  customElements.get("svg-document-new") || customElements.define("svg-document-new", F);
});
let Et = F;
const me = n`
    <style>
...
o(J, "register", () => {
  lt.register(), S.register(), A.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", J);
});
let Vt = J;
const Zt = 150, Ce = n`
    <style>
...
o(y, "register", () => {
  R.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", y);
...
o(k, "register", () => {
  ht.register(), R.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", k);
...
o(L, "register", () => {
  p.register(), S.register(), ct.register(), customElements.get("ui-search") || customElements.define("ui-search", L);
...
`, M = class M extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = $e, this.cleanup = new a(), this.ui = {
      ...
      lock: !1,
      enableHistory() {
        this.onpopstate === null && (this.onpopstate = () => {
          history.pushState(null, document.title, location.href), this.goBack();
        }, history.pushState(null, document.title, location.href), window.addEventListener("popstate", this.onpopstate));
      },
      disableHistory() {
...
o(M, "register", () => {
  ut.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", M);
