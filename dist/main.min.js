...
var o = (r, t, e) => (me(r, typeof t != "symbol" ? t + "" : t, e), e), Gt = (r, t, e) => {
  if (!t.has(r))
    throw TypeError("Cannot " + e);
};
var i = (r, t, e) => (Gt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), n = (r, t, e) => {
  if (t.has(r))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(r) : t.set(r, e);
}, c = (r, t, e, s) => (Gt(r, t, "write to private field"), s ? s.call(r, e) : t.set(r, e), e);
const _t = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function fe(r, t = {}) {
  ...
  const e = () => {
    const w = [...r.parentNode.children].indexOf(r);
    r.draggable = !0, r.ondragstart = (g) => {
      ...
      g.preventDefault(), t.onDragging && t.onDragging(w);
    }, r.ondrop = (g) => {
...
class S {
  ...
  on(t, e) {
    ...
    return i(this, m)[t] || (i(this, m)[t] = []), i(this, m)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let s = !1, l = 0;
    for (const w of i(this, m)[t])
      w === e && (i(this, m)[t].splice(l, 1), s = !0), l++;
    if (!s)
...
function Nt(r, t = {}) {
  ...
  return r.classList.add("ripple-container"), r.style.overflow = "hidden", t.useClick === !0 ? r.addEventListener("click", (w) => {
    e = Ot(w, t), Pt(e);
...
const Ce = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ripple: we,
  utils: ke
}, Symbol.toStringTag, { value: "Module" })), Le = a`
<style>
    :host {
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Le, this.cleanup = new h(), this.ui = new Me(this);
  }
  connectedCallback() {
  }
...
let Ee = (ee = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Nt(i(this, p), { centered: !0 }), i(this, p).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Te, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Ee(this);
  }
  connectedCallback() {
...
o(z, "register", () => customElements.define("ui-button", z)), o(z, "observedAttributes", ["no-ripple"]);
let tt = z;
const He = a`
<style>
    :host {
...
let Ae = (ie = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Nt(i(this, d), { centered: !0 }), i(this, d).removeAttribute("no-ripple"));
  }
  disableRipple() {
...
o(q, "register", () => customElements.define("ui-icon-button", q)), o(q, "observedAttributes", ["no-ripple"]);
let et = q;
const Se = a`
<style>
    :host {
...
o(wt, "register", () => customElements.define("ui-container", wt));
let it = wt;
const Re = a`
<style>
    :host dialog * {
...
let $e = (se = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    n(this, M, void 0);
    c(this, L, t), c(this, f, e), this.events = new S(), c(this, M, document.createElement("h4")), i(this, M).slot = "title", i(this, L).appendChild(i(this, M));
  }
  get fullscreen() {
...
}, L = new WeakMap(), f = new WeakMap(), M = new WeakMap(), se);
var X, F;
const yt = class yt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Re, this.cleanup = new h(), this.ui = new $e(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    const e = this.shadowRoot.querySelector(".header ui-icon-button");
    e.addEventListener("click", i(this, F)), e.addEventListener("click", i(this, X)), this.cleanup.add(() => {
      e.removeEventListener("click", i(this, F)), e.removeEventListener("click", i(this, X));
    });
  }
  disconnectedCallback() {
    this.cleanup.run();
...
X = new WeakMap(), F = new WeakMap(), o(yt, "register", () => customElements.define("ui-dialog", yt));
let st = yt;
const Dt = "1", Ie = a`
<style></style>
<slot></slot>
...
let je = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : Dt;
  }
  set flex(t) {
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ie, this.cleanup = new h(), this.ui = new je(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(N, "register", () => customElements.define("ui-flex-grid-item", N)), o(N, "observedAttributes", ["flex"]);
let rt = N;
const Vt = "0", Ue = a`
<style></style>
<slot></slot>
...
let ze = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || Vt;
  }
  set gap(t) {
...
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ue, this.cleanup = new h(), this.ui = new ze(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(O, "register", () => customElements.define("ui-flex-grid-row", O)), o(O, "observedAttributes", ["gap"]);
let ot = O;
const Zt = "0", qe = a`
<style></style>
<slot></slot>
...
let Ne = class {
  ...
  get gap() {
    return this.root.getAttribute("gap") || Zt;
  }
  set gap(t) {
    t === null ? this.root.removeAttribute("gap") : this.root.setAttribute("gap", t);
  }
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = qe, this.cleanup = new h(), this.ui = new Ne(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(P, "register", () => customElements.define("ui-flex-grid", P)), o(P, "observedAttributes", ["gap"]);
let nt = P;
...
let Oe = class {
   ...
   */
  constructor(t) {
    this.root = t, this.events = new S(), this.input = this.root.shadowRoot.querySelector("input"), this.input.type = this.root.getAttribute("type") || "text", this.input.oninput = () => this.events.dispatch("input", this.value), this.input.onchange = () => this.events.dispatch("change", this.value);
  }
  /**
   * @param {string | null} v
   */
...
const D = class D extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(de.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new Oe(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(D, "register", () => customElements.define("ui-input", D)), o(D, "observedAttributes", [
  "title",
  "type",
  "value",
  "placeholder",
...
let De = (re = class {
  ...
  get value() {
    return i(this, x).getAttribute("value");
  }
  set value(t) {
    i(this, x).setAttribute("value", t);
  }
  get selected() {
    return i(this, x).hasAttribute("selected");
  }
  set selected(t) {
    t ? i(this, x).setAttribute("selected", "") : i(this, x).removeAttribute("selected");
  }
}, x = new WeakMap(), re);
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.setAttribute("role", "button"), this.ui = new De(this);
  }
};
o(xt, "register", () => customElements.define("ui-select-option", xt));
let J = xt;
const Ve = a`
<style>
    * {
  ...
  constructor() {
    ...
    n(this, K, async (e) => {
      (e.composedPath() || []).forEach((s) => {
        s instanceof J && ([...this.querySelectorAll("ui-select-option")].forEach(
          (l) => l.removeAttribute("selected")
        ), s.setAttribute("selected", ""), this.ui.events.dispatch("change", s));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.cleanup = new h(), this.ui = new Ze();
  }
  // }}}
  connectedCallback() {
...
K = new WeakMap(), // }}}
o(kt, "register", () => customElements.define("ui-select", kt));
let lt = kt;
var T, R, Q, oe;
let Be = (oe = class {
  /** @param {Lang} root */
  constructor(t) {
     ...
     */
    n(this, Q, void 0);
    c(this, T, t), c(this, R, new S()), this.langType = null;
  }
  get current() {
    return i(this, T).getAttribute("current");
  }
  set current(t) {
    t === null ? i(this, T).removeAttribute("current") : i(this, T).setAttribute("current", t);
  }
  /** @returns {import("./lang-type").LangType} */
  getFallbackElement() {
    return i(this, T).querySelector("ui-lang-type[fallback]");
  }
  /**
  ...
  get(t, e) {
    var s, l;
    return ((l = (s = i(this, Q)) == null ? void 0 : s[t]) == null ? void 0 : l[e]) || null;
  }
  /**
   * @param {"change"} key
...
}, T = new WeakMap(), R = new WeakMap(), Q = new WeakMap(), oe);
...
o(V, "register", () => customElements.define("ui-lang", V)), o(V, "observedAttributes", ["current"]);
let ct = V;
var b, ne;
let Je = (ne = class {
  /**
...
o(Ct, "register", () => customElements.define("ui-lang-type", Ct));
let ht = Ct;
const Ye = a`
<style>
    .background {
...
`, Lt = class Lt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ye, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const Mt = class Mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Xe, this.cleanup = new h(), this.ui = new Fe(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(Mt, "register", () => customElements.define("ui-stack-layout-page", Mt));
let dt = Mt;
const Ke = a`
    <style>
        :host {
...
let Qe = (le = class {
  ...
  constructor(t) {
     ...
     */
    n(this, I, {});
    c(this, H, t), this.events = new S(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    if (!this.stack.length || i(this, A))
      return;
    const t = this.stack.pop();
    i(this, H).removeChild(t), this.stack.length && i(this, H).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent();
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (!i(this, A)) {
      if (this.stack.push(
        // @ts-expect-error
        i(this, H).appendChild(i(this, I)[t]().children[0])
      ), this.stack.length > 1) {
...
}, H = new WeakMap(), A = new WeakMap(), I = new WeakMap(), le);
const Tt = class Tt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ke, this.cleanup = new h(), this.ui = new Qe(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(Tt, "register", () => customElements.define("ui-stack-layout", Tt));
let pt = Tt;
var k, C, ce;
let We = (ce = class {
  /**
...
o(Et, "register", () => customElements.define("ui-store", Et));
let gt = Et;
const Ge = a`
<style>
    :host {
...
o(Ht, "register", () => customElements.define("ui-svg-back-arrow-navigation", Ht));
let Bt = Ht;
const _e = a`
<style>
    :host {
...
o(At, "register", () => customElements.define("ui-svg-chevron-down", At));
let Jt = At;
const ti = a`
<style>
    :host {
...
o(Rt, "register", () => customElements.define("ui-svg-delete-recycle-bin", Rt));
let Xt = Rt;
const ii = a`
<style>
    :host {
...
o($t, "register", () => customElements.define("ui-svg-edit2", $t));
let Ft = $t;
const si = a`
<style>
    :host {
...
o(It, "register", () => customElements.define("ui-svg-pdf-document", It));
let Kt = It;
const ri = a`
<style>
    :host {
...
o(Ut, "register", () => customElements.define("ui-svg-today-outline", Ut));
let Wt = Ut;
const y = {
...
let ai = (he = class {
  ...
  enableRipple() {
    i(this, U) || (this.removeRipple = Nt(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
    i(this, U) && i(this, U).call(this), this.stopInputHandling();
  }
  /**
   * @private
   */
  startInputHandling() {
    i(this, j) || (i(this, u).addEventListener("click", i(this, W)), this.getInputSlot().forEach((t) => {
      t.addEventListener("click", i(this, G));
    }), c(this, j, !0));
  }
  /**
   * @private
  ...
  stopInputHandling() {
    i(this, u).removeEventListener("click", i(this, W)), [...i(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, G));
    }), c(this, j, !1);
  }
}, u = new WeakMap(), j = new WeakMap(), W = new WeakMap(), G = new WeakMap(), U = new WeakMap(), he);
const Z = class Z extends HTMLElement {
  constructor() {
...
`, zt = class zt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = li, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
<slot></slot>
`, qt = class qt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ci, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
o(qt, "register", () => customElements.define("ui-secondary", qt));
let Y = qt;
var v;
class hi {
  constructor() {
...
o(B, "register", () => customElements.define("ui-theme-handler", B)), o(B, "observedAttributes", ["auto", "mode"]);
let bt = B;
...
async function di() {
  _.register(), et.register(), tt.register(), it.register(), rt.register(), ot.register(), nt.register(), at.register(), J.register(), lt.register(), ht.register(), ct.register(), ut.register(), dt.register(), pt.register(), gt.register(), Y.register(), ft.register(), mt.register(), bt.register(), st.register();
}
async function pi() {
  y.BackArrowNavigation.register(), y.ChevronDown.register(), y.Close.register(), y.DeleteRecycleBin.register(), y.Edit2.register(), y.PDFDocument.register(), y.Settings.register(), y.TodayOutline.register();
}
const Ri = {
  js: Ce,
  wc: ui,
