...
var Ft = (r, t, e) => t in r ? $t(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var s = (r, t, e) => Ft(r, typeof t != "symbol" ? t + "" : t, e), Dt = (r, t, e) => t.has(r) || At("Cannot " + e);
var b = (r, t, e) => (Dt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), Lt = (r, t, e) => t.has(r) ? At("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(r) : t.set(r, e);
class Ht {
  constructor() {
    this.callbacks = [];
  }
...
function Vt(r, t, e = {}) {
  ...
  const i = () => {
    const h = [...r.children].indexOf(t);
    t.draggable = !0, t.ondragstart = (c) => {
      c.dataTransfer.effectAllowed = "move", c.dataTransfer.dropEffect = "move", e.onDragStart && e.onDragStart(h);
    }, t.ondragover = (c) => (c.preventDefault(), !1), t.ondragenter = (c) => {
      c.preventDefault(), [...r.children].forEach((g, G) => {
        if (G === h) {
          g.style.background = "var(--ui-primary-bgColor)", g.style.color = "var(--ui-primary-color)";
          return;
        }
        g.style.background = "inherit", g.style.color = "inherit";
      }), e.onDragging && e.onDragging(h);
    }, t.ondrop = (c) => {
      c.preventDefault(), c.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(h), [...r.children].forEach((g) => {
        g.style.background = "inherit", g.style.color = "inherit";
      });
    };
  }, o = () => {
...
function Ot(r, { onDragEnd: t = null, onDragStart: e = null }) {
  let i = null, o = null;
  const l = (n) => {
    if (!o && !i && Array.from(n.target.classList).includes("draggable")) {
      const d = !!n.targetTouches && n.targetTouches[0] || n;
      i = n.target, r.append(o = n.target.cloneNode(!0)), o.className = "dragging", e && e();
      const m = d.pageX - o.offsetWidth / 2 + "px", _ = d.pageY - o.offsetHeight / 2 + "px";
      o.style.willChange = "transform", o.style.transform = `translate(${m}, ${_})`;
    }
  }, h = (n) => {
    if (o && i) {
      const d = !!n.targetTouches && n.targetTouches[0] || n, m = d.pageX - o.offsetWidth / 2 + "px", _ = d.pageY - o.offsetHeight / 2 + "px";
      o.style.transform = `translate(${m}, ${_})`;
      const Et = Array.from(
        document.elementFromPoint(d.clientX, d.clientY).children
      ).find((jt) => jt.classList.contains("draggable")) || null;
      Et && g(i, Et);
    }
  }, c = () => {
    o && r.removeChild(o), t && t(), o = null, i = null;
  };
  function g(n, d) {
    G(n, d) ? r.insertBefore(n, d) : r.insertBefore(n, d.nextElementSibling);
  }
  function G(n, d) {
    let m = n.previousElementSibling;
    for (; m; ) {
      if (m === d)
        return !0;
  ...
  return (() => {
    Array.from(r.children).forEach(
      (n) => {
        n.classList.add("draggable"), n.onmousedown = l, n.ontouchstart = l, n.onmousemove = h, n.ontouchmove = h, n.onmouseup = c, n.ontouchend = c;
      }
    );
  })(), {
    destroy: () => {
...
class u {
  ...
  on(t, e) {
    ...
    return b(this, p)[t] || (b(this, p)[t] = []), b(this, p)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
  ...
  off(t, e) {
    ...
    let i = !1, o = 0;
    for (const l of b(this, p)[t])
      l === e && (b(this, p)[t].splice(o, 1), i = !0), o++;
    if (!i)
...
function Mt(r, t) {
  ...
  const o = Math.max(i.width, i.height) * 0.02;
...
function f(r, t = {}) {
  ...
  return r.classList.add("ripple-container"), r.style.overflow = "hidden", t.useClick === !0 ? r.addEventListener("click", (l) => {
    e = Mt(l, t), Tt(e);
  }) : (r.addEventListener("pointerdown", i), r.addEventListener("pointerup", o), r.addEventListener("pointerleave", o)), {
    destroy: () => {
      r.classList.remove("ripple-container"), r.removeEventListener("pointerdown", i), r.removeEventListener("pointerup", o), r.removeEventListener("pointerleave", o);
    }
  };
}
function Yt() {
...
const a = String.raw, Q = String.raw, Wt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: Ht,
  Events: u,
  createDraggable: Vt,
  createMobileDraggable: Ot,
  createRipple: f,
  css: Q,
  defaultRippleOptions: qt,
  html: a,
  isAndroid: Yt
}, Symbol.toStringTag, { value: "Module" })), F = class F extends HTMLElement {
  constructor() {
...
s(F, "register", () => {
  customElements.get("ui-app-bar") || customElements.define("ui-app-bar", F);
});
let U = F;
...
s(D, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", D);
});
let I = D;
const y = class y extends HTMLElement {
    ...
    super(), this.attachShadow({ mode: "open" }), this.removeRippleCallback = null, this.ui = {
      ...
      set noripple(t) {
        if (!t) {
          ...
          this.root.removeRippleCallback = f(this.root);
        }
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <slot></slot>
    `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = f(this)), this.addEventListener("click", () => {
...
s(y, "register", () => {
  customElements.get("ui-button") || customElements.define("ui-button", y);
}), s(y, "observedAttributes", ["noripple"]);
let tt = y;
const w = class w extends HTMLElement {
  ...
  shadowRender() {
    ...
    `, typeof this.removeRippleCallback != "function" && (this.removeRippleCallback = f(this, { centered: !0 })), this.addEventListener("click", () => {
      this.ui.events.dispatch("click", this);
    });
  }
  connectedCallback() {
...
}), s(w, "observedAttributes", ["noripple"]);
let et = w;
...
s(V, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", V);
});
let it = V;
const Pt = a`
...
`, k = class k extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new Ht(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new u(),
      get title() {
       ...
       */
      open(e = !1, i = !0) {
        const o = this.root.shadowRoot.querySelector("dialog"), l = o.inert;
        o.inert = i, e ? o.showModal() : o.show(), this.events.dispatch("open", null), o.inert = l;
      },
      close() {
  ...
  shadowRender() {
    ...
    const i = this.shadowRoot.querySelector("dialog"), o = (l) => l.preventDefault();
    i.addEventListener("cancel", o), this.shadowRenderCleanUp.add(() => {
      t.removeEventListener("click", e), i.removeEventListener("cancel", o);
    });
  }
  connectedCallback() {
  }
...
s(k, "register", () => {
  customElements.get("ui-dialog") || customElements.define("ui-dialog", k);
}), s(k, "observedAttributes", ["title"]);
let ot = k;
...
s(x, "register", () => {
  customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", x);
}), s(x, "observedAttributes", ["title"]);
let st = x;
const Y = class Y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {}, this.shadowRender();
...
s(Y, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", Y);
});
let nt = Y;
...
s(R, "register", () => {
  customElements.get("ui-flex-grid-row") || customElements.define("ui-flex-grid-row", R);
}), s(R, "observedAttributes", ["gap", "justify", "align"]);
let lt = R;
...
s(E, "register", () => {
  customElements.get("ui-flex-grid") || customElements.define("ui-flex-grid", E);
}), s(E, "observedAttributes", ["gap"]);
let ct = E;
...
s(A, "register", () => {
  customElements.get("ui-check") || customElements.define("ui-check", A);
}), s(A, "observedAttributes", ["primary", "secondary", "value", "checked"]);
let dt = A;
const L = class L extends HTMLElement {
  ...
  enableRipple() {
    if (this.removeRipple || (this.removeRipple = f(this), this.style.cursor = "pointer", this.running)) return;
...
s(L, "register", () => {
  customElements.get("ui-label") || customElements.define("ui-label", L);
}), s(L, "observedAttributes", ["ripple", "secondary", "primary"]);
let ut = L;
...
s(P, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", P);
});
let ht = P;
...
s(X, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", X);
});
let v = X;
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set title(t) {
        ...
        !t && e && this.root.removeChild(e), t && (e || (e = new v(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t);
      },
      get type() {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Xt}</ui-icon-button>
      </div>
...
s(M, "register", () => {
  customElements.get("ui-search") || customElements.define("ui-search", M);
...
s(B, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", B);
});
let $ = B;
const J = class J extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <div class="options">
        <div class="icon"><ui-svg>${zt}</ui-svg></div>
    ...
    const t = (i) => {
      const o = async (l) => {
        (l.composedPath() || []).forEach((h) => {
          h instanceof $ && ([...this.querySelectorAll("ui-select-option")].forEach(
            (c) => c.removeAttribute("selected")
          ), h.setAttribute("selected", ""), this.ui.events.dispatch("change", h));
        });
      };
      this.classList.toggle("open") ? (i.stopPropagation(), this.addEventListener("click", o)) : setTimeout(() => this.removeEventListener("click", o));
    };
...
s(T, "register", () => {
  customElements.get("ui-textarea") || customElements.define("ui-textarea", T);
...
const H = class H extends HTMLElement {
  constructor() {
    super(), this.ui = {
      ...
      get(t, e) {
        var i, o;
        return ((o = (i = this.data) == null ? void 0 : i[t]) == null ? void 0 : o[e]) || null;
      }
    }, this.shadowRender();
  }
  shadowRender() {
...
s(H, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", H);
}), s(H, "observedAttributes", ["current"]);
let ft = H;
const W = class W extends HTMLElement {
  constructor() {
    super(), this.ui = {
...
s(W, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", W);
});
let vt = W;
...
s(q, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", q);
}), s(q, "observedAttributes", ["nobg"]);
let yt = q;
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.pages = {}, this.stack = [], this.onpopstate = () => this.goBack(), this.ui = {
      ...
      set(t, e = null, i = !1) {
        if (this.lock) return;
        const o = this.root.pages[t]();
        this.root.stack.push(this.root.appendChild(o)), typeof e == "function" && e(o);
        let l = null;
...
s(Z, "register", () => {
  customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", Z);
});
let kt = Z;
...
s(K, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", K);
});
let xt = K;
const j = class j extends HTMLElement {
  constructor() {
    super(), this.mediaHandler = null, this.themes = {}, this.currentTheme = null, this.mode = "", this.ui = {
      ...
      set(t) {
          ...
          return;
        {
          ...
          o && (document.head.removeChild(o), this.root.currentTheme = null);
        }
...
s(N, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", N);
});
let Rt = N;
function Zt() {
  I.register(), U.register(), tt.register(), et.register(), it.register(), ot.register(), nt.register(), st.register(), rt.register(), at.register(), lt.register(), ct.register(), dt.register(), pt.register(), gt.register(), $.register(), bt.register(), mt.register(), vt.register(), ft.register(), yt.register(), kt.register(), wt.register(), xt.register(), Rt.register(), ut.register(), ht.register(), v.register(), Ct.register();
}
export {
  U as UIAppBar,
  I as UIAppBarItem,
