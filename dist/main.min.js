...
var Xt = (o, t, e) => t in o ? Ot(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Xt(o, typeof t != "symbol" ? t + "" : t, e), Bt = (o, t, e) => t.has(o) || Mt("Cannot " + e);
var b = (o, t, e) => (Bt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), Ht = (o, t, e) => t.has(o) ? Mt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(o) : t.set(o, e);
class $t {
  constructor() {
    this.callbacks = [];
  }
...
function Pt(o, t, e = {}) {
  ...
  const i = () => {
    ...
    t.draggable = !0, t.ondragstart = (c) => {
      ...
      c.preventDefault(), [...o.children].forEach((u, F) => {
        if (F === h) {
          u.style.background = "var(--ui-primary-bgColor)", u.style.color = "var(--ui-primary-color)";
          return;
        }
        u.style.background = "inherit", u.style.color = "inherit";
      }), e.onDragging && e.onDragging(h);
    }, t.ondrop = (c) => {
      c.preventDefault(), c.dataTransfer.dropEffect = "move", e.onDragEnd && e.onDragEnd(h), [...o.children].forEach((u) => {
        u.style.background = "inherit", u.style.color = "inherit";
      });
    };
  }, s = () => {
...
function Jt(o, { onDragEnd: t = null, onDragStart: e = null }) {
  let i = null, s = null, l = null, h = null, c = null, u = !1, F = null, Et = null;
  const At = (n) => {
    !i && Array.from(n.currentTarget.classList).includes("draggable") && (l = n.clientX, h = n.clientY, s = (/* @__PURE__ */ new Date()).getTime(), i = n.currentTarget, c || clearTimeout(c), c = setTimeout(() => {
      F = i.style.color, Et = i.style.backgroundColor, i.style.color = "var(--ui-primary-color)", i.style.backgroundColor = "var(--ui-primary-bgColor)", o.classList.add("dragging"), u = !0, e && e();
    }, 200));
  }, Lt = (n) => {
    if (!s || !i) return;
    if (!u && (/* @__PURE__ */ new Date()).getTime() - s < 200) {
      const St = Math.abs(l - n.clientX), Tt = Math.abs(h - n.clientY);
      if ((St > Tt ? St : Tt) < 24)
        return;
      _();
      return;
    }
    n.preventDefault(), u || (u = !0, e && e());
    const m = !!n.targetTouches && n.targetTouches[0] || n;
    let p = document.elementFromPoint(m.clientX, m.clientY);
    for (; !p.classList.contains("draggable") && p.parentElement; )
      p = p.parentElement;
    p.classList.contains("draggable") && Yt(i, p);
  }, _ = () => {
    c !== null && (clearTimeout(c), c = null), i && (i.style.color = F, i.style.backgroundColor = Et, i = null), s = null, o.classList.remove("dragging"), u && (t && t(), u = !1);
  };
  function Yt(n, m) {
    Vt(n, m) ? o.insertBefore(n, m) : o.insertBefore(n, m.nextElementSibling);
  }
  function Vt(n, m) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (n) => {
        n.classList.add("draggable"), n.onmousedown = At, n.ontouchstart = At, n.onmousemove = Lt, n.ontouchmove = Lt, n.onmouseup = _, n.ontouchend = _;
      }
    );
  })(), {
    destroy: () => {
...
class d {
  ...
  on(t, e) {
    ...
    return b(this, g)[t] || (b(this, g)[t] = []), b(this, g)[t].push(e), () => {
      this.off(t, e);
    };
  }
  /**
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const l of b(this, g)[t])
      l === e && (b(this, g)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
const a = String.raw, G = String.raw, _t = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CleanUp: $t,
  Events: d,
  createDraggable: Pt,
  createMobileDraggable: Jt,
  createRipple: f,
  css: G,
  defaultRippleOptions: Ft,
  html: a,
  isAndroid: Zt
...
r(Y, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", Y);
});
let I = Y;
const y = class y extends HTMLElement {
  constructor() {
...
`, k = class k extends HTMLElement {
   ...
   */
  constructor(t) {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new $t(), this._title = t || "", this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
...
r(X, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", X);
});
let nt = X;
...
r(B, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", B);
});
let ht = B;
...
r(P, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", P);
});
let v = P;
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <div class="container">
        <slot name="title"></slot>
        <input type="search" />
        <ui-icon-button name="submit" ghost>${Qt}</ui-icon-button>
      </div>
...
r(J, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", J);
});
let $ = J;
const Z = class Z extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
      ...
      <div class="options">
        <div class="icon"><ui-svg>${Dt}</ui-svg></div>
