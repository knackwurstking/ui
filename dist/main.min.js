...
var fi = (o, e, t) => e in o ? gi(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var s = (o, e, t) => fi(o, typeof e != "symbol" ? e + "" : e, t), Qt = (o, e, t) => e.has(o) || Ve("Cannot " + t);
var p = (o, e, t) => (Qt(o, e, "read from private field"), t ? t.call(o) : e.get(o)), a = (o, e, t) => e.has(o) ? Ve("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t), M = (o, e, t, i) => (Qt(o, e, "write to private field"), i ? i.call(o, t) : e.set(o, t), t), c = (o, e, t) => (Qt(o, e, "access private method"), t);
class $i {
  constructor() {
    this.callbacks = [];
  }
...
function mi(o, e, { onDragStart: t = null, onDragging: i = null, onDragEnd: r = null } = {}) {
  const u = () => {
...
function bi(o, { onDragEnd: e = null, onDragStart: t = null } = {}) {
  ...
  const nt = (l) => {
    ...
    if (!m && (/* @__PURE__ */ new Date()).getTime() - r < 200) {
      const je = Math.abs(u - l.clientX), Te = Math.abs(h - l.clientY);
      if ((je > Te ? je : Te) < 24)
        return;
      Kt();
      return;
    ...
    for (; !v.classList.contains("draggable") && v.parentElement; )
      v = v.parentElement;
    v.classList.contains("draggable") && hi(i, v);
  }, Kt = () => {
  ...
  function hi(l, C) {
    pi(l, C) ? o.insertBefore(l, C) : o.insertBefore(l, C.nextElementSibling);
  }
  function pi(l, C) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (l) => {
        l.classList.add("draggable"), l.onmousedown = nt, l.ontouchstart = nt, l.onmousemove = He, l.ontouchmove = He, l.onmouseup = Kt, l.ontouchend = Kt;
      }
    );
  })(), {
...
function L(o, e = {}) {
  ...
  let t = null;
  const i = (f) => {
    t = It(f, e), o.addEventListener("pointermove", u);
  }, r = () => {
    o.removeEventListener("pointermove", u), Ut(t), t = null;
  }, u = () => r(), h = (f) => {
    t = It(f, e), Ut(t), t = null;
  }, d = () => {
...
ct = new WeakSet(), Be = function() {
  ...
  customElements.get("ui-flex-grid-item") || (console.debug('[ui] Register "ui-flex-grid-item" component'), customElements.define("ui-flex-grid-item", E));
...
ut = new WeakSet(), qe = function() {
  ...
  customElements.get("ui-flex-grid-row") || (console.debug('[ui] Register "ui-flex-grid-row" component'), customElements.define("ui-flex-grid-row", A));
...
dt = new WeakSet(), Oe = function() {
  ...
  customElements.get("ui-flex-grid") || (console.debug('[ui] Register "ui-flex-grid" component'), customElements.define("ui-flex-grid", H));
...
const pt = class pt extends N {
  ...
  constructor(t = null) {
    ...
    }, c(this, ht, $e).call(this), t && this.ui.set(t);
  }
...
vt = new WeakSet(), Ye = function() {
  ...
  customElements.get("ui-button") || (console.debug('[ui] Register "ui-button" component'), customElements.define("ui-button", j));
...
kt = new WeakSet(), De = function() {
  ...
  customElements.get("ui-icon-button") || (console.debug('[ui] Register "ui-icon-button" component'), customElements.define("ui-icon-button", T));
...
const wt = class wt extends HTMLElement {
  constructor() {
    super();
    a(this, yt);
    this.ui = {}, c(this, yt, Xe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Ct = new WeakSet(), Ne = function() {
  ...
  customElements.get("ui-dialog") || (console.debug('[ui] Register "ui-dialog" component'), customElements.define("ui-dialog", V));
...
Mt = new WeakSet(), Ke = function() {
  ...
  customElements.get("ui-drawer-group") || (console.debug('[ui] Register "ui-drawer-group" component'), customElements.define("ui-drawer-group", _));
...
const Rt = class Rt extends HTMLElement {
  constructor() {
    super();
    a(this, St);
    this.ui = {}, c(this, St, Qe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let pe = Z;
pe.register();
var Q, W, I, U, tt, et, it, rt, ot, st, y, Ie, x;
const G = class G extends HTMLElement {
  constructor() {
    ...
    this.ui = {
      ...
      get family() {
        return p(this.root, st);
      },
      set family(t) {
        var i;
        t === null && (t = p(this.root, ot)), M(this.root, st, t), c(i = this.root, y, x).call(i);
      }
    }, c(this, y, Ie).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Q = new WeakMap(), W = new WeakMap(), I = new WeakMap(), U = new WeakMap(), tt = new WeakMap(), et = new WeakMap(), it = new WeakMap(), rt = new WeakMap(), ot = new WeakMap(), st = new WeakMap(), y = new WeakSet(), Ie = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            <style>
                :host {
                    display: inline-block;
  ...
  customElements.get("ui-text") || (console.debug('[ui] Register "ui-text" component'), customElements.define("ui-text", G));
...
At = new WeakSet(), Ue = function() {
  ...
  customElements.get("ui-label") || (console.debug('[ui] Register "ui-label" component'), customElements.define("ui-label", z));
...
_t = new WeakSet(), ii = function() {
  ...
  customElements.get("ui-input") || (console.debug('[ui] Register "ui-input" component'), customElements.define("ui-input", B));
...
Zt = new WeakSet(), ri = function() {
  ...
  customElements.get("ui-search") || (console.debug('[ui] Register "ui-search" component'), customElements.define("ui-search", q));
...
Bt = new WeakSet(), si = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            ...
            <div class="options">
                <div class="icon"><ui-svg>${Ae}</ui-svg></div>
  ...
  const t = (r) => {
    const u = async (h) => {
      (h.composedPath() || []).forEach((d) => {
        d instanceof K && ([...this.querySelectorAll("ui-select-option")].forEach(
  ...
  customElements.get("ui-select") || (console.debug('[ui] Register "ui-select" component'), customElements.define("ui-select", O));
...
qt = new WeakSet(), ni = function() {
  ...
  customElements.get("ui-textarea") || (console.debug('[ui] Register "ui-textarea" component'), customElements.define("ui-textarea", $));
...
ke.register();
var Ot, ai;
const F = class F extends HTMLDetailsElement {
  constructor() {
    super();
    a(this, Ot);
    this.ui = {
      ...
      set title(t) {
        this.root.shadowRoot.querySelector("summary").innerText = t || "";
      },
      options() {
...
Ot = new WeakSet(), ai = function() {
  ...
  customElements.get("ui-dropdown") && (console.debug('[ui] Register "ui-dropdown" component'), customElements.define("ui-dropdown", F));
}), s(F, "observedAttributes", ["title"]);
let ye = F;
ye.register();
var $t, li;
const Ft = class Ft extends HTMLLIElement {
  constructor() {
    super();
    a(this, $t);
    c(this, $t, li).call(this);
  }
};
$t = new WeakSet(), li = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n` <a href="#"><slot></slot></a> `;
}, s(Ft, "register", () => {
  customElements.get("ui-dropdown-option") && (console.debug('[ui] Register "ui-dropdown-option" component'), customElements.define("ui-dropdown-option", Ft));
});
let we = Ft;
we.register();
...
s(Pt, "register", () => {
  customElements.get("ui-lang-type") || (console.debug('[ui] Register "ui-lang-type" component'), customElements.define("ui-lang-type", Pt));
});
let xe = Pt;
xe.register();
var Yt, ci;
...
Nt = new WeakSet(), di = function() {
  ...
  customElements.get("ui-stack-layout-page") || (console.debug('[ui] Register "ui-stack-layout-page" component'), customElements.define("ui-stack-layout-page", D));
...
s(Jt, "register", () => {
  customElements.get("ui-store") || (console.debug('[ui] Register "ui-store" component'), customElements.define("ui-store", Jt));
});
let Re = Jt;
Re.register();
const X = class X extends HTMLElement {
  constructor() {
    super(), this.mediaHandler = null, this.themes = {}, this.currentTheme = null, this.mode = null, this.theme = "original", this.ui = {
      root: this,
      get auto() {
  ...
  setTheme(e, t = null) {
    ...
    i.classList.add("theme"), i.rel = "stylesheet", i.href = `${t.prefixPath}/${e || "original"}.css`, t.target.appendChild(i);
  }
};
s(X, "register", () => {
  customElements.get("ui-theme-handler") || (console.debug('[ui] Register "ui-theme-handler" component'), customElements.define("ui-theme-handler", X));
}), s(X, "observedAttributes", ["auto", "mode", "theme"]);
let Ee = X;
Ee.register();
export {
  $i as CleanUp,
  ...
  ue as UIDrawer,
  de as UIDrawerGroup,
  he as UIDrawerGroupItem,
  ye as UIDropdown,
  we as UIDropdownOption,
  ie as UIFlexGrid,
  N as UIFlexGridItem,
  ee as UIFlexGridRow,
  ae as UIIconButton,
  ...
  Le as UISpinner,
  Me as UIStackLayout,
  Se as UIStackLayoutPage,
  Re as UIStore,
  J as UIText,
  ke as UITextarea,
  Ee as UIThemeHandler,
  S as css,
  Fi as draggable,
  vi as globalStyleSheets,
