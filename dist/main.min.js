...
var s = (o, e, t) => di(o, typeof e != "symbol" ? e + "" : e, t), Ce = (o, e, t) => e.has(o) || He("Cannot " + t);
var p = (o, e, t) => (Ce(o, e, "read from private field"), t ? t.call(o) : e.get(o)), a = (o, e, t) => e.has(o) ? He("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t), S = (o, e, t, i) => (Ce(o, e, "write to private field"), i ? i.call(o, t) : e.set(o, t), t), c = (o, e, t) => (Ce(o, e, "access private method"), t);
class zi {
  constructor() {
    this.callbacks = [];
  }
...
function pi(o, { onDragEnd: e = null, onDragStart: t = null } = {}) {
  ...
  return (() => {
    Array.from(o.children).forEach(
      (l) => {
        l.classList.add("draggable"), l.onmousedown = st, l.ontouchstart = st, l.onmousemove = Re, l.ontouchmove = Re, l.onmouseup = we, l.ontouchend = we;
      }
    );
  })(), {
...
let xe = null;
function gi() {
  return xe === null && (xe = Array.from(document.styleSheets).map((o) => {
...
function L(o, e = {}) {
  ...
  let t = null;
  const i = (f) => {
    t = Le(f, e), o.addEventListener("pointermove", u);
  }, r = () => {
    o.removeEventListener("pointermove", u), Me(t), t = null;
  }, u = () => r(), h = (f) => {
    t = Le(f, e), Me(t), t = null;
  }, d = () => {
...
_t = new WeakSet(), _e = function() {
  ...
  customElements.get("ui-alerts") || (console.debug('[ui] Register "ui-alerts" component'), customElements.define("ui-alerts", Zt));
});
let nt = Zt;
nt.register();
var Gt, Ze;
...
Gt = new WeakSet(), Ze = function() {
  ...
  customElements.get("ui-flex-grid-item") || (console.debug('[ui] Register "ui-flex-grid-item" component'), customElements.define("ui-flex-grid-item", H));
}), s(H, "observedAttributes", ["flex"]);
let E = H;
E.register();
var zt, Ge;
...
zt = new WeakSet(), Ge = function() {
  ...
  customElements.get("ui-flex-grid-row") || (console.debug('[ui] Register "ui-flex-grid-row" component'), customElements.define("ui-flex-grid-row", j));
...
Bt = new WeakSet(), ze = function() {
  ...
  customElements.get("ui-flex-grid") || (console.debug('[ui] Register "ui-flex-grid" component'), customElements.define("ui-flex-grid", T));
}), s(T, "observedAttributes", ["gap"]);
let lt = T;
lt.register();
var qt, Be;
const Ot = class Ot extends E {
  ...
  constructor(t = null) {
    ...
    }, c(this, qt, Be).call(this), t && this.ui.set(t);
  }
...
qt = new WeakSet(), Be = function() {
  ...
  customElements.get("ui-alert") || (console.debug('[ui] Register "ui-alert" component'), customElements.define("ui-alert", Ot));
});
let ct = Ot;
ct.register();
var $t, qe;
...
Pt = new WeakSet(), Oe = function() {
  ...
  customElements.get("ui-app-bar-item") || (console.debug('[ui] Register "ui-app-bar-item" component'), customElements.define("ui-app-bar-item", Dt));
});
let dt = Dt;
dt.register();
var Yt, $e;
...
Yt = new WeakSet(), $e = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            ...
            <slot></slot>
        `, typeof this.ripple != "function" && (this.ripple = L(this)), this.addEventListener("click", (t) => {
    this.ui.events.dispatch("click", t);
  });
}, s(V, "register", () => {
  customElements.get("ui-button") || (console.debug('[ui] Register "ui-button" component'), customElements.define("ui-button", V));
...
Xt = new WeakSet(), Fe = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
        ...
        `, typeof this.ripple != "function" && (this.ripple = L(this, { centered: !0 })), this.addEventListener("click", (t) => {
    this.ui.events.dispatch("click", t);
  });
}, s(_, "register", () => {
  customElements.get("ui-icon-button") || (console.debug('[ui] Register "ui-icon-button" component'), customElements.define("ui-icon-button", _));
}), s(_, "observedAttributes", ["noripple"]);
let pt = _;
pt.register();
var Nt, Pe;
const Jt = class Jt extends HTMLElement {
  constructor() {
    super();
    a(this, Nt);
    this.ui = {}, c(this, Nt, Pe).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Nt = new WeakSet(), Pe = function() {
  ...
  customElements.get("ui-container") || (console.debug('[ui] Register "ui-container" component'), customElements.define("ui-container", Jt));
});
let gt = Jt;
gt.register();
var Kt, De;
...
Kt = new WeakSet(), De = function() {
  ...
  customElements.get("ui-dialog") || (console.debug('[ui] Register "ui-dialog" component'), customElements.define("ui-dialog", Z));
...
Qt = new WeakSet(), Ye = function() {
  ...
  customElements.get("ui-drawer") || (console.debug('[ui] Register "ui-drawer" component'), customElements.define("ui-drawer", Wt));
});
let mt = Wt;
mt.register();
var It, Xe;
...
It = new WeakSet(), Xe = function() {
  ...
  customElements.get("ui-drawer-group") || (console.debug('[ui] Register "ui-drawer-group" component'), customElements.define("ui-drawer-group", G));
}), s(G, "observedAttributes", ["title"]);
let bt = G;
bt.register();
var Ut, Ne;
const te = class te extends HTMLElement {
  constructor() {
    super();
    a(this, Ut);
    this.ui = {}, c(this, Ut, Ne).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
Ut = new WeakSet(), Ne = function() {
  ...
  customElements.get("ui-drawer-group-item") || (console.debug('[ui] Register "ui-drawer-group-item" component'), customElements.define("ui-drawer-group-item", te));
});
let vt = te;
vt.register();
var ee, Je;
...
ee = new WeakSet(), Je = function() {
  ...
  customElements.get("ui-check") || (console.debug('[ui] Register "ui-check" component'), customElements.define("ui-check", z));
}), s(z, "observedAttributes", ["checked"]);
let kt = z;
kt.register();
var K, Q, W, I, U, tt, et, it, rt, ot, y, Ke, x;
const B = class B extends HTMLElement {
  constructor() {
    ...
    a(this, U, 0);
    a(this, tt, p(this, U));
    a(this, et, "var(--ui-fontSize)");
    a(this, it, p(this, et));
    a(this, rt, "var(--ui-fontFamily)");
    a(this, ot, p(this, rt));
    this.ui = {
      root: this,
      get casl() {
        return p(this.root, Q);
      },
      set casl(t) {
        var i;
        t === null && (t = p(this.root, K)), S(this.root, Q, t), c(i = this.root, y, x).call(i);
      },
      get mono() {
      ...
      set mono(t) {
        var i;
        t === null && (t = p(this.root, W)), S(this.root, I, t), c(i = this.root, y, x).call(i);
      },
      get slnt() {
      ...
      set slnt(t) {
        var i;
        t === null && (t = p(this.root, U)), S(this.root, tt, t), c(i = this.root, y, x).call(i);
      },
      get size() {
      ...
      set size(t) {
        var i;
        t === null && (t = p(this.root, et)), S(this.root, it, t), c(i = this.root, y, x).call(i);
      },
      get family() {
        return p(this.root, ot);
      },
      set family(t) {
        var i;
        t === null && (t = p(this.root, rt)), S(this.root, ot, t), c(i = this.root, y, x).call(i);
      }
...
K = new WeakMap(), Q = new WeakMap(), W = new WeakMap(), I = new WeakMap(), U = new WeakMap(), tt = new WeakMap(), et = new WeakMap(), it = new WeakMap(), rt = new WeakMap(), ot = new WeakMap(), y = new WeakSet(), Ke = function() {
  this.attachShadow({ mode: "open" }), g(this.shadowRoot), this.shadowRoot.innerHTML = n`
            <style>
                :host {
                    display: inline-block;
  ...
  customElements.get("ui-text") || (console.debug('[ui] Register "ui-text" component'), customElements.define("ui-text", B));
}), s(B, "observedAttributes", ["casl", "mono", "slnt", "size", "family"]);
let J = B;
J.register();
var ie, Qe;
...
ie = new WeakSet(), Qe = function() {
  ...
  customElements.get("ui-label") || (console.debug('[ui] Register "ui-label" component'), customElements.define("ui-label", q));
}), s(q, "observedAttributes", ["ripple", "secondary", "primary"]);
let yt = q;
yt.register();
var re, We;
const oe = class oe extends J {
  constructor() {
    super();
    a(this, re);
    c(this, re, We).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
re = new WeakSet(), We = function() {
  this.ui.size = "1.1rem", this.ui.casl = 1, this.ui.mono = 0, this.ui.slnt = 0;
}, s(oe, "register", () => {
  customElements.get("ui-primary") || (console.debug('[ui] Register "ui-primary" component'), customElements.define("ui-primary", oe));
});
let wt = oe;
wt.register();
var se, Ie;
...
se = new WeakSet(), Ie = function() {
  this.ui.size = "0.9rem", this.ui.casl = 1, this.ui.mono = 0, this.ui.slnt = -15;
}, s(ne, "register", () => {
  customElements.get("ui-secondary") || (console.debug('[ui] Register "ui-secondary" component'), customElements.define("ui-secondary", ne));
});
let M = ne;
M.register();
var ae, Ue;
  ...
  constructor() {
    ...
    this.ui = {
      ...
      set title(t) {
        ...
        !t && i && this.root.removeChild(i), t && (i || (i = new M(), i.slot = "title", this.root.appendChild(i)), i.innerHTML = t);
      },
      get type() {
...
ae = new WeakSet(), Ue = function() {
  ...
  customElements.get("ui-input") || (console.debug('[ui] Register "ui-input" component'), customElements.define("ui-input", O));
...
le = new WeakSet(), ti = function() {
  ...
  customElements.get("ui-search") || (console.debug('[ui] Register "ui-search" component'), customElements.define("ui-search", $));
...
ce = new WeakSet(), ei = function() {
  ...
  customElements.get("ui-select-option") || (console.debug('[ui] Register "ui-select-option" component'), customElements.define("ui-select-option", ue));
});
let A = ue;
A.register();
var de, ii;
...
de = new WeakSet(), ii = function() {
  ...
  const t = (r) => {
    const u = async (h) => {
      (h.composedPath() || []).forEach((d) => {
        d instanceof A && ([...this.querySelectorAll("ui-select-option")].forEach(
  ...
  customElements.get("ui-select") || (console.debug('[ui] Register "ui-select" component'), customElements.define("ui-select", F));
}), s(F, "observedAttributes", ["open"]);
let Lt = F;
Lt.register();
var he, ri;
...
he = new WeakSet(), ri = function() {
  ...
  customElements.get("ui-textarea") || (console.debug('[ui] Register "ui-textarea" component'), customElements.define("ui-textarea", P));
...
s(D, "register", () => {
  customElements.get("ui-lang") || (console.debug('[ui] Register "ui-lang" component'), customElements.define("ui-lang", D));
}), s(D, "observedAttributes", ["current"]);
let St = D;
St.register();
...
s(pe, "register", () => {
  customElements.get("ui-lang-type") || (console.debug('[ui] Register "ui-lang-type" component'), customElements.define("ui-lang-type", pe));
});
let Rt = pe;
Rt.register();
var ge, oi;
...
ge = new WeakSet(), oi = function() {
  ...
  customElements.get("ui-spinner") || (console.debug('[ui] Register "ui-spinner" component'), customElements.define("ui-spinner", Y));
}), s(Y, "observedAttributes", ["nobg"]);
let Et = Y;
Et.register();
var fe, si;
  ...
  constructor() {
    ...
    this.pages = {}, this.stack = [], this.onpopstate = () => this.goBack(), this.ui = {
      ...
      async set(t, i = null, r = !1) {
        if (this.lock) return;
        const u = await this.root.pages[t]();
...
fe = new WeakSet(), si = function() {
  ...
  customElements.get("ui-stack-layout") || (console.debug('[ui] Register "ui-stack-layout" component'), customElements.define("ui-stack-layout", me));
});
let At = me;
At.register();
var be, ni;
...
be = new WeakSet(), ni = function() {
  ...
  customElements.get("ui-stack-layout-page") || (console.debug('[ui] Register "ui-stack-layout-page" component'), customElements.define("ui-stack-layout-page", X));
}), s(X, "observedAttributes", ["name"]);
let Ht = X;
Ht.register();
...
s(ve, "register", () => {
  customElements.get("ui-store") || (console.debug('[ui] Register "ui-store" component'), customElements.define("ui-store", ve));
});
let jt = ve;
jt.register();
...
s(N, "register", () => {
  customElements.get("ui-theme-handler") || (console.debug('[ui] Register "ui-theme-handler" component'), customElements.define("ui-theme-handler", N));
}), s(N, "observedAttributes", ["auto", "mode"]);
let Tt = N;
Tt.register();
var ke, ai;
const ye = class ye extends HTMLElement {
  constructor() {
    super();
    a(this, ke);
    this.ui = {}, c(this, ke, ai).call(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
ke = new WeakSet(), ai = function() {
  ...
  customElements.get("ui-svg") || (console.debug('[ui] Register "ui-svg" component'), customElements.define("ui-svg", ye));
});
let Vt = ye;
Vt.register();
function Pi() {
  nt.register(), ct.register(), dt.register(), ut.register(), ht.register(), pt.register(), gt.register(), ft.register(), vt.register(), bt.register(), mt.register(), E.register(), at.register(), lt.register(), kt.register(), Ct.register(), xt.register(), A.register(), Lt.register(), Mt.register(), Rt.register(), St.register(), Et.register(), At.register(), Ht.register(), jt.register(), Vt.register(), yt.register(), wt.register(), M.register(), Tt.register();
}
export {
  zi as CleanUp,
  b as Events,
  ...
  Et as UISpinner,
  At as UIStackLayout,
  Ht as UIStackLayoutPage,
  jt as UIStore,
  J as UIText,
  Mt as UITextarea,
  Tt as UIThemeHandler,
  R as css,
  Bi as draggable,
