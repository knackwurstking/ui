...
`, m = class m extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRenderCleanUp = new T(), this.ui = {
      root: this,
      /** @type {Events<T>} */
      events: new d(),
      get title() {
...
r(C, "register", () => {
  M.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
...
}), r(E, "observedAttributes", ["storageprefix"]);
let ut = E;
