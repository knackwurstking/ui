...
var he = (s, t, e) => t in s ? ce(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var r = (s, t, e) => (he(s, typeof t != "symbol" ? t + "" : t, e), e), Zt = (s, t, e) => {
  if (!t.has(s))
...
const R = class R extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ne.content.cloneNode(!0)), this.ui = new xe(this);
  }
  connectedCallback() {
...
const A = class A extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ae.content.cloneNode(!0)), this.ui = new Le(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
const mt = class mt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ce, this.ui = new Ee(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
V = new WeakMap(), Z = new WeakMap(), r(mt, "register", () => customElements.define("ui-dialog", mt));
let _ = mt;
const Jt = "1", Te = `
<style></style>
<slot></slot>
...
r(U, "register", () => customElements.define("ui-label", U)), r(U, "observedAttributes", ["ripple", "secondary", "primary"]);
let ct = U;
const Fe = `
<style>
    :host {
...
async function ei() {
  K.register(), W.register(), Q.register(), F.register(), G.register(), tt.register(), et.register(), it.register(), q.register(), st.register(), rt.register(), ot.register(), nt.register(), at.register(), lt.register(), dt.register(), ht.register(), ct.register(), ut.register(), _.register();
}
async function ii() {
