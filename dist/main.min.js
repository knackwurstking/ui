...
var xt = (o, e, t) => e in o ? Ct(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var i = (o, e, t) => xt(o, typeof e != "symbol" ? e + "" : e, t), St = (o, e, t) => e.has(o) || bt("Cannot " + t);
var g = (o, e, t) => (St(o, e, "read from private field"), t ? t.call(o) : e.get(o)), ft = (o, e, t) => e.has(o) ? bt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t);
const vt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
function At(o, e = {}) {
  ...
  const t = () => {
    ...
    o.draggable = !0, o.ondragstart = (h) => {
      h.dataTransfer.effectAllowed = "move", h.dataTransfer.dropEffect = "move", h.dataTransfer.setData(
        "text/plain",
        n.toString()
      ), e.onDragStart && e.onDragStart(n);
    }, o.ondragover = (h) => (h.preventDefault(), !1), o.ondragenter = (h) => {
      h.preventDefault(), e.onDragging && e.onDragging(n);
    }, o.ondrop = (h) => {
...
class p {
  ...
  on(e, t) {
    ...
    return g(this, c)[e] || (g(this, c)[e] = []), g(this, c)[e].push(t), () => {
      this.off(e, t);
    };
  }
  // }}}
  ...
  off(e, t) {
    ...
    let r = !1, s = 0;
    for (const n of g(this, c)[e])
      n === t && (g(this, c)[e].splice(s, 1), r = !0), s++;
    if (!r)
...
function J(o, e = {}) {
  ...
  return o.classList.add("ripple-container"), o.style.overflow = "hidden", e.useClick === !0 ? o.addEventListener("click", (n) => {
    t = wt(n, e), yt(t);
  }) : (o.addEventListener("pointerdown", r), o.addEventListener("pointerup", s), o.addEventListener("pointerleave", s)), () => {
    o.classList.remove("ripple-container"), o.removeEventListener("pointerdown", r), o.removeEventListener("pointerup", s), o.removeEventListener("pointerleave", s);
  };
}
function Et() {
...
const Mt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.ui = {
      ...
      set position(e) {
        if (e || (e = v.defaultAttributes.position), !e) {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
        ...
        `;
    for (const [e, t] of Object.entries(v.defaultAttributes))
...
const w = class w extends HTMLElement {
  ...
  shadowRender() {
    this.shadowRoot.innerHTML = a`
            ...
            <slot></slot>
        `;
    for (const [e, t] of Object.entries(w.defaultAttributes))
      !this.hasAttribute(e) && t !== null && this.setAttribute(e, t);
  }
  render() {
  }
...
i(w, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", w);
}), i(w, "defaultAttributes", {});
let Q = w;
const d = class d extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.removeRippleCallback = null, this.ui = {
      ...
      set noRipple(e) {
        if (e || (e = !!d.defaultAttributes.noRipple), !e) {
      ...
      set disabled(e) {
        if (e || (e = !!d.defaultAttributes.disabled), !e) {
  ...
  render() {
    this.setAttribute("role", "button"), this.addEventListener("click", async () => {
      this.ui.events.dispatch("click", this);
    }), this.ui.noRipple || this.attributeChangedCallback("no-ripple", null, null);
  }
  /**
   * @param {string} name
...
i(k, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", k);
}), i(k, "observedAttributes", ["no-ripple", "color"]);
let B = k;
...
`, j = class j extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      open(t = !1, r = !0) {
        ...
        this.dialog.inert = r, t ? this.dialog.showModal() : this.dialog.show(), this.events.dispatch("open", null), this.dialog.inert = s;
      },
      close() {
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".header ui-icon-button"), r = () => {
      this.ui.close();
    };
    t.addEventListener("click", r);
    const s = this.shadowRoot.querySelector("dialog"), n = (h) => {
      h.preventDefault();
    };
    s.addEventListener("cancel", n), this.cleanup.add(() => {
      t.removeEventListener("click", r), s.removeEventListener("cancel", n);
    });
  }
  disconnectedCallback() {
    this.ui.cleanup.run(), this.cleanup.run();
...
i(j, "register", () => {
  customElements.get("ui-dialog") || customElements.define("ui-dialog", j);
});
let I = j;
...
i(C, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", C);
}), i(C, "observedAttributes", ["open"]);
let U = C;
...
i(S, "register", () => {
  $.register(), y.register(), customElements.get("ui-label") || customElements.define("ui-label", S);
}), i(S, "observedAttributes", ["ripple", "secondary", "primary"]);
let ot = S;
    ...
    switch (t) {
      case "title":
        ...
        if (s === null && n && (this.removeChild(n), n = null), s === null)
          return;
        n || (n = new y(), n.slot = "title", this.appendChild(n)), n.innerHTML = s;
        break;
      case "type":
...
i(A, "register", () => {
  customElements.get("ui-input") || customElements.define("ui-input", A);
...
const N = class N extends HTMLElement {
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), r = async (n) => {
      (n.composedPath() || []).forEach((h) => {
        h instanceof M && ([...this.querySelectorAll("ui-select-option")].forEach(
...
`, E = class E extends HTMLElement {
  ...
  attributeChangedCallback(t, r, s) {
    switch (t) {
      case "title":
        let n = this.querySelector('[slot="title"]');
        s === null && n && (this.removeChild(n), n = null), n || (n = new y(), n.slot = "title", this.appendChild(n)), n.innerHTML = s || "";
        break;
      case "value":
        this.ui.setValue(s);
        break;
...
const T = class T extends HTMLElement {
  constructor() {
    super(), this.ui = {
      ...
      get(e, t) {
        var r, s;
        return ((s = (r = this.data) == null ? void 0 : r[e]) == null ? void 0 : s[t]) || null;
      },
      /**
       * @param {"change"} key
...
i(T, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", T);
}), i(T, "observedAttributes", ["current"]);
let ut = T;
...
const R = class R extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setPage(t, r = null, s = !1) {
        if (this.lock) return;
        const n = this.pages[t]();
        this.stack.push(this.root.appendChild(n)), typeof r == "function" && setTimeout(() => r(n));
        let h = null;
        this.stack.length > 1 && !s && (h = this.stack[this.stack.length - 2], h.parentElement.removeChild(h)), this.dispatchChangeEvent(h), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
...
i(R, "register", () => {
  z.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", R);
}), i(R, "observedAttributes", ["use-history"]);
let ct = R;
...
}), i(H, "observedAttributes", ["auto", "mode"]);
let gt = H;
...
let mt = Y;
function $t() {
  Q.register(), X.register(), W.register(), B.register(), _.register(), I.register(), et.register(), tt.register(), U.register(), it.register(), st.register(), rt.register(), nt.register(), lt.register(), M.register(), at.register(), ht.register(), ut.register(), dt.register(), ct.register(), z.register(), pt.register(), mt.register(), ot.register(), $.register(), y.register(), gt.register();
}
export {
  X as UIAppBar,
  Q as UIAppBarItem,
