...
var i = (o, t, e) => (St(o, t, "read from private field"), e ? e.call(o) : t.get(o)), l = (o, t, e) => {
  if (t.has(o))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(o) : t.set(o, e);
}, c = (o, t, e, s) => (St(o, t, "write to private field"), s ? s.call(o, e) : t.set(o, e), e);
const qt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class v {
  ...
  on(t, e) {
    ...
    return i(this, g)[t] || (i(this, g)[t] = []), i(this, g)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let s = !1, a = 0;
    for (const d of i(this, g)[t])
      d === e && (i(this, g)[t].splice(a, 1), s = !0), a++;
    if (!s)
...
const n = String.raw, Ae = String.raw;
class h {
  constructor() {
    this.callbacks = [];
  }
...
const Ei = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: He
}, Symbol.toStringTag, { value: "Module" })), xt = "1", Re = n`
<style></style>
<slot></slot>
`;
let $e = class {
  ...
  get flex() {
    return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : xt;
  }
  set flex(t) {
...
const q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Re, this.cleanup = new h(), this.ui = new $e(this), this.updateStyle();
  }
  connectedCallback() {
  }
...
const j = class j extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = new h(), this.ui = new qe(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let Ze = (he = class {
  ...
  getLeftSlot() {
    return [...i(this, E).querySelectorAll('[slot="left"]')];
  }
  getCenterSlot() {
    return [...i(this, E).querySelectorAll('[slot="center"]')];
  }
  getRightSlot() {
    return [...i(this, E).querySelectorAll('[slot="right"]')];
  }
}, E = new WeakMap(), he);
const I = class I extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ne, this.cleanup = new h(), this.ui = new Ze(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(I, "register", () => {
  W.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", I);
});
let Pt = I;
const Pe = n`
<style>
...
let Ve = class {
  ...
  enableRipple() {
    this.removeRipple || (this.removeRipple = Ct(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
  }
  disableRipple() {
...
const N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Ve(this);
  }
  connectedCallback() {
...
}), r(N, "observedAttributes", ["no-ripple"]);
let Vt = N;
const Oe = n`
<style>
    :host {
...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Oe, this.setAttribute("role", "button"), this.cleanup = new h(), this.ui = new Be(this);
  }
  connectedCallback() {
    !this.hasAttribute("no-ripple") && !this.ui.removeRipple && this.ui.enableRipple();
  }
...
`, U = class U extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = De, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(lt, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", lt);
});
let Qt = lt;
const _e = n`
<style>
...
r(ct, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", ct);
});
let Wt = ct;
const ti = n`
<style>
...
r(ht, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", ht);
});
let Gt = ht;
const ei = n`
<style>
...
let ii = (ue = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    l(this, x, void 0);
    c(this, C, t), c(this, m, e), this.events = new v(), c(this, x, document.createElement("h4")), i(this, x).slot = "title", i(this, C).appendChild(i(this, x));
  }
  get fullscreen() {
  ...
  get title() {
    return i(this, x).innerText;
  }
  set title(t) {
    i(this, x).innerText = t;
  }
  getDialogElement() {
    return i(this, m);
  }
  open(t = !1, e = !0) {
    const s = i(this, m).inert;
    i(this, m).inert = e, t ? i(this, m).showModal() : i(this, m).show(), this.events.dispatch("open", null), i(this, m).inert = s;
  }
  close() {
    i(this, m).close(), this.events.dispatch("close", null);
  }
}, C = new WeakMap(), m = new WeakMap(), x = new WeakMap(), ue);
const ut = class ut extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ei, this.cleanup = new h(), this.ui = new ii(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
    ...
    const s = this.shadowRoot.querySelector("dialog"), a = (d) => {
      d.preventDefault();
    };
...
r(ut, "register", () => {
  Mt.register(), Ht.register(), W.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", ut);
});
let It = ut;
const Ut = 150, ye = document.createElement("template");
ye.innerHTML = `
    <style>
        :host {
            display: block;
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ye.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new si(this);
  }
  connectedCallback() {
    const t = (s) => {
...
const dt = class dt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(ke.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new oi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(dt, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", dt);
});
let At = dt;
...
const V = class V extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ce.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new ri(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(V, "register", () => {
  At.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", V);
}), r(V, "observedAttributes", ["title"]);
let te = V;
const ni = n`
<style>
    :host {
...
`, pt = class pt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ni, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
`, gt = class gt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ai, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let ci = (de = class {
  ...
  enableRipple() {
    i(this, A) || (this.removeRipple = Ct(i(this, u)), i(this, u).style.cursor = "pointer", this.startInputHandling());
  }
  disableRipple() {
    i(this, A) && i(this, A).call(this), this.stopInputHandling();
  }
  /**
   * @private
   */
  startInputHandling() {
    i(this, H) || (i(this, u).addEventListener("click", i(this, Y)), this.getInputSlot().forEach((t) => {
   ...
   */
  stopInputHandling() {
    i(this, u).removeEventListener("click", i(this, Y)), [...i(this, u).querySelectorAll('[slot="input"]')].forEach((t) => {
      t.removeEventListener("click", i(this, X));
    }), c(this, H, !1);
  }
}, u = new WeakMap(), H = new WeakMap(), Y = new WeakMap(), X = new WeakMap(), A = new WeakMap(), de);
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = li, this.cleanup = new h(), this.ui = new ci(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(O, "register", () => {
  Rt.register(), J.register(), customElements.get("ui-label") || customElements.define("ui-label", O);
...
let hi = class {
  ...
  set title(t) {
    ...
    t === null && e && (this.root.removeChild(e), e = null), e || (e = new J(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t || "";
  }
  get title() {
    var t;
...
const B = class B extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(xe.content.cloneNode(!0)), this.cleanup = new h(), this.ui = new hi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(B, "register", () => {
  J.register(), customElements.get("ui-input") || customElements.define("ui-input", B);
...
let di = (pe = class {
  ...
  get value() {
    return i(this, w).getAttribute("value");
  }
  set value(t) {
    i(this, w).setAttribute("value", t);
  }
  get selected() {
    return i(this, w).hasAttribute("selected");
  }
  set selected(t) {
    t ? i(this, w).setAttribute("selected", "") : i(this, w).removeAttribute("selected");
  }
}, w = new WeakMap(), pe);
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ui, this.setAttribute("role", "button"), this.ui = new di(this);
  }
};
r(mt, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", mt);
});
let G = mt;
const pi = n`
<style>
...
const ft = class ft extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = pi, this.cleanup = new h(), this.ui = new gi();
  }
  // }}}
  connectedCallback() {
...
K = new WeakMap(), // }}}
r(ft, "register", () => {
  Tt.register(), G.register(), customElements.get("ui-select") || customElements.define("ui-select", ft);
});
let se = ft;
var L, R, Q, ge;
let mi = (ge = class {
  ...
  constructor(t) {
     ...
     */
    l(this, Q, void 0);
    c(this, L, t), c(this, R, new v()), this.langType = null;
  }
  get current() {
    return i(this, L).getAttribute("current");
  }
  set current(t) {
    t === null ? i(this, L).removeAttribute("current") : i(this, L).setAttribute("current", t);
  }
  /** @returns {UILangType} */
  getFallbackElement() {
    return i(this, L).querySelector("ui-lang-type[fallback]");
  }
  /**
   ...
   */
  new(t, e) {
    this.langType = t, c(this, Q, e), i(this, R).dispatch("change", this.langType);
  }
  /**
   * @param {string} group
   * @param {string} key
  ...
  get(t, e) {
    var s, a;
    return ((a = (s = i(this, Q)) == null ? void 0 : s[t]) == null ? void 0 : a[e]) || null;
  }
  /**
   * @param {"change"} key
  ...
  on(t, e, s = !1) {
    ...
    return s && e(this.langType), i(this, R).on(t, e);
  }
}, L = new WeakMap(), R = new WeakMap(), Q = new WeakMap(), ge);
...
r(D, "register", () => {
  customElements.get("ui-lang") || customElements.define("ui-lang", D);
}), r(D, "observedAttributes", ["current"]);
let oe = D;
var f, me;
let fi = (me = class {
  /**
  ...
  */
  ...
  get name() {
    return i(this, f).getAttribute("name");
  }
  set name(t) {
    i(this, f).setAttribute("name", t);
  }
  get href() {
    return i(this, f).getAttribute("href");
  }
  set href(t) {
    i(this, f).setAttribute("href", t);
  }
  get fallback() {
    return i(this, f).hasAttribute("fallback");
  }
  set fallback(t) {
    t ? i(this, f).setAttribute("fallback", "") : i(this, f).removeAttribute("fallback");
  }
}, f = new WeakMap(), me);
const bt = class bt extends HTMLElement {
  constructor() {
    super(), this.ui = new fi(this);
  }
};
r(bt, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", bt);
});
let re = bt;
const bi = n`
<style>
...
`, vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = bi, this.cleanup = new h();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(vt, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", vt);
});
let ne = vt;
const vi = n`
    <style>
...
let wi = (fe = class {
  ...
  */
  ...
  get name() {
    return i(this, $).getAttribute("name");
  }
  set name(t) {
    i(this, $).setAttribute("name", t);
  }
}, $ = new WeakMap(), fe);
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = vi, this.cleanup = new h(), this.ui = new wi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(wt, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", wt);
});
let $t = wt;
const yi = n`
    <style>
...
let ki = (be = class {
  ...
  constructor(t) {
     ...
     */
    l(this, S, {});
    c(this, M, t), this.events = new v(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  goBack() {
    if (!this.stack.length || i(this, T))
      return;
    const t = this.stack.pop(), e = i(this, M).removeChild(t);
    this.stack.length && i(this, M).appendChild(this.stack[this.stack.length - 1]), this.dispatchChangeEvent(e);
  }
  /**
   * @param {string} name
   */
  setPage(t) {
    if (!i(this, T)) {
      if (this.stack.push(
        // @ts-expect-error
        i(this, M).appendChild(i(this, S)[t]().children[0])
      ), this.stack.length > 1) {
...
}, M = new WeakMap(), T = new WeakMap(), S = new WeakMap(), be);
const yt = class yt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = yi, this.cleanup = new h(), this.ui = new ki(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(yt, "register", () => {
  $t.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", yt);
});
let ae = yt;
var y, k, ve;
let Ci = (ve = class {
  ...
  constructor(t) {
    ...
    /** @type {any} */
    l(this, k, {});
    c(this, y, t), this.events = new v();
  }
  get localStoragePrefix() {
    return i(this, y).getAttribute("local-storage-prefix");
  }
  set localStoragePrefix(t) {
    i(this, y).setAttribute("local-storage-prefix", t);
  }
  get enableLocalStorage() {
    return i(this, y).hasAttribute("enable-local-storage");
  }
  set enableLocalStorage(t) {
    t ? i(this, y).setAttribute("enable-local-storage", "") : i(this, y).removeAttribute("enable-local-storage");
  }
  /**
   * @template {keyof T} K
   * @param {K} key
...
}, y = new WeakMap(), k = new WeakMap(), ve);
...
r(kt, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", kt);
});
let le = kt;
var b;
class xi {
  ...
  enableAutoMode() {
    if (this.removeMode(), i(this, b)) {
      this.mediaChangeHandler(i(this, b));
      return;
    }
    c(this, b, window.matchMedia("(prefers-color-scheme: dark)")), i(this, b).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(i(this, b));
  }
  disableAutoMode() {
    this.removeMedia();
  }
   ...
   */
  removeMedia() {
    i(this, b) && (i(this, b).removeEventListener("change", this.mediaChangeHandler), c(this, b, null));
  }
}
b = new WeakMap();
