...
var i = (o, e, t) => Tt(o, typeof e != "symbol" ? e + "" : e, t), At = (o, e, t) => e.has(o) || wt("Cannot " + t);
var p = (o, e, t) => (At(o, e, "read from private field"), t ? t.call(o) : e.get(o)), yt = (o, e, t) => e.has(o) ? wt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(o) : e.set(o, t);
const kt = {
  onDragStart: null,
  onDragging: null,
  onDragEnd: null
...
class d {
  ...
  on(e, t) {
    ...
    return p(this, h)[e] || (p(this, h)[e] = []), p(this, h)[e].push(t), () => {
      this.off(e, t);
    };
  }
  // }}}
  ...
  off(e, t) {
    ...
    let s = !1, r = 0;
    for (const n of p(this, h)[e])
      n === t && (p(this, h)[e].splice(r, 1), s = !0), r++;
    if (!s)
...
function B(o, e = {}) {
  ...
  return o.classList.add("ripple-container"), o.style.overflow = "hidden", e.useClick === !0 ? o.addEventListener("click", (n) => {
    t = Ct(n, e), xt(t);
  }) : (o.addEventListener("pointerdown", s), o.addEventListener("pointerup", r), o.addEventListener("pointerleave", r)), () => {
    o.classList.remove("ripple-container"), o.removeEventListener("pointerdown", s), o.removeEventListener("pointerup", r), o.removeEventListener("pointerleave", r);
  };
}
function Rt() {
  return /(android)/i.test(navigator.userAgent);
}
const l = String.raw, c = String.raw;
class a {
  constructor() {
    this.callbacks = [];
  }
...
const qt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  createRipple: B,
  css: c,
  defaultRippleOptions: St,
  html: l,
  isAndroid: Rt
}, Symbol.toStringTag, { value: "Module" })), H = "1", m = class m extends HTMLElement {
  constructor() {
    super();
    i(this, "shadowCSS", ({ flex: t = H }) => c`
        :host {
            flex: ${t};
        }
    `);
    i(this, "shadowTemplate", () => l`<slot></slot>`);
    this.attachShadow({ mode: "open" }), this.render(), this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      attr: {
       ...
       */
      setFlex(t) {
        this.attr.flex = t || H, this.root.render({ ...this.attr });
      }
    };
  }
  connectedCallback() {
...
}), i(m, "observedAttributes", ["flex"]);
let W = m;
const M = "0", b = class b extends HTMLElement {
  constructor() {
    super();
    i(this, "shadowCSS", ({ gap: t = M }) => c`
        :host {
    ...
    this.attachShadow({ mode: "open" }), this.render(), this.ui = {
       ...
       */
      setGap(t) {
        this.attr.gap = t || M, this.root.render({ ...this.attr });
      }
    };
  }
  connectedCallback() {
...
}), i(b, "observedAttributes", ["gap"]);
let _ = b;
const $ = "0", f = class f extends HTMLElement {
  constructor() {
    super();
    i(this, "shadowCSS", ({ gap: t = $ }) => c`
        :host {
            display: flex !important;
    ...
    this.attachShadow({ mode: "open" }), this.render(), this.ui = {
       ...
       */
      setGap(t) {
        this.attr.gap = t || $, this.root.render({ ...this.attr });
      }
    };
  }
  connectedCallback() {
...
i(F, "register", () => {
  customElements.get("ui-app-bar-item") || customElements.define("ui-app-bar-item", F);
});
let tt = F;
const v = class v extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.setAttribute("role", "button"), this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = B(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
      },
      disableRipple() {
        this.removeRipple && (this.removeRipple(), this.removeRipple = null, this.root.setAttribute("no-ripple", ""));
      }
    }, this.cleanup = new a(), this.render();
  }
  connectedCallback() {
  ...
  attributeChangedCallback(t, s, r) {
    switch (t) {
      case "no-ripple":
        ...
        break;
      case "color":
        r !== null && (["primary", "secondary", "destructive"].includes(
          r
        ) ? this.style.color = null : this.style.color = r);
        break;
    }
  }
  render() {
...
i(v, "register", () => {
  customElements.get("ui-button") || customElements.define("ui-button", v);
}), i(v, "observedAttributes", ["no-ripple", "color"]);
let et = v;
const w = class w extends HTMLElement {
  constructor() {
    ...
    `);
    i(this, "shadowTemplate", () => l` <ui-svg><slot></slot></ui-svg> `);
    this.attachShadow({ mode: "open" }), this.setAttribute("role", "button"), this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
...
i(w, "register", () => {
  customElements.get("ui-icon-button") || customElements.define("ui-icon-button", w);
...
i(j, "register", () => {
  customElements.get("ui-container") || customElements.define("ui-container", j);
});
let rt = j;
const Ht = l`
...
`, V = class V extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      open(t = !1, s = !0) {
        const r = this.dialog.inert;
        this.dialog.inert = s, t ? this.dialog.showModal() : this.dialog.show(), this.events.dispatch("open", null), this.dialog.inert = r;
      },
      close() {
        this.dialog.close(), this.events.dispatch("close", null);
      }
    }, this.cleanup = new a(), this.render({ ...this.ui.renderProps });
  }
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".header ui-icon-button"), s = () => {
      this.ui.close();
    };
    t.addEventListener("click", s);
    const r = this.shadowRoot.querySelector("dialog"), n = (u) => {
      u.preventDefault();
    };
    r.addEventListener("cancel", n), this.cleanup.add(() => {
      t.removeEventListener("click", s), r.removeEventListener("cancel", n);
    });
  }
  disconnectedCallback() {
    this.ui.cleanup.run(), this.cleanup.run();
...
const y = class y extends HTMLElement {
  constructor() {
    ...
    `);
    this.attachShadow({ mode: "open" }), this.render(), this.cleanup = new a(), this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
  ...
  connectedCallback() {
    const t = (r) => {
      r.stopPropagation(), this.ui.setOpen(!1);
    }, s = (r) => {
      r.stopPropagation();
    };
    this.addEventListener("click", t), this.ui.aside.addEventListener("click", s), this.cleanup.add(() => {
      this.ui.aside.removeEventListener("click", s), this.removeEventListener("click", t);
    });
  }
  disconnectedCallback() {
    this.ui.cleanup.run(), this.cleanup.run();
  ...
  attributeChangedCallback(t, s, r) {
    switch (t) {
      case "open":
        r !== null ? (this.classList.add("open"), this.ui.events.dispatch("open", this)) : (this.classList.remove("open"), this.ui.events.dispatch("close", this));
        break;
    }
  }
  render() {
    this.shadowRoot.innerHTML = `
            <style>${this.shadowCSS().trim()}</style>
            ${this.shadowTemplate().trim()}
        `, this.ui && (this.ui.aside = this.shadowRoot.querySelector("aside"));
  }
};
i(y, "register", () => {
  customElements.get("ui-drawer") || customElements.define("ui-drawer", y);
}), i(y, "observedAttributes", ["open"]);
let ot = y;
const k = class k extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.render(), this.ui = {
       ...
       */
      setTitle(t) {
        let s = this.root.shadowRoot.querySelector(
          ".ui-drawer-group-title"
        );
        s.classList.add("visible"), s.innerHTML = `
                    <span
                        style="
                            font-size: 1.5rem;
                            font-weight: 600;
  ...
  attributeChangedCallback(t, s, r) {
    switch (t) {
      case "title":
        r === "" ? this.removeAttribute("title") : r !== null ? this.ui.setTitle(r) : this.ui.removeTitle();
        break;
    }
  }
  render() {
...
i(k, "register", () => {
  customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", k);
}), i(k, "observedAttributes", ["title"]);
let nt = k;
...
i(N, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", N);
});
let at = N;
...
i(O, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", O);
});
let z = O;
...
const C = class C extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = B(this.root), this.root.style.cursor = "pointer", this.startInputHandling());
      },
      disableRipple() {
...
i(C, "register", () => {
  z.register(), g.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
}), i(C, "observedAttributes", ["ripple", "secondary", "primary"]);
let lt = C;
  ...
  attributeChangedCallback(t, s, r) {
    switch (t) {
      case "title":
        ...
        if (r === null && n && (this.removeChild(n), n = null), r === null)
          return;
        n || (n = new g(), n.slot = "title", this.appendChild(n)), n.innerHTML = r;
        break;
      case "type":
        this.ui.input.type = r || "text";
        break;
      case "value":
        this.ui.setValue(r);
        break;
      case "placeholder":
        this.ui.input.placeholder = r || "";
        break;
      case "invalid":
        this.ui.input.ariaInvalid = r;
        break;
      case "min":
        this.ui.input.min = r || "";
        break;
...
i(x, "register", () => {
  customElements.get("ui-input") || customElements.define("ui-input", x);
}), i(x, "observedAttributes", [
  "title",
  "type",
  "value",
  "placeholder",
...
const K = class K extends HTMLElement {
  constructor() {
    ...
    i(this, "shadowTemplate", () => l`
        <div class="options">
            <div class="icon"><ui-svg>${Mt}</ui-svg></div>
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), s = async (n) => {
      (n.composedPath() || []).forEach((u) => {
        u instanceof R && ([...this.querySelectorAll("ui-select-option")].forEach(
          (Q) => Q.removeAttribute("selected")
        ), u.setAttribute("selected", ""), this.ui.events.dispatch("change", u));
      });
    }, r = (n) => {
      this.classList.toggle("open") ? (n.stopPropagation(), this.addEventListener("click", s)) : setTimeout(
        () => this.removeEventListener("click", s)
      );
    };
    t.addEventListener("click", r), this.cleanup.add(() => {
      this.removeEventListener("click", r), t.removeEventListener("click", r);
...
i(K, "register", () => {
  customElements.get("ui-select") || customElements.define("ui-select", K);
});
let ut = K;
const $t = l`
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`, S = class S extends HTMLElement {
  constructor() {
    ...
    i(this, "shadowTemplate", () => l`
        <div class="container">
            <slot name="title"></slot>
            <input type="search" />
            <ui-icon-button ghost>${$t}</ui-icon-button>
        </div>
    `);
    this.attachShadow({ mode: "open" }), this.ui = {
      /** @private */
  ...
  attributeChangedCallback(t, s, r) {
    switch (t) {
      case "title":
        let n = this.querySelector('[slot="title"]');
        r === null && n && (this.removeChild(n), n = null), n || (n = new g(), n.slot = "title", this.appendChild(n)), n.innerHTML = r || "";
        break;
      case "value":
        this.ui.setValue(r);
        break;
      ...
      case "invalid":
        ...
        break;
      case "no-submit":
        r !== null ? this.ui.disableSubmit() : this.ui.enableSubmit();
        break;
      case "use-storage":
  ...
  render() {
    ...
    {
      this.ui.input = this.shadowRoot.querySelector("input"), this.ui.input.type = "text", this.ui.input.onkeydown = async (s) => {
        this.ui.hasSubmit() && s.key === "Enter" && this.ui.submit.click();
...
i(S, "register", () => {
  customElements.get("ui-search") || customElements.define("ui-search", S);
...
i(Y, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", Y);
});
let dt = Y;
const E = class E extends HTMLElement {
  constructor() {
    super(), this.ui = {
      ...
      get(e, t) {
        var s, r;
        return ((r = (s = this.data) == null ? void 0 : s[e]) == null ? void 0 : r[t]) || null;
      },
      /**
       * @param {"change"} key
      ...
      on(e, t, s = !1) {
        ...
        return s && t(this.langType), this.events.on(e, t);
      }
    };
  }
  /**
  ...
  async loadLanguage(e) {
    ...
    const s = await fetch(t.ui.getHref());
    this.ui.new(t, await s.json());
  }
};
i(E, "register", () => {
...
i(J, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", J);
});
let gt = J;
...
i(Z, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", Z);
});
let q = Z;
const T = class T extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.ui = {
       ...
       */
      setPage(t, s = null, r = !1) {
        if (this.lock) return;
        const n = this.pages[t]();
        this.stack.push(this.root.appendChild(n)), typeof s == "function" && setTimeout(() => s(n));
        let u = null;
        this.stack.length > 1 && !r && (u = this.stack[this.stack.length - 2], u.parentElement.removeChild(u)), this.dispatchChangeEvent(u), this.onpopstate !== null && history.pushState(null, document.title, location.href);
      },
      /**
  ...
  attributeChangedCallback(t, s, r) {
    switch (t) {
      case "use-history":
        r !== null ? this.ui.enableHistory() : this.ui.disableHistory();
        break;
    }
  }
  render() {
...
i(T, "register", () => {
  q.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", T);
  ...
  constructor() {
    super(), this.ui = {
      ...
      on(e, t, s = !1) {
        if (typeof t != "function")
          throw "callback is not a function";
        return s && t(this.get(e)), this.events.on(e, t);
      }
    };
  }
  /**
...
i(A, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", A);
}), i(A, "observedAttributes", ["use-storage", "storage-prefix"]);
let bt = A;
...
i(X, "register", () => {
  customElements.get("ui-svg") || customElements.define("ui-svg", X);
});
let vt = X;
function Pt() {
  tt.register(), U.register(), et.register(), it.register(), rt.register(), st.register(), at.register(), nt.register(), ot.register(), W.register(), _.register(), I.register(), ct.register(), ht.register(), R.register(), ut.register(), dt.register(), pt.register(), gt.register(), mt.register(), q.register(), bt.register(), vt.register(), lt.register(), z.register(), g.register(), ft.register();
}
export {
  U as UIAppBar,
  tt as UIAppBarItem,
