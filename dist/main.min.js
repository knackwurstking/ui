...
o(V, "register", () => {
  S.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", V);
});
let vt = V;
const re = n`
    <style>
...
o(J, "register", () => {
  lt.register(), R.register(), S.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", J);
});
let Vt = J;
const Zt = 150, Ce = n`
    <style>
...
o(M, "register", () => {
  ht.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", M);
