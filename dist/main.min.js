...
var Xt = (o, t, e) => t in o ? Jt(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => (Xt(o, typeof t != "symbol" ? t + "" : t, e), e), Qt = (o, t, e) => {
  if (!t.has(o))
    throw TypeError("Cannot " + e);
};
var d = (o, t, e) => (Qt(o, t, "read from private field"), e ? e.call(o) : t.get(o)), Ot = (o, t, e) => {
  if (t.has(o))
...
function Wt(o, t = {}) {
  ...
  const e = () => {
    const l = [...o.parentNode.children].indexOf(o);
    o.draggable = !0, o.ondragstart = (c) => {
      c.dataTransfer.effectAllowed = "move", c.dataTransfer.dropEffect = "move", c.dataTransfer.setData(
        "text/plain",
        l.toString()
      ), t.onDragStart && t.onDragStart(l);
    }, o.ondragover = (c) => (c.preventDefault(), !1), o.ondragenter = (c) => {
...
const Ge = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: It
}, Symbol.toStringTag, { value: "Module" })), ut = "1", te = n`
    <style></style>
    <slot></slot>
`, f = class f extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = te, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      getFlex() {
        return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : ut;
      },
      /**
...
`, m = class m extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ee, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      getGap() {
...
`, b = class b extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ie, this.ui = {
      /**
       * @private
       */
      root: this,
...
`, F = class F extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = re, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      getLeftSlot() {
...
r(F, "register", () => {
  R.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", F);
});
let ft = F;
const oe = n`
    <style>
...
`, z = class z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = oe, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      enable() {
...
}), r(v, "observedAttributes", ["no-ripple", "color"]);
let bt = v;
const ne = n`
    <style>
        * {
...
}), r(w, "observedAttributes", ["no-ripple", "color"]);
let H = w;
const ae = n`
    <style>
        * {
...
`, q = class q extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ae, this.ui = {
      cleanup: new a()
    };
  }
  connectedCallback() {
...
r(O, "register", () => {
  customElements.get("svg-plus") || customElements.define("svg-plus", O);
});
let wt = O;
const ce = n`
    <style>
...
r(_, "register", () => {
  customElements.get("svg-chevron-left") || customElements.define("svg-chevron-left", _);
});
let kt = _;
const ue = n`
    <style>
...
r(P, "register", () => {
  customElements.get("svg-chevron-down") || customElements.define("svg-chevron-down", P);
});
let T = P;
const he = n`
    <style>
...
r(N, "register", () => {
  customElements.get("svg-close") || customElements.define("svg-close", N);
});
let V = N;
const de = n`
    <style>
...
r(D, "register", () => {
  customElements.get("svg-download") || customElements.define("svg-download", D);
});
let yt = D;
const pe = n`
    <style>
...
r(K, "register", () => {
  customElements.get("svg-pen") || customElements.define("svg-pen", K);
});
let Ct = K;
const ge = n`
    <style>
...
r(Y, "register", () => {
  customElements.get("svg-document-new") || customElements.define("svg-document-new", Y);
});
let Lt = Y;
const fe = n`
    <style>
...
r(J, "register", () => {
  customElements.get("svg-trash") || customElements.define("svg-trash", J);
});
let xt = J;
const me = n`
    <style>
...
r(X, "register", () => {
  customElements.get("svg-search") || customElements.define("svg-search", X);
});
let Z = X;
const be = n`
    <style>
...
r(Q, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", Q);
});
let Mt = Q;
const ve = n`
    <style>
...
r(W, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", W);
});
let Et = W;
const we = n`
    <style>
...
r(I, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", I);
});
let St = I;
const ke = n`
    <style>
...
r(U, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", U);
});
let At = U;
const ye = n`
    <style>
...
r(tt, "register", () => {
  V.register(), H.register(), R.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", tt);
});
let Rt = tt;
const Dt = 150, Ce = n`
    <style>
...
`, et = class et extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Le, this.ui = {
      cleanup: new a()
    };
  }
  connectedCallback() {
...
r(et, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", et);
});
let $ = et;
const xe = n`
    <style>
...
`, y = class y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = xe, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      getTitle() {
...
r(y, "register", () => {
  $.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", y);
}), r(y, "observedAttributes", ["title"]);
let Tt = y;
const Me = n`
    <style>
        :host {
...
`, it = class it extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this.ui = {
      cleanup: new a()
    };
  }
  connectedCallback() {
...
r(it, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", it);
});
let j = it;
const Ee = n`
    <style>
...
r(rt, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", rt);
});
let p = rt;
const Se = n`
    <style>
...
`, C = class C extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      /** @private */
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = ct(this.root), this.root.style.cursor = "pointer", this.startInputHandling());
      },
      disableRipple() {
...
r(C, "register", () => {
  j.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", C);
}), r(C, "observedAttributes", ["ripple", "secondary", "primary"]);
let Vt = C;
const Ae = n`
    <style>
        * {
...
r(ot, "register", () => {
  customElements.get("ui-select-option") || customElements.define("ui-select-option", ot);
});
let g = ot;
const He = n`
    <style>
  ...
  connectedCallback() {
    const t = this.shadowRoot.querySelector(".options"), e = async (s) => {
      (s.composedPath() || []).forEach((l) => {
        l instanceof g && ([...this.querySelectorAll("ui-select-option")].forEach(
...
r(st, "register", () => {
  T.register(), g.register(), customElements.get("ui-select") || customElements.define("ui-select", st);
});
let $t = st;
const Te = n`
    <style>
...
r(x, "register", () => {
  p.register(), H.register(), Z.register(), customElements.get("ui-search") || customElements.define("ui-search", x);
}), r(x, "observedAttributes", [
  "title",
  "value",
  "placeholder",
  "invalid",
...
r(nt, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", nt);
});
let G = nt;
...
r(M, "register", () => {
  G.register(), customElements.get("ui-lang") || customElements.define("ui-lang", M);
}), r(M, "observedAttributes", ["current"]);
let Gt = M;
const Ve = n`
    <style>
        :host {
...
`, at = class at extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.ui = {
      cleanup: new a()
    };
  }
  connectedCallback() {
...
r(at, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", at);
});
let Bt = at;
const Ze = n`
    <style>
...
`, lt = class lt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ze, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      getName() {
...
`, E = class E extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = $e, this.ui = {
      /** @private */
      root: this,
      cleanup: new a(),
      /**
...
r(E, "register", () => {
  B.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", E);
}), r(E, "observedAttributes", ["use-history"]);
let Ft = E;
...
r(A, "register", () => {
  customElements.get("ui-theme-handler") || customElements.define("ui-theme-handler", A);
}), r(A, "observedAttributes", ["auto", "mode"]);
let qt = A;
function Be() {
  mt.register(), ft.register(), bt.register(), H.register(), vt.register(), Rt.register(), $.register(), Tt.register(), Ht.register(), pt.register(), R.register(), gt.register(), Zt.register(), jt.register(), g.register(), $t.register(), G.register(), Gt.register(), Bt.register(), Ft.register(), B.register(), zt.register(), Vt.register(), j.register(), p.register(), qt.register();
}
function Fe() {
  T.register(), kt.register(), V.register(), Lt.register(), yt.register(), Et.register(), Ct.register(), wt.register(), Z.register(), Mt.register(), St.register(), At.register(), xt.register();
}
export {
  T as SvgChevronDown,
  kt as SvgChevronLeft,
  V as SvgClose,
  Lt as SvgDocumentNew,
  yt as SvgDownload,
  Et as SvgMenu,
  Ct as SvgPen,
  wt as SvgPlus,
  ...
  Bt as UISpinner,
  Ft as UIStackLayout,
  B as UIStackLayoutPage,
  zt as UIStore,
  qt as UIThemeHandler,
  Ge as js,
  Be as registerComponents,
  Fe as registerSVGs
};
