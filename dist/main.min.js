...
var Gt = (s, t, e) => t in s ? Wt(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e;
var o = (s, t, e) => (Gt(s, typeof t != "symbol" ? t + "" : t, e), e), It = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
};
var h = (s, t, e) => (It(s, t, "read from private field"), e ? e.call(s) : t.get(s)), rt = (s, t, e) => {
  if (t.has(s))
...
class d {
  ...
  off(t, e) {
    ...
    let i = !1, r = 0;
    for (const l of h(this, u)[t])
      l === e && (h(this, u)[t].splice(r, 1), i = !0), r++;
    if (!i)
...
const n = String.raw, te = String.raw;
class a {
  constructor() {
    this.callbacks = [];
  }
...
const Pe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  html: n,
  isAndroid: _t
}, Symbol.toStringTag, { value: "Module" })), nt = "1", ee = n`
    <style></style>
    <slot></slot>
`, g = class g extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ee, this.cleanup = new a(), this.ui = {
      ...
      root: this,
      getFlex() {
        return this.root.hasAttribute("flex") ? this.root.getAttribute("flex") : nt;
      },
      /**
...
o(S, "register", () => {
  T.register(), customElements.get("ui-app-bar") || customElements.define("ui-app-bar", S);
});
let wt = S;
const re = n`
    <style>
...
`, f = class f extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ne, this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = st(this.root, { centered: !0 }), this.root.removeAttribute("no-ripple"));
      },
      disableRipple() {
...
`, v = class v extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ae, this.setAttribute("role", "button"), this.cleanup = new a(), this.ui = {
      /** @private */
      root: this,
      /**
...
o(j, "register", () => {
  customElements.get("svg-add") || customElements.define("svg-add", j);
});
let xt = j;
const he = n`
<style>
...
o(q, "register", () => {
  customElements.get("svg-back-arrow") || customElements.define("svg-back-arrow", q);
});
let Lt = q;
const ue = n`
<style>
...
o(N, "register", () => {
  customElements.get("svg-chevron-down") || customElements.define("svg-chevron-down", N);
});
let ct = N;
const de = n`
<style>
...
o(V, "register", () => {
  customElements.get("svg-download") || customElements.define("svg-download", V);
});
let Et = V;
const ge = n`
<style>
...
o(O, "register", () => {
  customElements.get("svg-edit") || customElements.define("svg-edit", O);
});
let Mt = O;
const me = n`
<style>
...
o(F, "register", () => {
  customElements.get("svg-recycle") || customElements.define("svg-recycle", F);
});
let At = F;
const fe = n`
<style>
...
o(D, "register", () => {
  customElements.get("svg-search") || customElements.define("svg-search", D);
});
let ut = D;
const ve = n`
<style>
...
o(B, "register", () => {
  customElements.get("svg-settings") || customElements.define("svg-settings", B);
});
let Ht = B;
const we = n`
<style>
...
o(Y, "register", () => {
  customElements.get("svg-menu") || customElements.define("svg-menu", Y);
});
let Rt = Y;
const ye = n`
<style>
...
o(J, "register", () => {
  customElements.get("svg-share") || customElements.define("svg-share", J);
});
let St = J;
const ke = n`
<style>
...
o(X, "register", () => {
  customElements.get("svg-today") || customElements.define("svg-today", X);
});
let $t = X;
const Ce = n`
    <style>
...
o(K, "register", () => {
  A.register(), ht.register(), T.register(), customElements.get("ui-dialog") || customElements.define("ui-dialog", K);
});
let zt = K;
const jt = 150, xe = n`
    <style>
...
o(Q, "register", () => {
  customElements.get("ui-primary") || customElements.define("ui-primary", Q);
});
let H = Q;
const Ee = n`
    <style>
...
o(W, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", W);
});
let p = W;
const Me = n`
    <style>
...
`, y = class y extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Me, this.cleanup = new a(), this.ui = {
      ...
      enableRipple() {
        this.removeRipple || (this.removeRipple = st(this.root), this.root.style.cursor = "pointer", this.startInputHandling());
      },
      disableRipple() {
...
o(y, "register", () => {
  H.register(), p.register(), customElements.get("ui-label") || customElements.define("ui-label", y);
...
o(G, "register", () => {
  customElements.get("ui-drawer-group-item") || customElements.define("ui-drawer-group-item", G);
});
let dt = G;
const Ae = n`
    <style>
...
o(k, "register", () => {
  dt.register(), H.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", k);
  ...
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = He, this.cleanup = new a(), this.ui = {
      ...
      setTitle(t) {
        ...
        t === null && e && (this.root.removeChild(e), e = null), e || (e = new p(), e.slot = "title", this.root.appendChild(e)), e.innerHTML = t || "";
      },
      getTitle() {
        var t;
  ...
  attributeChangedCallback(t, e, i) {
    switch (t) {
      case "title":
        ...
        break;
      case "type":
        i === null ? this.ui.setType("text") : this.ui.setType(i);
        break;
      case "value":
        this.ui.setValue(this.parseNewValue(i));
        break;
      case "placeholder":
        i === null ? this.ui.setPlaceholder(null) : this.ui.setPlaceholder(i);
        break;
      case "invalid":
        this.ui.setInvalid(i !== null);
        break;
      case "min":
        this.ui.setMin(this.parseNewValue(i));
        break;
      case "max":
        this.ui.setMax(this.parseNewValue(i));
        break;
    }
  }
  /**
...
const U = class U extends HTMLElement {
  constructor() {
    ...
    rt(this, M, async (e) => {
      (e.composedPath() || []).forEach((i) => {
        i instanceof R && ([...this.querySelectorAll("ui-select-option")].forEach(
          (r) => r.removeAttribute("selected")
        ), i.setAttribute("selected", ""), this.ui.events.dispatch("change", i));
      });
    });
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Se, this.cleanup = new a(), this.ui = {
      /**
  ...
  async onClickOptions(e) {
    this.classList.toggle("open") ? (e.stopPropagation(), this.addEventListener("click", h(this, M))) : setTimeout(() => this.removeEventListener("click", h(this, M)));
  }
};
M = new WeakMap(), // }}}
o(U, "register", () => {
  ct.register(), R.register(), customElements.get("ui-select") || customElements.define("ui-select", U);
});
let Ot = U;
const $e = n`
    <style>
...
o(x, "register", () => {
  p.register(), A.register(), ut.register(), customElements.get("ui-search") || customElements.define("ui-search", x);
...
o(_, "register", () => {
  customElements.get("ui-lang-type") || customElements.define("ui-lang-type", _);
});
let Dt = _;
const ze = n`
    <style>
...
o(tt, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", tt);
});
let Bt = tt;
const je = n`
    <style>
...
o(et, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", et);
});
let pt = et;
const qe = n`
    <style>
...
`, it = class it extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = qe, this.cleanup = new a(), this.ui = {
      /** @private */
      root: this,
      /**
       * @private
      ...
      setPage(t, e = !1) {
        if (this.lock)
          return;
        this.stack.push(this.root.appendChild(this.pages[t]()));
        let i = null;
...
o(it, "register", () => {
  pt.register(), customElements.get("ui-stack-layout") || customElements.define("ui-stack-layout", it);
});
let Yt = it;
        ...
        if (i && this.enableLocalStorage) {
          const r = JSON.parse(
            localStorage.getItem(
              this.localStoragePrefix + t.toString()
            ) || "null"
          );
          this.stores[t] = r ?? e;
        } else
          this.stores[t] = e;
        this.enableLocalStorage && localStorage.setItem(
          this.localStoragePrefix + t.toString(),
...
o(ot, "register", () => {
  customElements.get("ui-store") || customElements.define("ui-store", ot);
});
let Jt = ot;
...
export {
  ...
  qt as UIDrawer,
  Pt as UIDrawerGroup,
  dt as UIDrawerGroupItem,
  vt as UIFlexGrid,
  ft as UIFlexGridItem,
  T as UIFlexGridRow,
  A as UIIconButton,
  Vt as UIInput,
  Nt as UILabel,
