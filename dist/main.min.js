...
const Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Pe, this.cleanup = new h(), this.ui = new Ve(this), this.updateStyle();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let Be = (de = class {
  ...
  getLeftSlot() {
    return [...i(this, T).querySelectorAll('[slot="left"]')];
  }
  getCenterSlot() {
    return [...i(this, T).querySelectorAll('[slot="center"]')];
  }
  getRightSlot() {
    return [...i(this, T).querySelectorAll('[slot="right"]')];
  }
}, T = new WeakMap(), de);
...
let ni = (me = class {
  ...
  constructor(t, e) {
    ...
    /** @type {HTMLElement} */
    l(this, L, void 0);
    c(this, x, t), c(this, b, e), this.events = new M(), c(this, L, document.createElement("h4")), i(this, L).slot = "title", i(this, x).appendChild(i(this, L));
  }
  get fullscreen() {
...
let ai = class {
   ...
   */
  constructor(t) {
    this.root = t, this.aside = this.root.shadowRoot.querySelector("aside"), this.events = new M();
  }
  get open() {
...
let ci = class {
   ...
   */
  setTitle(t) {
    let e = this.root.querySelector('ui-drawer-group-item[slot="title"]');
    e || (e = new U(), e.slot = "title"), e.innerHTML = `
            <h4>${t}</h4>
        `, this.root.appendChild(e);
  }
  removeTitle() {
    const t = this.root.querySelector('span[slot="title"]');
    t && this.root.removeChild(t);
  }
};
...
r(B, "register", () => {
  U.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", B);
...
r(D, "register", () => {
  St.register(), X.register(), customElements.get("ui-label") || customElements.define("ui-label", D);
...
let gi = class {
   ...
   */
  constructor(t) {
    this.root = t, this.events = new M(), this.input = this.root.shadowRoot.querySelector("input"), this.input.type = this.root.getAttribute("type") || "text", this.input.oninput = () => this.events.dispatch("input", this.value), this.input.onchange = () => this.events.dispatch("change", this.value);
  }
  /**
   * @param {string | null} v
   */
...
let wi = (ve = class {
  ...
  constructor(t) {
     ...
     */
    l(this, G, void 0);
    c(this, E, t), c(this, S, new M()), this.langType = null;
  }
  get current() {
...
let Ei = (ke = class {
  ...
  constructor(t) {
     ...
     */
    l(this, j, {});
    c(this, H, t), this.events = new M(), this.stack = [];
  }
  /**
   * @param {string} name
  ...
  setPage(t) {
    if (!i(this, A)) {
      if (this.stack.push(
        // @ts-expect-error
        i(this, H).appendChild(i(this, j)[t]().children[0])
      ), this.stack.length > 1) {
...
}, H = new WeakMap(), A = new WeakMap(), j = new WeakMap(), ke);
