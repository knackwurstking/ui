...
var Lt = (o, t, e) => t in o ? St(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[t] = e;
var r = (o, t, e) => Lt(o, typeof t != "symbol" ? t + "" : t, e), Tt = (o, t, e) => t.has(o) || yt("Cannot " + e);
...
const x = class x extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.removeRipple = null, this.running = !1, this.onClick = async () => {
      ...
      set primary(t) {
        this.root.shadowRoot.querySelector("ui-primary").innerText = t || "";
      },
      get secondary() {
        return this.root.shadowRoot.querySelector("ui-secondary").innerText;
      },
      set secondary(t) {
        this.root.shadowRoot.querySelector("ui-secondary").innerText = t || "";
      },
      get inputSlot() {
...
r(S, "register", () => {
  customElements.get("ui-spinner") || customElements.define("ui-spinner", S);
}), r(S, "observedAttributes", ["nobg"]);
let pt = S;
...
r(L, "register", () => {
  customElements.get("ui-stack-layout-page") || customElements.define("ui-stack-layout-page", L);
}), r(L, "observedAttributes", ["name"]);
let gt = L;
const Y = class Y extends HTMLElement {
  constructor() {
