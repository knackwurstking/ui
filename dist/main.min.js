...
`, N = class N extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Be, this.setAttribute("role", "button"), this.cleanup = new c(), this.ui = {
      /**
      ...
      enableRipple: () => {
        this.ui.removeRipple || (this.ui.removeRipple = Mt(this, { centered: !0 }), this.removeAttribute("no-ripple"));
      },
      disableRipple: () => {
...
`, Z = class Z extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ve, this.setAttribute("role", "button"), this.cleanup = new c(), this.ui = {
      /**
...
`, et = class et extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = Ye, this.cleanup = new c(), this.ui = {};
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const mt = class mt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = oi, this.cleanup = new c(), this.ui = new ri(this, this.shadowRoot.querySelector("dialog"));
  }
  connectedCallback() {
...
const P = class P extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Le.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new ni(this);
  }
  connectedCallback() {
    const t = (i) => {
...
`, ft = class ft extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ai, this.cleanup = new c();
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
r(ft, "register", () => {
  customElements.get("ui-secondary") || customElements.define("ui-secondary", ft);
});
let T = ft;
const ci = l`
<style>
...
}, u = new WeakMap(), H = new WeakMap(), J = new WeakMap(), X = new WeakMap(), A = new WeakMap(), be);
const O = class O extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = ci, this.cleanup = new c(), this.ui = new hi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const vt = class vt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Ee.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new ui(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const D = class D extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Me.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new di(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const F = class F extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.appendChild(Te.content.cloneNode(!0)), this.cleanup = new c(), this.ui = new pi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
const wt = class wt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = gi, this.setAttribute("role", "button"), this.ui = new mi(this);
  }
};
r(wt, "register", () => {
...
const yt = class yt extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = bi, this.cleanup = new c(), this.ui = new fi();
  }
  // }}}
  connectedCallback() {
...
const B = class B extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = vi, this.cleanup = new c(), this.ui = new wi(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
let ki = (we = class {
  ...
  */
  ...
  get name() {
    return s(this, b).getAttribute("name");
  }
  set name(t) {
    s(this, b).setAttribute("name", t);
  }
  get href() {
    return s(this, b).getAttribute("href");
  }
  set href(t) {
    s(this, b).setAttribute("href", t);
  }
  get fallback() {
    return s(this, b).hasAttribute("fallback");
  }
  set fallback(t) {
    t ? s(this, b).setAttribute("fallback", "") : s(this, b).removeAttribute("fallback");
  }
}, b = new WeakMap(), we);
const kt = class kt extends HTMLElement {
  constructor() {
    super(), this.ui = new ki(this);
  }
};
r(kt, "register", () => {
...
const xt = class xt extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.innerHTML = xi, this.cleanup = new c(), this.ui = new Li(this);
  }
  connectedCallback() {
  }
  disconnectedCallback() {
...
class Hi {
  ...
  enableAutoMode() {
    if (this.removeMode(), s(this, f)) {
      this.mediaChangeHandler(s(this, f));
      return;
    }
    h(this, f, window.matchMedia("(prefers-color-scheme: dark)")), s(this, f).addEventListener("change", this.mediaChangeHandler), this.mediaChangeHandler(s(this, f));
  }
  disableAutoMode() {
    this.removeMedia();
  }
   ...
   */
  removeMedia() {
    s(this, f) && (s(this, f).removeEventListener("change", this.mediaChangeHandler), h(this, f, null));
  }
}
f = new WeakMap();
const Y = class Y extends HTMLElement {
  constructor() {
    super(), this.ui = new Hi();
  }
  /**
   * @param {string} name
   * @param {string | null} _oldValue 
