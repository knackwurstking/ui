...
var u = (r, t, e) => (Qt(r, t, "read from private field"), e ? e.call(r) : t.get(r)), ut = (r, t, e) => {
  if (t.has(r))
...
class d {
  ...
  on(t, e) {
    ...
    return u(this, h)[t] || (u(this, h)[t] = []), u(this, h)[t].push(e), () => {
      this.off(t, e);
    };
  }
  // }}}
  ...
  off(t, e) {
    ...
    let i = !1, s = 0;
    for (const a of u(this, h)[t])
      a === e && (u(this, h)[t].splice(s, 1), i = !0), s++;
    if (!i)
...
o(k, "register", () => {
  ht.register(), S.register(), customElements.get("ui-drawer-group") || customElements.define("ui-drawer-group", k);
