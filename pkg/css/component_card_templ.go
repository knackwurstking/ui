...
//
// This file contains all the constant class names used for styling card components.
// The constants are grouped by category to improve readability and maintainability.
