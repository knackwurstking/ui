...
class MainAppBar extends UIAppBar<"title"> {
    ...
    protected renderDialogsSection() {
        return html`
            <section id="dialogs" class="has-border" style="margin-top: var(--ui-spacing)">
                ...
                <ui-dialog name="dialog1" title="Dialog Title" no-footer modal inert>
                    <div class="flex justify-center align-center">
                        <ui-text>Dialog content here...</ui-text>
                    </div>
                </ui-dialog>

                <ui-dialog name="dialog2" title="Dialog Title" fullscreen no-footer modal inert>
                    <div class="flex justify-center align-center">
                        <ui-text>Dialog content here...</ui-text>
                    </div>
                </ui-dialog>
