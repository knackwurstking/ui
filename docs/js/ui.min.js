...
function $(r, t) {
  ...
  const u = (i) => {
    ...
    if (c) {
      ...
      c.classList.contains("draggable") && ((() => {
        ...
        return !1;
      })() ? r.insertBefore(e, c) : r.insertBefore(e, c.nextElementSibling));
    }
  }, d = () => {
  ...
  return [...r.children].forEach((i) => {
    i.classList.add("draggable"), i.onmousedown = u, i.ontouchstart = u, i.onmousemove = g, i.ontouchmove = g, r.onmouseleave = i.onmouseup = d, i.ontouchend = d;
  }), () => {
  ...
  async function l(n) {
    ...
    if ((e == null ? void 0 : e.href) !== void 0) {
      ...
      r.innerHTML = u, e.scripts !== void 0 && e.scripts.forEach((g) => {
        ...
        d.setAttribute("data-template", e.href), d.src = g.src, r.appendChild(d);
      });
    }
...
function D(r, t) {
  let e;
  if (r ? e = `?${Object.entries(r).map(([l, n]) => `${encodeURIComponent(l)}=${encodeURIComponent(n)}`).join("&")}` : e = "", !t && !e) {
    location.hash = "";
    return;
  }
